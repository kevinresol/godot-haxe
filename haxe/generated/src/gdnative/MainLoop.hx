...
/**
	Class
**/
@:forward abstract MainLoop(MainLoop_extern) from MainLoop_extern to MainLoop_extern {
	@:from
...
@:include("godot_cpp/classes/main_loop.hpp") @:semantic(reference) @:cpp.PointerType({ type : "MainLoop", namespace : ['godot'] }) extern class MainLoop_extern extends gdnative.Object.Object_extern {
