...
/**
	Built-in Class
**/
@:forward abstract Array(Array_extern) from Array_extern to Array_extern {
	@:from
	...
	@:to
	inline function toVariant():gdnative.Variant return new gdnative.Variant.Variant_extern(untyped __cpp__("static_cast<godot::Array &>({0})", this));
	inline function val():Array_extern return untyped __cpp__('(*{0})', this);
	@:op(A == B)
	...
	public extern overload inline function new(p_base:gd.Array, p_type:cpp.Int64, p_class_name:std.String, p_script:gd.Variant) this = new gdnative.Array.Array_extern(p_base, p_type, p_class_name, p_script);
...
@:include("godot_cpp/variant/array.hpp") @:semantics(reference) @:cpp.ValueType({ type : "Array", namespace : ['godot'] }) extern class Array_extern {
	...
	function get(p_index:cpp.Int64):gdnative.Variant;
	function set(p_index:cpp.Int64, p_value:gdnative.Variant):Void;
	...
	function resize(p_size:cpp.Int64):cpp.Int64;
	function insert(p_position:cpp.Int64, p_value:gdnative.Variant):cpp.Int64;
	function remove_at(p_position:cpp.Int64):Void;
	...
	overload function find(p_what:gdnative.Variant):cpp.Int64;
	overload function find(p_what:gdnative.Variant, p_from:cpp.Int64):cpp.Int64;
	overload function find_custom(p_method:gdnative.Callable):cpp.Int64;
	overload function find_custom(p_method:gdnative.Callable, p_from:cpp.Int64):cpp.Int64;
	overload function rfind(p_what:gdnative.Variant):cpp.Int64;
	overload function rfind(p_what:gdnative.Variant, p_from:cpp.Int64):cpp.Int64;
	overload function rfind_custom(p_method:gdnative.Callable):cpp.Int64;
	overload function rfind_custom(p_method:gdnative.Callable, p_from:cpp.Int64):cpp.Int64;
	function count(p_value:gdnative.Variant):cpp.Int64;
	function has(p_value:gdnative.Variant):Bool;
	function pop_back():gdnative.Variant;
	function pop_front():gdnative.Variant;
	function pop_at(p_position:cpp.Int64):gdnative.Variant;
	function sort():Void;
	function sort_custom(p_func:gdnative.Callable):Void;
	function shuffle():Void;
	overload function bsearch(p_value:gdnative.Variant):cpp.Int64;
	overload function bsearch(p_value:gdnative.Variant, p_before:Bool):cpp.Int64;
	overload function bsearch_custom(p_value:gdnative.Variant, p_func:gdnative.Callable):cpp.Int64;
	overload function bsearch_custom(p_value:gdnative.Variant, p_func:gdnative.Callable, p_before:Bool):cpp.Int64;
	...
	overload function slice(p_begin:cpp.Int64, p_end:cpp.Int64, p_step:cpp.Int64, p_deep:Bool):gdnative.Array;
	...
	function get_typed_builtin():cpp.Int64;
