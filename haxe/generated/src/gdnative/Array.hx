...
@:include("godot_cpp/variant/array.hpp") @:native("godot::Array") @:structAccess extern class Array_extern {
	...
	function find(p_what:gdnative.Variant, ?p_from:Int):Int;
	function rfind(p_what:gdnative.Variant, ?p_from:Int):Int;
	...
	function bsearch(p_value:gdnative.Variant, ?p_before:Bool):Int;
	function bsearch_custom(p_value:gdnative.Variant, p_func:gdnative.Callable, ?p_before:Bool):Int;
	function reverse():Void;
	function duplicate(?p_deep:Bool):gdnative.Array;
	function slice(p_begin:Int, ?p_end:Int, ?p_step:Int, ?p_deep:Bool):gdnative.Array;
