...
@:include("godot_cpp/classes/tile_map.hpp") @:native("godot::TileMap") @:structAccess extern class TileMap_extern extends gdnative.Node2D.Node2D_extern {
	...
	function set_cell(p_layer:Int, p_coords:gdnative.Vector2i, ?p_source_id:Int, ?p_atlas_coords:gdnative.Vector2i, ?p_alternative_tile:Int):Void;
	function erase_cell(p_layer:Int, p_coords:gdnative.Vector2i):Void;
	function get_cell_source_id(p_layer:Int, p_coords:gdnative.Vector2i, ?p_use_proxies:Bool):Int;
	function get_cell_atlas_coords(p_layer:Int, p_coords:gdnative.Vector2i, ?p_use_proxies:Bool):gdnative.Vector2i;
	function get_cell_alternative_tile(p_layer:Int, p_coords:gdnative.Vector2i, ?p_use_proxies:Bool):Int;
	function get_cell_tile_data(p_layer:Int, p_coords:gdnative.Vector2i, ?p_use_proxies:Bool):gdnative.TileData;
