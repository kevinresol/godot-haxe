...
@:include("godot_cpp/classes/editor_interface.hpp") @:native("godot::EditorInterface") @:structAccess extern class EditorInterface_extern extends gdnative.Object.Object_extern {
	...
	function get_editor_viewport_3d(?p_idx:Int):gdnative.SubViewport;
	...
	function popup_dialog(p_dialog:gdnative.Window, ?p_rect:gdnative.Rect2i):Void;
	function popup_dialog_centered(p_dialog:gdnative.Window, ?p_minsize:gdnative.Vector2i):Void;
	function popup_dialog_centered_ratio(p_dialog:gdnative.Window, ?p_ratio:Float):Void;
	function popup_dialog_centered_clamped(p_dialog:gdnative.Window, ?p_minsize:gdnative.Vector2i, ?p_fallback_ratio:Float):Void;
	...
	function popup_property_selector(p_object:gdnative.Object, p_callback:gdnative.Callable, ?p_type_filter:gdnative.PackedInt32Array):Void;
	...
	function inspect_object(p_object:gdnative.Object, ?p_for_property:gdnative.String, ?p_inspector_only:Bool):Void;
	function edit_resource(p_resource:gdnative.Resource):Void;
	function edit_node(p_node:gdnative.Node):Void;
	function edit_script(p_script:gdnative.Script, ?p_line:Int, ?p_column:Int, ?p_grab_focus:Bool):Void;
	...
	function save_scene_as(p_path:gdnative.String, ?p_with_preview:Bool):Void;
