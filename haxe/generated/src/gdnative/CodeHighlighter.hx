...
@:include("godot_cpp/classes/code_highlighter.hpp") @:native("godot::CodeHighlighter") @:structAccess extern class CodeHighlighter_extern extends gdnative.SyntaxHighlighter.SyntaxHighlighter_extern {
	...
	overload function add_color_region(p_start_key:gdnative.String, p_end_key:gdnative.String, p_color:gdnative.Color):Void;
	overload function add_color_region(p_start_key:gdnative.String, p_end_key:gdnative.String, p_color:gdnative.Color, p_line_only:Bool):Void;
