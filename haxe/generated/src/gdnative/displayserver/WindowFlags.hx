...
@:semantics(value) @:cpp.ValueType({ type : "WindowFlags", namespace : ["godot", "DisplayServer"] }) @:include("godot_cpp/classes/display_server.hpp") extern enum abstract WindowFlags(Int) to Int {
	@:op(A == B)
	static inline function eq(v1:WindowFlags, v2:WindowFlags):Bool return __cast(v1) == __cast(v2);
	static inline function __cast(v:WindowFlags):Int return v;
	...
	@:native("godot::DisplayServer::WindowFlags::WINDOW_FLAG_SHARP_CORNERS")
	final SHARP_CORNERS;
