...
@:semantics(value) @:cpp.ValueType({ type : "CursorShape", namespace : ["godot", "DisplayServer"] }) @:include("godot_cpp/classes/display_server.hpp") extern enum abstract CursorShape(Int) to Int {
	@:op(A == B)
	static inline function eq(v1:CursorShape, v2:CursorShape):Bool return __cast(v1) == __cast(v2);
	static inline function __cast(v:CursorShape):Int return v;
