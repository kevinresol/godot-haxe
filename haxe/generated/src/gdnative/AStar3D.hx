...
@:include("godot_cpp/classes/a_star3d.hpp") @:native("godot::AStar3D") @:structAccess extern class AStar3D_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	function add_point(p_id:Int, p_position:gdnative.Vector3, ?p_weight_scale:Float):Void;
	...
	function clear():Void;
	function get_closest_point(p_to_position:gdnative.Vector3, ?p_include_disabled:Bool):Int;
	function get_closest_position_in_segment(p_to_position:gdnative.Vector3):gdnative.Vector3;
	function get_point_path(p_from_id:Int, p_to_id:Int, ?p_allow_partial_path:Bool):gdnative.PackedVector3Array;
