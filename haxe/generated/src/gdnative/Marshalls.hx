...
@:include("godot_cpp/classes/marshalls.hpp") @:native("godot::Marshalls") @:structAccess extern class Marshalls_extern extends gdnative.Object.Object_extern {
	...
	overload function variant_to_base64(p_variant:gdnative.Variant):gdnative.String;
	overload function variant_to_base64(p_variant:gdnative.Variant, p_full_objects:Bool):gdnative.String;
	overload function base64_to_variant(p_base64_str:gdnative.String):gdnative.Variant;
	overload function base64_to_variant(p_base64_str:gdnative.String, p_allow_objects:Bool):gdnative.Variant;
