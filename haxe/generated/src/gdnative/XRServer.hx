...
@:include("godot_cpp/classes/xr_server.hpp") @:native("godot::XRServer") @:structAccess extern class XRServer_extern extends gdnative.Object.Object_extern {
	...
	function get_world_origin():gdnative.Transform3D;
	function set_world_origin(p_world_origin:gdnative.Transform3D):Void;
	function get_reference_frame():gdnative.Transform3D;
	...
	function get_hmd_transform():gdnative.Transform3D;
