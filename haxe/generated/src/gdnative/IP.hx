...
@:include("godot_cpp/classes/ip.hpp") @:native("godot::IP") @:structAccess extern class IP_extern extends gdnative.Object.Object_extern {
	...
	function resolve_hostname(p_host:gdnative.String, ?p_ip_type:gdnative.ip.Type):gdnative.String;
	function resolve_hostname_addresses(p_host:gdnative.String, ?p_ip_type:gdnative.ip.Type):gdnative.PackedStringArray;
	function resolve_hostname_queue_item(p_host:gdnative.String, ?p_ip_type:gdnative.ip.Type):Int;
	...
	function clear_cache(?p_hostname:gdnative.String):Void;
}
