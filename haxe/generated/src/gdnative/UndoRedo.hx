...
@:include("godot_cpp/classes/undo_redo.hpp") @:native("godot::UndoRedo") @:structAccess extern class UndoRedo_extern extends gdnative.Object.Object_extern {
	...
	overload function create_action(p_name:gdnative.String, p_merge_mode:gdnative.undoredo.MergeMode, p_backward_undo_ops:Bool):Void;
	...
	overload function clear_history():Void;
	overload function clear_history(p_increase_version:Bool):Void;
