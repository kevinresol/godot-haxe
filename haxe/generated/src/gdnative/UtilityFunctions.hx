...
@:include("godot_cpp/variant/utility_functions.hpp") @:native("godot::UtilityFunctions") extern class UtilityFunctions {
	...
	static function snappedi(p_x:Float, p_step:cpp.Int64):cpp.Int64;
	...
	static function step_decimals(p_x:Float):cpp.Int64;
	...
	static function wrapi(p_value:cpp.Int64, p_min:cpp.Int64, p_max:cpp.Int64):cpp.Int64;
	...
	static function maxi(p_a:cpp.Int64, p_b:cpp.Int64):cpp.Int64;
	...
	static function mini(p_a:cpp.Int64, p_b:cpp.Int64):cpp.Int64;
	...
	static function clampi(p_value:cpp.Int64, p_min:cpp.Int64, p_max:cpp.Int64):cpp.Int64;
	static function clampf(p_value:Float, p_min:Float, p_max:Float):Float;
	static function nearest_po2(p_value:cpp.Int64):cpp.Int64;
	static function pingpong(p_value:Float, p_length:Float):Float;
	static function randomize():Void;
	static function randi():cpp.Int64;
	static function randf():Float;
	static function randi_range(p_from:cpp.Int64, p_to:cpp.Int64):cpp.Int64;
	...
	static function rand_from_seed(p_seed:cpp.Int64):gdnative.PackedInt64Array;
	static function weakref(p_obj:gdnative.Variant):gdnative.Variant;
	@:native("godot::UtilityFunctions::type_of")
	static function typeof(p_variable:gdnative.Variant):cpp.Int64;
	static function type_convert(p_variant:gdnative.Variant, p_type:cpp.Int64):gdnative.Variant;
	...
	static function error_string(p_error:cpp.Int64):gdnative.String;
	static function type_string(p_type:cpp.Int64):gdnative.String;
	...
	static function hash(p_variable:gdnative.Variant):cpp.Int64;
	static function instance_from_id(p_instance_id:cpp.Int64):gdnative.Object;
	static function is_instance_id_valid(p_id:cpp.Int64):Bool;
	static function rid_allocate_id():cpp.Int64;
	static function rid_from_int64(p_base:cpp.Int64):gdnative.RID;
