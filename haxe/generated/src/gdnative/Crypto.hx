...
@:include("godot_cpp/classes/crypto.hpp") @:native("godot::Crypto") @:structAccess extern class Crypto_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	function generate_self_signed_certificate(p_key:gdnative.CryptoKey, ?p_issuer_name:gdnative.String, ?p_not_before:gdnative.String, ?p_not_after:gdnative.String):gdnative.X509Certificate;
