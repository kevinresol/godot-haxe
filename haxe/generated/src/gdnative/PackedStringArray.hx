...
/**
	Built-in Class
**/
@:forward abstract PackedStringArray(PackedStringArray_extern) from PackedStringArray_extern to PackedStringArray_extern {
	@:from
	...
	@:to
	inline function toVariant():gdnative.Variant return new gdnative.Variant.Variant_extern(untyped __cpp__("static_cast<godot::PackedStringArray &>({0})", this));
	inline function val():PackedStringArray_extern return untyped __cpp__('(*{0})', this);
	@:op(A == B)
...
@:include("godot_cpp/variant/packed_string_array.hpp") @:semantics(reference) @:cpp.ValueType({ type : "PackedStringArray", namespace : ['godot'] }) extern class PackedStringArray_extern {
	...
	function set(p_index:cpp.Int64, p_value:gdnative.String):Void;
	...
	function insert(p_at_index:cpp.Int64, p_value:gdnative.String):cpp.Int64;
	...
	overload function slice(p_begin:cpp.Int64):gdnative.PackedStringArray;
	overload function slice(p_begin:cpp.Int64, p_end:cpp.Int64):gdnative.PackedStringArray;
	function to_byte_array():gdnative.PackedByteArray;
	function sort():Void;
	overload function bsearch(p_value:gdnative.String):cpp.Int64;
	overload function bsearch(p_value:gdnative.String, p_before:Bool):cpp.Int64;
	function duplicate():gdnative.PackedStringArray;
	overload function find(p_value:gdnative.String):cpp.Int64;
	overload function find(p_value:gdnative.String, p_from:cpp.Int64):cpp.Int64;
	overload function rfind(p_value:gdnative.String):cpp.Int64;
	overload function rfind(p_value:gdnative.String, p_from:cpp.Int64):cpp.Int64;
	function count(p_value:gdnative.String):cpp.Int64;
}