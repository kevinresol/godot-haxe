...
@:include("godot_cpp/classes/navigation_mesh_source_geometry_data3d.hpp") @:native("godot::NavigationMeshSourceGeometryData3D") @:structAccess extern class NavigationMeshSourceGeometryData3D_extern extends gdnative.Resource.Resource_extern {
	...
	function add_mesh(p_mesh:gdnative.Mesh, p_xform:gdnative.Transform3D):Void;
	function add_mesh_array(p_mesh_array:gdnative.Array, p_xform:gdnative.Transform3D):Void;
	function add_faces(p_faces:gdnative.PackedVector3Array, p_xform:gdnative.Transform3D):Void;
