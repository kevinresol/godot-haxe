...
@:include("godot_cpp/classes/input_map.hpp") @:native("godot::InputMap") @:structAccess extern class InputMap_extern extends gdnative.Object.Object_extern {
	...
	function add_action(p_action:gdnative.StringName, ?p_deadzone:Float):Void;
	...
	function event_is_action(p_event:gdnative.InputEvent, p_action:gdnative.StringName, ?p_exact_match:Bool):Bool;
