...
@:include("godot_cpp/classes/animation_player.hpp") @:native("godot::AnimationPlayer") @:structAccess extern class AnimationPlayer_extern extends gdnative.AnimationMixer.AnimationMixer_extern {
	...
	function play(?p_name:gdnative.StringName, ?p_custom_blend:Float, ?p_custom_speed:Float, ?p_from_end:Bool):Void;
	function play_backwards(?p_name:gdnative.StringName, ?p_custom_blend:Float):Void;
	function play_with_capture(?p_name:gdnative.StringName, ?p_duration:Float, ?p_custom_blend:Float, ?p_custom_speed:Float, ?p_from_end:Bool, ?p_trans_type:gdnative.tween.TransitionType, ?p_ease_type:gdnative.tween.EaseType):Void;
	function pause():Void;
