...
@:include("godot_cpp/classes/tile_data.hpp") @:native("godot::TileData") @:structAccess extern class TileData_extern extends gdnative.Object.Object_extern {
	...
	function get_occluder(p_layer_id:Int, ?p_flip_h:Bool, ?p_flip_v:Bool, ?p_transpose:Bool):gdnative.OccluderPolygon2D;
	...
	function get_navigation_polygon(p_layer_id:Int, ?p_flip_h:Bool, ?p_flip_v:Bool, ?p_transpose:Bool):gdnative.NavigationPolygon;
