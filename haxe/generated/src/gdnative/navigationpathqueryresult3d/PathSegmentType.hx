...
@:native("godot::NavigationPathQueryResult3D::PathSegmentType") extern enum abstract PathSegmentType(PathSegmentType_extern) {
	...
	static inline function __cast(v:PathSegmentType):PathSegmentType_extern return untyped __cpp__("(cpp::Struct<godot::NavigationPathQueryResult3D::PathSegmentType, cpp::EnumHandler>){0}", v);
