...
@:native("godot::PhysicsServer2D::CCDMode") extern enum abstract CCDMode(CCDMode_extern) {
	...
	final CAST_RAY;
	@:native("godot::PhysicsServer2D::CCDMode::CCD_MODE_CAST_SHAPE")
	final CAST_SHAPE;
}
@:include("godot_cpp/classes/physics_server2d.hpp") @:native("cpp::Struct<godot::PhysicsServer2D::CCDMode, cpp::EnumHandler>") extern class CCDMode_extern {
