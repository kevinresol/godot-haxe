...
@:native("godot::PhysicsServer2D::BodyDampMode") extern enum abstract BodyDampMode(BodyDampMode_extern) {
	...
	static inline function __cast(v:BodyDampMode):BodyDampMode_extern return untyped __cpp__("(cpp::Struct<godot::PhysicsServer2D::BodyDampMode, cpp::EnumHandler>){0}", v);
