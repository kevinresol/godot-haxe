...
@:native("godot::PhysicsServer2D::BodyParameter") extern enum abstract BodyParameter(BodyParameter_extern) {
	...
	static inline function __cast(v:BodyParameter):BodyParameter_extern return untyped __cpp__("(cpp::Struct<godot::PhysicsServer2D::BodyParameter, cpp::EnumHandler>){0}", v);
