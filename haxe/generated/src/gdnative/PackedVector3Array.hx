...
/**
	Built-in Class
**/
@:forward abstract PackedVector3Array(PackedVector3Array_extern) from PackedVector3Array_extern to PackedVector3Array_extern {
	@:from
	...
	inline function val():PackedVector3Array_extern return untyped __cpp__('(*{0})', this);
	@:op(A == B)
...
@:include("godot_cpp/variant/packed_vector3_array.hpp") @:semantics(value) @:cpp.ValueType({ type : "PackedVector3Array", namespace : ['godot'] }) extern class PackedVector3Array_extern {
	...
	function new();
	function get(p_index:cpp.Int64):gdnative.Vector3;
	function set(p_index:cpp.Int64, p_value:gdnative.Vector3):Void;
	...
	function insert(p_at_index:cpp.Int64, p_value:gdnative.Vector3):cpp.Int64;
	...
	overload function slice(p_begin:cpp.Int64):gdnative.PackedVector3Array;
	overload function slice(p_begin:cpp.Int64, p_end:cpp.Int64):gdnative.PackedVector3Array;
	function to_byte_array():gdnative.PackedByteArray;
	function sort():Void;
	overload function bsearch(p_value:gdnative.Vector3):cpp.Int64;
	overload function bsearch(p_value:gdnative.Vector3, p_before:Bool):cpp.Int64;
	function duplicate():gdnative.PackedVector3Array;
	overload function find(p_value:gdnative.Vector3):cpp.Int64;
	overload function find(p_value:gdnative.Vector3, p_from:cpp.Int64):cpp.Int64;
	overload function rfind(p_value:gdnative.Vector3):cpp.Int64;
	overload function rfind(p_value:gdnative.Vector3, p_from:cpp.Int64):cpp.Int64;
	function count(p_value:gdnative.Vector3):cpp.Int64;
	function erase(p_value:gdnative.Vector3):Bool;
}