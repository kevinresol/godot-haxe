...
@:native("godot::NavigationPathQueryParameters2D::PathfindingAlgorithm") extern enum abstract PathfindingAlgorithm(PathfindingAlgorithm_extern) {
	...
	static inline function __cast(v:PathfindingAlgorithm):PathfindingAlgorithm_extern return untyped __cpp__("(cpp::Struct<godot::NavigationPathQueryParameters2D::PathfindingAlgorithm, cpp::EnumHandler>){0}", v);
