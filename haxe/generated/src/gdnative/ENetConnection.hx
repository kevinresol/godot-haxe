...
@:include("godot_cpp/classes/e_net_connection.hpp") @:native("godot::ENetConnection") @:structAccess extern class ENetConnection_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	function create_host_bound(p_bind_address:gdnative.String, p_bind_port:Int, ?p_max_peers:Int, ?p_max_channels:Int, ?p_in_bandwidth:Int, ?p_out_bandwidth:Int):gdnative.Error;
	function create_host(?p_max_peers:Int, ?p_max_channels:Int, ?p_in_bandwidth:Int, ?p_out_bandwidth:Int):gdnative.Error;
	function destroy():Void;
	function connect_to_host(p_address:gdnative.String, p_port:Int, ?p_channels:Int, ?p_data:Int):gdnative.ENetPacketPeer;
	function service(?p_timeout:Int):gdnative.Array;
	function flush():Void;
	...
	function dtls_client_setup(p_hostname:gdnative.String, ?p_client_options:gdnative.TLSOptions):gdnative.Error;
