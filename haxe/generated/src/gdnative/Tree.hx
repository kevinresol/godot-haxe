...
@:include("godot_cpp/classes/tree.hpp") @:native("godot::Tree") @:structAccess extern class Tree_extern extends gdnative.Control.Control_extern {
	...
	function clear():Void;
	function create_item(?p_parent:gdnative.TreeItem, ?p_index:Int):gdnative.TreeItem;
	...
	function get_item_area_rect(p_item:gdnative.TreeItem, ?p_column:Int, ?p_button_index:Int):gdnative.Rect2;
	...
	function scroll_to_item(p_item:gdnative.TreeItem, ?p_center_on_item:Bool):Void;
