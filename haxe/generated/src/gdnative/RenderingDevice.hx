...
@:include("godot_cpp/classes/rendering_device.hpp") @:native("godot::RenderingDevice") @:structAccess extern class RenderingDevice_extern extends gdnative.Object.Object_extern {
	...
	overload function texture_create_shared_from_slice(p_view:gdnative.RDTextureView, p_with_texture:gdnative.RID, p_layer:Int, p_mipmap:Int, p_mipmaps:Int, p_slice_type:gdnative.renderingdevice.TextureSliceType):gdnative.RID;
	overload function texture_create_shared_from_slice(p_view:gdnative.RDTextureView, p_with_texture:gdnative.RID, p_layer:Int, p_mipmap:Int, p_mipmaps:Int):gdnative.RID;
	overload function texture_create_shared_from_slice(p_view:gdnative.RDTextureView, p_with_texture:gdnative.RID, p_layer:Int, p_mipmap:Int):gdnative.RID;
	...
	overload function framebuffer_format_create_empty(p_samples:gdnative.renderingdevice.TextureSamples):Int;
	overload function framebuffer_format_create_empty():Int;
	overload function framebuffer_format_get_texture_samples(p_format:Int, p_render_pass:Int):gdnative.renderingdevice.TextureSamples;
	overload function framebuffer_format_get_texture_samples(p_format:Int):gdnative.renderingdevice.TextureSamples;
	overload function framebuffer_create_empty(p_size:gdnative.Vector2i, p_samples:gdnative.renderingdevice.TextureSamples, p_validate_with_format:Int):gdnative.RID;
	overload function framebuffer_create_empty(p_size:gdnative.Vector2i, p_samples:gdnative.renderingdevice.TextureSamples):gdnative.RID;
	overload function framebuffer_create_empty(p_size:gdnative.Vector2i):gdnative.RID;
	...
	overload function vertex_buffer_create(p_size_bytes:Int, p_data:gdnative.PackedByteArray, p_use_as_storage:Bool):gdnative.RID;
	overload function vertex_buffer_create(p_size_bytes:Int, p_data:gdnative.PackedByteArray):gdnative.RID;
	overload function vertex_buffer_create(p_size_bytes:Int):gdnative.RID;
	overload function index_buffer_create(p_size_indices:Int, p_format:gdnative.renderingdevice.IndexBufferFormat, p_data:gdnative.PackedByteArray, p_use_restart_indices:Bool):gdnative.RID;
	overload function index_buffer_create(p_size_indices:Int, p_format:gdnative.renderingdevice.IndexBufferFormat, p_data:gdnative.PackedByteArray):gdnative.RID;
	overload function index_buffer_create(p_size_indices:Int, p_format:gdnative.renderingdevice.IndexBufferFormat):gdnative.RID;
	function index_array_create(p_index_buffer:gdnative.RID, p_index_offset:Int, p_index_count:Int):gdnative.RID;
	overload function shader_compile_spirv_from_source(p_shader_source:gdnative.RDShaderSource, p_allow_cache:Bool):gdnative.RDShaderSPIRV;
	overload function shader_compile_spirv_from_source(p_shader_source:gdnative.RDShaderSource):gdnative.RDShaderSPIRV;
	overload function shader_compile_binary_from_spirv(p_spirv_data:gdnative.RDShaderSPIRV, p_name:gdnative.String):gdnative.PackedByteArray;
	overload function shader_compile_binary_from_spirv(p_spirv_data:gdnative.RDShaderSPIRV):gdnative.PackedByteArray;
	overload function shader_create_from_spirv(p_spirv_data:gdnative.RDShaderSPIRV, p_name:gdnative.String):gdnative.RID;
	overload function shader_create_from_spirv(p_spirv_data:gdnative.RDShaderSPIRV):gdnative.RID;
	overload function shader_create_from_bytecode(p_binary_data:gdnative.PackedByteArray, p_placeholder_rid:gdnative.RID):gdnative.RID;
	overload function shader_create_from_bytecode(p_binary_data:gdnative.PackedByteArray):gdnative.RID;
	function shader_create_placeholder():gdnative.RID;
	function shader_get_vertex_input_attribute_mask(p_shader:gdnative.RID):Int;
	overload function uniform_buffer_create(p_size_bytes:Int, p_data:gdnative.PackedByteArray):gdnative.RID;
	overload function uniform_buffer_create(p_size_bytes:Int):gdnative.RID;
	overload function storage_buffer_create(p_size_bytes:Int, p_data:gdnative.PackedByteArray, p_usage:Int):gdnative.RID;
	overload function storage_buffer_create(p_size_bytes:Int, p_data:gdnative.PackedByteArray):gdnative.RID;
	overload function storage_buffer_create(p_size_bytes:Int):gdnative.RID;
	overload function texture_buffer_create(p_size_bytes:Int, p_format:gdnative.renderingdevice.DataFormat, p_data:gdnative.PackedByteArray):gdnative.RID;
	overload function texture_buffer_create(p_size_bytes:Int, p_format:gdnative.renderingdevice.DataFormat):gdnative.RID;
	...
	overload function buffer_get_data(p_buffer:gdnative.RID, p_offset_bytes:Int, p_size_bytes:Int):gdnative.PackedByteArray;
	overload function buffer_get_data(p_buffer:gdnative.RID, p_offset_bytes:Int):gdnative.PackedByteArray;
	overload function buffer_get_data(p_buffer:gdnative.RID):gdnative.PackedByteArray;
	...
	overload function screen_get_width(p_screen:Int):Int;
	overload function screen_get_width():Int;
	overload function screen_get_height(p_screen:Int):Int;
	overload function screen_get_height():Int;
	overload function screen_get_framebuffer_format(p_screen:Int):Int;
	overload function screen_get_framebuffer_format():Int;
	overload function draw_list_begin_for_screen(p_screen:Int, p_clear_color:gdnative.Color):Int;
	overload function draw_list_begin_for_screen(p_screen:Int):Int;
	overload function draw_list_begin_for_screen():Int;
	overload function draw_list_begin(p_framebuffer:gdnative.RID, p_initial_color_action:gdnative.renderingdevice.InitialAction, p_final_color_action:gdnative.renderingdevice.FinalAction, p_initial_depth_action:gdnative.renderingdevice.InitialAction, p_final_depth_action:gdnative.renderingdevice.FinalAction, p_clear_color_values:gdnative.PackedColorArray, p_clear_depth:Float, p_clear_stencil:Int, p_region:gdnative.Rect2):Int;
	overload function draw_list_begin(p_framebuffer:gdnative.RID, p_initial_color_action:gdnative.renderingdevice.InitialAction, p_final_color_action:gdnative.renderingdevice.FinalAction, p_initial_depth_action:gdnative.renderingdevice.InitialAction, p_final_depth_action:gdnative.renderingdevice.FinalAction, p_clear_color_values:gdnative.PackedColorArray, p_clear_depth:Float, p_clear_stencil:Int):Int;
	overload function draw_list_begin(p_framebuffer:gdnative.RID, p_initial_color_action:gdnative.renderingdevice.InitialAction, p_final_color_action:gdnative.renderingdevice.FinalAction, p_initial_depth_action:gdnative.renderingdevice.InitialAction, p_final_depth_action:gdnative.renderingdevice.FinalAction, p_clear_color_values:gdnative.PackedColorArray, p_clear_depth:Float):Int;
	overload function draw_list_begin(p_framebuffer:gdnative.RID, p_initial_color_action:gdnative.renderingdevice.InitialAction, p_final_color_action:gdnative.renderingdevice.FinalAction, p_initial_depth_action:gdnative.renderingdevice.InitialAction, p_final_depth_action:gdnative.renderingdevice.FinalAction, p_clear_color_values:gdnative.PackedColorArray):Int;
	overload function draw_list_begin(p_framebuffer:gdnative.RID, p_initial_color_action:gdnative.renderingdevice.InitialAction, p_final_color_action:gdnative.renderingdevice.FinalAction, p_initial_depth_action:gdnative.renderingdevice.InitialAction, p_final_depth_action:gdnative.renderingdevice.FinalAction):Int;
	...
	overload function draw_list_draw(p_draw_list:Int, p_use_indices:Bool, p_instances:Int, p_procedural_vertex_count:Int):Void;
	overload function draw_list_draw(p_draw_list:Int, p_use_indices:Bool, p_instances:Int):Void;
	overload function draw_list_enable_scissor(p_draw_list:Int, p_rect:gdnative.Rect2):Void;
	overload function draw_list_enable_scissor(p_draw_list:Int):Void;
	...
	function sync():Void;
	overload function barrier(p_from:Int, p_to:Int):Void;
	overload function barrier(p_from:Int):Void;
	overload function barrier():Void;
