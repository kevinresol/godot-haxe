...
@:include("godot_cpp/classes/upnp.hpp") @:native("godot::UPNP") @:structAccess extern class UPNP_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	function discover(?p_timeout:Int, ?p_ttl:Int, ?p_device_filter:gdnative.String):Int;
	function query_external_address():gdnative.String;
	function add_port_mapping(p_port:Int, ?p_port_internal:Int, ?p_desc:gdnative.String, ?p_proto:gdnative.String, ?p_duration:Int):Int;
	function delete_port_mapping(p_port:Int, ?p_proto:gdnative.String):Int;
