...
@:include("godot_cpp/classes/curve2d.hpp") @:native("godot::Curve2D") @:structAccess extern class Curve2D_extern extends gdnative.Resource.Resource_extern {
	...
	function add_point(p_position:gdnative.Vector2, ?p_in:gdnative.Vector2, ?p_out:gdnative.Vector2, ?p_index:Int):Void;
	...
	function sample_baked(?p_offset:Float, ?p_cubic:Bool):gdnative.Vector2;
	...
	function tessellate(?p_max_stages:Int, ?p_tolerance_degrees:Float):gdnative.PackedVector2Array;
	function tessellate_even_length(?p_max_stages:Int, ?p_tolerance_length:Float):gdnative.PackedVector2Array;
}
