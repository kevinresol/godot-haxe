...
@:include("godot_cpp/classes/audio_server.hpp") @:native("godot::AudioServer") @:structAccess extern class AudioServer_extern extends gdnative.Object.Object_extern {
	...
	function add_bus_effect(p_bus_idx:Int, p_effect:gdnative.AudioEffect, ?p_at_position:Int):Void;
	...
	function get_bus_effect_instance(p_bus_idx:Int, p_effect_idx:Int, ?p_channel:Int):gdnative.AudioEffectInstance;
