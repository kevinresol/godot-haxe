...
@:include("godot_cpp/classes/navigation_server2d.hpp") @:native("godot::NavigationServer2D") @:structAccess extern class NavigationServer2D_extern extends gdnative.Object.Object_extern {
	...
	overload function map_get_path(p_map:gdnative.RID, p_origin:gdnative.Vector2, p_destination:gdnative.Vector2, p_optimize:Bool):gdnative.PackedVector2Array;
	overload function map_get_path(p_map:gdnative.RID, p_origin:gdnative.Vector2, p_destination:gdnative.Vector2, p_optimize:Bool, p_navigation_layers:Int):gdnative.PackedVector2Array;
	...
	overload function parse_source_geometry_data(p_navigation_polygon:gdnative.NavigationPolygon, p_source_geometry_data:gdnative.NavigationMeshSourceGeometryData2D, p_root_node:gdnative.Node):Void;
	overload function parse_source_geometry_data(p_navigation_polygon:gdnative.NavigationPolygon, p_source_geometry_data:gdnative.NavigationMeshSourceGeometryData2D, p_root_node:gdnative.Node, p_callback:gdnative.Callable):Void;
	overload function bake_from_source_geometry_data(p_navigation_polygon:gdnative.NavigationPolygon, p_source_geometry_data:gdnative.NavigationMeshSourceGeometryData2D):Void;
	overload function bake_from_source_geometry_data(p_navigation_polygon:gdnative.NavigationPolygon, p_source_geometry_data:gdnative.NavigationMeshSourceGeometryData2D, p_callback:gdnative.Callable):Void;
	overload function bake_from_source_geometry_data_async(p_navigation_polygon:gdnative.NavigationPolygon, p_source_geometry_data:gdnative.NavigationMeshSourceGeometryData2D):Void;
	overload function bake_from_source_geometry_data_async(p_navigation_polygon:gdnative.NavigationPolygon, p_source_geometry_data:gdnative.NavigationMeshSourceGeometryData2D, p_callback:gdnative.Callable):Void;
