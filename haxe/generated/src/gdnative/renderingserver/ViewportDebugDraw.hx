...
@:native("godot::RenderingServer::ViewportDebugDraw") extern enum abstract ViewportDebugDraw(ViewportDebugDraw_extern) {
	@:op(A == B)
	static inline function eq(v1:ViewportDebugDraw, v2:ViewportDebugDraw):Bool return __cast(v1) == __cast(v2);
	static inline function __cast(v:ViewportDebugDraw):ViewportDebugDraw_extern return untyped __cpp__("(cpp::Struct<godot::RenderingServer::ViewportDebugDraw, cpp::EnumHandler>){0}", v);
