...
@:native("godot::RenderingServer::LightParam") extern enum abstract LightParam(LightParam_extern) {
	@:op(A == B)
	static inline function eq(v1:LightParam, v2:LightParam):Bool return __cast(v1) == __cast(v2);
	static inline function __cast(v:LightParam):LightParam_extern return untyped __cpp__("(cpp::Struct<godot::RenderingServer::LightParam, cpp::EnumHandler>){0}", v);
