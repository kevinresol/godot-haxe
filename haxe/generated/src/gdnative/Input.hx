...
@:include("godot_cpp/classes/input.hpp") @:native("godot::Input") @:structAccess extern class Input_extern extends gdnative.Object.Object_extern {
	...
	function is_action_pressed(p_action:gdnative.StringName, ?p_exact_match:Bool):Bool;
	function is_action_just_pressed(p_action:gdnative.StringName, ?p_exact_match:Bool):Bool;
	function is_action_just_released(p_action:gdnative.StringName, ?p_exact_match:Bool):Bool;
	function get_action_strength(p_action:gdnative.StringName, ?p_exact_match:Bool):Float;
	function get_action_raw_strength(p_action:gdnative.StringName, ?p_exact_match:Bool):Float;
	function get_axis(p_negative_action:gdnative.StringName, p_positive_action:gdnative.StringName):Float;
	function get_vector(p_negative_x:gdnative.StringName, p_positive_x:gdnative.StringName, p_negative_y:gdnative.StringName, p_positive_y:gdnative.StringName, ?p_deadzone:Float):gdnative.Vector2;
	function add_joy_mapping(p_mapping:gdnative.String, ?p_update_existing:Bool):Void;
	...
	function action_press(p_action:gdnative.StringName, ?p_strength:Float):Void;
	function action_release(p_action:gdnative.StringName):Void;
	function set_default_cursor_shape(?p_shape:gdnative.input.CursorShape):Void;
	function get_current_cursor_shape():gdnative.input.CursorShape;
	function set_custom_mouse_cursor(p_image:gdnative.Resource, ?p_shape:gdnative.input.CursorShape, ?p_hotspot:gdnative.Vector2):Void;
