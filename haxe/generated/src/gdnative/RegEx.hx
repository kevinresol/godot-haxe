...
@:include("godot_cpp/classes/reg_ex.hpp") @:native("godot::RegEx") @:structAccess extern class RegEx_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	function search(p_subject:gdnative.String, ?p_offset:Int, ?p_end:Int):gdnative.RegExMatch;
	function sub(p_subject:gdnative.String, p_replacement:gdnative.String, ?p_all:Bool, ?p_offset:Int, ?p_end:Int):gdnative.String;
