...
@:forward abstract InputEventMouse(gdnative.Ref<InputEventMouse_extern>) from gdnative.Ref<InputEventMouse_extern> to gdnative.Ref<InputEventMouse_extern> {
	@:from
	static inline function fromWrapper(v:gd.InputEventMouse):gdnative.InputEventMouse return cast @:privateAccess v.__gd;
	@:to
	inline function toWrapper():gd.InputEventMouse return new gd.InputEventMouse(this);
}
@:include("godot_cpp/classes/input_event_mouse.hpp") @:semantics(reference) @:cpp.PointerType({ type : "InputEventMouse", namespace : ['godot'] }) extern class InputEventMouse_extern extends gdnative.InputEventWithModifiers.InputEventWithModifiers_extern {
