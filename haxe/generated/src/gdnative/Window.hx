...
@:include("godot_cpp/classes/window.hpp") @:native("godot::Window") @:structAccess extern class Window_extern extends gdnative.Viewport.Viewport_extern {
	...
	function popup(?p_rect:gdnative.Rect2i):Void;
	function popup_on_parent(p_parent_rect:gdnative.Rect2i):Void;
	function popup_centered(?p_minsize:gdnative.Vector2i):Void;
	function popup_centered_ratio(?p_ratio:Float):Void;
	function popup_centered_clamped(?p_minsize:gdnative.Vector2i, ?p_fallback_ratio:Float):Void;
	function popup_exclusive(p_from_node:gdnative.Node, ?p_rect:gdnative.Rect2i):Void;
	function popup_exclusive_on_parent(p_from_node:gdnative.Node, p_parent_rect:gdnative.Rect2i):Void;
	function popup_exclusive_centered(p_from_node:gdnative.Node, ?p_minsize:gdnative.Vector2i):Void;
	function popup_exclusive_centered_ratio(p_from_node:gdnative.Node, ?p_ratio:Float):Void;
	function popup_exclusive_centered_clamped(p_from_node:gdnative.Node, ?p_minsize:gdnative.Vector2i, ?p_fallback_ratio:Float):Void;
}
