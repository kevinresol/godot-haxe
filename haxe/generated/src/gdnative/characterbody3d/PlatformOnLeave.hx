...
@:native("godot::CharacterBody3D::PlatformOnLeave") extern enum abstract PlatformOnLeave(PlatformOnLeave_extern) {
	...
	static inline function __cast(v:PlatformOnLeave):PlatformOnLeave_extern return untyped __cpp__("(cpp::Struct<godot::CharacterBody3D::PlatformOnLeave, cpp::EnumHandler>){0}", v);
