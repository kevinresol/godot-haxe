...
@:include("godot_cpp/classes/rendering_server.hpp") @:native("godot::RenderingServer") @:structAccess extern class RenderingServer_extern extends gdnative.Object.Object_extern {
	...
	function texture_rd_create(p_rd_texture:gdnative.RID, ?p_layer_type:gdnative.renderingserver.TextureLayeredType):gdnative.RID;
	function texture_get_rd_texture(p_texture:gdnative.RID, ?p_srgb:Bool):gdnative.RID;
	function texture_get_native_handle(p_texture:gdnative.RID, ?p_srgb:Bool):Int;
	...
	function shader_set_default_texture_parameter(p_shader:gdnative.RID, p_name:gdnative.StringName, p_texture:gdnative.RID, ?p_index:Int):Void;
	function shader_get_default_texture_parameter(p_shader:gdnative.RID, p_name:gdnative.StringName, ?p_index:Int):gdnative.RID;
	...
	function mesh_add_surface_from_arrays(p_mesh:gdnative.RID, p_primitive:gdnative.renderingserver.PrimitiveType, p_arrays:gdnative.Array, ?p_blend_shapes:gdnative.Array, ?p_lods:gdnative.Dictionary, ?p_compress_format:Int):Void;
	...
	function multimesh_allocate_data(p_multimesh:gdnative.RID, p_instances:Int, p_transform_format:gdnative.renderingserver.MultimeshTransformFormat, ?p_color_format:Bool, ?p_custom_data_format:Bool):Void;
	...
	function skeleton_allocate_data(p_skeleton:gdnative.RID, p_bones:Int, ?p_is_2d_skeleton:Bool):Void;
	...
	function viewport_attach_to_screen(p_viewport:gdnative.RID, ?p_rect:gdnative.Rect2, ?p_screen:Int):Void;
	...
	function viewport_set_positional_shadow_atlas_size(p_viewport:gdnative.RID, p_size:Int, ?p_use_16_bits:Bool):Void;
	...
	function environment_set_ambient_light(p_env:gdnative.RID, p_color:gdnative.Color, ?p_ambient:gdnative.renderingserver.EnvironmentAmbientSource, ?p_energy:Float, ?p_sky_contibution:Float, ?p_reflection_source:gdnative.renderingserver.EnvironmentReflectionSource):Void;
	...
	function environment_set_fog(p_env:gdnative.RID, p_enable:Bool, p_light_color:gdnative.Color, p_light_energy:Float, p_sun_scatter:Float, p_density:Float, p_height:Float, p_height_density:Float, p_aerial_perspective:Float, p_sky_affect:Float, ?p_fog_mode:gdnative.renderingserver.EnvironmentFogMode):Void;
	...
	function instances_cull_aabb(p_aabb:gdnative.AABB, ?p_scenario:gdnative.RID):gdnative.PackedInt64Array;
	function instances_cull_ray(p_from:gdnative.Vector3, p_to:gdnative.Vector3, ?p_scenario:gdnative.RID):gdnative.PackedInt64Array;
	...
	function canvas_item_set_custom_rect(p_item:gdnative.RID, p_use_custom_rect:Bool, ?p_rect:gdnative.Rect2):Void;
	...
	function canvas_item_add_line(p_item:gdnative.RID, p_from:gdnative.Vector2, p_to:gdnative.Vector2, p_color:gdnative.Color, ?p_width:Float, ?p_antialiased:Bool):Void;
	function canvas_item_add_polyline(p_item:gdnative.RID, p_points:gdnative.PackedVector2Array, p_colors:gdnative.PackedColorArray, ?p_width:Float, ?p_antialiased:Bool):Void;
	function canvas_item_add_multiline(p_item:gdnative.RID, p_points:gdnative.PackedVector2Array, p_colors:gdnative.PackedColorArray, ?p_width:Float, ?p_antialiased:Bool):Void;
	function canvas_item_add_rect(p_item:gdnative.RID, p_rect:gdnative.Rect2, p_color:gdnative.Color, ?p_antialiased:Bool):Void;
	function canvas_item_add_circle(p_item:gdnative.RID, p_pos:gdnative.Vector2, p_radius:Float, p_color:gdnative.Color, ?p_antialiased:Bool):Void;
	function canvas_item_add_texture_rect(p_item:gdnative.RID, p_rect:gdnative.Rect2, p_texture:gdnative.RID, ?p_tile:Bool, ?p_modulate:gdnative.Color, ?p_transpose:Bool):Void;
	function canvas_item_add_msdf_texture_rect_region(p_item:gdnative.RID, p_rect:gdnative.Rect2, p_texture:gdnative.RID, p_src_rect:gdnative.Rect2, ?p_modulate:gdnative.Color, ?p_outline_size:Int, ?p_px_range:Float, ?p_scale:Float):Void;
	...
	function canvas_item_add_polygon(p_item:gdnative.RID, p_points:gdnative.PackedVector2Array, p_colors:gdnative.PackedColorArray, ?p_uvs:gdnative.PackedVector2Array, ?p_texture:gdnative.RID):Void;
	function canvas_item_add_triangle_array(p_item:gdnative.RID, p_indices:gdnative.PackedInt32Array, p_points:gdnative.PackedVector2Array, p_colors:gdnative.PackedColorArray, ?p_uvs:gdnative.PackedVector2Array, ?p_bones:gdnative.PackedInt32Array, ?p_weights:gdnative.PackedFloat32Array, ?p_texture:gdnative.RID, ?p_count:Int):Void;
	function canvas_item_add_multimesh(p_item:gdnative.RID, p_mesh:gdnative.RID, ?p_texture:gdnative.RID):Void;
	...
	function canvas_item_add_animation_slice(p_item:gdnative.RID, p_animation_length:Float, p_slice_begin:Float, p_slice_end:Float, ?p_offset:Float):Void;
	...
	function canvas_item_set_canvas_group_mode(p_item:gdnative.RID, p_mode:gdnative.renderingserver.CanvasGroupMode, ?p_clear_margin:Float, ?p_fit_empty:Bool, ?p_fit_margin:Float, ?p_blur_mipmaps:Bool):Void;
	...
	function set_boot_image(p_image:gdnative.Image, p_color:gdnative.Color, p_scale:Bool, ?p_use_filter:Bool):Void;
