...
@:include("godot_cpp/classes/rendering_server.hpp") @:native("godot::RenderingServer") @:structAccess extern class RenderingServer_extern extends gdnative.Object.Object_extern {
	...
	function multimesh_instance_set_transform(p_multimesh:gdnative.RID, p_index:Int, p_transform:gdnative.Transform3D):Void;
	function multimesh_instance_set_transform_2d(p_multimesh:gdnative.RID, p_index:Int, p_transform:gdnative.Transform2D):Void;
	...
	function multimesh_instance_get_transform(p_multimesh:gdnative.RID, p_index:Int):gdnative.Transform3D;
	function multimesh_instance_get_transform_2d(p_multimesh:gdnative.RID, p_index:Int):gdnative.Transform2D;
	...
	function skeleton_bone_set_transform(p_skeleton:gdnative.RID, p_bone:Int, p_transform:gdnative.Transform3D):Void;
	function skeleton_bone_get_transform(p_skeleton:gdnative.RID, p_bone:Int):gdnative.Transform3D;
	function skeleton_bone_set_transform_2d(p_skeleton:gdnative.RID, p_bone:Int, p_transform:gdnative.Transform2D):Void;
	function skeleton_bone_get_transform_2d(p_skeleton:gdnative.RID, p_bone:Int):gdnative.Transform2D;
	function skeleton_set_base_transform_2d(p_skeleton:gdnative.RID, p_base_transform:gdnative.Transform2D):Void;
	...
	function voxel_gi_allocate_data(p_voxel_gi:gdnative.RID, p_to_cell_xform:gdnative.Transform3D, p_aabb:gdnative.AABB, p_octree_size:gdnative.Vector3i, p_octree_cells:gdnative.PackedByteArray, p_data_cells:gdnative.PackedByteArray, p_distance_field:gdnative.PackedByteArray, p_level_counts:gdnative.PackedInt32Array):Void;
	...
	function voxel_gi_get_to_cell_xform(p_voxel_gi:gdnative.RID):gdnative.Transform3D;
	...
	function particles_emit(p_particles:gdnative.RID, p_transform:gdnative.Transform3D, p_velocity:gdnative.Vector3, p_color:gdnative.Color, p_custom:gdnative.Color, p_emit_flags:Int):Void;
	...
	function particles_set_emission_transform(p_particles:gdnative.RID, p_transform:gdnative.Transform3D):Void;
	...
	function camera_set_transform(p_camera:gdnative.RID, p_transform:gdnative.Transform3D):Void;
	...
	function viewport_set_canvas_transform(p_viewport:gdnative.RID, p_canvas:gdnative.RID, p_offset:gdnative.Transform2D):Void;
	...
	function viewport_set_global_canvas_transform(p_viewport:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	...
	function instance_set_transform(p_instance:gdnative.RID, p_transform:gdnative.Transform3D):Void;
	...
	function canvas_item_set_transform(p_item:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	...
	function canvas_item_transform_physics_interpolation(p_item:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	...
	overload function canvas_item_add_mesh(p_item:gdnative.RID, p_mesh:gdnative.RID):Void;
	overload function canvas_item_add_mesh(p_item:gdnative.RID, p_mesh:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	overload function canvas_item_add_mesh(p_item:gdnative.RID, p_mesh:gdnative.RID, p_transform:gdnative.Transform2D, p_modulate:gdnative.Color):Void;
	overload function canvas_item_add_mesh(p_item:gdnative.RID, p_mesh:gdnative.RID, p_transform:gdnative.Transform2D, p_modulate:gdnative.Color, p_texture:gdnative.RID):Void;
	...
	function canvas_item_add_set_transform(p_item:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	...
	function canvas_light_set_transform(p_light:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	...
	function canvas_light_transform_physics_interpolation(p_light:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	...
	function canvas_light_occluder_set_transform(p_occluder:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	...
	function canvas_light_occluder_transform_physics_interpolation(p_occluder:gdnative.RID, p_transform:gdnative.Transform2D):Void;
