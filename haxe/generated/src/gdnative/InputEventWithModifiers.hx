...
@:forward abstract InputEventWithModifiers(gdnative.Ref<InputEventWithModifiers_extern>) from gdnative.Ref<InputEventWithModifiers_extern> to gdnative.Ref<InputEventWithModifiers_extern> {
	@:from
	static inline function fromWrapper(v:gd.InputEventWithModifiers):gdnative.InputEventWithModifiers return @:privateAccess v.__inputeventwithmodifiers_ptr();
	@:to
	inline function toWrapper():gd.InputEventWithModifiers return new gd.InputEventWithModifiers(this);
}
@:include("godot_cpp/classes/input_event_with_modifiers.hpp") @:semantics(value) @:cpp.PointerType({ type : "InputEventWithModifiers", namespace : ['godot'] }) extern class InputEventWithModifiers_extern extends gdnative.InputEventFromWindow.InputEventFromWindow_extern {
