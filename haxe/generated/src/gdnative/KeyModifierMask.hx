package gdnative;
@:semantics(reference) @:cpp.ValueType({ type : "KeyModifierMask", namespace : ["godot"] }) @:include("godot_cpp/classes/global_constants.hpp") extern enum abstract KeyModifierMask(Int) to Int {
	@:op(A == B)
	static inline function eq(v1:KeyModifierMask, v2:KeyModifierMask):Bool return __cast(v1) == __cast(v2);
	static inline function __cast(v:KeyModifierMask):Int return v;
	final KEY_CODE_MASK;
