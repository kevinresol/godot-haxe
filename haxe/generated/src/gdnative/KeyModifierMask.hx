package gdnative;
@:semantics(value) @:cpp.ValueType({ type : "KeyModifierMask", namespace : ["godot"] }) @:include("godot_cpp/classes/global_constants.hpp") extern enum abstract KeyModifierMask(Int) to Int {
	@:op(A == B)
