...
@:include("godot_cpp/classes/jsonrpc.hpp") @:native("godot::JSONRPC") @:structAccess extern class JSONRPC_extern extends gdnative.Object.Object_extern {
	...
	function process_action(p_action:gdnative.Variant, ?p_recurse:Bool):gdnative.Variant;
	...
	function make_response_error(p_code:Int, p_message:gdnative.String, ?p_id:gdnative.Variant):gdnative.Dictionary;
}
