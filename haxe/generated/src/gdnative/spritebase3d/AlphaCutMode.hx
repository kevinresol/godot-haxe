...
@:native("godot::SpriteBase3D::AlphaCutMode") extern enum abstract AlphaCutMode(AlphaCutMode_extern) {
	...
	static inline function __cast(v:AlphaCutMode):AlphaCutMode_extern return untyped __cpp__("(cpp::Struct<godot::SpriteBase3D::AlphaCutMode, cpp::EnumHandler>){0}", v);
