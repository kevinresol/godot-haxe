...
@:include("godot_cpp/classes/animation_node.hpp") @:native("godot::AnimationNode") @:structAccess extern class AnimationNode_extern extends gdnative.Resource.Resource_extern {
	...
	function blend_animation(p_animation:gdnative.StringName, p_time:Float, p_delta:Float, p_seeked:Bool, p_is_external_seeking:Bool, p_blend:Float, ?p_looped_flag:gdnative.animation.LoopedFlag):Void;
	function blend_node(p_name:gdnative.StringName, p_node:gdnative.AnimationNode, p_time:Float, p_seek:Bool, p_is_external_seeking:Bool, p_blend:Float, ?p_filter:gdnative.animationnode.FilterAction, ?p_sync:Bool, ?p_test_only:Bool):Float;
	function blend_input(p_input_index:Int, p_time:Float, p_seek:Bool, p_is_external_seeking:Bool, p_blend:Float, ?p_filter:gdnative.animationnode.FilterAction, ?p_sync:Bool, ?p_test_only:Bool):Float;
