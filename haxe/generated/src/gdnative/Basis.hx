...
@:forward abstract Basis(cpp.Struct<Basis_extern>) from cpp.Struct<Basis_extern> to cpp.Struct<Basis_extern> {
	...
	@:op(A * B)
	extern inline function __op_multiply_int(p_rhs:cpp.Int64):gdnative.Basis return untyped __cpp__('{0} * {1}', val(), p_rhs);
	@:op(A / B)
	extern inline function __op_divide_int(p_rhs:cpp.Int64):gdnative.Basis return untyped __cpp__('{0} * (1.0 / {1})', val(), p_rhs);
	@:op(A * B)
