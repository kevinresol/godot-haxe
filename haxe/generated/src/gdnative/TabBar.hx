...
@:include("godot_cpp/classes/tab_bar.hpp") @:native("godot::TabBar") @:structAccess extern class TabBar_extern extends gdnative.Control.Control_extern {
	...
	overload function add_tab():Void;
	overload function add_tab(p_title:gdnative.String):Void;
	overload function add_tab(p_title:gdnative.String, p_icon:gdnative.Texture2D):Void;
