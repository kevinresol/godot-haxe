...
/**
	Built-in Class
**/
@:forward abstract PackedVector2Array(PackedVector2Array_extern) from PackedVector2Array_extern to PackedVector2Array_extern {
	@:from
	...
	@:to
	inline function toVariant():gdnative.Variant return new gdnative.Variant.Variant_extern(untyped __cpp__("static_cast<godot::PackedVector2Array &>({0})", this));
	inline function val():PackedVector2Array_extern return untyped __cpp__('(*{0})', this);
	@:op(A == B)
...
@:include("godot_cpp/variant/packed_vector2_array.hpp") @:semantics(reference) @:cpp.ValueType({ type : "PackedVector2Array", namespace : ['godot'] }) extern class PackedVector2Array_extern {
	@:overload(function(p_from:gdnative.PackedVector2Array):Void { })
	@:overload(function(p_from:gdnative.Array):Void { })
	function new();
	function get(p_index:cpp.Int64):gdnative.Vector2;
	function size():cpp.Int64;
	function is_empty():Bool;
	function set(p_index:cpp.Int64, p_value:gdnative.Vector2):Void;
	...
	function insert(p_at_index:cpp.Int64, p_value:gdnative.Vector2):cpp.Int64;
	...
	overload function slice(p_begin:cpp.Int64):gdnative.PackedVector2Array;
	overload function slice(p_begin:cpp.Int64, p_end:cpp.Int64):gdnative.PackedVector2Array;
	function to_byte_array():gdnative.PackedByteArray;
	function sort():Void;
	overload function bsearch(p_value:gdnative.Vector2):cpp.Int64;
	overload function bsearch(p_value:gdnative.Vector2, p_before:Bool):cpp.Int64;
	function duplicate():gdnative.PackedVector2Array;
	overload function find(p_value:gdnative.Vector2):cpp.Int64;
	overload function find(p_value:gdnative.Vector2, p_from:cpp.Int64):cpp.Int64;
	overload function rfind(p_value:gdnative.Vector2):cpp.Int64;
	overload function rfind(p_value:gdnative.Vector2, p_from:cpp.Int64):cpp.Int64;
	function count(p_value:gdnative.Vector2):cpp.Int64;
}