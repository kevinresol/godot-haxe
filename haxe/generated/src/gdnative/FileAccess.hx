...
@:include("godot_cpp/classes/file_access.hpp") @:native("godot::FileAccess") @:structAccess extern class FileAccess_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	overload static function open_compressed(p_path:gdnative.String, p_mode_flags:gdnative.fileaccess.ModeFlags):gdnative.FileAccess;
	overload static function open_compressed(p_path:gdnative.String, p_mode_flags:gdnative.fileaccess.ModeFlags, p_compression_mode:gdnative.fileaccess.CompressionMode):gdnative.FileAccess;
	...
	overload function seek_end():Void;
	overload function seek_end(p_position:Int):Void;
	...
	overload function get_csv_line():gdnative.PackedStringArray;
	overload function get_csv_line(p_delim:gdnative.String):gdnative.PackedStringArray;
	overload function get_as_text():gdnative.String;
	overload function get_as_text(p_skip_cr:Bool):gdnative.String;
	...
	overload function store_csv_line(p_values:gdnative.PackedStringArray):Void;
	overload function store_csv_line(p_values:gdnative.PackedStringArray, p_delim:gdnative.String):Void;
	function store_string(p_string:gdnative.String):Void;
	overload function store_var(p_value:gdnative.Variant):Void;
	overload function store_var(p_value:gdnative.Variant, p_full_objects:Bool):Void;
