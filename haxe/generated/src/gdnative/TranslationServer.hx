...
@:include("godot_cpp/classes/translation_server.hpp") @:native("godot::TranslationServer") @:structAccess extern class TranslationServer_extern extends gdnative.Object.Object_extern {
	...
	overload function translate(p_message:gdnative.StringName):gdnative.StringName;
	overload function translate(p_message:gdnative.StringName, p_context:gdnative.StringName):gdnative.StringName;
	overload function translate_plural(p_message:gdnative.StringName, p_plural_message:gdnative.StringName, p_n:Int):gdnative.StringName;
	overload function translate_plural(p_message:gdnative.StringName, p_plural_message:gdnative.StringName, p_n:Int, p_context:gdnative.StringName):gdnative.StringName;
