...
@:include("godot_cpp/variant/packed_byte_array.hpp") @:native("godot::PackedByteArray") @:structAccess extern class PackedByteArray_extern {
	...
	function slice(p_begin:Int, ?p_end:Int):gdnative.PackedByteArray;
	function sort():Void;
	...
	function compress(?p_compression_mode:Int):gdnative.PackedByteArray;
	function decompress(p_buffer_size:Int, ?p_compression_mode:Int):gdnative.PackedByteArray;
	function decompress_dynamic(p_max_output_size:Int, ?p_compression_mode:Int):gdnative.PackedByteArray;
	...
	function decode_var(p_byte_offset:Int, ?p_allow_objects:Bool):gdnative.Variant;
	...
	function encode_var(p_byte_offset:Int, p_value:gdnative.Variant, ?p_allow_objects:Bool):Int;
}
