...
/**
	Built-in Class
**/
@:forward abstract PackedByteArray(PackedByteArray_extern) from PackedByteArray_extern to PackedByteArray_extern {
	@:from
	...
	inline function val():PackedByteArray_extern return untyped __cpp__('(*{0})', this);
	@:op(A == B)
...
@:include("godot_cpp/variant/packed_byte_array.hpp") @:semantics(value) @:cpp.ValueType({ type : "PackedByteArray", namespace : ['godot'] }) extern class PackedByteArray_extern {
	...
	overload function get_string_from_multibyte_char():gdnative.String;
	overload function get_string_from_multibyte_char(p_encoding:gdnative.String):gdnative.String;
	...
	function to_vector2_array():gdnative.PackedVector2Array;
	function to_vector3_array():gdnative.PackedVector3Array;
	function to_vector4_array():gdnative.PackedVector4Array;
	function to_color_array():gdnative.PackedColorArray;
	overload function bswap16():Void;
	overload function bswap16(p_offset:cpp.Int64):Void;
	overload function bswap16(p_offset:cpp.Int64, p_count:cpp.Int64):Void;
	overload function bswap32():Void;
	overload function bswap32(p_offset:cpp.Int64):Void;
	overload function bswap32(p_offset:cpp.Int64, p_count:cpp.Int64):Void;
	overload function bswap64():Void;
	overload function bswap64(p_offset:cpp.Int64):Void;
	overload function bswap64(p_offset:cpp.Int64, p_count:cpp.Int64):Void;
