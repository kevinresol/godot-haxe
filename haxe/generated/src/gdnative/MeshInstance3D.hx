...
@:include("godot_cpp/classes/mesh_instance3d.hpp") @:native("godot::MeshInstance3D") @:structAccess extern class MeshInstance3D_extern extends gdnative.GeometryInstance3D.GeometryInstance3D_extern {
	...
	function create_convex_collision(?p_clean:Bool, ?p_simplify:Bool):Void;
	function create_multiple_convex_collisions(?p_settings:gdnative.MeshConvexDecompositionSettings):Void;
	...
	function bake_mesh_from_current_blend_shape_mix(?p_existing:gdnative.ArrayMesh):gdnative.ArrayMesh;
}
