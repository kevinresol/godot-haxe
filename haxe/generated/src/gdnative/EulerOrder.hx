package gdnative;
@:semantics(value) @:cpp.ValueType({ type : "EulerOrder", namespace : ["godot"] }) @:include("godot_cpp/classes/global_constants.hpp") extern enum abstract EulerOrder(Int) to Int {
	@:op(A == B)
