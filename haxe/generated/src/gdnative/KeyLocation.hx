package gdnative;
@:semantics(reference) @:cpp.ValueType({ type : "KeyLocation", namespace : ["godot"] }) @:include("godot_cpp/classes/global_constants.hpp") extern enum abstract KeyLocation(Int) to Int {
	@:op(A == B)
