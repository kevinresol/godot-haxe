...
@:semantics(value) @:cpp.ValueType({ type : "TextureFilter", namespace : ["godot", "CanvasItem"] }) @:include("godot_cpp/classes/canvas_item.hpp") extern enum abstract TextureFilter(Int) to Int {
	@:op(A == B)
