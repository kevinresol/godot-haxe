...
@:native("godot::XRBodyTracker::Joint") extern enum abstract Joint(Joint_extern) {
	@:op(A == B)
	static inline function eq(v1:Joint, v2:Joint):Bool return __cast(v1) == __cast(v2);
	static inline function __cast(v:Joint):Joint_extern return untyped __cpp__("(cpp::Struct<godot::XRBodyTracker::Joint, cpp::EnumHandler>){0}", v);
