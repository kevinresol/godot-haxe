...
@:include("godot_cpp/classes/code_edit.hpp") @:native("godot::CodeEdit") @:structAccess extern class CodeEdit_extern extends gdnative.TextEdit.TextEdit_extern {
	...
	overload function convert_indent():Void;
	overload function convert_indent(p_from_line:Int):Void;
	overload function convert_indent(p_from_line:Int, p_to_line:Int):Void;
	...
	overload function set_code_region_tags():Void;
	overload function set_code_region_tags(p_start:gdnative.String):Void;
	overload function set_code_region_tags(p_start:gdnative.String, p_end:gdnative.String):Void;
	function is_line_code_region_start(p_line:Int):Bool;
	function is_line_code_region_end(p_line:Int):Bool;
	overload function add_string_delimiter(p_start_key:gdnative.String, p_end_key:gdnative.String):Void;
	overload function add_string_delimiter(p_start_key:gdnative.String, p_end_key:gdnative.String, p_line_only:Bool):Void;
	...
	overload function is_in_string(p_line:Int):Int;
	overload function is_in_string(p_line:Int, p_column:Int):Int;
	overload function add_comment_delimiter(p_start_key:gdnative.String, p_end_key:gdnative.String):Void;
	overload function add_comment_delimiter(p_start_key:gdnative.String, p_end_key:gdnative.String, p_line_only:Bool):Void;
	...
	overload function is_in_comment(p_line:Int):Int;
	overload function is_in_comment(p_line:Int, p_column:Int):Int;
	...
	overload function request_code_completion():Void;
	overload function request_code_completion(p_force:Bool):Void;
	overload function add_code_completion_option(p_type:gdnative.codeedit.CodeCompletionKind, p_display_text:gdnative.String, p_insert_text:gdnative.String):Void;
	overload function add_code_completion_option(p_type:gdnative.codeedit.CodeCompletionKind, p_display_text:gdnative.String, p_insert_text:gdnative.String, p_text_color:gdnative.Color):Void;
	overload function add_code_completion_option(p_type:gdnative.codeedit.CodeCompletionKind, p_display_text:gdnative.String, p_insert_text:gdnative.String, p_text_color:gdnative.Color, p_icon:gdnative.Resource):Void;
	overload function add_code_completion_option(p_type:gdnative.codeedit.CodeCompletionKind, p_display_text:gdnative.String, p_insert_text:gdnative.String, p_text_color:gdnative.Color, p_icon:gdnative.Resource, p_value:gdnative.Variant):Void;
	overload function add_code_completion_option(p_type:gdnative.codeedit.CodeCompletionKind, p_display_text:gdnative.String, p_insert_text:gdnative.String, p_text_color:gdnative.Color, p_icon:gdnative.Resource, p_value:gdnative.Variant, p_location:Int):Void;
	...
	overload function confirm_code_completion():Void;
	overload function confirm_code_completion(p_replace:Bool):Void;
