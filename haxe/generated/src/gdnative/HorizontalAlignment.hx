package gdnative;
@:semantics(value) @:cpp.ValueType({ type : "HorizontalAlignment", namespace : ["godot"] }) @:include("godot_cpp/classes/global_constants.hpp") extern enum abstract HorizontalAlignment(Int) to Int {
	@:op(A == B)
