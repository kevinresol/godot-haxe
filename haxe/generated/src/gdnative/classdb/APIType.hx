...
@:semantics(reference) @:cpp.ValueType({ type : "APIType", namespace : ["godot", "ClassDBSingleton"] }) @:include("godot_cpp/classes/class_db_singleton.hpp") extern enum abstract APIType(Int) to Int {
	@:op(A == B)
