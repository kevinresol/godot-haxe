...
@:include("godot_cpp/classes/canvas_item.hpp") @:native("godot::CanvasItem") @:structAccess extern class CanvasItem_extern extends gdnative.Node.Node_extern {
	...
	function draw_polyline(p_points:gdnative.PackedVector2Array, p_color:gdnative.Color, ?p_width:Float, ?p_antialiased:Bool):Void;
	function draw_polyline_colors(p_points:gdnative.PackedVector2Array, p_colors:gdnative.PackedColorArray, ?p_width:Float, ?p_antialiased:Bool):Void;
	...
	function draw_multiline(p_points:gdnative.PackedVector2Array, p_color:gdnative.Color, ?p_width:Float, ?p_antialiased:Bool):Void;
	function draw_multiline_colors(p_points:gdnative.PackedVector2Array, p_colors:gdnative.PackedColorArray, ?p_width:Float, ?p_antialiased:Bool):Void;
	function draw_rect(p_rect:gdnative.Rect2, p_color:gdnative.Color, ?p_filled:Bool, ?p_width:Float, ?p_antialiased:Bool):Void;
	...
	function draw_texture_rect(p_texture:gdnative.Texture2D, p_rect:gdnative.Rect2, p_tile:Bool, ?p_modulate:gdnative.Color, ?p_transpose:Bool):Void;
	function draw_texture_rect_region(p_texture:gdnative.Texture2D, p_rect:gdnative.Rect2, p_src_rect:gdnative.Rect2, ?p_modulate:gdnative.Color, ?p_transpose:Bool, ?p_clip_uv:Bool):Void;
	function draw_msdf_texture_rect_region(p_texture:gdnative.Texture2D, p_rect:gdnative.Rect2, p_src_rect:gdnative.Rect2, ?p_modulate:gdnative.Color, ?p_outline:Float, ?p_pixel_range:Float, ?p_scale:Float):Void;
	function draw_lcd_texture_rect_region(p_texture:gdnative.Texture2D, p_rect:gdnative.Rect2, p_src_rect:gdnative.Rect2, ?p_modulate:gdnative.Color):Void;
	function draw_style_box(p_style_box:gdnative.StyleBox, p_rect:gdnative.Rect2):Void;
	function draw_primitive(p_points:gdnative.PackedVector2Array, p_colors:gdnative.PackedColorArray, p_uvs:gdnative.PackedVector2Array, ?p_texture:gdnative.Texture2D):Void;
	function draw_polygon(p_points:gdnative.PackedVector2Array, p_colors:gdnative.PackedColorArray, ?p_uvs:gdnative.PackedVector2Array, ?p_texture:gdnative.Texture2D):Void;
	function draw_colored_polygon(p_points:gdnative.PackedVector2Array, p_color:gdnative.Color, ?p_uvs:gdnative.PackedVector2Array, ?p_texture:gdnative.Texture2D):Void;
	function draw_string(p_font:gdnative.Font, p_pos:gdnative.Vector2, p_text:gdnative.String, ?p_alignment:gdnative.HorizontalAlignment, ?p_width:Float, ?p_font_size:Int, ?p_modulate:gdnative.Color, ?p_justification_flags:Int, ?p_direction:gdnative.textserver.Direction, ?p_orientation:gdnative.textserver.Orientation):Void;
	function draw_multiline_string(p_font:gdnative.Font, p_pos:gdnative.Vector2, p_text:gdnative.String, ?p_alignment:gdnative.HorizontalAlignment, ?p_width:Float, ?p_font_size:Int, ?p_max_lines:Int, ?p_modulate:gdnative.Color, ?p_brk_flags:Int, ?p_justification_flags:Int, ?p_direction:gdnative.textserver.Direction, ?p_orientation:gdnative.textserver.Orientation):Void;
	function draw_string_outline(p_font:gdnative.Font, p_pos:gdnative.Vector2, p_text:gdnative.String, ?p_alignment:gdnative.HorizontalAlignment, ?p_width:Float, ?p_font_size:Int, ?p_size:Int, ?p_modulate:gdnative.Color, ?p_justification_flags:Int, ?p_direction:gdnative.textserver.Direction, ?p_orientation:gdnative.textserver.Orientation):Void;
	function draw_multiline_string_outline(p_font:gdnative.Font, p_pos:gdnative.Vector2, p_text:gdnative.String, ?p_alignment:gdnative.HorizontalAlignment, ?p_width:Float, ?p_font_size:Int, ?p_max_lines:Int, ?p_size:Int, ?p_modulate:gdnative.Color, ?p_brk_flags:Int, ?p_justification_flags:Int, ?p_direction:gdnative.textserver.Direction, ?p_orientation:gdnative.textserver.Orientation):Void;
	function draw_char(p_font:gdnative.Font, p_pos:gdnative.Vector2, p_char:gdnative.String, ?p_font_size:Int, ?p_modulate:gdnative.Color):Void;
	function draw_char_outline(p_font:gdnative.Font, p_pos:gdnative.Vector2, p_char:gdnative.String, ?p_font_size:Int, ?p_size:Int, ?p_modulate:gdnative.Color):Void;
