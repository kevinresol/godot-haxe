...
@:semantics(reference) @:cpp.ValueType({ type : "AutoTranslateMode", namespace : ["godot", "Node"] }) @:include("godot_cpp/classes/node.hpp") extern enum abstract AutoTranslateMode(Int) to Int {
	@:op(A == B)
