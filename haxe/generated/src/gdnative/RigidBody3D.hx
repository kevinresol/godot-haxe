...
@:include("godot_cpp/classes/rigid_body3d.hpp") @:native("godot::RigidBody3D") @:structAccess extern class RigidBody3D_extern extends gdnative.PhysicsBody3D.PhysicsBody3D_extern {
	...
	function set_inertia(p_inertia:gdnative.Vector3):Void;
	function get_inertia():gdnative.Vector3;
	function set_center_of_mass_mode(p_mode:gdnative.rigidbody3d.CenterOfMassMode):Void;
	function get_center_of_mass_mode():gdnative.rigidbody3d.CenterOfMassMode;
	...
	function get_linear_damp_mode():gdnative.rigidbody3d.DampMode;
	function set_angular_damp_mode(p_angular_damp_mode:gdnative.rigidbody3d.DampMode):Void;
	function get_angular_damp_mode():gdnative.rigidbody3d.DampMode;
	...
	function set_axis_velocity(p_axis_velocity:gdnative.Vector3):Void;
	function apply_central_impulse(p_impulse:gdnative.Vector3):Void;
	function apply_impulse(p_impulse:gdnative.Vector3, ?p_position:gdnative.Vector3):Void;
	function apply_torque_impulse(p_impulse:gdnative.Vector3):Void;
	function apply_central_force(p_force:gdnative.Vector3):Void;
	function apply_force(p_force:gdnative.Vector3, ?p_position:gdnative.Vector3):Void;
	function apply_torque(p_torque:gdnative.Vector3):Void;
	function add_constant_central_force(p_force:gdnative.Vector3):Void;
	function add_constant_force(p_force:gdnative.Vector3, ?p_position:gdnative.Vector3):Void;
