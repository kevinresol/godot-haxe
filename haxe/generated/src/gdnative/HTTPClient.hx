...
@:include("godot_cpp/classes/http_client.hpp") @:native("godot::HTTPClient") @:structAccess extern class HTTPClient_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	function connect_to_host(p_host:gdnative.String, ?p_port:Int, ?p_tls_options:gdnative.TLSOptions):gdnative.Error;
	...
	function request(p_method:gdnative.httpclient.Method, p_url:gdnative.String, p_headers:gdnative.PackedStringArray, ?p_body:gdnative.String):gdnative.Error;
	function close():Void;
