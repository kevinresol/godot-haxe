...
@:include("godot_cpp/classes/translation.hpp") @:native("godot::Translation") @:structAccess extern class Translation_extern extends gdnative.Resource.Resource_extern {
	...
	function add_message(p_src_message:gdnative.StringName, p_xlated_message:gdnative.StringName, ?p_context:gdnative.StringName):Void;
	function add_plural_message(p_src_message:gdnative.StringName, p_xlated_messages:gdnative.PackedStringArray, ?p_context:gdnative.StringName):Void;
	function get_message(p_src_message:gdnative.StringName, ?p_context:gdnative.StringName):gdnative.StringName;
	function get_plural_message(p_src_message:gdnative.StringName, p_src_plural_message:gdnative.StringName, p_n:Int, ?p_context:gdnative.StringName):gdnative.StringName;
	function erase_message(p_src_message:gdnative.StringName, ?p_context:gdnative.StringName):Void;
