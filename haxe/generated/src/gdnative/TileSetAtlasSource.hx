...
@:include("godot_cpp/classes/tile_set_atlas_source.hpp") @:native("godot::TileSetAtlasSource") @:structAccess extern class TileSetAtlasSource_extern extends gdnative.TileSetSource.TileSetSource_extern {
	...
	function create_tile(p_atlas_coords:gdnative.Vector2i, ?p_size:gdnative.Vector2i):Void;
	function remove_tile(p_atlas_coords:gdnative.Vector2i):Void;
	function move_tile_in_atlas(p_atlas_coords:gdnative.Vector2i, ?p_new_atlas_coords:gdnative.Vector2i, ?p_new_size:gdnative.Vector2i):Void;
	function get_tile_size_in_atlas(p_atlas_coords:gdnative.Vector2i):gdnative.Vector2i;
	function has_room_for_tile(p_atlas_coords:gdnative.Vector2i, p_size:gdnative.Vector2i, p_animation_columns:Int, p_animation_separation:gdnative.Vector2i, p_frames_count:Int, ?p_ignored_tile:gdnative.Vector2i):Bool;
	...
	function create_alternative_tile(p_atlas_coords:gdnative.Vector2i, ?p_alternative_id_override:Int):Int;
	...
	function get_tile_texture_region(p_atlas_coords:gdnative.Vector2i, ?p_frame:Int):gdnative.Rect2i;
