...
@:include("godot_cpp/classes/crypto_key.hpp") @:native("godot::CryptoKey") @:structAccess extern class CryptoKey_extern extends gdnative.Resource.Resource_extern {
	...
	overload function save(p_path:gdnative.String, p_public_only:Bool):gdnative.Error;
	overload function save(p_path:gdnative.String):gdnative.Error;
	overload function load(p_path:gdnative.String, p_public_only:Bool):gdnative.Error;
	overload function load(p_path:gdnative.String):gdnative.Error;
	function is_public_only():Bool;
	overload function save_to_string(p_public_only:Bool):gdnative.String;
	overload function save_to_string():gdnative.String;
	overload function load_from_string(p_string_key:gdnative.String, p_public_only:Bool):gdnative.Error;
	overload function load_from_string(p_string_key:gdnative.String):gdnative.Error;
}
