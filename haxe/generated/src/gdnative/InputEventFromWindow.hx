...
@:include("godot_cpp/classes/input_event_from_window.hpp") @:semantic(reference) @:cpp.PointerType({ type : "InputEventFromWindow", namespace : ['godot'] }) extern class InputEventFromWindow_extern extends gdnative.InputEvent.InputEvent_extern {
