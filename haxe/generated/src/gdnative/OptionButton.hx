...
@:include("godot_cpp/classes/option_button.hpp") @:native("godot::OptionButton") @:structAccess extern class OptionButton_extern extends gdnative.Button.Button_extern {
	...
	overload function add_separator(p_text:gdnative.String):Void;
	function clear():Void;
	...
	overload function get_selectable_item():Int;
	overload function get_selectable_item(p_from_last:Bool):Int;
