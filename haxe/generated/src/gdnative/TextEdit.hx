...
@:include("godot_cpp/classes/text_edit.hpp") @:native("godot::TextEdit") @:structAccess extern class TextEdit_extern extends gdnative.Control.Control_extern {
	...
	function insert_text_at_caret(p_text:gdnative.String, ?p_caret_index:Int):Void;
	function insert_text(p_text:gdnative.String, p_line:Int, p_column:Int, ?p_before_selection_begin:Bool, ?p_before_selection_end:Bool):Void;
	...
	function get_line_column_at_pos(p_position:gdnative.Vector2i, ?p_allow_out_of_bounds:Bool):gdnative.Vector2i;
	...
	function get_sorted_carets(?p_include_ignored_carets:Bool):gdnative.PackedInt32Array;
	...
	function get_caret_draw_pos(?p_caret_index:Int):gdnative.Vector2;
	...
	function get_word_under_caret(?p_caret_index:Int):gdnative.String;
	...
	function get_selected_text(?p_caret_index:Int):gdnative.String;
