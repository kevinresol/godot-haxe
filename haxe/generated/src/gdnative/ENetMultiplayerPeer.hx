...
@:include("godot_cpp/classes/e_net_multiplayer_peer.hpp") @:native("godot::ENetMultiplayerPeer") @:structAccess extern class ENetMultiplayerPeer_extern extends gdnative.MultiplayerPeer.MultiplayerPeer_extern {
	...
	function create_server(p_port:Int, ?p_max_clients:Int, ?p_max_channels:Int, ?p_in_bandwidth:Int, ?p_out_bandwidth:Int):gdnative.Error;
	function create_client(p_address:gdnative.String, p_port:Int, ?p_channel_count:Int, ?p_in_bandwidth:Int, ?p_out_bandwidth:Int, ?p_local_port:Int):gdnative.Error;
