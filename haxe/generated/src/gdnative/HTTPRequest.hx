...
@:include("godot_cpp/classes/http_request.hpp") @:native("godot::HTTPRequest") @:structAccess extern class HTTPRequest_extern extends gdnative.Node.Node_extern {
	...
	function request(p_url:gdnative.String, ?p_custom_headers:gdnative.PackedStringArray, ?p_method:gdnative.httpclient.Method, ?p_request_data:gdnative.String):gdnative.Error;
	function request_raw(p_url:gdnative.String, ?p_custom_headers:gdnative.PackedStringArray, ?p_method:gdnative.httpclient.Method, ?p_request_data_raw:gdnative.PackedByteArray):gdnative.Error;
