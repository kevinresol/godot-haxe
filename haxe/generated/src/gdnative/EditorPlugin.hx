...
@:include("godot_cpp/classes/editor_plugin.hpp") @:native("godot::EditorPlugin") @:structAccess extern class EditorPlugin_extern extends gdnative.Node.Node_extern {
	...
	overload function add_control_to_bottom_panel(p_control:gdnative.Control, p_title:gdnative.String):gdnative.Button;
	overload function add_control_to_bottom_panel(p_control:gdnative.Control, p_title:gdnative.String, p_shortcut:gdnative.Shortcut):gdnative.Button;
	overload function add_control_to_dock(p_slot:gdnative.editorplugin.DockSlot, p_control:gdnative.Control):Void;
	overload function add_control_to_dock(p_slot:gdnative.editorplugin.DockSlot, p_control:gdnative.Control, p_shortcut:gdnative.Shortcut):Void;
	...
	overload function add_import_plugin(p_importer:gdnative.EditorImportPlugin):Void;
	overload function add_import_plugin(p_importer:gdnative.EditorImportPlugin, p_first_priority:Bool):Void;
	function remove_import_plugin(p_importer:gdnative.EditorImportPlugin):Void;
	overload function add_scene_format_importer_plugin(p_scene_format_importer:gdnative.EditorSceneFormatImporter):Void;
	overload function add_scene_format_importer_plugin(p_scene_format_importer:gdnative.EditorSceneFormatImporter, p_first_priority:Bool):Void;
	function remove_scene_format_importer_plugin(p_scene_format_importer:gdnative.EditorSceneFormatImporter):Void;
	overload function add_scene_post_import_plugin(p_scene_import_plugin:gdnative.EditorScenePostImportPlugin):Void;
	overload function add_scene_post_import_plugin(p_scene_import_plugin:gdnative.EditorScenePostImportPlugin, p_first_priority:Bool):Void;
