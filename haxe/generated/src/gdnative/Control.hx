...
@:include("godot_cpp/classes/control.hpp") @:native("godot::Control") @:structAccess extern class Control_extern extends gdnative.CanvasItem.CanvasItem_extern {
	...
	overload function set_anchors_preset(p_preset:gdnative.control.LayoutPreset, p_keep_offsets:Bool):Void;
	overload function set_anchors_preset(p_preset:gdnative.control.LayoutPreset):Void;
	overload function set_offsets_preset(p_preset:gdnative.control.LayoutPreset, p_resize_mode:gdnative.control.LayoutPresetMode, p_margin:Int):Void;
	overload function set_offsets_preset(p_preset:gdnative.control.LayoutPreset, p_resize_mode:gdnative.control.LayoutPresetMode):Void;
	overload function set_offsets_preset(p_preset:gdnative.control.LayoutPreset):Void;
	overload function set_anchors_and_offsets_preset(p_preset:gdnative.control.LayoutPreset, p_resize_mode:gdnative.control.LayoutPresetMode, p_margin:Int):Void;
	overload function set_anchors_and_offsets_preset(p_preset:gdnative.control.LayoutPreset, p_resize_mode:gdnative.control.LayoutPresetMode):Void;
	overload function set_anchors_and_offsets_preset(p_preset:gdnative.control.LayoutPreset):Void;
	overload function set_anchor(p_side:gdnative.Side, p_anchor:Float, p_keep_offset:Bool, p_push_opposite_anchor:Bool):Void;
	overload function set_anchor(p_side:gdnative.Side, p_anchor:Float, p_keep_offset:Bool):Void;
	overload function set_anchor(p_side:gdnative.Side, p_anchor:Float):Void;
	...
	overload function set_anchor_and_offset(p_side:gdnative.Side, p_anchor:Float, p_offset:Float, p_push_opposite_anchor:Bool):Void;
	overload function set_anchor_and_offset(p_side:gdnative.Side, p_anchor:Float, p_offset:Float):Void;
	function set_begin(p_position:gdnative.Vector2):Void;
	function set_end(p_position:gdnative.Vector2):Void;
	overload function set_position(p_position:gdnative.Vector2, p_keep_offsets:Bool):Void;
	overload function set_position(p_position:gdnative.Vector2):Void;
	overload function set_size(p_size:gdnative.Vector2, p_keep_offsets:Bool):Void;
	overload function set_size(p_size:gdnative.Vector2):Void;
	function reset_size():Void;
	function set_custom_minimum_size(p_size:gdnative.Vector2):Void;
	overload function set_global_position(p_position:gdnative.Vector2, p_keep_offsets:Bool):Void;
	overload function set_global_position(p_position:gdnative.Vector2):Void;
	...
	overload function get_tooltip(p_at_position:gdnative.Vector2):gdnative.String;
	overload function get_tooltip():gdnative.String;
	...
	overload function get_cursor_shape(p_position:gdnative.Vector2):gdnative.control.CursorShape;
	overload function get_cursor_shape():gdnative.control.CursorShape;
