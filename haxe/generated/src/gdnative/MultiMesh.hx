...
@:include("godot_cpp/classes/multi_mesh.hpp") @:native("godot::MultiMesh") @:structAccess extern class MultiMesh_extern extends gdnative.Resource.Resource_extern {
	...
	function set_instance_transform(p_instance:Int, p_transform:gdnative.Transform3D):Void;
	function set_instance_transform_2d(p_instance:Int, p_transform:gdnative.Transform2D):Void;
	function get_instance_transform(p_instance:Int):gdnative.Transform3D;
	function get_instance_transform_2d(p_instance:Int):gdnative.Transform2D;
