...
@:include("godot_cpp/classes/physics_server3d.hpp") @:native("godot::PhysicsServer3D") @:structAccess extern class PhysicsServer3D_extern extends gdnative.Object.Object_extern {
	...
	function body_apply_impulse(p_body:gdnative.RID, p_impulse:gdnative.Vector3, ?p_position:gdnative.Vector3):Void;
	...
	function body_apply_force(p_body:gdnative.RID, p_force:gdnative.Vector3, ?p_position:gdnative.Vector3):Void;
	...
	function body_add_constant_force(p_body:gdnative.RID, p_force:gdnative.Vector3, ?p_position:gdnative.Vector3):Void;
	...
	function body_test_motion(p_body:gdnative.RID, p_parameters:gdnative.PhysicsTestMotionParameters3D, ?p_result:gdnative.PhysicsTestMotionResult3D):Bool;
