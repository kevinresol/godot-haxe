...
@:include("godot_cpp/classes/tree_item.hpp") @:native("godot::TreeItem") @:structAccess extern class TreeItem_extern extends gdnative.Object.Object_extern {
	...
	function set_custom_bg_color(p_column:Int, p_color:gdnative.Color, ?p_just_outline:Bool):Void;
	...
	function add_button(p_column:Int, p_button:gdnative.Texture2D, ?p_id:Int, ?p_disabled:Bool, ?p_tooltip_text:gdnative.String):Void;
	...
	function create_child(?p_index:Int):gdnative.TreeItem;
	...
	function get_next_in_tree(?p_wrap:Bool):gdnative.TreeItem;
	function get_prev_in_tree(?p_wrap:Bool):gdnative.TreeItem;
	function get_next_visible(?p_wrap:Bool):gdnative.TreeItem;
	function get_prev_visible(?p_wrap:Bool):gdnative.TreeItem;
