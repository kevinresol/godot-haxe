...
@:include("godot_cpp/classes/audio_stream_interactive.hpp") @:native("godot::AudioStreamInteractive") @:structAccess extern class AudioStreamInteractive_extern extends gdnative.AudioStream.AudioStream_extern {
	...
	function add_transition(p_from_clip:Int, p_to_clip:Int, p_from_time:gdnative.audiostreaminteractive.TransitionFromTime, p_to_time:gdnative.audiostreaminteractive.TransitionToTime, p_fade_mode:gdnative.audiostreaminteractive.FadeMode, p_fade_beats:Float, ?p_use_filler_clip:Bool, ?p_filler_clip:Int, ?p_hold_previous:Bool):Void;
