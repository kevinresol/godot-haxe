...
@:include("godot_cpp/classes/multiplayer_api.hpp") @:native("godot::MultiplayerAPI") @:structAccess extern class MultiplayerAPI_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	overload function rpc(p_peer:Int, p_object:gdnative.Object, p_method:gdnative.StringName):gdnative.Error;
	overload function rpc(p_peer:Int, p_object:gdnative.Object, p_method:gdnative.StringName, p_arguments:gdnative.Array):gdnative.Error;
