...
@:include("godot_cpp/classes/engine_debugger.hpp") @:native("godot::EngineDebugger") @:structAccess extern class EngineDebugger_extern extends gdnative.Object.Object_extern {
	...
	overload function profiler_enable(p_name:gdnative.StringName, p_enable:Bool):Void;
	overload function profiler_enable(p_name:gdnative.StringName, p_enable:Bool, p_arguments:gdnative.Array):Void;
	...
	overload function debug():Void;
	overload function debug(p_can_continue:Bool):Void;
	overload function debug(p_can_continue:Bool, p_is_error_breakpoint:Bool):Void;
	overload function script_debug(p_language:gdnative.ScriptLanguage):Void;
	overload function script_debug(p_language:gdnative.ScriptLanguage, p_can_continue:Bool):Void;
	overload function script_debug(p_language:gdnative.ScriptLanguage, p_can_continue:Bool, p_is_error_breakpoint:Bool):Void;
