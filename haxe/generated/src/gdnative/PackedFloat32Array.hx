...
@:include("godot_cpp/variant/packed_float32_array.hpp") @:semantics(value) @:cpp.ValueType({ type : "PackedFloat32Array", namespace : ['godot'] }) extern class PackedFloat32Array_extern {
