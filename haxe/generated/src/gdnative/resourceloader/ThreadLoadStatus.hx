...
@:semantics(value) @:cpp.ValueType({ type : "ThreadLoadStatus", namespace : ["godot", "ResourceLoader"] }) @:include("godot_cpp/classes/resource_loader.hpp") extern enum abstract ThreadLoadStatus(Int) to Int {
	@:op(A == B)
