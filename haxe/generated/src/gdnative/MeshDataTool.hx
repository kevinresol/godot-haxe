...
@:include("godot_cpp/classes/mesh_data_tool.hpp") @:native("godot::MeshDataTool") @:structAccess extern class MeshDataTool_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	overload function commit_to_surface(p_mesh:gdnative.ArrayMesh):gdnative.Error;
	overload function commit_to_surface(p_mesh:gdnative.ArrayMesh, p_compression_flags:Int):gdnative.Error;
