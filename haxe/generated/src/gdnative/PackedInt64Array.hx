...
@:include("godot_cpp/variant/packed_int64_array.hpp") @:semantics(value) @:cpp.ValueType({ type : "PackedInt64Array", namespace : ['godot'] }) extern class PackedInt64Array_extern {
