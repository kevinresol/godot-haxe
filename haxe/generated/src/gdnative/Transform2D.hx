...
@:forward abstract Transform2D(cpp.Struct<Transform2D_extern>) from cpp.Struct<Transform2D_extern> to cpp.Struct<Transform2D_extern> {
	...
	@:op(A * B)
	extern inline function __op_multiply_int(p_rhs:cpp.Int64):gdnative.Transform2D return untyped __cpp__('{0} * {1}', val(), p_rhs);
	@:op(A / B)
	extern inline function __op_divide_int(p_rhs:cpp.Int64):gdnative.Transform2D return untyped __cpp__('{0} * (1.0 / {1})', val(), p_rhs);
	@:op(A * B)
