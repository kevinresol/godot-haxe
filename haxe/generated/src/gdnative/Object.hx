...
@:include("godot_cpp/classes/object.hpp") @:native("godot::Object") @:structAccess extern class Object_extern {
	...
	function add_user_signal(p_signal:gdnative.String, ?p_arguments:gdnative.Array):Void;
	...
	function connect(p_signal:gdnative.StringName, p_callable:gdnative.Callable, ?p_flags:Int):gdnative.Error;
