...
@:include("godot_cpp/variant/string.hpp") @:native("godot::String") @:structAccess extern class String_extern {
	...
	overload static function num(p_number:Float, p_decimals:Int):gdnative.String;
	overload static function num_int64(p_number:Int):gdnative.String;
	overload static function num_int64(p_number:Int, p_base:Int):gdnative.String;
	overload static function num_int64(p_number:Int, p_base:Int, p_capitalize_hex:Bool):gdnative.String;
	overload static function num_uint64(p_number:Int):gdnative.String;
	overload static function num_uint64(p_number:Int, p_base:Int):gdnative.String;
	overload static function num_uint64(p_number:Int, p_base:Int, p_capitalize_hex:Bool):gdnative.String;
	static function chr(p_char:Int):gdnative.String;
	static function humanize_size(p_size:Int):gdnative.String;
}