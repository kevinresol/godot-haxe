...
@:include("godot_cpp/variant/string.hpp") @:native("godot::String") @:structAccess extern class String_extern {
	...
	overload function num(p_number:Float, p_decimals:Int):gdnative.String;
	overload function num(p_number:Float):gdnative.String;
	overload function num_int64(p_number:Int, p_base:Int, p_capitalize_hex:Bool):gdnative.String;
	overload function num_int64(p_number:Int, p_base:Int):gdnative.String;
	overload function num_int64(p_number:Int):gdnative.String;
	overload function num_uint64(p_number:Int, p_base:Int, p_capitalize_hex:Bool):gdnative.String;
	overload function num_uint64(p_number:Int, p_base:Int):gdnative.String;
