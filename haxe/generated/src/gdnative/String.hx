...
/**
	Built-in Class
**/
@:forward abstract String(String_extern) from String_extern to String_extern {
	@:to
	...
	@:from
	static inline function fromWrapperInternal(v:gd.String.String_wrapper):gdnative.String return @:privateAccess v.__gd;
	@:to
	...
	@:to
	inline function toVariant():gdnative.Variant return new gdnative.Variant.Variant_extern(untyped __cpp__("static_cast<godot::String &>({0})", this));
	inline function val():String_extern return untyped __cpp__('(*{0})', this);
	@:op(A == B)
	...
	@:op(A % B)
	extern inline function __op_modulus_int(p_rhs:cpp.Int64):gdnative.String return untyped __cpp__('{0} % {1}', val(), p_rhs);
	@:op(A % B)
	...
	@:op(A < B)
	extern inline function __op_less_than_string(p_rhs:gdnative.String):Bool return untyped __cpp__('{0} < {1}', val(), @:privateAccess p_rhs.val());
	@:op(A <= B)
	extern inline function __op_less_equal_string(p_rhs:gdnative.String):Bool return untyped __cpp__('{0} <= {1}', val(), @:privateAccess p_rhs.val());
	@:op(A > B)
	extern inline function __op_greater_than_string(p_rhs:gdnative.String):Bool return untyped __cpp__('{0} > {1}', val(), @:privateAccess p_rhs.val());
	@:op(A >= B)
	extern inline function __op_greater_equal_string(p_rhs:gdnative.String):Bool return untyped __cpp__('{0} >= {1}', val(), @:privateAccess p_rhs.val());
	@:op(A + B)
...
@:include("godot_cpp/variant/string.hpp") @:semantics(reference) @:cpp.ValueType({ type : "String", namespace : ['godot'] }) extern class String_extern {
	...
	function naturalcasecmp_to(p_to:gdnative.String):cpp.Int64;
	function naturalnocasecmp_to(p_to:gdnative.String):cpp.Int64;
	function filecasecmp_to(p_to:gdnative.String):cpp.Int64;
	function filenocasecmp_to(p_to:gdnative.String):cpp.Int64;
	function length():cpp.Int64;
	overload function substr(p_from:cpp.Int64):gdnative.String;
	overload function substr(p_from:cpp.Int64, p_len:cpp.Int64):gdnative.String;
	function get_slice(p_delimiter:gdnative.String, p_slice:cpp.Int64):gdnative.String;
	function get_slicec(p_delimiter:cpp.Int64, p_slice:cpp.Int64):gdnative.String;
	function get_slice_count(p_delimiter:gdnative.String):cpp.Int64;
	overload function find(p_what:gdnative.String):cpp.Int64;
	overload function find(p_what:gdnative.String, p_from:cpp.Int64):cpp.Int64;
	overload function findn(p_what:gdnative.String):cpp.Int64;
	overload function findn(p_what:gdnative.String, p_from:cpp.Int64):cpp.Int64;
	overload function count(p_what:gdnative.String):cpp.Int64;
	overload function count(p_what:gdnative.String, p_from:cpp.Int64):cpp.Int64;
	overload function count(p_what:gdnative.String, p_from:cpp.Int64, p_to:cpp.Int64):cpp.Int64;
	overload function countn(p_what:gdnative.String):cpp.Int64;
	overload function countn(p_what:gdnative.String, p_from:cpp.Int64):cpp.Int64;
	overload function countn(p_what:gdnative.String, p_from:cpp.Int64, p_to:cpp.Int64):cpp.Int64;
	overload function rfind(p_what:gdnative.String):cpp.Int64;
	overload function rfind(p_what:gdnative.String, p_from:cpp.Int64):cpp.Int64;
	overload function rfindn(p_what:gdnative.String):cpp.Int64;
	overload function rfindn(p_what:gdnative.String, p_from:cpp.Int64):cpp.Int64;
	...
	overload function erase(p_position:cpp.Int64):gdnative.String;
	overload function erase(p_position:cpp.Int64, p_chars:cpp.Int64):gdnative.String;
	...
	overload function split(p_delimiter:gdnative.String, p_allow_empty:Bool, p_maxsplit:cpp.Int64):gdnative.PackedStringArray;
	...
	overload function rsplit(p_delimiter:gdnative.String, p_allow_empty:Bool, p_maxsplit:cpp.Int64):gdnative.PackedStringArray;
	...
	function left(p_length:cpp.Int64):gdnative.String;
	function right(p_length:cpp.Int64):gdnative.String;
	...
	function to_int():cpp.Int64;
	function to_float():Float;
	function hex_to_int():cpp.Int64;
	function bin_to_int():cpp.Int64;
	overload function lpad(p_min_length:cpp.Int64):gdnative.String;
	overload function lpad(p_min_length:cpp.Int64, p_character:gdnative.String):gdnative.String;
	overload function rpad(p_min_length:cpp.Int64):gdnative.String;
	overload function rpad(p_min_length:cpp.Int64, p_character:gdnative.String):gdnative.String;
	function pad_decimals(p_digits:cpp.Int64):gdnative.String;
	function pad_zeros(p_digits:cpp.Int64):gdnative.String;
	...
	static function num_scientific(p_number:Float):gdnative.String;
	overload static function num(p_number:Float):gdnative.String;
	overload static function num(p_number:Float, p_decimals:cpp.Int64):gdnative.String;
	overload static function num_int64(p_number:cpp.Int64):gdnative.String;
	overload static function num_int64(p_number:cpp.Int64, p_base:cpp.Int64):gdnative.String;
	overload static function num_int64(p_number:cpp.Int64, p_base:cpp.Int64, p_capitalize_hex:Bool):gdnative.String;
	overload static function num_uint64(p_number:cpp.Int64):gdnative.String;
	overload static function num_uint64(p_number:cpp.Int64, p_base:cpp.Int64):gdnative.String;
	overload static function num_uint64(p_number:cpp.Int64, p_base:cpp.Int64, p_capitalize_hex:Bool):gdnative.String;
	static function chr(p_char:cpp.Int64):gdnative.String;
	static function humanize_size(p_size:cpp.Int64):gdnative.String;
}