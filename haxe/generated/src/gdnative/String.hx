...
@:include("godot_cpp/variant/string.hpp") @:native("godot::String") @:structAccess extern class String_extern {
	...
	function length():Int;
	function substr(p_from:Int, ?p_len:Int):gdnative.String;
	...
	function find(p_what:gdnative.String, ?p_from:Int):Int;
	function findn(p_what:gdnative.String, ?p_from:Int):Int;
	function count(p_what:gdnative.String, ?p_from:Int, ?p_to:Int):Int;
	function countn(p_what:gdnative.String, ?p_from:Int, ?p_to:Int):Int;
	function rfind(p_what:gdnative.String, ?p_from:Int):Int;
	function rfindn(p_what:gdnative.String, ?p_from:Int):Int;
	...
	function format(p_values:gdnative.Variant, ?p_placeholder:gdnative.String):gdnative.String;
	...
	function erase(p_position:Int, ?p_chars:Int):gdnative.String;
	...
	function split(?p_delimiter:gdnative.String, ?p_allow_empty:Bool, ?p_maxsplit:Int):gdnative.PackedStringArray;
	function rsplit(?p_delimiter:gdnative.String, ?p_allow_empty:Bool, ?p_maxsplit:Int):gdnative.PackedStringArray;
	function split_floats(p_delimiter:gdnative.String, ?p_allow_empty:Bool):gdnative.PackedFloat64Array;
	...
	function strip_edges(?p_left:Bool, ?p_right:Bool):gdnative.String;
	...
	function xml_escape(?p_escape_quotes:Bool):gdnative.String;
	...
	function lpad(p_min_length:Int, ?p_character:gdnative.String):gdnative.String;
	function rpad(p_min_length:Int, ?p_character:gdnative.String):gdnative.String;
	...
	function num_scientific(p_number:Float):gdnative.String;
	function num(p_number:Float, ?p_decimals:Int):gdnative.String;
	function num_int64(p_number:Int, ?p_base:Int, ?p_capitalize_hex:Bool):gdnative.String;
	function num_uint64(p_number:Int, ?p_base:Int, ?p_capitalize_hex:Bool):gdnative.String;
