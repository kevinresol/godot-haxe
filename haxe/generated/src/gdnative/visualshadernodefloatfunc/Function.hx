...
@:native("godot::VisualShaderNodeFloatFunc::Function") extern enum abstract Function(Function_extern) {
	...
	static inline function __cast(v:Function):Function_extern return untyped __cpp__("(cpp::Struct<godot::VisualShaderNodeFloatFunc::Function, cpp::EnumHandler>){0}", v);
