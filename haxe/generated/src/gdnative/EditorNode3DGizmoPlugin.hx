...
@:include("godot_cpp/classes/editor_node3d_gizmo_plugin.hpp") @:native("godot::EditorNode3DGizmoPlugin") @:structAccess extern class EditorNode3DGizmoPlugin_extern extends gdnative.Resource.Resource_extern {
	...
	function create_material(p_name:gdnative.String, p_color:gdnative.Color, ?p_billboard:Bool, ?p_on_top:Bool, ?p_use_vertex_color:Bool):Void;
	function create_icon_material(p_name:gdnative.String, p_texture:gdnative.Texture2D, ?p_on_top:Bool, ?p_color:gdnative.Color):Void;
	function create_handle_material(p_name:gdnative.String, ?p_billboard:Bool, ?p_texture:gdnative.Texture2D):Void;
	function add_material(p_name:gdnative.String, p_material:gdnative.StandardMaterial3D):Void;
	function get_material(p_name:gdnative.String, ?p_gizmo:gdnative.EditorNode3DGizmo):gdnative.StandardMaterial3D;
}
