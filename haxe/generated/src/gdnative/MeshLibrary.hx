...
@:include("godot_cpp/classes/mesh_library.hpp") @:native("godot::MeshLibrary") @:structAccess extern class MeshLibrary_extern extends gdnative.Resource.Resource_extern {
	...
	function set_item_mesh_transform(p_id:Int, p_mesh_transform:gdnative.Transform3D):Void;
	function set_item_navigation_mesh(p_id:Int, p_navigation_mesh:gdnative.NavigationMesh):Void;
	function set_item_navigation_mesh_transform(p_id:Int, p_navigation_mesh:gdnative.Transform3D):Void;
	...
	function get_item_mesh_transform(p_id:Int):gdnative.Transform3D;
	function get_item_navigation_mesh(p_id:Int):gdnative.NavigationMesh;
	function get_item_navigation_mesh_transform(p_id:Int):gdnative.Transform3D;
