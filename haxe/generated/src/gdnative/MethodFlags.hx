package gdnative;
@:semantics(reference) @:cpp.ValueType({ type : "MethodFlags", namespace : ["godot"] }) @:include("godot_cpp/classes/global_constants.hpp") extern enum abstract MethodFlags(Int) to Int {
	@:op(A == B)
