...
@:include("godot_cpp/classes/physics_test_motion_result3d.hpp") @:native("godot::PhysicsTestMotionResult3D") @:structAccess extern class PhysicsTestMotionResult3D_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	function get_collision_point(?p_collision_index:Int):gdnative.Vector3;
	function get_collision_normal(?p_collision_index:Int):gdnative.Vector3;
	...
	function get_collider_shape(?p_collision_index:Int):Int;
	function get_collision_local_shape(?p_collision_index:Int):Int;
	function get_collision_depth(?p_collision_index:Int):Float;
}
