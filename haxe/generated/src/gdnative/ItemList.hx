...
@:include("godot_cpp/classes/item_list.hpp") @:native("godot::ItemList") @:structAccess extern class ItemList_extern extends gdnative.Control.Control_extern {
	...
	function add_item(p_text:gdnative.String, ?p_icon:gdnative.Texture2D, ?p_selectable:Bool):Int;
	function add_icon_item(p_icon:gdnative.Texture2D, ?p_selectable:Bool):Int;
	...
	function get_item_rect(p_idx:Int, ?p_expand:Bool):gdnative.Rect2;
	...
	function get_item_at_position(p_position:gdnative.Vector2, ?p_exact:Bool):Int;
