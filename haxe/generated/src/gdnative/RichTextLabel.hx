...
@:include("godot_cpp/classes/rich_text_label.hpp") @:native("godot::RichTextLabel") @:structAccess extern class RichTextLabel_extern extends gdnative.Control.Control_extern {
	...
	function add_image(p_image:gdnative.Texture2D, ?p_width:Int, ?p_height:Int, ?p_color:gdnative.Color, ?p_inline_align:gdnative.InlineAlignment, ?p_region:gdnative.Rect2, ?p_key:gdnative.Variant, ?p_pad:Bool, ?p_tooltip:gdnative.String, ?p_size_in_percent:Bool):Void;
	function update_image(p_key:gdnative.Variant, p_mask:Int, p_image:gdnative.Texture2D, ?p_width:Int, ?p_height:Int, ?p_color:gdnative.Color, ?p_inline_align:gdnative.InlineAlignment, ?p_region:gdnative.Rect2, ?p_pad:Bool, ?p_tooltip:gdnative.String, ?p_size_in_percent:Bool):Void;
	function newline():Void;
	function remove_paragraph(p_paragraph:Int, ?p_no_invalidate:Bool):Bool;
	function invalidate_paragraph(p_paragraph:Int):Bool;
	function push_font(p_font:gdnative.Font, ?p_font_size:Int):Void;
	...
	function push_paragraph(p_alignment:gdnative.HorizontalAlignment, ?p_base_direction:gdnative.control.TextDirection, ?p_language:gdnative.String, ?p_st_parser:gdnative.textserver.StructuredTextParser, ?p_justification_flags:Int, ?p_tab_stops:gdnative.PackedFloat32Array):Void;
	function push_indent(p_level:Int):Void;
	function push_list(p_level:Int, p_type:gdnative.richtextlabel.ListType, p_capitalize:Bool, ?p_bullet:gdnative.String):Void;
	function push_meta(p_data:gdnative.Variant, ?p_underline_mode:gdnative.richtextlabel.MetaUnderline):Void;
	...
	function push_table(p_columns:Int, ?p_inline_align:gdnative.InlineAlignment, ?p_align_to_row:Int):Void;
	function push_dropcap(p_string:gdnative.String, p_font:gdnative.Font, p_size:Int, ?p_dropcap_margins:gdnative.Rect2, ?p_color:gdnative.Color, ?p_outline_size:Int, ?p_outline_color:gdnative.Color):Void;
	function set_table_column_expand(p_column:Int, p_expand:Bool, ?p_ratio:Int):Void;
