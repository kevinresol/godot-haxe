...
@:include("godot_cpp/classes/curve3d.hpp") @:native("godot::Curve3D") @:structAccess extern class Curve3D_extern extends gdnative.Resource.Resource_extern {
	...
	overload function sample_baked_with_rotation():gdnative.Transform3D;
	overload function sample_baked_with_rotation(p_offset:Float):gdnative.Transform3D;
	overload function sample_baked_with_rotation(p_offset:Float, p_cubic:Bool):gdnative.Transform3D;
	overload function sample_baked_with_rotation(p_offset:Float, p_cubic:Bool, p_apply_tilt:Bool):gdnative.Transform3D;
