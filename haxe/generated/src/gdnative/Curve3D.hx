...
@:include("godot_cpp/classes/curve3d.hpp") @:native("godot::Curve3D") @:structAccess extern class Curve3D_extern extends gdnative.Resource.Resource_extern {
	...
	function add_point(p_position:gdnative.Vector3, ?p_in:gdnative.Vector3, ?p_out:gdnative.Vector3, ?p_index:Int):Void;
	...
	function sample_baked(?p_offset:Float, ?p_cubic:Bool):gdnative.Vector3;
	function sample_baked_up_vector(p_offset:Float, ?p_apply_tilt:Bool):gdnative.Vector3;
	...
	function tessellate(?p_max_stages:Int, ?p_tolerance_degrees:Float):gdnative.PackedVector3Array;
	function tessellate_even_length(?p_max_stages:Int, ?p_tolerance_length:Float):gdnative.PackedVector3Array;
}
