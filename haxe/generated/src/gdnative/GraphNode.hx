...
@:include("godot_cpp/classes/graph_node.hpp") @:native("godot::GraphNode") @:structAccess extern class GraphNode_extern extends gdnative.GraphElement.GraphElement_extern {
	...
	function set_slot(p_slot_index:Int, p_enable_left_port:Bool, p_type_left:Int, p_color_left:gdnative.Color, p_enable_right_port:Bool, p_type_right:Int, p_color_right:gdnative.Color, ?p_custom_icon_left:gdnative.Texture2D, ?p_custom_icon_right:gdnative.Texture2D, ?p_draw_stylebox:Bool):Void;
