...
@:forward abstract Skeleton3D(cpp.Pointer<Skeleton3D_extern>) from cpp.Pointer<Skeleton3D_extern> to cpp.Pointer<Skeleton3D_extern> {
	...
	@:to
	inline function toWrapper():gd.Skeleton3D return new gd.Skeleton3D(this);
}
@:include("godot_cpp/classes/skeleton3d.hpp") @:native("godot::Skeleton3D") @:structAccess extern class Skeleton3D_extern extends gdnative.Node3D.Node3D_extern {
	...
	function get_bone_rest(p_bone_idx:Int):gdnative.Transform3D;
	function set_bone_rest(p_bone_idx:Int, p_rest:gdnative.Transform3D):Void;
	function get_bone_global_rest(p_bone_idx:Int):gdnative.Transform3D;
	...
	function get_bone_pose(p_bone_idx:Int):gdnative.Transform3D;
	function set_bone_pose(p_bone_idx:Int, p_pose:gdnative.Transform3D):Void;
	...
	overload function set_bone_enabled(p_bone_idx:Int):Void;
	overload function set_bone_enabled(p_bone_idx:Int, p_enabled:Bool):Void;
	function get_bone_global_pose(p_bone_idx:Int):gdnative.Transform3D;
	function set_bone_global_pose(p_bone_idx:Int, p_pose:gdnative.Transform3D):Void;
	...
	overload function set_bone_global_pose_override(p_bone_idx:Int, p_pose:gdnative.Transform3D, p_amount:Float):Void;
	overload function set_bone_global_pose_override(p_bone_idx:Int, p_pose:gdnative.Transform3D, p_amount:Float, p_persistent:Bool):Void;
	function get_bone_global_pose_override(p_bone_idx:Int):gdnative.Transform3D;
	function get_bone_global_pose_no_override(p_bone_idx:Int):gdnative.Transform3D;
