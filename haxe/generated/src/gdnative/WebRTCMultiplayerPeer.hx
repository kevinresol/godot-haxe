...
@:include("godot_cpp/classes/web_rtc_multiplayer_peer.hpp") @:native("godot::WebRTCMultiplayerPeer") @:structAccess extern class WebRTCMultiplayerPeer_extern extends gdnative.MultiplayerPeer.MultiplayerPeer_extern {
	...
	function create_server(?p_channels_config:gdnative.Array):gdnative.Error;
	function create_client(p_peer_id:Int, ?p_channels_config:gdnative.Array):gdnative.Error;
	function create_mesh(p_peer_id:Int, ?p_channels_config:gdnative.Array):gdnative.Error;
	function add_peer(p_peer:gdnative.WebRTCPeerConnection, p_peer_id:Int, ?p_unreliable_lifetime:Int):gdnative.Error;
