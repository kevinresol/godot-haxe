package gdnative;
@:semantics(value) @:cpp.ValueType({ type : "PropertyUsageFlags", namespace : ["godot"] }) @:include("godot_cpp/classes/global_constants.hpp") extern enum abstract PropertyUsageFlags(Int) to Int {
	@:op(A == B)
