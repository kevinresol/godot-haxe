...
@:include("godot_cpp/classes/input_event.hpp") @:native("godot::InputEvent") @:structAccess extern class InputEvent_extern extends gdnative.Resource.Resource_extern {
	...
	function is_action(p_action:gdnative.StringName, ?p_exact_match:Bool):Bool;
	function is_action_pressed(p_action:gdnative.StringName, ?p_allow_echo:Bool, ?p_exact_match:Bool):Bool;
	function is_action_released(p_action:gdnative.StringName, ?p_exact_match:Bool):Bool;
	...
	function is_match(p_event:gdnative.InputEvent, ?p_exact_match:Bool):Bool;
