...
@:include("godot_cpp/classes/curve.hpp") @:native("godot::Curve") @:structAccess extern class Curve_extern extends gdnative.Resource.Resource_extern {
	...
	function add_point(p_position:gdnative.Vector2, ?p_left_tangent:Float, ?p_right_tangent:Float, ?p_left_mode:gdnative.curve.TangentMode, ?p_right_mode:gdnative.curve.TangentMode):Int;
