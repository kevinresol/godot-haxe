...
@:include("godot_cpp/classes/resource_loader.hpp") @:semantics(value) @:cpp.PointerType({ type : "ResourceLoader", namespace : ['godot'] }) extern class ResourceLoader_extern extends gdnative.Object.Object_extern {
