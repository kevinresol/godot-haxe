...
@:include("godot_cpp/classes/resource_loader.hpp") @:native("godot::ResourceLoader") @:structAccess extern class ResourceLoader_extern extends gdnative.Object.Object_extern {
	...
	function load_threaded_get_status(p_path:gdnative.String, ?p_progress:gdnative.Array):gdnative.resourceloader.ThreadLoadStatus;
	...
	function add_resource_format_loader(p_format_loader:gdnative.ResourceFormatLoader, ?p_at_front:Bool):Void;
