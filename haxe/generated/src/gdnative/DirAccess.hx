...
@:include("godot_cpp/classes/dir_access.hpp") @:native("godot::DirAccess") @:structAccess extern class DirAccess_extern extends gdnative.RefCounted.RefCounted_extern {
	...
	function get_current_dir(?p_include_drive:Bool):gdnative.String;
	...
	function copy(p_from:gdnative.String, p_to:gdnative.String, ?p_chmod_flags:Int):gdnative.Error;
	static function copy_absolute(p_from:gdnative.String, p_to:gdnative.String, ?p_chmod_flags:Int):gdnative.Error;
