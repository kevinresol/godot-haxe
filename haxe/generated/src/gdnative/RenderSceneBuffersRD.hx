...
@:include("godot_cpp/classes/render_scene_buffers_rd.hpp") @:native("godot::RenderSceneBuffersRD") @:structAccess extern class RenderSceneBuffersRD_extern extends gdnative.RenderSceneBuffers.RenderSceneBuffers_extern {
	...
	overload function get_color_texture():gdnative.RID;
	overload function get_color_texture(p_msaa:Bool):gdnative.RID;
	overload function get_color_layer(p_layer:Int):gdnative.RID;
	overload function get_color_layer(p_layer:Int, p_msaa:Bool):gdnative.RID;
	overload function get_depth_texture():gdnative.RID;
	overload function get_depth_texture(p_msaa:Bool):gdnative.RID;
	overload function get_depth_layer(p_layer:Int):gdnative.RID;
	overload function get_depth_layer(p_layer:Int, p_msaa:Bool):gdnative.RID;
	overload function get_velocity_texture():gdnative.RID;
	overload function get_velocity_texture(p_msaa:Bool):gdnative.RID;
	overload function get_velocity_layer(p_layer:Int):gdnative.RID;
	overload function get_velocity_layer(p_layer:Int, p_msaa:Bool):gdnative.RID;
