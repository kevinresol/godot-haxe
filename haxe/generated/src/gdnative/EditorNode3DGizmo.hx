...
@:include("godot_cpp/classes/editor_node3d_gizmo.hpp") @:native("godot::EditorNode3DGizmo") @:structAccess extern class EditorNode3DGizmo_extern extends gdnative.Node3DGizmo.Node3DGizmo_extern {
	...
	function _set_subgizmo_transform(p_id:Int, p_transform:gdnative.Transform3D):Void;
	function _get_subgizmo_transform(p_id:Int):gdnative.Transform3D;
	...
	overload function add_mesh(p_mesh:gdnative.Mesh):Void;
	overload function add_mesh(p_mesh:gdnative.Mesh, p_material:gdnative.Material):Void;
	overload function add_mesh(p_mesh:gdnative.Mesh, p_material:gdnative.Material, p_transform:gdnative.Transform3D):Void;
	overload function add_mesh(p_mesh:gdnative.Mesh, p_material:gdnative.Material, p_transform:gdnative.Transform3D, p_skeleton:gdnative.SkinReference):Void;
