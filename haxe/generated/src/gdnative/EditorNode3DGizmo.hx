...
@:include("godot_cpp/classes/editor_node3d_gizmo.hpp") @:native("godot::EditorNode3DGizmo") @:structAccess extern class EditorNode3DGizmo_extern extends gdnative.Node3DGizmo.Node3DGizmo_extern {
	...
	function add_lines(p_lines:gdnative.PackedVector3Array, p_material:gdnative.Material, ?p_billboard:Bool, ?p_modulate:gdnative.Color):Void;
	...
	function add_unscaled_billboard(p_material:gdnative.Material, ?p_default_scale:Float, ?p_modulate:gdnative.Color):Void;
	function add_handles(p_handles:gdnative.PackedVector3Array, p_material:gdnative.Material, p_ids:gdnative.PackedInt32Array, ?p_billboard:Bool, ?p_secondary:Bool):Void;
