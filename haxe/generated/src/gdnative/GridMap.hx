...
@:include("godot_cpp/classes/grid_map.hpp") @:native("godot::GridMap") @:structAccess extern class GridMap_extern extends gdnative.Node3D.Node3D_extern {
	...
	function get_cell_item_basis(p_position:gdnative.Vector3i):gdnative.Basis;
	function get_basis_with_orthogonal_index(p_index:Int):gdnative.Basis;
	function get_orthogonal_index_from_basis(p_basis:gdnative.Basis):Int;
