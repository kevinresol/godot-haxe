...
@:include("godot_cpp/classes/java_script_bridge.hpp") @:native("godot::JavaScriptBridge") @:structAccess extern class JavaScriptBridge_extern extends gdnative.Object.Object_extern {
	...
	function eval(p_code:gdnative.String, ?p_use_global_execution_context:Bool):gdnative.Variant;
	...
	function download_buffer(p_buffer:gdnative.PackedByteArray, p_name:gdnative.String, ?p_mime:gdnative.String):Void;
