...
@:native("godot::RigidBody3D::CenterOfMassMode") extern enum abstract CenterOfMassMode(CenterOfMassMode_extern) {
	...
	static inline function __cast(v:CenterOfMassMode):CenterOfMassMode_extern return untyped __cpp__("(cpp::Struct<godot::RigidBody3D::CenterOfMassMode, cpp::EnumHandler>){0}", v);
