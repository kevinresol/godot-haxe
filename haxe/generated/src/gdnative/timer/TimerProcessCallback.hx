...
@:semantics(value) @:cpp.ValueType({ type : "TimerProcessCallback", namespace : ["godot", "Timer"] }) @:include("godot_cpp/classes/timer.hpp") extern enum abstract TimerProcessCallback(Int) to Int {
	@:op(A == B)
