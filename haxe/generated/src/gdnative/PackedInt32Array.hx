...
@:include("godot_cpp/variant/packed_int32_array.hpp") @:semantics(value) @:cpp.ValueType({ type : "PackedInt32Array", namespace : ['godot'] }) extern class PackedInt32Array_extern {
