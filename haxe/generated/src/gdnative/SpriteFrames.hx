...
@:include("godot_cpp/classes/sprite_frames.hpp") @:native("godot::SpriteFrames") @:structAccess extern class SpriteFrames_extern extends gdnative.Resource.Resource_extern {
	...
	function add_frame(p_anim:gdnative.StringName, p_texture:gdnative.Texture2D, ?p_duration:Float, ?p_at_position:Int):Void;
	function set_frame(p_anim:gdnative.StringName, p_idx:Int, p_texture:gdnative.Texture2D, ?p_duration:Float):Void;
