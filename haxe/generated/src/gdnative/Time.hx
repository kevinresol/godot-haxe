...
@:include("godot_cpp/classes/time.hpp") @:native("godot::Time") @:structAccess extern class Time_extern extends gdnative.Object.Object_extern {
	...
	overload function get_datetime_string_from_unix_time(p_unix_time_val:Int):gdnative.String;
	overload function get_datetime_string_from_unix_time(p_unix_time_val:Int, p_use_space:Bool):gdnative.String;
	...
	overload function get_datetime_dict_from_system():gdnative.Dictionary;
	overload function get_datetime_dict_from_system(p_utc:Bool):gdnative.Dictionary;
	overload function get_date_dict_from_system():gdnative.Dictionary;
	overload function get_date_dict_from_system(p_utc:Bool):gdnative.Dictionary;
	overload function get_time_dict_from_system():gdnative.Dictionary;
	overload function get_time_dict_from_system(p_utc:Bool):gdnative.Dictionary;
	overload function get_datetime_string_from_system():gdnative.String;
	overload function get_datetime_string_from_system(p_utc:Bool):gdnative.String;
	overload function get_datetime_string_from_system(p_utc:Bool, p_use_space:Bool):gdnative.String;
	overload function get_date_string_from_system():gdnative.String;
	overload function get_date_string_from_system(p_utc:Bool):gdnative.String;
	overload function get_time_string_from_system():gdnative.String;
	overload function get_time_string_from_system(p_utc:Bool):gdnative.String;
