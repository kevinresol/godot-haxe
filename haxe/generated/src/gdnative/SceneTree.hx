...
@:include("godot_cpp/classes/scene_tree.hpp") @:native("godot::SceneTree") @:structAccess extern class SceneTree_extern extends gdnative.MainLoop.MainLoop_extern {
	...
	function create_timer(p_time_sec:Float, ?p_process_always:Bool, ?p_process_in_physics:Bool, ?p_ignore_time_scale:Bool):gdnative.SceneTreeTimer;
	...
	function set_multiplayer(p_multiplayer:gdnative.MultiplayerAPI, ?p_root_path:gdnative.NodePath):Void;
	function get_multiplayer(?p_for_path:gdnative.NodePath):gdnative.MultiplayerAPI;
