...
@:include("godot_cpp/classes/class_db_singleton.hpp") @:native("godot::ClassDBSingleton") @:structAccess extern class ClassDB_extern extends gdnative.Object.Object_extern {
	...
	function class_has_method(p_class:gdnative.StringName, p_method:gdnative.StringName, ?p_no_inheritance:Bool):Bool;
	function class_get_method_argument_count(p_class:gdnative.StringName, p_method:gdnative.StringName, ?p_no_inheritance:Bool):Int;
	function class_get_integer_constant_list(p_class:gdnative.StringName, ?p_no_inheritance:Bool):gdnative.PackedStringArray;
	...
	function class_has_enum(p_class:gdnative.StringName, p_name:gdnative.StringName, ?p_no_inheritance:Bool):Bool;
	function class_get_enum_list(p_class:gdnative.StringName, ?p_no_inheritance:Bool):gdnative.PackedStringArray;
	function class_get_enum_constants(p_class:gdnative.StringName, p_enum:gdnative.StringName, ?p_no_inheritance:Bool):gdnative.PackedStringArray;
	function class_get_integer_constant_enum(p_class:gdnative.StringName, p_name:gdnative.StringName, ?p_no_inheritance:Bool):gdnative.StringName;
	function is_class_enum_bitfield(p_class:gdnative.StringName, p_enum:gdnative.StringName, ?p_no_inheritance:Bool):Bool;
