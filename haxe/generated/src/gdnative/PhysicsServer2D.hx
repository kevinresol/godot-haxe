...
@:include("godot_cpp/classes/physics_server2d.hpp") @:native("godot::PhysicsServer2D") @:structAccess extern class PhysicsServer2D_extern extends gdnative.Object.Object_extern {
	...
	overload function area_add_shape(p_area:gdnative.RID, p_shape:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	overload function area_add_shape(p_area:gdnative.RID, p_shape:gdnative.RID, p_transform:gdnative.Transform2D, p_disabled:Bool):Void;
	function area_set_shape(p_area:gdnative.RID, p_shape_idx:Int, p_shape:gdnative.RID):Void;
	function area_set_shape_transform(p_area:gdnative.RID, p_shape_idx:Int, p_transform:gdnative.Transform2D):Void;
	...
	function area_get_shape_transform(p_area:gdnative.RID, p_shape_idx:Int):gdnative.Transform2D;
	...
	function area_set_transform(p_area:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	function area_get_param(p_area:gdnative.RID, p_param:gdnative.physicsserver2d.AreaParameter):gdnative.Variant;
	function area_get_transform(p_area:gdnative.RID):gdnative.Transform2D;
	...
	overload function body_add_shape(p_body:gdnative.RID, p_shape:gdnative.RID, p_transform:gdnative.Transform2D):Void;
	overload function body_add_shape(p_body:gdnative.RID, p_shape:gdnative.RID, p_transform:gdnative.Transform2D, p_disabled:Bool):Void;
	function body_set_shape(p_body:gdnative.RID, p_shape_idx:Int, p_shape:gdnative.RID):Void;
	function body_set_shape_transform(p_body:gdnative.RID, p_shape_idx:Int, p_transform:gdnative.Transform2D):Void;
	...
	function body_get_shape_transform(p_body:gdnative.RID, p_shape_idx:Int):gdnative.Transform2D;
