...
@:include("godot_cpp/classes/physics_server2d.hpp") @:native("godot::PhysicsServer2D") @:structAccess extern class PhysicsServer2D_extern extends gdnative.Object.Object_extern {
	...
	function body_apply_impulse(p_body:gdnative.RID, p_impulse:gdnative.Vector2, ?p_position:gdnative.Vector2):Void;
	function body_apply_central_force(p_body:gdnative.RID, p_force:gdnative.Vector2):Void;
	function body_apply_force(p_body:gdnative.RID, p_force:gdnative.Vector2, ?p_position:gdnative.Vector2):Void;
	...
	function body_add_constant_force(p_body:gdnative.RID, p_force:gdnative.Vector2, ?p_position:gdnative.Vector2):Void;
	...
	function body_set_force_integration_callback(p_body:gdnative.RID, p_callable:gdnative.Callable, ?p_userdata:gdnative.Variant):Void;
	function body_test_motion(p_body:gdnative.RID, p_parameters:gdnative.PhysicsTestMotionParameters2D, ?p_result:gdnative.PhysicsTestMotionResult2D):Bool;
	...
	function joint_make_pin(p_joint:gdnative.RID, p_anchor:gdnative.Vector2, p_body_a:gdnative.RID, ?p_body_b:gdnative.RID):Void;
	function joint_make_groove(p_joint:gdnative.RID, p_groove1_a:gdnative.Vector2, p_groove2_a:gdnative.Vector2, p_anchor_b:gdnative.Vector2, ?p_body_a:gdnative.RID, ?p_body_b:gdnative.RID):Void;
	function joint_make_damped_spring(p_joint:gdnative.RID, p_anchor_a:gdnative.Vector2, p_anchor_b:gdnative.Vector2, p_body_a:gdnative.RID, ?p_body_b:gdnative.RID):Void;
