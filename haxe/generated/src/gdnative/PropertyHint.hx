package gdnative;
@:semantics(value) @:cpp.ValueType({ type : "PropertyHint", namespace : ["godot"] }) @:include("godot_cpp/classes/global_constants.hpp") extern enum abstract PropertyHint(Int) to Int {
	@:op(A == B)
