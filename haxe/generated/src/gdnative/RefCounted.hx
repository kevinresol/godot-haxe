...
@:include("godot_cpp/classes/ref_counted.hpp") @:semantic(reference) @:cpp.PointerType({ type : "RefCounted", namespace : ['godot'] }) extern class RefCounted_extern extends gdnative.Object.Object_extern {
