package godot;
@:include("godot_cpp/classes/canvas_item.hpp") @:native("godot::CanvasItem") @:structAccess extern class CanvasItem_extern extends godot.Node.Node_extern {
	function _draw():Void;
	...
	function set_modulate(p_modulate:godot.Color):Void;
	function get_modulate():godot.Color;
	function set_self_modulate(p_self_modulate:godot.Color):Void;
	function get_self_modulate():godot.Color;
	...
	function draw_line(p_from:godot.Vector2, p_to:godot.Vector2, p_color:godot.Color, ?p_width:Float, ?p_antialiased:Bool):Void;
