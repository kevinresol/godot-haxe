...
class GDExtensionManager extends gd.Object {
	...
	public function unload_extension(p_path:std.String):gd.gdextensionmanager.LoadStatus return __gdextensionmanager_ptr().value.unload_extension(((p_path : std.String)));
	public function is_extension_loaded(p_path:std.String):Bool return __gdextensionmanager_ptr().value.is_extension_loaded(((p_path : std.String)));
	public function get_loaded_extensions():gd.PackedStringArray return __gdextensionmanager_ptr().value.get_loaded_extensions();
	public function get_extension(p_path:std.String):gd.GDExtension return __gdextensionmanager_ptr().value.get_extension(((p_path : std.String)));
}