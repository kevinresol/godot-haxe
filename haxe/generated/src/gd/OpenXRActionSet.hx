...
class OpenXRActionSet extends gd.Resource {
	...
	public function set_localized_name(p_localized_name:std.String):std.String {
		__openxractionset_ptr().value.set_localized_name(p_localized_name);
	...
	public function set_priority(p_priority:Int):Int {
		__openxractionset_ptr().value.set_priority(p_priority);
		return p_priority;
	}
	...
	public function set_actions(p_actions:gd.Array):gd.Array {
		__openxractionset_ptr().value.set_actions(p_actions);
		return p_actions;
	}
	public function get_actions():gd.Array return __openxractionset_ptr().value.get_actions();
	public function add_action(p_action:gd.OpenXRAction):Void __openxractionset_ptr().value.add_action(p_action);
	public function remove_action(p_action:gd.OpenXRAction):Void __openxractionset_ptr().value.remove_action(p_action);
