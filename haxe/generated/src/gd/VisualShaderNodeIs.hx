...
class VisualShaderNodeIs extends gd.VisualShaderNode {
	...
	var _function(get, set) : gd.visualshadernodeis.Function;
	function get__function():gd.visualshadernodeis.Function return get_function();
	function set__function(v:gd.visualshadernodeis.Function):gd.visualshadernodeis.Function {
		set_function(v);
		return v;
	}
}