...
class AudioStreamWAV extends gd.AudioStream {
	...
	public function set_data(p_data:gd.PackedByteArray):gd.PackedByteArray {
		__audiostreamwav_ptr().value.set_data(p_data);
		return p_data;
	}
	...
	public function set_format(p_format:gd.audiostreamwav.Format):gd.audiostreamwav.Format {
		__audiostreamwav_ptr().value.set_format(p_format);
		return p_format;
	}
	...
	public function set_loop_mode(p_loop_mode:gd.audiostreamwav.LoopMode):gd.audiostreamwav.LoopMode {
		__audiostreamwav_ptr().value.set_loop_mode(p_loop_mode);
		return p_loop_mode;
	}
	...
	public function set_loop_begin(p_loop_begin:Int):Int {
		__audiostreamwav_ptr().value.set_loop_begin(p_loop_begin);
		return p_loop_begin;
	}
	...
	public function set_loop_end(p_loop_end:Int):Int {
		__audiostreamwav_ptr().value.set_loop_end(p_loop_end);
		return p_loop_end;
	}
	...
	public function set_mix_rate(p_mix_rate:Int):Int {
		__audiostreamwav_ptr().value.set_mix_rate(p_mix_rate);
		return p_mix_rate;
	}
	...
	public function set_stereo(p_stereo:Bool):Bool {
		__audiostreamwav_ptr().value.set_stereo(p_stereo);
		return p_stereo;
	}
	public function is_stereo():Bool return __audiostreamwav_ptr().value.is_stereo();
	public function save_to_wav(p_path:std.String):gd.Error return __audiostreamwav_ptr().value.save_to_wav(p_path);
