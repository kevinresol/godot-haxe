...
class ShapeCast2D extends gd.Node2D {
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__shapecast2d_ptr().value.set_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_shape(p_shape:gd.Shape2D):gd.Shape2D {
		__shapecast2d_ptr().value.set_shape(p_shape);
		return p_shape;
	}
	...
	public function set_target_position(p_local_point:gd.Vector2):gd.Vector2 {
		__shapecast2d_ptr().value.set_target_position(p_local_point);
	...
	public function set_margin(p_margin:Float):Float {
		__shapecast2d_ptr().value.set_margin(p_margin);
		return p_margin;
	}
	...
	public function set_max_results(p_max_results:Int):Int {
		__shapecast2d_ptr().value.set_max_results(p_max_results);
	...
	public function get_collider(p_index:Int):gd.Object return __shapecast2d_ptr().value.get_collider(p_index);
	public function get_collider_rid(p_index:Int):gd.RID return __shapecast2d_ptr().value.get_collider_rid(p_index);
	public function get_collider_shape(p_index:Int):Int return __shapecast2d_ptr().value.get_collider_shape(p_index);
	public function get_collision_point(p_index:Int):gd.Vector2 return __shapecast2d_ptr().value.get_collision_point(p_index);
	public function get_collision_normal(p_index:Int):gd.Vector2 return __shapecast2d_ptr().value.get_collision_normal(p_index);
	...
	public function add_exception_rid(p_rid:gd.RID):Void __shapecast2d_ptr().value.add_exception_rid(p_rid);
	public function add_exception(p_node:gd.CollisionObject2D):Void __shapecast2d_ptr().value.add_exception(p_node);
	public function remove_exception_rid(p_rid:gd.RID):Void __shapecast2d_ptr().value.remove_exception_rid(p_rid);
	public function remove_exception(p_node:gd.CollisionObject2D):Void __shapecast2d_ptr().value.remove_exception(p_node);
	...
	public function set_collision_mask(p_mask:Int):Int {
		__shapecast2d_ptr().value.set_collision_mask(p_mask);
		return p_mask;
	}
	public function get_collision_mask():Int return __shapecast2d_ptr().value.get_collision_mask();
	public function set_collision_mask_value(p_layer_number:Int, p_value:Bool):Void __shapecast2d_ptr().value.set_collision_mask_value(p_layer_number, p_value);
	public function get_collision_mask_value(p_layer_number:Int):Bool return __shapecast2d_ptr().value.get_collision_mask_value(p_layer_number);
	public function set_exclude_parent_body(p_mask:Bool):Void __shapecast2d_ptr().value.set_exclude_parent_body(p_mask);
	...
	public function set_collide_with_areas(p_enable:Bool):Bool {
		__shapecast2d_ptr().value.set_collide_with_areas(p_enable);
		return p_enable;
	}
	...
	public function set_collide_with_bodies(p_enable:Bool):Bool {
		__shapecast2d_ptr().value.set_collide_with_bodies(p_enable);
		return p_enable;
	}
