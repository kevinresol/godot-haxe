...
class SkeletonModification2D extends gd.Resource {
	...
	public function _execute(p_delta:Float):Void __skeletonmodification2d_ptr().value._execute(((p_delta : Float)));
	public function _setup_modification(p_modification_stack:gd.SkeletonModificationStack2D):Void __skeletonmodification2d_ptr().value._setup_modification(((p_modification_stack : gd.SkeletonModificationStack2D)));
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__skeletonmodification2d_ptr().value.set_enabled(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_is_setup(p_is_setup:Bool):Void __skeletonmodification2d_ptr().value.set_is_setup(((p_is_setup : Bool)));
	...
	public function set_execution_mode(p_execution_mode:Int):Int {
		__skeletonmodification2d_ptr().value.set_execution_mode(((p_execution_mode : Int)));
