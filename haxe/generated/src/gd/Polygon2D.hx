...
class Polygon2D extends gd.Node2D {
	...
	public function set_polygon(p_polygon:gd.PackedVector2Array):gd.PackedVector2Array {
		__polygon2d_ptr().value.set_polygon(p_polygon);
		return p_polygon;
	}
	...
	public function set_uv(p_uv:gd.PackedVector2Array):gd.PackedVector2Array {
		__polygon2d_ptr().value.set_uv(p_uv);
		return p_uv;
	}
	...
	public function set_color(p_color:gd.Color):gd.Color {
		__polygon2d_ptr().value.set_color(p_color);
		return p_color;
	}
	...
	public function set_polygons(p_polygons:gd.Array):gd.Array {
		__polygon2d_ptr().value.set_polygons(p_polygons);
		return p_polygons;
	}
	...
	public function set_vertex_colors(p_vertex_colors:gd.PackedColorArray):gd.PackedColorArray {
		__polygon2d_ptr().value.set_vertex_colors(p_vertex_colors);
	...
	public function set_texture(p_texture:gd.Texture2D):gd.Texture2D {
		__polygon2d_ptr().value.set_texture(p_texture);
		return p_texture;
	}
	...
	public function set_texture_offset(p_texture_offset:gd.Vector2):gd.Vector2 {
		__polygon2d_ptr().value.set_texture_offset(p_texture_offset);
	...
	public function set_texture_rotation(p_texture_rotation:Float):Float {
		__polygon2d_ptr().value.set_texture_rotation(p_texture_rotation);
	...
	public function set_texture_scale(p_texture_scale:gd.Vector2):gd.Vector2 {
		__polygon2d_ptr().value.set_texture_scale(p_texture_scale);
	...
	public function set_invert_enabled(p_invert:Bool):Bool {
		__polygon2d_ptr().value.set_invert_enabled(p_invert);
		return p_invert;
	}
	...
	public function set_antialiased(p_antialiased:Bool):Bool {
		__polygon2d_ptr().value.set_antialiased(p_antialiased);
	...
	public function set_invert_border(p_invert_border:Float):Float {
		__polygon2d_ptr().value.set_invert_border(p_invert_border);
	...
	public function set_offset(p_offset:gd.Vector2):gd.Vector2 {
		__polygon2d_ptr().value.set_offset(p_offset);
		return p_offset;
	}
	public function get_offset():gd.Vector2 return __polygon2d_ptr().value.get_offset();
	public function add_bone(p_path:std.String, p_weights:gd.PackedFloat32Array):Void __polygon2d_ptr().value.add_bone(p_path, p_weights);
	public function get_bone_count():Int return __polygon2d_ptr().value.get_bone_count();
	public function get_bone_path(p_index:Int):std.String return __polygon2d_ptr().value.get_bone_path(p_index);
	public function get_bone_weights(p_index:Int):gd.PackedFloat32Array return __polygon2d_ptr().value.get_bone_weights(p_index);
	public function erase_bone(p_index:Int):Void __polygon2d_ptr().value.erase_bone(p_index);
	public function clear_bones():Void __polygon2d_ptr().value.clear_bones();
	public function set_bone_path(p_index:Int, p_path:std.String):Void __polygon2d_ptr().value.set_bone_path(p_index, p_path);
	public function set_bone_weights(p_index:Int, p_weights:gd.PackedFloat32Array):Void __polygon2d_ptr().value.set_bone_weights(p_index, p_weights);
	public function set_skeleton(p_skeleton:std.String):std.String {
		__polygon2d_ptr().value.set_skeleton(p_skeleton);
		return p_skeleton;
	}
	...
	public function set_internal_vertex_count(p_internal_vertex_count:Int):Int {
		__polygon2d_ptr().value.set_internal_vertex_count(p_internal_vertex_count);
