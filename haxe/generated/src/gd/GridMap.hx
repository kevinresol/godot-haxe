...
class GridMap extends gd.Node3D {
	...
	public function set_collision_layer(p_layer:Int):Int {
		__gridmap_ptr().value.set_collision_layer(p_layer);
		return p_layer;
	}
	...
	public function set_collision_mask(p_mask:Int):Int {
		__gridmap_ptr().value.set_collision_mask(p_mask);
		return p_mask;
	}
	public function get_collision_mask():Int return __gridmap_ptr().value.get_collision_mask();
	public function set_collision_mask_value(p_layer_number:Int, p_value:Bool):Void __gridmap_ptr().value.set_collision_mask_value(p_layer_number, p_value);
	public function get_collision_mask_value(p_layer_number:Int):Bool return __gridmap_ptr().value.get_collision_mask_value(p_layer_number);
	public function set_collision_layer_value(p_layer_number:Int, p_value:Bool):Void __gridmap_ptr().value.set_collision_layer_value(p_layer_number, p_value);
	public function get_collision_layer_value(p_layer_number:Int):Bool return __gridmap_ptr().value.get_collision_layer_value(p_layer_number);
	public function set_collision_priority(p_priority:Float):Float {
		__gridmap_ptr().value.set_collision_priority(p_priority);
		return p_priority;
	}
	...
	public function set_physics_material(p_material:gd.PhysicsMaterial):gd.PhysicsMaterial {
		__gridmap_ptr().value.set_physics_material(p_material);
		return p_material;
	}
	...
	public function set_bake_navigation(p_bake_navigation:Bool):Bool {
		__gridmap_ptr().value.set_bake_navigation(p_bake_navigation);
		return p_bake_navigation;
	}
	public function is_baking_navigation():Bool return __gridmap_ptr().value.is_baking_navigation();
	public function set_navigation_map(p_navigation_map:gd.RID):Void __gridmap_ptr().value.set_navigation_map(p_navigation_map);
	...
	public function set_mesh_library(p_mesh_library:gd.MeshLibrary):gd.MeshLibrary {
		__gridmap_ptr().value.set_mesh_library(p_mesh_library);
	...
	public function set_cell_size(p_size:gd.Vector3):gd.Vector3 {
		__gridmap_ptr().value.set_cell_size(p_size);
		return p_size;
	}
	...
	public function set_cell_scale(p_scale:Float):Float {
		__gridmap_ptr().value.set_cell_scale(p_scale);
		return p_scale;
	}
	public function get_cell_scale():Float return __gridmap_ptr().value.get_cell_scale();
	public function set_octant_size(p_size:Int):Void __gridmap_ptr().value.set_octant_size(p_size);
	public function get_octant_size():Int return __gridmap_ptr().value.get_octant_size();
	public function set_cell_item(p_position:gd.Vector3i, p_item:Int, ?p_orientation:Int = 0):Void __gridmap_ptr().value.set_cell_item(p_position, p_item, p_orientation);
	public function get_cell_item(p_position:gd.Vector3i):Int return __gridmap_ptr().value.get_cell_item(p_position);
	public function get_cell_item_orientation(p_position:gd.Vector3i):Int return __gridmap_ptr().value.get_cell_item_orientation(p_position);
	public function local_to_map(p_local_position:gd.Vector3):gd.Vector3i return __gridmap_ptr().value.local_to_map(p_local_position);
	public function map_to_local(p_map_position:gd.Vector3i):gd.Vector3 return __gridmap_ptr().value.map_to_local(p_map_position);
	public function resource_changed(p_resource:gd.Resource):Void __gridmap_ptr().value.resource_changed(p_resource);
	public function set_center_x(p_enable:Bool):Void __gridmap_ptr().value.set_center_x(p_enable);
	public function get_center_x():Bool return __gridmap_ptr().value.get_center_x();
	public function set_center_y(p_enable:Bool):Void __gridmap_ptr().value.set_center_y(p_enable);
	public function get_center_y():Bool return __gridmap_ptr().value.get_center_y();
	public function set_center_z(p_enable:Bool):Void __gridmap_ptr().value.set_center_z(p_enable);
	...
	public function get_bake_mesh_instance(p_idx:Int):gd.RID return __gridmap_ptr().value.get_bake_mesh_instance(p_idx);
	public function clear_baked_meshes():Void __gridmap_ptr().value.clear_baked_meshes();
	public function make_baked_meshes(?p_gen_lightmap_uv:Bool = false, ?p_lightmap_uv_texel_size:Float = 0.1):Void __gridmap_ptr().value.make_baked_meshes(p_gen_lightmap_uv, p_lightmap_uv_texel_size);
