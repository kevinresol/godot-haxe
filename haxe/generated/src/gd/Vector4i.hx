...
class Vector4i_wrapper {
	...
	public function sign():gd.Vector4i return {
		final v = __gd.sign();
		v;
	};
	public function abs():gd.Vector4i return {
		final v = __gd.abs();
		v;
	};
	public function clamp(p_min:gd.Vector4i, p_max:gd.Vector4i):gd.Vector4i return {
		final v = __gd.clamp(((p_min : gd.Vector4i)), ((p_max : gd.Vector4i)));
		v;
	};
	public function clampi(p_min:cpp.Int64, p_max:cpp.Int64):gd.Vector4i return {
		final v = __gd.clampi(((p_min : cpp.Int64)), ((p_max : cpp.Int64)));
		v;
	};
	public function snapped(p_step:gd.Vector4i):gd.Vector4i return {
		final v = __gd.snapped(((p_step : gd.Vector4i)));
		v;
	};
	public function snappedi(p_step:cpp.Int64):gd.Vector4i return {
		final v = __gd.snappedi(((p_step : cpp.Int64)));
		v;
	};
	public function min(p_with:gd.Vector4i):gd.Vector4i return {
		final v = __gd.min(((p_with : gd.Vector4i)));
		v;
	};
	public function mini(p_with:cpp.Int64):gd.Vector4i return {
		final v = __gd.mini(((p_with : cpp.Int64)));
		v;
	};
	public function max(p_with:gd.Vector4i):gd.Vector4i return {
		final v = __gd.max(((p_with : gd.Vector4i)));
		v;
	};
	public function maxi(p_with:cpp.Int64):gd.Vector4i return {
