...
class Vector4i_wrapper {
	...
	function __op_multiply_int(p_rhs:cpp.Int64):gd.Vector4i return this.__gd * ((p_rhs : cpp.Int64));
	function __op_modulus_int(p_rhs:cpp.Int64):gd.Vector4i return this.__gd % ((p_rhs : cpp.Int64));
