...
class Node2D extends gd.CanvasItem {
	...
	public function set_rotation(p_radians:Float):Void __node2d_ptr().value.set_rotation(p_radians);
	public function set_rotation_degrees(p_degrees:Float):Void __node2d_ptr().value.set_rotation_degrees(p_degrees);
	public function set_skew(p_radians:Float):Void __node2d_ptr().value.set_skew(p_radians);
	public function set_scale(p_scale:gd.Vector2):Void __node2d_ptr().value.set_scale(p_scale);
	...
	public function set_global_position(p_position:gd.Vector2):Void __node2d_ptr().value.set_global_position(p_position);
	public function get_global_position():gd.Vector2 return __node2d_ptr().value.get_global_position();
	public function set_global_rotation(p_radians:Float):Void __node2d_ptr().value.set_global_rotation(p_radians);
	public function set_global_rotation_degrees(p_degrees:Float):Void __node2d_ptr().value.set_global_rotation_degrees(p_degrees);
	...
	public function set_global_skew(p_radians:Float):Void __node2d_ptr().value.set_global_skew(p_radians);
	public function get_global_skew():Float return __node2d_ptr().value.get_global_skew();
	public function set_global_scale(p_scale:gd.Vector2):Void __node2d_ptr().value.set_global_scale(p_scale);
