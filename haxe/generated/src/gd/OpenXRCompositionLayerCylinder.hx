...
class OpenXRCompositionLayerCylinder extends gd.OpenXRCompositionLayer {
	...
	public function set_radius(p_radius:Float):Float {
		__openxrcompositionlayercylinder_ptr().value.set_radius(p_radius);
		return p_radius;
	}
	...
	public function set_aspect_ratio(p_aspect_ratio:Float):Float {
		__openxrcompositionlayercylinder_ptr().value.set_aspect_ratio(p_aspect_ratio);
	...
	public function set_central_angle(p_angle:Float):Float {
		__openxrcompositionlayercylinder_ptr().value.set_central_angle(p_angle);
		return p_angle;
	}
	...
	public function set_fallback_segments(p_segments:Int):Int {
		__openxrcompositionlayercylinder_ptr().value.set_fallback_segments(p_segments);
		return p_segments;
	}
