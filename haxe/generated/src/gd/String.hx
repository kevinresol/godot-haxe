...
class String_wrapper {
	...
	function __op_less_than_string(p_rhs:std.String):Bool return @:privateAccess this.__gd.__op_less_than_string(((p_rhs : gdnative.String)));
	function __op_less_equal_string(p_rhs:std.String):Bool return @:privateAccess this.__gd.__op_less_equal_string(((p_rhs : gdnative.String)));
	function __op_greater_than_string(p_rhs:std.String):Bool return @:privateAccess this.__gd.__op_greater_than_string(((p_rhs : gdnative.String)));
	function __op_greater_equal_string(p_rhs:std.String):Bool return @:privateAccess this.__gd.__op_greater_equal_string(((p_rhs : gdnative.String)));
