...
class String_wrapper {
	...
	public static function num(p_number:Float, ?p_decimals:Int):std.String return switch [p_number, p_decimals] {
		case [_, null]:gdnative.String.String_extern.num(((p_number : Float)));
		default:gdnative.String.String_extern.num(((p_number : Float)), ((p_decimals : Int)));
	};
	public static function num_int64(p_number:Int, ?p_base:Int, ?p_capitalize_hex:Bool):std.String return switch [p_number, p_base, p_capitalize_hex] {
		case [_, null, _]:gdnative.String.String_extern.num_int64(((p_number : Int)));
		case [_, _, null]:gdnative.String.String_extern.num_int64(((p_number : Int)), ((p_base : Int)));
		default:gdnative.String.String_extern.num_int64(((p_number : Int)), ((p_base : Int)), ((p_capitalize_hex : Bool)));
	};
	public static function num_uint64(p_number:Int, ?p_base:Int, ?p_capitalize_hex:Bool):std.String return switch [p_number, p_base, p_capitalize_hex] {
		case [_, null, _]:gdnative.String.String_extern.num_uint64(((p_number : Int)));
		case [_, _, null]:gdnative.String.String_extern.num_uint64(((p_number : Int)), ((p_base : Int)));
		default:gdnative.String.String_extern.num_uint64(((p_number : Int)), ((p_base : Int)), ((p_capitalize_hex : Bool)));
	};
	public static function chr(p_char:Int):std.String return gdnative.String.String_extern.chr(((p_char : Int)));
	public static function humanize_size(p_size:Int):std.String return gdnative.String.String_extern.humanize_size(((p_size : Int)));
