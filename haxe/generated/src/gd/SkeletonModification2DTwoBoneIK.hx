...
class SkeletonModification2DTwoBoneIK extends gd.SkeletonModification2D {
	...
	public function set_target_node(p_target_nodepath:std.String):Void __skeletonmodification2dtwoboneik_ptr().value.set_target_node(p_target_nodepath);
	...
	public function set_target_minimum_distance(p_minimum_distance:Float):Float {
		__skeletonmodification2dtwoboneik_ptr().value.set_target_minimum_distance(p_minimum_distance);
	...
	public function set_target_maximum_distance(p_maximum_distance:Float):Float {
		__skeletonmodification2dtwoboneik_ptr().value.set_target_maximum_distance(p_maximum_distance);
	...
	public function set_flip_bend_direction(p_flip_direction:Bool):Bool {
		__skeletonmodification2dtwoboneik_ptr().value.set_flip_bend_direction(p_flip_direction);
	...
	public function set_joint_one_bone2d_node(p_bone2d_node:std.String):Void __skeletonmodification2dtwoboneik_ptr().value.set_joint_one_bone2d_node(p_bone2d_node);
	...
	public function set_joint_one_bone_idx(p_bone_idx:Int):Void __skeletonmodification2dtwoboneik_ptr().value.set_joint_one_bone_idx(p_bone_idx);
	public function get_joint_one_bone_idx():Int return __skeletonmodification2dtwoboneik_ptr().value.get_joint_one_bone_idx();
	public function set_joint_two_bone2d_node(p_bone2d_node:std.String):Void __skeletonmodification2dtwoboneik_ptr().value.set_joint_two_bone2d_node(p_bone2d_node);
	...
	public function set_joint_two_bone_idx(p_bone_idx:Int):Void __skeletonmodification2dtwoboneik_ptr().value.set_joint_two_bone_idx(p_bone_idx);
