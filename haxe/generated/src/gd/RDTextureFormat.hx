...
class RDTextureFormat extends gd.RefCounted {
	...
	public function set_format(p_p_member:gd.renderingdevice.DataFormat):gd.renderingdevice.DataFormat {
		__rdtextureformat_ptr().value.set_format(p_p_member);
		return p_p_member;
	}
	...
	public function set_array_layers(p_p_member:Int):Int {
		__rdtextureformat_ptr().value.set_array_layers(p_p_member);
		return p_p_member;
	}
	...
	public function set_mipmaps(p_p_member:Int):Int {
		__rdtextureformat_ptr().value.set_mipmaps(p_p_member);
		return p_p_member;
	}
	...
	public function set_texture_type(p_p_member:gd.renderingdevice.TextureType):gd.renderingdevice.TextureType {
		__rdtextureformat_ptr().value.set_texture_type(p_p_member);
		return p_p_member;
	}
	...
	public function set_samples(p_p_member:gd.renderingdevice.TextureSamples):gd.renderingdevice.TextureSamples {
		__rdtextureformat_ptr().value.set_samples(p_p_member);
		return p_p_member;
	}
	...
	public function set_usage_bits(p_p_member:Int):Int {
		__rdtextureformat_ptr().value.set_usage_bits(p_p_member);
		return p_p_member;
	}
	public function get_usage_bits():Int return __rdtextureformat_ptr().value.get_usage_bits();
	public function add_shareable_format(p_format:gd.renderingdevice.DataFormat):Void __rdtextureformat_ptr().value.add_shareable_format(p_format);
	public function remove_shareable_format(p_format:gd.renderingdevice.DataFormat):Void __rdtextureformat_ptr().value.remove_shareable_format(p_format);
