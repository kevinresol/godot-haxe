...
class AudioEffectDelay extends gd.AudioEffect {
	...
	public function set_dry(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_dry(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_tap1_active(p_amount:Bool):Bool {
		__audioeffectdelay_ptr().value.set_tap1_active(((p_amount : Bool)));
		return p_amount;
	}
	...
	public function set_tap1_delay_ms(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_tap1_delay_ms(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_tap1_level_db(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_tap1_level_db(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_tap1_pan(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_tap1_pan(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_tap2_active(p_amount:Bool):Bool {
		__audioeffectdelay_ptr().value.set_tap2_active(((p_amount : Bool)));
		return p_amount;
	}
	...
	public function set_tap2_delay_ms(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_tap2_delay_ms(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_tap2_level_db(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_tap2_level_db(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_tap2_pan(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_tap2_pan(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_feedback_active(p_amount:Bool):Bool {
		__audioeffectdelay_ptr().value.set_feedback_active(((p_amount : Bool)));
		return p_amount;
	}
	...
	public function set_feedback_delay_ms(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_feedback_delay_ms(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_feedback_level_db(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_feedback_level_db(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_feedback_lowpass(p_amount:Float):Float {
		__audioeffectdelay_ptr().value.set_feedback_lowpass(((p_amount : Float)));
		return p_amount;
	}
