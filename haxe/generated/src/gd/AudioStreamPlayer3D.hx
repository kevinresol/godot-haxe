...
class AudioStreamPlayer3D extends gd.Node3D {
	...
	public function set_stream(p_stream:gd.AudioStream):gd.AudioStream {
		__audiostreamplayer3d_ptr().value.set_stream(p_stream);
		return p_stream;
	}
	...
	public function set_volume_db(p_volume_db:Float):Float {
		__audiostreamplayer3d_ptr().value.set_volume_db(p_volume_db);
		return p_volume_db;
	}
	...
	public function set_unit_size(p_unit_size:Float):Float {
		__audiostreamplayer3d_ptr().value.set_unit_size(p_unit_size);
		return p_unit_size;
	}
	...
	public function set_max_db(p_max_db:Float):Float {
		__audiostreamplayer3d_ptr().value.set_max_db(p_max_db);
		return p_max_db;
	}
	...
	public function set_pitch_scale(p_pitch_scale:Float):Float {
		__audiostreamplayer3d_ptr().value.set_pitch_scale(p_pitch_scale);
		return p_pitch_scale;
	}
	public function get_pitch_scale():Float return __audiostreamplayer3d_ptr().value.get_pitch_scale();
	public function play(?p_from_position:Float = 0.):Void __audiostreamplayer3d_ptr().value.play(p_from_position);
	public function seek(p_to_position:Float):Void __audiostreamplayer3d_ptr().value.seek(p_to_position);
	...
	public function set_bus(p_bus:std.String):std.String {
		__audiostreamplayer3d_ptr().value.set_bus(p_bus);
		return p_bus;
	}
	...
	public function set_autoplay(p_enable:Bool):Bool {
		__audiostreamplayer3d_ptr().value.set_autoplay(p_enable);
		return p_enable;
	}
	...
	public function set_max_distance(p_meters:Float):Float {
		__audiostreamplayer3d_ptr().value.set_max_distance(p_meters);
		return p_meters;
	}
	...
	public function set_area_mask(p_mask:Int):Int {
		__audiostreamplayer3d_ptr().value.set_area_mask(p_mask);
		return p_mask;
	}
	public function get_area_mask():Int return __audiostreamplayer3d_ptr().value.get_area_mask();
	public function set_emission_angle(p_degrees:Float):Void __audiostreamplayer3d_ptr().value.set_emission_angle(p_degrees);
	...
	public function set_emission_angle_enabled(p_enabled:Bool):Bool {
		__audiostreamplayer3d_ptr().value.set_emission_angle_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_emission_angle_filter_attenuation_db(p_db:Float):Float {
		__audiostreamplayer3d_ptr().value.set_emission_angle_filter_attenuation_db(p_db);
		return p_db;
	}
	...
	public function set_attenuation_filter_cutoff_hz(p_degrees:Float):Float {
		__audiostreamplayer3d_ptr().value.set_attenuation_filter_cutoff_hz(p_degrees);
		return p_degrees;
	}
	...
	public function set_attenuation_filter_db(p_db:Float):Float {
		__audiostreamplayer3d_ptr().value.set_attenuation_filter_db(p_db);
		return p_db;
	}
	...
	public function set_attenuation_model(p_model:gd.audiostreamplayer3d.AttenuationModel):gd.audiostreamplayer3d.AttenuationModel {
		__audiostreamplayer3d_ptr().value.set_attenuation_model(p_model);
		return p_model;
	}
	...
	public function set_doppler_tracking(p_mode:gd.audiostreamplayer3d.DopplerTracking):gd.audiostreamplayer3d.DopplerTracking {
		__audiostreamplayer3d_ptr().value.set_doppler_tracking(p_mode);
		return p_mode;
	}
	...
	public function set_stream_paused(p_pause:Bool):Bool {
		__audiostreamplayer3d_ptr().value.set_stream_paused(p_pause);
		return p_pause;
	}
	...
	public function set_max_polyphony(p_max_polyphony:Int):Int {
		__audiostreamplayer3d_ptr().value.set_max_polyphony(p_max_polyphony);
	...
	public function set_panning_strength(p_panning_strength:Float):Float {
		__audiostreamplayer3d_ptr().value.set_panning_strength(p_panning_strength);
	...
	public function set_playback_type(p_playback_type:gd.audioserver.PlaybackType):gd.audioserver.PlaybackType {
		__audiostreamplayer3d_ptr().value.set_playback_type(p_playback_type);
