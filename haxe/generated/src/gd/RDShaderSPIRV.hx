...
class RDShaderSPIRV extends gd.Resource {
	...
	public var bytecode_vertex(get, set) : gd.PackedByteArray;
	...
	public var bytecode_fragment(get, set) : gd.PackedByteArray;
	...
	public var bytecode_tesselation_control(get, set) : gd.PackedByteArray;
	...
	public var bytecode_tesselation_evaluation(get, set) : gd.PackedByteArray;
	...
	public var bytecode_compute(get, set) : gd.PackedByteArray;
	...
	public var compile_error_vertex(get, set) : std.String;
	...
	public var compile_error_fragment(get, set) : std.String;
	...
	public var compile_error_tesselation_control(get, set) : std.String;
	...
	public var compile_error_tesselation_evaluation(get, set) : std.String;
	...
	public var compile_error_compute(get, set) : std.String;
