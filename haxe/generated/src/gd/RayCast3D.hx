...
class RayCast3D extends gd.Node3D {
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__raycast3d_ptr().value.set_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_target_position(p_local_point:gd.Vector3):gd.Vector3 {
		__raycast3d_ptr().value.set_target_position(p_local_point);
	...
	public function add_exception_rid(p_rid:gd.RID):Void __raycast3d_ptr().value.add_exception_rid(p_rid);
	public function add_exception(p_node:gd.CollisionObject3D):Void __raycast3d_ptr().value.add_exception(p_node);
	public function remove_exception_rid(p_rid:gd.RID):Void __raycast3d_ptr().value.remove_exception_rid(p_rid);
	public function remove_exception(p_node:gd.CollisionObject3D):Void __raycast3d_ptr().value.remove_exception(p_node);
	...
	public function set_collision_mask(p_mask:Int):Int {
		__raycast3d_ptr().value.set_collision_mask(p_mask);
		return p_mask;
	}
	public function get_collision_mask():Int return __raycast3d_ptr().value.get_collision_mask();
	public function set_collision_mask_value(p_layer_number:Int, p_value:Bool):Void __raycast3d_ptr().value.set_collision_mask_value(p_layer_number, p_value);
	public function get_collision_mask_value(p_layer_number:Int):Bool return __raycast3d_ptr().value.get_collision_mask_value(p_layer_number);
	public function set_exclude_parent_body(p_mask:Bool):Void __raycast3d_ptr().value.set_exclude_parent_body(p_mask);
	...
	public function set_collide_with_areas(p_enable:Bool):Bool {
		__raycast3d_ptr().value.set_collide_with_areas(p_enable);
		return p_enable;
	}
	...
	public function set_collide_with_bodies(p_enable:Bool):Bool {
		__raycast3d_ptr().value.set_collide_with_bodies(p_enable);
		return p_enable;
	}
	...
	public function set_hit_from_inside(p_enable:Bool):Bool {
		__raycast3d_ptr().value.set_hit_from_inside(p_enable);
		return p_enable;
	}
	...
	public function set_hit_back_faces(p_enable:Bool):Bool {
		__raycast3d_ptr().value.set_hit_back_faces(p_enable);
		return p_enable;
	}
	...
	public function set_debug_shape_custom_color(p_debug_shape_custom_color:gd.Color):gd.Color {
		__raycast3d_ptr().value.set_debug_shape_custom_color(p_debug_shape_custom_color);
	...
	public function set_debug_shape_thickness(p_debug_shape_thickness:Int):Int {
		__raycast3d_ptr().value.set_debug_shape_thickness(p_debug_shape_thickness);
