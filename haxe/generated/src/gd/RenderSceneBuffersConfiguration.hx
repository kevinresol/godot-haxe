...
class RenderSceneBuffersConfiguration extends gd.RefCounted {
	...
	public function set_render_target(p_render_target:gd.RID):gd.RID {
		__renderscenebuffersconfiguration_ptr().value.set_render_target(((p_render_target : gd.RID)));
	...
	public function set_internal_size(p_internal_size:gd.Vector2i):gd.Vector2i {
		__renderscenebuffersconfiguration_ptr().value.set_internal_size(((p_internal_size : gd.Vector2i)));
	...
	public function set_target_size(p_target_size:gd.Vector2i):gd.Vector2i {
		__renderscenebuffersconfiguration_ptr().value.set_target_size(((p_target_size : gd.Vector2i)));
	...
	public function set_view_count(p_view_count:Int):Int {
		__renderscenebuffersconfiguration_ptr().value.set_view_count(((p_view_count : Int)));
		return p_view_count;
	}
	...
	public function set_scaling_3d_mode(p_scaling_3d_mode:gd.renderingserver.ViewportScaling3DMode):gd.renderingserver.ViewportScaling3DMode {
		__renderscenebuffersconfiguration_ptr().value.set_scaling_3d_mode(((p_scaling_3d_mode : gd.renderingserver.ViewportScaling3DMode)));
	...
	public function set_msaa_3d(p_msaa_3d:gd.renderingserver.ViewportMSAA):gd.renderingserver.ViewportMSAA {
		__renderscenebuffersconfiguration_ptr().value.set_msaa_3d(((p_msaa_3d : gd.renderingserver.ViewportMSAA)));
		return p_msaa_3d;
	}
	...
	public function set_screen_space_aa(p_screen_space_aa:gd.renderingserver.ViewportScreenSpaceAA):gd.renderingserver.ViewportScreenSpaceAA {
		__renderscenebuffersconfiguration_ptr().value.set_screen_space_aa(((p_screen_space_aa : gd.renderingserver.ViewportScreenSpaceAA)));
	...
	public function set_fsr_sharpness(p_fsr_sharpness:Float):Float {
		__renderscenebuffersconfiguration_ptr().value.set_fsr_sharpness(((p_fsr_sharpness : Float)));
