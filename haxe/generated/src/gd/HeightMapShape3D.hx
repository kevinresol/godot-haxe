...
class HeightMapShape3D extends gd.Shape3D {
	...
	public function set_map_width(p_width:Int):Int {
		__heightmapshape3d_ptr().value.set_map_width(p_width);
		return p_width;
	}
	...
	public function set_map_depth(p_height:Int):Int {
		__heightmapshape3d_ptr().value.set_map_depth(p_height);
		return p_height;
	}
	...
	public function set_map_data(p_data:gd.PackedFloat32Array):gd.PackedFloat32Array {
		__heightmapshape3d_ptr().value.set_map_data(p_data);
		return p_data;
	}
	...
	public function update_map_data_from_image(p_image:gd.Image, p_height_min:Float, p_height_max:Float):Void __heightmapshape3d_ptr().value.update_map_data_from_image(p_image, p_height_min, p_height_max);
