...
class SubViewport extends gd.Viewport {
	...
	public function set_size(p_size:gd.Vector2i):gd.Vector2i {
		__subviewport_ptr().value.set_size(((p_size : gd.Vector2i)));
		return p_size;
	}
	...
	public function set_size_2d_override(p_size:gd.Vector2i):gd.Vector2i {
		__subviewport_ptr().value.set_size_2d_override(((p_size : gd.Vector2i)));
		return p_size;
	}
	...
	public function set_size_2d_override_stretch(p_enable:Bool):Bool {
		__subviewport_ptr().value.set_size_2d_override_stretch(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_update_mode(p_mode:gd.subviewport.UpdateMode):Void __subviewport_ptr().value.set_update_mode(((p_mode : gd.subviewport.UpdateMode)));
	public function get_update_mode():gd.subviewport.UpdateMode return __subviewport_ptr().value.get_update_mode();
	public function set_clear_mode(p_mode:gd.subviewport.ClearMode):Void __subviewport_ptr().value.set_clear_mode(((p_mode : gd.subviewport.ClearMode)));
	...
	public var size_2d_override(get, set) : gd.Vector2i;
	...
	public var render_target_clear_mode(get, set) : gd.subviewport.ClearMode;
	...
	public var render_target_update_mode(get, set) : gd.subviewport.UpdateMode;
