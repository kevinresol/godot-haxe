...
@:cppInclude('iostream') class MainLoop extends gd.Object {
	...
	extern inline function __mainloop_ptr():gdnative.MainLoop.MainLoop_extern return cast __gd;
	...
	public function _initialize():Void __mainloop_ptr()._initialize();
	public function _physics_process(p_delta:Float):Bool return __mainloop_ptr()._physics_process(((p_delta : Float)));
	public function _process(p_delta:Float):Bool return __mainloop_ptr()._process(((p_delta : Float)));
	public function _finalize():Void __mainloop_ptr()._finalize();
}