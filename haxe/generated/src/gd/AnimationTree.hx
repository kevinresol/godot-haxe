...
class AnimationTree extends gd.AnimationMixer {
	...
	public function set_tree_root(p_animation_node:gd.AnimationRootNode):gd.AnimationRootNode {
		__animationtree_ptr().value.set_tree_root(p_animation_node);
	...
	public function set_advance_expression_base_node(p_path:std.String):std.String {
		__animationtree_ptr().value.set_advance_expression_base_node(p_path);
		return p_path;
	}
	...
	public function set_animation_player(p_path:std.String):Void __animationtree_ptr().value.set_animation_player(p_path);
	public function get_animation_player():std.String return __animationtree_ptr().value.get_animation_player();
	public function set_process_callback(p_mode:gd.animationtree.AnimationProcessCallback):Void __animationtree_ptr().value.set_process_callback(p_mode);
