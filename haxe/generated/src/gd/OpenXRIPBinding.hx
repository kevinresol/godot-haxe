...
class OpenXRIPBinding extends gd.Resource {
	...
	public function set_action(p_action:gd.OpenXRAction):gd.OpenXRAction {
		__openxripbinding_ptr().value.set_action(p_action);
		return p_action;
	}
	...
	public function set_paths(p_paths:gd.PackedStringArray):gd.PackedStringArray {
		__openxripbinding_ptr().value.set_paths(p_paths);
		return p_paths;
	}
	public function get_paths():gd.PackedStringArray return __openxripbinding_ptr().value.get_paths();
	public function has_path(p_path:std.String):Bool return __openxripbinding_ptr().value.has_path(p_path);
	public function add_path(p_path:std.String):Void __openxripbinding_ptr().value.add_path(p_path);
	public function remove_path(p_path:std.String):Void __openxripbinding_ptr().value.remove_path(p_path);
