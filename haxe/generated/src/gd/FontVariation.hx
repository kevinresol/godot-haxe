...
class FontVariation extends gd.Font {
	...
	public function set_base_font(p_font:gd.Font):gd.Font {
		__fontvariation_ptr().value.set_base_font(p_font);
		return p_font;
	}
	...
	public function set_variation_opentype(p_coords:gd.Dictionary):gd.Dictionary {
		__fontvariation_ptr().value.set_variation_opentype(p_coords);
		return p_coords;
	}
	...
	public function set_variation_embolden(p_strength:Float):Float {
		__fontvariation_ptr().value.set_variation_embolden(p_strength);
		return p_strength;
	}
	...
	public function set_variation_face_index(p_face_index:Int):Int {
		__fontvariation_ptr().value.set_variation_face_index(p_face_index);
		return p_face_index;
	}
	public function get_variation_face_index():Int return __fontvariation_ptr().value.get_variation_face_index();
	public function set_opentype_features(p_features:gd.Dictionary):Void __fontvariation_ptr().value.set_opentype_features(p_features);
	public function set_spacing(p_spacing:gd.textserver.SpacingType, p_value:Int):Void __fontvariation_ptr().value.set_spacing(p_spacing, p_value);
	public function set_baseline_offset(p_baseline_offset:Float):Float {
		__fontvariation_ptr().value.set_baseline_offset(p_baseline_offset);
