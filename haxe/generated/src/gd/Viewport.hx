...
class Viewport extends gd.Node {
	...
	public function set_world_2d(p_world_2d:gd.World2D):gd.World2D {
		__viewport_ptr().value.set_world_2d(p_world_2d);
		return p_world_2d;
	}
	...
	public function set_transparent_background(p_enable:Bool):Void __viewport_ptr().value.set_transparent_background(p_enable);
	...
	public function set_use_hdr_2d(p_enable:Bool):Bool {
		__viewport_ptr().value.set_use_hdr_2d(p_enable);
		return p_enable;
	}
	...
	public function set_msaa_2d(p_msaa:gd.viewport.MSAA):gd.viewport.MSAA {
		__viewport_ptr().value.set_msaa_2d(p_msaa);
		return p_msaa;
	}
	...
	public function set_msaa_3d(p_msaa:gd.viewport.MSAA):gd.viewport.MSAA {
		__viewport_ptr().value.set_msaa_3d(p_msaa);
		return p_msaa;
	}
	...
	public function set_screen_space_aa(p_screen_space_aa:gd.viewport.ScreenSpaceAA):gd.viewport.ScreenSpaceAA {
		__viewport_ptr().value.set_screen_space_aa(p_screen_space_aa);
	...
	public function set_use_taa(p_enable:Bool):Bool {
		__viewport_ptr().value.set_use_taa(p_enable);
		return p_enable;
	}
	...
	public function set_use_debanding(p_enable:Bool):Bool {
		__viewport_ptr().value.set_use_debanding(p_enable);
		return p_enable;
	}
	...
	public function set_use_occlusion_culling(p_enable:Bool):Bool {
		__viewport_ptr().value.set_use_occlusion_culling(p_enable);
		return p_enable;
	}
	...
	public function set_debug_draw(p_debug_draw:gd.viewport.DebugDraw):gd.viewport.DebugDraw {
		__viewport_ptr().value.set_debug_draw(p_debug_draw);
		return p_debug_draw;
	}
	public function get_debug_draw():gd.viewport.DebugDraw return __viewport_ptr().value.get_debug_draw();
	public function get_render_info(p_type:gd.viewport.RenderInfoType, p_info:gd.viewport.RenderInfo):Int return __viewport_ptr().value.get_render_info(p_type, p_info);
	...
	public function set_physics_object_picking(p_enable:Bool):Bool {
		__viewport_ptr().value.set_physics_object_picking(p_enable);
		return p_enable;
	}
	...
	public function set_physics_object_picking_sort(p_enable:Bool):Bool {
		__viewport_ptr().value.set_physics_object_picking_sort(p_enable);
		return p_enable;
	}
	...
	public function set_physics_object_picking_first_only(p_enable:Bool):Bool {
		__viewport_ptr().value.set_physics_object_picking_first_only(p_enable);
		return p_enable;
	}
	...
	public function push_text_input(p_text:std.String):Void __viewport_ptr().value.push_text_input(p_text);
	public function push_input(p_event:gd.InputEvent, ?p_in_local_coords:Bool = false):Void __viewport_ptr().value.push_input(p_event, p_in_local_coords);
	public function push_unhandled_input(p_event:gd.InputEvent, ?p_in_local_coords:Bool = false):Void __viewport_ptr().value.push_unhandled_input(p_event, p_in_local_coords);
	public function get_mouse_position():gd.Vector2 return __viewport_ptr().value.get_mouse_position();
	public function warp_mouse(p_position:gd.Vector2):Void __viewport_ptr().value.warp_mouse(p_position);
	...
	public function set_disable_input(p_disable:Bool):Void __viewport_ptr().value.set_disable_input(p_disable);
	...
	public function set_positional_shadow_atlas_size(p_size:Int):Int {
		__viewport_ptr().value.set_positional_shadow_atlas_size(p_size);
		return p_size;
	}
	...
	public function set_positional_shadow_atlas_16_bits(p_enable:Bool):Bool {
		__viewport_ptr().value.set_positional_shadow_atlas_16_bits(p_enable);
		return p_enable;
	}
	public function get_positional_shadow_atlas_16_bits():Bool return __viewport_ptr().value.get_positional_shadow_atlas_16_bits();
	public function set_snap_controls_to_pixels(p_enabled:Bool):Void __viewport_ptr().value.set_snap_controls_to_pixels(p_enabled);
	...
	public function set_snap_2d_transforms_to_pixel(p_enabled:Bool):Bool {
		__viewport_ptr().value.set_snap_2d_transforms_to_pixel(p_enabled);
		return p_enabled;
	}
	...
	public function set_snap_2d_vertices_to_pixel(p_enabled:Bool):Bool {
		__viewport_ptr().value.set_snap_2d_vertices_to_pixel(p_enabled);
		return p_enabled;
	}
	...
	public function set_positional_shadow_atlas_quadrant_subdiv(p_quadrant:Int, p_subdiv:gd.viewport.PositionalShadowAtlasQuadrantSubdiv):Void __viewport_ptr().value.set_positional_shadow_atlas_quadrant_subdiv(p_quadrant, p_subdiv);
	public function get_positional_shadow_atlas_quadrant_subdiv(p_quadrant:Int):gd.viewport.PositionalShadowAtlasQuadrantSubdiv return __viewport_ptr().value.get_positional_shadow_atlas_quadrant_subdiv(p_quadrant);
	...
	public function set_handle_input_locally(p_enable:Bool):Bool {
		__viewport_ptr().value.set_handle_input_locally(p_enable);
		return p_enable;
	}
	public function is_handling_input_locally():Bool return __viewport_ptr().value.is_handling_input_locally();
	public function set_default_canvas_item_texture_filter(p_mode:gd.viewport.DefaultCanvasItemTextureFilter):Void __viewport_ptr().value.set_default_canvas_item_texture_filter(p_mode);
	...
	public function set_embedding_subwindows(p_enable:Bool):Void __viewport_ptr().value.set_embedding_subwindows(p_enable);
	...
	public function set_canvas_cull_mask(p_mask:Int):Int {
		__viewport_ptr().value.set_canvas_cull_mask(p_mask);
		return p_mask;
	}
	public function get_canvas_cull_mask():Int return __viewport_ptr().value.get_canvas_cull_mask();
	public function set_canvas_cull_mask_bit(p_layer:Int, p_enable:Bool):Void __viewport_ptr().value.set_canvas_cull_mask_bit(p_layer, p_enable);
	public function get_canvas_cull_mask_bit(p_layer:Int):Bool return __viewport_ptr().value.get_canvas_cull_mask_bit(p_layer);
	public function set_default_canvas_item_texture_repeat(p_mode:gd.viewport.DefaultCanvasItemTextureRepeat):Void __viewport_ptr().value.set_default_canvas_item_texture_repeat(p_mode);
	...
	public function set_sdf_oversize(p_oversize:gd.viewport.SDFOversize):gd.viewport.SDFOversize {
		__viewport_ptr().value.set_sdf_oversize(p_oversize);
		return p_oversize;
	}
	...
	public function set_sdf_scale(p_scale:gd.viewport.SDFScale):gd.viewport.SDFScale {
		__viewport_ptr().value.set_sdf_scale(p_scale);
		return p_scale;
	}
	...
	public function set_mesh_lod_threshold(p_pixels:Float):Float {
		__viewport_ptr().value.set_mesh_lod_threshold(p_pixels);
		return p_pixels;
	}
	public function get_mesh_lod_threshold():Float return __viewport_ptr().value.get_mesh_lod_threshold();
	public function set_as_audio_listener_2d(p_enable:Bool):Void __viewport_ptr().value.set_as_audio_listener_2d(p_enable);
	...
	public function set_world_3d(p_world_3d:gd.World3D):gd.World3D {
		__viewport_ptr().value.set_world_3d(p_world_3d);
		return p_world_3d;
	}
	...
	public function set_use_own_world_3d(p_enable:Bool):Void __viewport_ptr().value.set_use_own_world_3d(p_enable);
	...
	public function set_as_audio_listener_3d(p_enable:Bool):Void __viewport_ptr().value.set_as_audio_listener_3d(p_enable);
	...
	public function set_scaling_3d_mode(p_scaling_3d_mode:gd.viewport.Scaling3DMode):gd.viewport.Scaling3DMode {
		__viewport_ptr().value.set_scaling_3d_mode(p_scaling_3d_mode);
	...
	public function set_scaling_3d_scale(p_scale:Float):Float {
		__viewport_ptr().value.set_scaling_3d_scale(p_scale);
		return p_scale;
	}
	...
	public function set_fsr_sharpness(p_fsr_sharpness:Float):Float {
		__viewport_ptr().value.set_fsr_sharpness(p_fsr_sharpness);
	...
	public function set_texture_mipmap_bias(p_texture_mipmap_bias:Float):Float {
		__viewport_ptr().value.set_texture_mipmap_bias(p_texture_mipmap_bias);
	...
	public function set_vrs_mode(p_mode:gd.viewport.VRSMode):gd.viewport.VRSMode {
		__viewport_ptr().value.set_vrs_mode(p_mode);
		return p_mode;
	}
	...
	public function set_vrs_update_mode(p_mode:gd.viewport.VRSUpdateMode):gd.viewport.VRSUpdateMode {
		__viewport_ptr().value.set_vrs_update_mode(p_mode);
		return p_mode;
	}
	...
	public function set_vrs_texture(p_texture:gd.Texture2D):gd.Texture2D {
		__viewport_ptr().value.set_vrs_texture(p_texture);
		return p_texture;
	}
