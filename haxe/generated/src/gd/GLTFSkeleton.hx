...
class GLTFSkeleton extends gd.Resource {
	...
	public function set_joints(p_joints:gd.PackedInt32Array):gd.PackedInt32Array {
		__gltfskeleton_ptr().value.set_joints(p_joints);
		return p_joints;
	}
	...
	public function set_roots(p_roots:gd.PackedInt32Array):gd.PackedInt32Array {
		__gltfskeleton_ptr().value.set_roots(p_roots);
		return p_roots;
	}
	...
	public function set_godot_bone_node(p_godot_bone_node:gd.Dictionary):gd.Dictionary {
		__gltfskeleton_ptr().value.set_godot_bone_node(p_godot_bone_node);
	...
	public function get_bone_attachment(p_idx:Int):gd.BoneAttachment3D return __gltfskeleton_ptr().value.get_bone_attachment(p_idx);
