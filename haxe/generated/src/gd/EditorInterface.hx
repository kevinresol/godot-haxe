...
class EditorInterface extends gd.Object {
	...
	public function restart_editor(?p_save:Bool = true):Void __editorinterface_ptr().value.restart_editor(p_save);
	...
	public function set_plugin_enabled(p_plugin:std.String, p_enabled:Bool):Void __editorinterface_ptr().value.set_plugin_enabled(p_plugin, p_enabled);
	public function is_plugin_enabled(p_plugin:std.String):Bool return __editorinterface_ptr().value.is_plugin_enabled(p_plugin);
	...
	public function get_editor_viewport_3d(?p_idx:Int = 0):gd.SubViewport return __editorinterface_ptr().value.get_editor_viewport_3d(p_idx);
	public function set_main_screen_editor(p_name:std.String):Void __editorinterface_ptr().value.set_main_screen_editor(p_name);
	public function set_distraction_free_mode(p_enter:Bool):Bool {
		__editorinterface_ptr().value.set_distraction_free_mode(p_enter);
		return p_enter;
	}
	...
	public function popup_dialog_centered_ratio(p_dialog:gd.Window, ?p_ratio:Float = 0.8):Void __editorinterface_ptr().value.popup_dialog_centered_ratio(p_dialog, p_ratio);
	public function get_current_feature_profile():std.String return __editorinterface_ptr().value.get_current_feature_profile();
	public function set_current_feature_profile(p_profile_name:std.String):Void __editorinterface_ptr().value.set_current_feature_profile(p_profile_name);
	public function get_file_system_dock():gd.FileSystemDock return __editorinterface_ptr().value.get_file_system_dock();
	public function select_file(p_file:std.String):Void __editorinterface_ptr().value.select_file(p_file);
	...
	public function inspect_object(p_object:gd.Object, ?p_for_property:std.String = "\"\"", ?p_inspector_only:Bool = false):Void __editorinterface_ptr().value.inspect_object(p_object, p_for_property, p_inspector_only);
	public function edit_resource(p_resource:gd.Resource):Void __editorinterface_ptr().value.edit_resource(p_resource);
	public function edit_node(p_node:gd.Node):Void __editorinterface_ptr().value.edit_node(p_node);
	public function edit_script(p_script:gd.Script, ?p_line:Int = -1, ?p_column:Int = 0, ?p_grab_focus:Bool = true):Void __editorinterface_ptr().value.edit_script(p_script, p_line, p_column, p_grab_focus);
	public function open_scene_from_path(p_scene_filepath:std.String):Void __editorinterface_ptr().value.open_scene_from_path(p_scene_filepath);
	public function reload_scene_from_path(p_scene_filepath:std.String):Void __editorinterface_ptr().value.reload_scene_from_path(p_scene_filepath);
	...
	public function save_scene_as(p_path:std.String, ?p_with_preview:Bool = true):Void __editorinterface_ptr().value.save_scene_as(p_path, p_with_preview);
	...
	public function play_custom_scene(p_scene_filepath:std.String):Void __editorinterface_ptr().value.play_custom_scene(p_scene_filepath);
	...
	public function set_movie_maker_enabled(p_enabled:Bool):Bool {
		__editorinterface_ptr().value.set_movie_maker_enabled(p_enabled);
		return p_enabled;
	}
