...
class RigidBody2D extends gd.PhysicsBody2D {
	...
	public function _integrate_forces(p_state:gd.PhysicsDirectBodyState2D):Void __rigidbody2d_ptr().value._integrate_forces(p_state);
	public function set_mass(p_mass:Float):Float {
		__rigidbody2d_ptr().value.set_mass(p_mass);
		return p_mass;
	}
	...
	public function set_center_of_mass(p_center_of_mass:gd.Vector2):gd.Vector2 {
		__rigidbody2d_ptr().value.set_center_of_mass(p_center_of_mass);
	...
	public function set_physics_material_override(p_physics_material_override:gd.PhysicsMaterial):gd.PhysicsMaterial {
		__rigidbody2d_ptr().value.set_physics_material_override(p_physics_material_override);
	...
	public function set_gravity_scale(p_gravity_scale:Float):Float {
		__rigidbody2d_ptr().value.set_gravity_scale(p_gravity_scale);
	...
	public function set_linear_damp_mode(p_linear_damp_mode:gd.rigidbody2d.DampMode):gd.rigidbody2d.DampMode {
		__rigidbody2d_ptr().value.set_linear_damp_mode(p_linear_damp_mode);
	...
	public function set_angular_damp_mode(p_angular_damp_mode:gd.rigidbody2d.DampMode):gd.rigidbody2d.DampMode {
		__rigidbody2d_ptr().value.set_angular_damp_mode(p_angular_damp_mode);
	...
	public function set_linear_damp(p_linear_damp:Float):Float {
		__rigidbody2d_ptr().value.set_linear_damp(p_linear_damp);
	...
	public function set_angular_damp(p_angular_damp:Float):Float {
		__rigidbody2d_ptr().value.set_angular_damp(p_angular_damp);
	...
	public function set_linear_velocity(p_linear_velocity:gd.Vector2):gd.Vector2 {
		__rigidbody2d_ptr().value.set_linear_velocity(p_linear_velocity);
	...
	public function set_angular_velocity(p_angular_velocity:Float):Float {
		__rigidbody2d_ptr().value.set_angular_velocity(p_angular_velocity);
	...
	public function set_max_contacts_reported(p_amount:Int):Int {
		__rigidbody2d_ptr().value.set_max_contacts_reported(p_amount);
		return p_amount;
	}
	...
	public function set_use_custom_integrator(p_enable:Bool):Void __rigidbody2d_ptr().value.set_use_custom_integrator(p_enable);
	...
	public function set_contact_monitor(p_enabled:Bool):Bool {
		__rigidbody2d_ptr().value.set_contact_monitor(p_enabled);
		return p_enabled;
	}
	public function is_contact_monitor_enabled():Bool return __rigidbody2d_ptr().value.is_contact_monitor_enabled();
	public function set_continuous_collision_detection_mode(p_mode:gd.rigidbody2d.CCDMode):Void __rigidbody2d_ptr().value.set_continuous_collision_detection_mode(p_mode);
	...
	public function set_axis_velocity(p_axis_velocity:gd.Vector2):Void __rigidbody2d_ptr().value.set_axis_velocity(p_axis_velocity);
	public function apply_torque_impulse(p_torque:Float):Void __rigidbody2d_ptr().value.apply_torque_impulse(p_torque);
	public function apply_central_force(p_force:gd.Vector2):Void __rigidbody2d_ptr().value.apply_central_force(p_force);
	public function apply_torque(p_torque:Float):Void __rigidbody2d_ptr().value.apply_torque(p_torque);
	public function add_constant_central_force(p_force:gd.Vector2):Void __rigidbody2d_ptr().value.add_constant_central_force(p_force);
	public function add_constant_torque(p_torque:Float):Void __rigidbody2d_ptr().value.add_constant_torque(p_torque);
	public function set_constant_force(p_force:gd.Vector2):gd.Vector2 {
		__rigidbody2d_ptr().value.set_constant_force(p_force);
		return p_force;
	}
	...
	public function set_constant_torque(p_torque:Float):Float {
		__rigidbody2d_ptr().value.set_constant_torque(p_torque);
		return p_torque;
	}
	...
	public function set_sleeping(p_sleeping:Bool):Bool {
		__rigidbody2d_ptr().value.set_sleeping(p_sleeping);
		return p_sleeping;
	}
	...
	public function set_can_sleep(p_able_to_sleep:Bool):Bool {
		__rigidbody2d_ptr().value.set_can_sleep(p_able_to_sleep);
		return p_able_to_sleep;
	}
	public function is_able_to_sleep():Bool return __rigidbody2d_ptr().value.is_able_to_sleep();
	public function set_lock_rotation_enabled(p_lock_rotation:Bool):Void __rigidbody2d_ptr().value.set_lock_rotation_enabled(p_lock_rotation);
	public function is_lock_rotation_enabled():Bool return __rigidbody2d_ptr().value.is_lock_rotation_enabled();
	public function set_freeze_enabled(p_freeze_mode:Bool):Void __rigidbody2d_ptr().value.set_freeze_enabled(p_freeze_mode);
	...
	public function set_freeze_mode(p_freeze_mode:gd.rigidbody2d.FreezeMode):gd.rigidbody2d.FreezeMode {
		__rigidbody2d_ptr().value.set_freeze_mode(p_freeze_mode);
