...
class EditorNode3DGizmoPlugin extends gd.Resource {
	...
	public function _get_subgizmo_transform(p_gizmo:gd.EditorNode3DGizmo, p_subgizmo_id:Int):gd.Transform3D return __editornode3dgizmoplugin_ptr().value._get_subgizmo_transform(((p_gizmo : gd.EditorNode3DGizmo)), ((p_subgizmo_id : Int)));
	public function _set_subgizmo_transform(p_gizmo:gd.EditorNode3DGizmo, p_subgizmo_id:Int, p_transform:gd.Transform3D):Void __editornode3dgizmoplugin_ptr().value._set_subgizmo_transform(((p_gizmo : gd.EditorNode3DGizmo)), ((p_subgizmo_id : Int)), ((p_transform : gd.Transform3D)));
