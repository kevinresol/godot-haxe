...
enum abstract ArrayFormat(cpp.UInt64) from cpp.UInt64 to cpp.UInt64 {
	...
	@:to
	extern inline function toNative():gdnative.renderingserver.ArrayFormat return untyped __cpp__("static_cast<godot::RenderingServer::ArrayFormat>({0})", this);
	@:from
	extern static inline function fromNative(v:gdnative.renderingserver.ArrayFormat):ArrayFormat return untyped __cpp__("static_cast<uint64_t>({0})", v);
