...
class SkeletonModificationStack2D extends gd.Resource {
	...
	public function execute(p_delta:Float, p_execution_mode:Int):Void __skeletonmodificationstack2d_ptr().value.execute(p_delta, p_execution_mode);
	public function enable_all_modifications(p_enabled:Bool):Void __skeletonmodificationstack2d_ptr().value.enable_all_modifications(p_enabled);
	public function get_modification(p_mod_idx:Int):gd.SkeletonModification2D return __skeletonmodificationstack2d_ptr().value.get_modification(p_mod_idx);
	public function add_modification(p_modification:gd.SkeletonModification2D):Void __skeletonmodificationstack2d_ptr().value.add_modification(p_modification);
	public function delete_modification(p_mod_idx:Int):Void __skeletonmodificationstack2d_ptr().value.delete_modification(p_mod_idx);
	public function set_modification(p_mod_idx:Int, p_modification:gd.SkeletonModification2D):Void __skeletonmodificationstack2d_ptr().value.set_modification(p_mod_idx, p_modification);
	public function set_modification_count(p_count:Int):Int {
		__skeletonmodificationstack2d_ptr().value.set_modification_count(p_count);
		return p_count;
	}
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__skeletonmodificationstack2d_ptr().value.set_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_strength(p_strength:Float):Float {
		__skeletonmodificationstack2d_ptr().value.set_strength(p_strength);
		return p_strength;
	}
