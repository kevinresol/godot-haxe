...
class VisualShaderNodeParticleMeshEmitter extends gd.VisualShaderNodeParticleEmitter {
	...
	public function set_mesh(p_mesh:gd.Mesh):gd.Mesh {
		__visualshadernodeparticlemeshemitter_ptr().value.set_mesh(p_mesh);
		return p_mesh;
	}
	...
	public function set_use_all_surfaces(p_enabled:Bool):Bool {
		__visualshadernodeparticlemeshemitter_ptr().value.set_use_all_surfaces(p_enabled);
		return p_enabled;
	}
	...
	public function set_surface_index(p_surface_index:Int):Int {
		__visualshadernodeparticlemeshemitter_ptr().value.set_surface_index(p_surface_index);
