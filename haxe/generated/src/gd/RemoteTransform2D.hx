...
class RemoteTransform2D extends gd.Node2D {
	...
	public function set_remote_node(p_path:std.String):Void __remotetransform2d_ptr().value.set_remote_node(p_path);
	...
	public function set_use_global_coordinates(p_use_global_coordinates:Bool):Bool {
		__remotetransform2d_ptr().value.set_use_global_coordinates(p_use_global_coordinates);
	...
	public function set_update_position(p_update_remote_position:Bool):Bool {
		__remotetransform2d_ptr().value.set_update_position(p_update_remote_position);
	...
	public function set_update_rotation(p_update_remote_rotation:Bool):Bool {
		__remotetransform2d_ptr().value.set_update_rotation(p_update_remote_rotation);
	...
	public function set_update_scale(p_update_remote_scale:Bool):Bool {
		__remotetransform2d_ptr().value.set_update_scale(p_update_remote_scale);
