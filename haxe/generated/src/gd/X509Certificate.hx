...
class X509Certificate extends gd.Resource {
	...
	public function save(p_path:std.String):gd.Error return __x509certificate_ptr().value.save(p_path);
	public function load(p_path:std.String):gd.Error return __x509certificate_ptr().value.load(p_path);
	public function save_to_string():std.String return __x509certificate_ptr().value.save_to_string();
	public function load_from_string(p_string:std.String):gd.Error return __x509certificate_ptr().value.load_from_string(p_string);
}