...
class GLTFLight extends gd.Resource {
	...
	public static function from_node(p_light_node:gd.Light3D):gd.GLTFLight return gdnative.GLTFLight.GLTFLight_extern.from_node(((p_light_node : gd.Light3D)));
	public function to_node():gd.Light3D return __gltflight_ptr().value.to_node();
	public static function from_dictionary(p_dictionary:gd.Dictionary):gd.GLTFLight return gdnative.GLTFLight.GLTFLight_extern.from_dictionary(((p_dictionary : gd.Dictionary)));
	...
	public function set_color(p_color:gd.Color):gd.Color {
		__gltflight_ptr().value.set_color(((p_color : gd.Color)));
		return p_color;
	}
	...
	public function set_intensity(p_intensity:Float):Float {
		__gltflight_ptr().value.set_intensity(((p_intensity : Float)));
		return p_intensity;
	}
	...
	public function set_inner_cone_angle(p_inner_cone_angle:Float):Float {
		__gltflight_ptr().value.set_inner_cone_angle(((p_inner_cone_angle : Float)));
	...
	public function set_outer_cone_angle(p_outer_cone_angle:Float):Float {
		__gltflight_ptr().value.set_outer_cone_angle(((p_outer_cone_angle : Float)));
