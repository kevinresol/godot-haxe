...
class NavigationMeshSourceGeometryData2D extends gd.Resource {
	...
	public function add_traversable_outline(p_shape_outline:gd.PackedVector2Array):Void __navigationmeshsourcegeometrydata2d_ptr().value.add_traversable_outline(p_shape_outline);
	public function add_obstruction_outline(p_shape_outline:gd.PackedVector2Array):Void __navigationmeshsourcegeometrydata2d_ptr().value.add_obstruction_outline(p_shape_outline);
	public function merge(p_other_geometry:gd.NavigationMeshSourceGeometryData2D):Void __navigationmeshsourcegeometrydata2d_ptr().value.merge(p_other_geometry);
	public function add_projected_obstruction(p_vertices:gd.PackedVector2Array, p_carve:Bool):Void __navigationmeshsourcegeometrydata2d_ptr().value.add_projected_obstruction(p_vertices, p_carve);
	...
	public function set_projected_obstructions(p_projected_obstructions:gd.Array):gd.Array {
		__navigationmeshsourcegeometrydata2d_ptr().value.set_projected_obstructions(p_projected_obstructions);
