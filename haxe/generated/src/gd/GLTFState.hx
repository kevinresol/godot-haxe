...
class GLTFState extends gd.Resource {
	...
	public function add_used_extension(p_extension_name:std.String, p_required:Bool):Void __gltfstate_ptr().value.add_used_extension(p_extension_name, p_required);
	public function append_data_to_buffers(p_data:gd.PackedByteArray, p_deduplication:Bool):Int return __gltfstate_ptr().value.append_data_to_buffers(p_data, p_deduplication);
	...
	public function set_json(p_json:gd.Dictionary):gd.Dictionary {
		__gltfstate_ptr().value.set_json(p_json);
		return p_json;
	}
	...
	public function set_major_version(p_major_version:Int):Int {
		__gltfstate_ptr().value.set_major_version(p_major_version);
	...
	public function set_minor_version(p_minor_version:Int):Int {
		__gltfstate_ptr().value.set_minor_version(p_minor_version);
	...
	public function set_copyright(p_copyright:std.String):std.String {
		__gltfstate_ptr().value.set_copyright(p_copyright);
		return p_copyright;
	}
	...
	public function set_glb_data(p_glb_data:gd.PackedByteArray):gd.PackedByteArray {
		__gltfstate_ptr().value.set_glb_data(p_glb_data);
		return p_glb_data;
	}
	...
	public function set_use_named_skin_binds(p_use_named_skin_binds:Bool):Bool {
		__gltfstate_ptr().value.set_use_named_skin_binds(p_use_named_skin_binds);
		return p_use_named_skin_binds;
	}
	public function get_animation_players_count(p_idx:Int):Int return __gltfstate_ptr().value.get_animation_players_count(p_idx);
	public function get_animation_player(p_idx:Int):gd.AnimationPlayer return __gltfstate_ptr().value.get_animation_player(p_idx);
	...
	public function set_scene_name(p_scene_name:std.String):std.String {
		__gltfstate_ptr().value.set_scene_name(p_scene_name);
		return p_scene_name;
	}
	...
	public function set_base_path(p_base_path:std.String):std.String {
		__gltfstate_ptr().value.set_base_path(p_base_path);
		return p_base_path;
	}
	...
	public function set_filename(p_filename:std.String):std.String {
		__gltfstate_ptr().value.set_filename(p_filename);
		return p_filename;
	}
	...
	public function set_root_nodes(p_root_nodes:gd.PackedInt32Array):gd.PackedInt32Array {
		__gltfstate_ptr().value.set_root_nodes(p_root_nodes);
		return p_root_nodes;
	}
	...
	public function set_create_animations(p_create_animations:Bool):Bool {
		__gltfstate_ptr().value.set_create_animations(p_create_animations);
	...
	public function set_import_as_skeleton_bones(p_import_as_skeleton_bones:Bool):Bool {
		__gltfstate_ptr().value.set_import_as_skeleton_bones(p_import_as_skeleton_bones);
		return p_import_as_skeleton_bones;
	}
	public function get_scene_node(p_idx:Int):gd.Node return __gltfstate_ptr().value.get_scene_node(p_idx);
	public function get_node_index(p_scene_node:gd.Node):Int return __gltfstate_ptr().value.get_node_index(p_scene_node);
	public function get_additional_data(p_extension_name:std.String):gd.Variant return __gltfstate_ptr().value.get_additional_data(p_extension_name);
	public function set_additional_data(p_extension_name:std.String, p_additional_data:gd.Variant):Void __gltfstate_ptr().value.set_additional_data(p_extension_name, p_additional_data);
	...
	public function set_handle_binary_image(p_method:Int):Int {
		__gltfstate_ptr().value.set_handle_binary_image(p_method);
		return p_method;
	}
	public function set_bake_fps(p_value:Float):Float {
		__gltfstate_ptr().value.set_bake_fps(p_value);
		return p_value;
	}
