...
enum abstract HandJointFlags(cpp.UInt64) from cpp.UInt64 to cpp.UInt64 {
	...
	@:to
	extern inline function toNative():gdnative.xrhandtracker.HandJointFlags return untyped __cpp__("static_cast<godot::XRHandTracker::HandJointFlags>({0})", this);
	@:from
	extern static inline function fromNative(v:gdnative.xrhandtracker.HandJointFlags):HandJointFlags return untyped __cpp__("static_cast<uint64_t>({0})", v);
