...
class PhysicalBoneSimulator3D extends gd.SkeletonModifier3D {
	...
	public function physical_bones_add_collision_exception(p_exception:gd.RID):Void __physicalbonesimulator3d_ptr().value.physical_bones_add_collision_exception(p_exception);
	public function physical_bones_remove_collision_exception(p_exception:gd.RID):Void __physicalbonesimulator3d_ptr().value.physical_bones_remove_collision_exception(p_exception);
}