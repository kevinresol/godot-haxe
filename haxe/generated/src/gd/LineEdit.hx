...
class LineEdit extends gd.Control {
	...
	public function set_horizontal_alignment(p_alignment:gd.HorizontalAlignment):Void __lineedit_ptr().value.set_horizontal_alignment(p_alignment);
	...
	public function select(?p_from:Int = 0, ?p_to:Int = -1):Void __lineedit_ptr().value.select(p_from, p_to);
	...
	public function set_text(p_text:std.String):std.String {
		__lineedit_ptr().value.set_text(p_text);
		return p_text;
	}
	...
	public function set_draw_control_chars(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_draw_control_chars(p_enable);
		return p_enable;
	}
	public function set_text_direction(p_direction:gd.control.TextDirection):gd.control.TextDirection {
		__lineedit_ptr().value.set_text_direction(p_direction);
		return p_direction;
	}
	...
	public function set_language(p_language:std.String):std.String {
		__lineedit_ptr().value.set_language(p_language);
		return p_language;
	}
	...
	public function set_structured_text_bidi_override(p_parser:gd.textserver.StructuredTextParser):gd.textserver.StructuredTextParser {
		__lineedit_ptr().value.set_structured_text_bidi_override(p_parser);
		return p_parser;
	}
	...
	public function set_structured_text_bidi_override_options(p_args:gd.Array):gd.Array {
		__lineedit_ptr().value.set_structured_text_bidi_override_options(p_args);
		return p_args;
	}
	...
	public function set_placeholder(p_text:std.String):Void __lineedit_ptr().value.set_placeholder(p_text);
	...
	public function set_caret_column(p_position:Int):Int {
		__lineedit_ptr().value.set_caret_column(p_position);
		return p_position;
	}
	...
	public function set_expand_to_text_length_enabled(p_enabled:Bool):Void __lineedit_ptr().value.set_expand_to_text_length_enabled(p_enabled);
	public function is_expand_to_text_length_enabled():Bool return __lineedit_ptr().value.is_expand_to_text_length_enabled();
	public function set_caret_blink_enabled(p_enabled:Bool):Void __lineedit_ptr().value.set_caret_blink_enabled(p_enabled);
	public function is_caret_blink_enabled():Bool return __lineedit_ptr().value.is_caret_blink_enabled();
	public function set_caret_mid_grapheme_enabled(p_enabled:Bool):Void __lineedit_ptr().value.set_caret_mid_grapheme_enabled(p_enabled);
	...
	public function set_caret_force_displayed(p_enabled:Bool):Bool {
		__lineedit_ptr().value.set_caret_force_displayed(p_enabled);
		return p_enabled;
	}
	...
	public function set_caret_blink_interval(p_interval:Float):Float {
		__lineedit_ptr().value.set_caret_blink_interval(p_interval);
		return p_interval;
	}
	...
	public function set_max_length(p_chars:Int):Int {
		__lineedit_ptr().value.set_max_length(p_chars);
		return p_chars;
	}
	public function get_max_length():Int return __lineedit_ptr().value.get_max_length();
	public function insert_text_at_caret(p_text:std.String):Void __lineedit_ptr().value.insert_text_at_caret(p_text);
	public function delete_char_at_caret():Void __lineedit_ptr().value.delete_char_at_caret();
	public function delete_text(p_from_column:Int, p_to_column:Int):Void __lineedit_ptr().value.delete_text(p_from_column, p_to_column);
	public function set_editable(p_enabled:Bool):Bool {
		__lineedit_ptr().value.set_editable(p_enabled);
		return p_enabled;
	}
	public function is_editable():Bool return __lineedit_ptr().value.is_editable();
	public function set_secret(p_enabled:Bool):Bool {
		__lineedit_ptr().value.set_secret(p_enabled);
		return p_enabled;
	}
	...
	public function set_secret_character(p_character:std.String):std.String {
		__lineedit_ptr().value.set_secret_character(p_character);
		return p_character;
	}
	public function get_secret_character():std.String return __lineedit_ptr().value.get_secret_character();
	public function menu_option(p_option:Int):Void __lineedit_ptr().value.menu_option(p_option);
	...
	public function set_context_menu_enabled(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_context_menu_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_virtual_keyboard_enabled(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_virtual_keyboard_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_virtual_keyboard_type(p_type:gd.lineedit.VirtualKeyboardType):gd.lineedit.VirtualKeyboardType {
		__lineedit_ptr().value.set_virtual_keyboard_type(p_type);
		return p_type;
	}
	...
	public function set_clear_button_enabled(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_clear_button_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_shortcut_keys_enabled(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_shortcut_keys_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_middle_mouse_paste_enabled(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_middle_mouse_paste_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_selecting_enabled(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_selecting_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_deselect_on_focus_loss_enabled(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_deselect_on_focus_loss_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_drag_and_drop_selection_enabled(p_enable:Bool):Bool {
		__lineedit_ptr().value.set_drag_and_drop_selection_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_right_icon(p_icon:gd.Texture2D):gd.Texture2D {
		__lineedit_ptr().value.set_right_icon(p_icon);
		return p_icon;
	}
	...
	public function set_flat(p_enabled:Bool):Bool {
		__lineedit_ptr().value.set_flat(p_enabled);
		return p_enabled;
	}
	...
	public function set_select_all_on_focus(p_enabled:Bool):Bool {
		__lineedit_ptr().value.set_select_all_on_focus(p_enabled);
		return p_enabled;
	}
