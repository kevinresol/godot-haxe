...
class OccluderInstance3D extends gd.VisualInstance3D {
	...
	public function set_bake_mask(p_mask:Int):Int {
		__occluderinstance3d_ptr().value.set_bake_mask(p_mask);
		return p_mask;
	}
	public function get_bake_mask():Int return __occluderinstance3d_ptr().value.get_bake_mask();
	public function set_bake_mask_value(p_layer_number:Int, p_value:Bool):Void __occluderinstance3d_ptr().value.set_bake_mask_value(p_layer_number, p_value);
	public function get_bake_mask_value(p_layer_number:Int):Bool return __occluderinstance3d_ptr().value.get_bake_mask_value(p_layer_number);
	public function set_bake_simplification_distance(p_simplification_distance:Float):Float {
		__occluderinstance3d_ptr().value.set_bake_simplification_distance(p_simplification_distance);
	...
	public function set_occluder(p_occluder:gd.Occluder3D):gd.Occluder3D {
		__occluderinstance3d_ptr().value.set_occluder(p_occluder);
		return p_occluder;
	}
