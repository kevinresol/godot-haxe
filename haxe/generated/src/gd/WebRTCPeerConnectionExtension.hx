...
class WebRTCPeerConnectionExtension extends gd.WebRTCPeerConnection {
	...
	public function _initialize(p_p_config:gd.Dictionary):gd.Error return __webrtcpeerconnectionextension_ptr().value._initialize(p_p_config);
	public function _create_data_channel(p_p_label:std.String, p_p_config:gd.Dictionary):gd.WebRTCDataChannel return __webrtcpeerconnectionextension_ptr().value._create_data_channel(p_p_label, p_p_config);
	public function _create_offer():gd.Error return __webrtcpeerconnectionextension_ptr().value._create_offer();
	public function _set_remote_description(p_p_type:std.String, p_p_sdp:std.String):gd.Error return __webrtcpeerconnectionextension_ptr().value._set_remote_description(p_p_type, p_p_sdp);
	public function _set_local_description(p_p_type:std.String, p_p_sdp:std.String):gd.Error return __webrtcpeerconnectionextension_ptr().value._set_local_description(p_p_type, p_p_sdp);
	public function _add_ice_candidate(p_p_sdp_mid_name:std.String, p_p_sdp_mline_index:Int, p_p_sdp_name:std.String):gd.Error return __webrtcpeerconnectionextension_ptr().value._add_ice_candidate(p_p_sdp_mid_name, p_p_sdp_mline_index, p_p_sdp_name);
