...
class VideoStreamPlayback extends gd.Resource {
	...
	public function _set_paused(p_paused:Bool):Void __videostreamplayback_ptr().value._set_paused(p_paused);
	...
	public function _seek(p_time:Float):Void __videostreamplayback_ptr().value._seek(p_time);
	public function _set_audio_track(p_idx:Int):Void __videostreamplayback_ptr().value._set_audio_track(p_idx);
	public function _get_texture():gd.Texture2D return __videostreamplayback_ptr().value._get_texture();
	public function _update(p_delta:Float):Void __videostreamplayback_ptr().value._update(p_delta);
