...
class AudioStreamPlayer extends gd.Node {
	...
	public function set_stream(p_stream:gd.AudioStream):gd.AudioStream {
		__audiostreamplayer_ptr().value.set_stream(p_stream);
		return p_stream;
	}
	...
	public function set_volume_db(p_volume_db:Float):Float {
		__audiostreamplayer_ptr().value.set_volume_db(p_volume_db);
		return p_volume_db;
	}
	...
	public function set_pitch_scale(p_pitch_scale:Float):Float {
		__audiostreamplayer_ptr().value.set_pitch_scale(p_pitch_scale);
		return p_pitch_scale;
	}
	public function get_pitch_scale():Float return __audiostreamplayer_ptr().value.get_pitch_scale();
	public function play(?p_from_position:Float = 0.):Void __audiostreamplayer_ptr().value.play(p_from_position);
	public function seek(p_to_position:Float):Void __audiostreamplayer_ptr().value.seek(p_to_position);
	...
	public function set_bus(p_bus:std.String):std.String {
		__audiostreamplayer_ptr().value.set_bus(p_bus);
		return p_bus;
	}
	...
	public function set_autoplay(p_enable:Bool):Bool {
		__audiostreamplayer_ptr().value.set_autoplay(p_enable);
		return p_enable;
	}
	...
	public function set_mix_target(p_mix_target:gd.audiostreamplayer.MixTarget):gd.audiostreamplayer.MixTarget {
		__audiostreamplayer_ptr().value.set_mix_target(p_mix_target);
		return p_mix_target;
	}
	...
	public function set_stream_paused(p_pause:Bool):Bool {
		__audiostreamplayer_ptr().value.set_stream_paused(p_pause);
		return p_pause;
	}
	...
	public function set_max_polyphony(p_max_polyphony:Int):Int {
		__audiostreamplayer_ptr().value.set_max_polyphony(p_max_polyphony);
	...
	public function set_playback_type(p_playback_type:gd.audioserver.PlaybackType):gd.audioserver.PlaybackType {
		__audiostreamplayer_ptr().value.set_playback_type(p_playback_type);
