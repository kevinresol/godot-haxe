...
class PackedVector3Array_wrapper {
	...
	public function get(p_index:Int):gd.Vector3 return __gd.get(((p_index : Int)));
	public function size():Int return __gd.size();
	public function is_empty():Bool return __gd.is_empty();
	public function set(p_index:Int, p_value:gd.Vector3):Void __gd.set(((p_index : Int)), ((p_value : gd.Vector3)));
	...
	public function insert(p_at_index:Int, p_value:gd.Vector3):Int return __gd.insert(((p_at_index : Int)), ((p_value : gd.Vector3)));
	...
	public function slice(p_begin:Int, ?p_end:Int):gd.PackedVector3Array return switch [p_begin, p_end] {
	...
	public function bsearch(p_value:gd.Vector3, ?p_before:Bool):Int return switch [p_value, p_before] {
	...
	public function find(p_value:gd.Vector3, ?p_from:Int):Int return switch [p_value, p_from] {
		case [_, null]:__gd.find(((p_value : gd.Vector3)));
		default:__gd.find(((p_value : gd.Vector3)), ((p_from : Int)));
	};
	public function rfind(p_value:gd.Vector3, ?p_from:Int):Int return switch [p_value, p_from] {
		case [_, null]:__gd.rfind(((p_value : gd.Vector3)));
		default:__gd.rfind(((p_value : gd.Vector3)), ((p_from : Int)));
	};
	public function count(p_value:gd.Vector3):Int return __gd.count(((p_value : gd.Vector3)));
