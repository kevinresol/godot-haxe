...
class XMLParser extends gd.RefCounted {
	...
	public function get_attribute_name(p_idx:Int):std.String return __xmlparser_ptr().value.get_attribute_name(((p_idx : Int)));
	public function get_attribute_value(p_idx:Int):std.String return __xmlparser_ptr().value.get_attribute_value(((p_idx : Int)));
	public function has_attribute(p_name:std.String):Bool return __xmlparser_ptr().value.has_attribute(((p_name : std.String)));
	public function get_named_attribute_value(p_name:std.String):std.String return __xmlparser_ptr().value.get_named_attribute_value(((p_name : std.String)));
	public function get_named_attribute_value_safe(p_name:std.String):std.String return __xmlparser_ptr().value.get_named_attribute_value_safe(((p_name : std.String)));
	...
	public function seek(p_position:Int):gd.Error return __xmlparser_ptr().value.seek(((p_position : Int)));
	public function open(p_file:std.String):gd.Error return __xmlparser_ptr().value.open(((p_file : std.String)));
	public function open_buffer(p_buffer:gd.PackedByteArray):gd.Error return __xmlparser_ptr().value.open_buffer(((p_buffer : gd.PackedByteArray)));
}