...
class GraphEdit extends gd.Control {
	...
	public function _is_in_input_hotzone(p_in_node:gd.Object, p_in_port:Int, p_mouse_position:gd.Vector2):Bool return __graphedit_ptr().value._is_in_input_hotzone(p_in_node, p_in_port, p_mouse_position);
	public function _is_in_output_hotzone(p_in_node:gd.Object, p_in_port:Int, p_mouse_position:gd.Vector2):Bool return __graphedit_ptr().value._is_in_output_hotzone(p_in_node, p_in_port, p_mouse_position);
	public function _get_connection_line(p_from_position:gd.Vector2, p_to_position:gd.Vector2):gd.PackedVector2Array return __graphedit_ptr().value._get_connection_line(p_from_position, p_to_position);
	public function _is_node_hover_valid(p_from_node:std.String, p_from_port:Int, p_to_node:std.String, p_to_port:Int):Bool return __graphedit_ptr().value._is_node_hover_valid(p_from_node, p_from_port, p_to_node, p_to_port);
	public function connect_node(p_from_node:std.String, p_from_port:Int, p_to_node:std.String, p_to_port:Int):gd.Error return __graphedit_ptr().value.connect_node(p_from_node, p_from_port, p_to_node, p_to_port);
	public function is_node_connected(p_from_node:std.String, p_from_port:Int, p_to_node:std.String, p_to_port:Int):Bool return __graphedit_ptr().value.is_node_connected(p_from_node, p_from_port, p_to_node, p_to_port);
	public function disconnect_node(p_from_node:std.String, p_from_port:Int, p_to_node:std.String, p_to_port:Int):Void __graphedit_ptr().value.disconnect_node(p_from_node, p_from_port, p_to_node, p_to_port);
	public function set_connection_activity(p_from_node:std.String, p_from_port:Int, p_to_node:std.String, p_to_port:Int, p_amount:Float):Void __graphedit_ptr().value.set_connection_activity(p_from_node, p_from_port, p_to_node, p_to_port, p_amount);
	public function get_closest_connection_at_point(p_point:gd.Vector2, ?p_max_distance:Float = 4.):gd.Dictionary return __graphedit_ptr().value.get_closest_connection_at_point(p_point, p_max_distance);
	...
	public function set_scroll_offset(p_offset:gd.Vector2):gd.Vector2 {
		__graphedit_ptr().value.set_scroll_offset(p_offset);
		return p_offset;
	}
	public function add_valid_right_disconnect_type(p_type:Int):Void __graphedit_ptr().value.add_valid_right_disconnect_type(p_type);
	public function remove_valid_right_disconnect_type(p_type:Int):Void __graphedit_ptr().value.remove_valid_right_disconnect_type(p_type);
	public function add_valid_left_disconnect_type(p_type:Int):Void __graphedit_ptr().value.add_valid_left_disconnect_type(p_type);
	public function remove_valid_left_disconnect_type(p_type:Int):Void __graphedit_ptr().value.remove_valid_left_disconnect_type(p_type);
	public function add_valid_connection_type(p_from_type:Int, p_to_type:Int):Void __graphedit_ptr().value.add_valid_connection_type(p_from_type, p_to_type);
	public function remove_valid_connection_type(p_from_type:Int, p_to_type:Int):Void __graphedit_ptr().value.remove_valid_connection_type(p_from_type, p_to_type);
	public function is_valid_connection_type(p_from_type:Int, p_to_type:Int):Bool return __graphedit_ptr().value.is_valid_connection_type(p_from_type, p_to_type);
	public function get_connection_line(p_from_node:gd.Vector2, p_to_node:gd.Vector2):gd.PackedVector2Array return __graphedit_ptr().value.get_connection_line(p_from_node, p_to_node);
	public function attach_graph_element_to_frame(p_element:std.String, p_frame:std.String):Void __graphedit_ptr().value.attach_graph_element_to_frame(p_element, p_frame);
	public function detach_graph_element_from_frame(p_element:std.String):Void __graphedit_ptr().value.detach_graph_element_from_frame(p_element);
	public function get_element_frame(p_element:std.String):gd.GraphFrame return __graphedit_ptr().value.get_element_frame(p_element);
	public function set_panning_scheme(p_scheme:gd.graphedit.PanningScheme):gd.graphedit.PanningScheme {
		__graphedit_ptr().value.set_panning_scheme(p_scheme);
		return p_scheme;
	}
	...
	public function set_zoom_max(p_zoom_max:Float):Float {
		__graphedit_ptr().value.set_zoom_max(p_zoom_max);
		return p_zoom_max;
	}
	...
	public function set_zoom_step(p_zoom_step:Float):Float {
		__graphedit_ptr().value.set_zoom_step(p_zoom_step);
		return p_zoom_step;
	}
	...
	public function set_show_grid(p_enable:Bool):Bool {
		__graphedit_ptr().value.set_show_grid(p_enable);
		return p_enable;
	}
	...
	public function set_grid_pattern(p_pattern:gd.graphedit.GridPattern):gd.graphedit.GridPattern {
		__graphedit_ptr().value.set_grid_pattern(p_pattern);
		return p_pattern;
	}
	...
	public function set_snapping_enabled(p_enable:Bool):Bool {
		__graphedit_ptr().value.set_snapping_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_snapping_distance(p_pixels:Int):Int {
		__graphedit_ptr().value.set_snapping_distance(p_pixels);
		return p_pixels;
	}
	...
	public function set_connection_lines_curvature(p_curvature:Float):Float {
		__graphedit_ptr().value.set_connection_lines_curvature(p_curvature);
		return p_curvature;
	}
	...
	public function set_connection_lines_thickness(p_pixels:Float):Float {
		__graphedit_ptr().value.set_connection_lines_thickness(p_pixels);
		return p_pixels;
	}
	...
	public function set_connection_lines_antialiased(p_pixels:Bool):Bool {
		__graphedit_ptr().value.set_connection_lines_antialiased(p_pixels);
		return p_pixels;
	}
	...
	public function set_minimap_size(p_size:gd.Vector2):gd.Vector2 {
		__graphedit_ptr().value.set_minimap_size(p_size);
		return p_size;
	}
	...
	public function set_minimap_opacity(p_opacity:Float):Float {
		__graphedit_ptr().value.set_minimap_opacity(p_opacity);
		return p_opacity;
	}
	...
	public function set_minimap_enabled(p_enable:Bool):Bool {
		__graphedit_ptr().value.set_minimap_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_show_menu(p_hidden:Bool):Bool {
		__graphedit_ptr().value.set_show_menu(p_hidden);
		return p_hidden;
	}
	...
	public function set_show_zoom_label(p_enable:Bool):Bool {
		__graphedit_ptr().value.set_show_zoom_label(p_enable);
		return p_enable;
	}
	...
	public function set_show_grid_buttons(p_hidden:Bool):Bool {
		__graphedit_ptr().value.set_show_grid_buttons(p_hidden);
		return p_hidden;
	}
	...
	public function set_show_zoom_buttons(p_hidden:Bool):Bool {
		__graphedit_ptr().value.set_show_zoom_buttons(p_hidden);
		return p_hidden;
	}
	...
	public function set_show_minimap_button(p_hidden:Bool):Bool {
		__graphedit_ptr().value.set_show_minimap_button(p_hidden);
		return p_hidden;
	}
	...
	public function set_show_arrange_button(p_hidden:Bool):Bool {
		__graphedit_ptr().value.set_show_arrange_button(p_hidden);
		return p_hidden;
	}
	...
	public function set_right_disconnects(p_enable:Bool):Bool {
		__graphedit_ptr().value.set_right_disconnects(p_enable);
		return p_enable;
	}
	...
	public function set_selected(p_node:gd.Node):Void __graphedit_ptr().value.set_selected(p_node);
