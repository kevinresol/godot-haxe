...
class CSGTorus3D extends gd.CSGPrimitive3D {
	...
	public function set_inner_radius(p_radius:Float):Float {
		__csgtorus3d_ptr().value.set_inner_radius(((p_radius : Float)));
		return p_radius;
	}
	...
	public function set_outer_radius(p_radius:Float):Float {
		__csgtorus3d_ptr().value.set_outer_radius(((p_radius : Float)));
		return p_radius;
	}
	...
	public function set_material(p_material:gd.Material):gd.Material {
		__csgtorus3d_ptr().value.set_material(((p_material : gd.Material)));
		return p_material;
	}
	...
	public function set_smooth_faces(p_smooth_faces:Bool):Bool {
		__csgtorus3d_ptr().value.set_smooth_faces(((p_smooth_faces : Bool)));
