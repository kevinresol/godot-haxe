...
class VisualShaderNodeVec2Parameter extends gd.VisualShaderNodeParameter {
	...
	public function set_default_value_enabled(p_enabled:Bool):Bool {
		__visualshadernodevec2parameter_ptr().value.set_default_value_enabled(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_default_value(p_value:gd.Vector2):gd.Vector2 {
		__visualshadernodevec2parameter_ptr().value.set_default_value(((p_value : gd.Vector2)));
		return p_value;
	}
	...
	public var default_value(get, set) : gd.Vector2;
}