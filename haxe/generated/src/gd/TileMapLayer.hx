...
class TileMapLayer extends gd.Node2D {
	...
	public function _use_tile_data_runtime_update(p_coords:gd.Vector2i):Bool return __tilemaplayer_ptr().value._use_tile_data_runtime_update(p_coords);
	public function _tile_data_runtime_update(p_coords:gd.Vector2i, p_tile_data:gd.TileData):Void __tilemaplayer_ptr().value._tile_data_runtime_update(p_coords, p_tile_data);
	public function erase_cell(p_coords:gd.Vector2i):Void __tilemaplayer_ptr().value.erase_cell(p_coords);
	...
	public function get_cell_source_id(p_coords:gd.Vector2i):Int return __tilemaplayer_ptr().value.get_cell_source_id(p_coords);
	public function get_cell_atlas_coords(p_coords:gd.Vector2i):gd.Vector2i return __tilemaplayer_ptr().value.get_cell_atlas_coords(p_coords);
	public function get_cell_alternative_tile(p_coords:gd.Vector2i):Int return __tilemaplayer_ptr().value.get_cell_alternative_tile(p_coords);
	public function get_cell_tile_data(p_coords:gd.Vector2i):gd.TileData return __tilemaplayer_ptr().value.get_cell_tile_data(p_coords);
	public function get_used_rect():gd.Rect2i return __tilemaplayer_ptr().value.get_used_rect();
	public function set_pattern(p_position:gd.Vector2i, p_pattern:gd.TileMapPattern):Void __tilemaplayer_ptr().value.set_pattern(p_position, p_pattern);
	public function has_body_rid(p_body:gd.RID):Bool return __tilemaplayer_ptr().value.has_body_rid(p_body);
	public function get_coords_for_body_rid(p_body:gd.RID):gd.Vector2i return __tilemaplayer_ptr().value.get_coords_for_body_rid(p_body);
	...
	public function map_pattern(p_position_in_tilemap:gd.Vector2i, p_coords_in_pattern:gd.Vector2i, p_pattern:gd.TileMapPattern):gd.Vector2i return __tilemaplayer_ptr().value.map_pattern(p_position_in_tilemap, p_coords_in_pattern, p_pattern);
	public function get_neighbor_cell(p_coords:gd.Vector2i, p_neighbor:gd.tileset.CellNeighbor):gd.Vector2i return __tilemaplayer_ptr().value.get_neighbor_cell(p_coords, p_neighbor);
	public function map_to_local(p_map_position:gd.Vector2i):gd.Vector2 return __tilemaplayer_ptr().value.map_to_local(p_map_position);
	public function local_to_map(p_local_position:gd.Vector2):gd.Vector2i return __tilemaplayer_ptr().value.local_to_map(p_local_position);
	public function set_tile_map_data_from_array(p_tile_map_layer_data:gd.PackedByteArray):Void __tilemaplayer_ptr().value.set_tile_map_data_from_array(p_tile_map_layer_data);
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__tilemaplayer_ptr().value.set_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_tile_set(p_tile_set:gd.TileSet):gd.TileSet {
		__tilemaplayer_ptr().value.set_tile_set(p_tile_set);
		return p_tile_set;
	}
	...
	public function set_y_sort_origin(p_y_sort_origin:Int):Int {
		__tilemaplayer_ptr().value.set_y_sort_origin(p_y_sort_origin);
	...
	public function set_x_draw_order_reversed(p_x_draw_order_reversed:Bool):Bool {
		__tilemaplayer_ptr().value.set_x_draw_order_reversed(p_x_draw_order_reversed);
	...
	public function set_rendering_quadrant_size(p_size:Int):Int {
		__tilemaplayer_ptr().value.set_rendering_quadrant_size(p_size);
		return p_size;
	}
	...
	public function set_collision_enabled(p_enabled:Bool):Bool {
		__tilemaplayer_ptr().value.set_collision_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_use_kinematic_bodies(p_use_kinematic_bodies:Bool):Bool {
		__tilemaplayer_ptr().value.set_use_kinematic_bodies(p_use_kinematic_bodies);
	...
	public function set_collision_visibility_mode(p_visibility_mode:gd.tilemaplayer.DebugVisibilityMode):gd.tilemaplayer.DebugVisibilityMode {
		__tilemaplayer_ptr().value.set_collision_visibility_mode(p_visibility_mode);
	...
	public function set_navigation_enabled(p_enabled:Bool):Bool {
		__tilemaplayer_ptr().value.set_navigation_enabled(p_enabled);
		return p_enabled;
	}
	public function is_navigation_enabled():Bool return __tilemaplayer_ptr().value.is_navigation_enabled();
	public function set_navigation_map(p_map:gd.RID):Void __tilemaplayer_ptr().value.set_navigation_map(p_map);
	...
	public function set_navigation_visibility_mode(p_show_navigation:gd.tilemaplayer.DebugVisibilityMode):gd.tilemaplayer.DebugVisibilityMode {
		__tilemaplayer_ptr().value.set_navigation_visibility_mode(p_show_navigation);
