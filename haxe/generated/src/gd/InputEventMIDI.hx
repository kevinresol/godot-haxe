...
class InputEventMIDI extends gd.InputEvent {
	...
	public function set_channel(p_channel:Int):Int {
		__inputeventmidi_ptr().value.set_channel(p_channel);
		return p_channel;
	}
	...
	public function set_message(p_message:gd.MIDIMessage):gd.MIDIMessage {
		__inputeventmidi_ptr().value.set_message(p_message);
		return p_message;
	}
	...
	public function set_instrument(p_instrument:Int):Int {
		__inputeventmidi_ptr().value.set_instrument(p_instrument);
		return p_instrument;
	}
	...
	public function set_pressure(p_pressure:Int):Int {
		__inputeventmidi_ptr().value.set_pressure(p_pressure);
		return p_pressure;
	}
	...
	public function set_controller_number(p_controller_number:Int):Int {
		__inputeventmidi_ptr().value.set_controller_number(p_controller_number);
	...
	public function set_controller_value(p_controller_value:Int):Int {
		__inputeventmidi_ptr().value.set_controller_value(p_controller_value);
