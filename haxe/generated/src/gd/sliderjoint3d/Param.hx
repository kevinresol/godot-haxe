...
enum abstract Param(Int) from Int to Int {
	...
	@:to
	extern inline function toNative():gdnative.sliderjoint3d.Param return untyped __cpp__("static_cast<godot::SliderJoint3D::Param>({0})", this);
	@:from
	extern static inline function fromNative(v:gdnative.sliderjoint3d.Param):Param return untyped __cpp__("static_cast<int32_t>({0})", v);
