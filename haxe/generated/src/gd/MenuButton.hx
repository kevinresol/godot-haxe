...
class MenuButton extends gd.Button {
	...
	public function set_switch_on_hover(p_enable:Bool):Bool {
		__menubutton_ptr().value.set_switch_on_hover(p_enable);
		return p_enable;
	}
	public function is_switch_on_hover():Bool return __menubutton_ptr().value.is_switch_on_hover();
	public function set_disable_shortcuts(p_disabled:Bool):Void __menubutton_ptr().value.set_disable_shortcuts(p_disabled);
	public function set_item_count(p_count:Int):Int {
		__menubutton_ptr().value.set_item_count(p_count);
		return p_count;
	}
