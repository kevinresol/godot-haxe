...
class NavigationLink3D extends gd.Node3D {
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__navigationlink3d_ptr().value.set_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_bidirectional(p_bidirectional:Bool):Bool {
		__navigationlink3d_ptr().value.set_bidirectional(p_bidirectional);
	...
	public function set_navigation_layers(p_navigation_layers:Int):Int {
		__navigationlink3d_ptr().value.set_navigation_layers(p_navigation_layers);
	...
	public function set_navigation_layer_value(p_layer_number:Int, p_value:Bool):Void __navigationlink3d_ptr().value.set_navigation_layer_value(p_layer_number, p_value);
	public function get_navigation_layer_value(p_layer_number:Int):Bool return __navigationlink3d_ptr().value.get_navigation_layer_value(p_layer_number);
	public function set_start_position(p_position:gd.Vector3):gd.Vector3 {
		__navigationlink3d_ptr().value.set_start_position(p_position);
		return p_position;
	}
	...
	public function set_end_position(p_position:gd.Vector3):gd.Vector3 {
		__navigationlink3d_ptr().value.set_end_position(p_position);
		return p_position;
	}
	public function get_end_position():gd.Vector3 return __navigationlink3d_ptr().value.get_end_position();
	public function set_global_start_position(p_position:gd.Vector3):Void __navigationlink3d_ptr().value.set_global_start_position(p_position);
	public function get_global_start_position():gd.Vector3 return __navigationlink3d_ptr().value.get_global_start_position();
	public function set_global_end_position(p_position:gd.Vector3):Void __navigationlink3d_ptr().value.set_global_end_position(p_position);
	...
	public function set_enter_cost(p_enter_cost:Float):Float {
		__navigationlink3d_ptr().value.set_enter_cost(p_enter_cost);
		return p_enter_cost;
	}
	...
	public function set_travel_cost(p_travel_cost:Float):Float {
		__navigationlink3d_ptr().value.set_travel_cost(p_travel_cost);
