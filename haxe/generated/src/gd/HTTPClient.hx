...
class HTTPClient extends gd.RefCounted {
	...
	public function connect_to_host(p_host:std.String, ?p_port:Int, ?p_tls_options:gd.TLSOptions):gd.Error return switch [p_host, p_port, p_tls_options] {
		case [_, null, _]:__httpclient_ptr().value.connect_to_host(((p_host : std.String)));
		case [_, _, null]:__httpclient_ptr().value.connect_to_host(((p_host : std.String)), ((p_port : Int)));
		default:__httpclient_ptr().value.connect_to_host(((p_host : std.String)), ((p_port : Int)), ((p_tls_options : gd.TLSOptions)));
	};
	public function set_connection(p_connection:gd.StreamPeer):gd.StreamPeer {
		__httpclient_ptr().value.set_connection(((p_connection : gd.StreamPeer)));
		return p_connection;
	}
	public function get_connection():gd.StreamPeer return __httpclient_ptr().value.get_connection();
	public function request_raw(p_method:gd.httpclient.Method, p_url:std.String, p_headers:gd.PackedStringArray, p_body:gd.PackedByteArray):gd.Error return __httpclient_ptr().value.request_raw(((p_method : gd.httpclient.Method)), ((p_url : std.String)), ((p_headers : gd.PackedStringArray)), ((p_body : gd.PackedByteArray)));
	public function request(p_method:gd.httpclient.Method, p_url:std.String, p_headers:gd.PackedStringArray, ?p_body:std.String):gd.Error return switch [p_method, p_url, p_headers, p_body] {
		case [_, _, _, null]:__httpclient_ptr().value.request(((p_method : gd.httpclient.Method)), ((p_url : std.String)), ((p_headers : gd.PackedStringArray)));
		default:__httpclient_ptr().value.request(((p_method : gd.httpclient.Method)), ((p_url : std.String)), ((p_headers : gd.PackedStringArray)), ((p_body : std.String)));
	};
	...
	public function set_read_chunk_size(p_bytes:Int):Int {
		__httpclient_ptr().value.set_read_chunk_size(((p_bytes : Int)));
		return p_bytes;
	}
	public function get_read_chunk_size():Int return __httpclient_ptr().value.get_read_chunk_size();
	public function set_blocking_mode(p_enabled:Bool):Void __httpclient_ptr().value.set_blocking_mode(((p_enabled : Bool)));
