...
class TubeTrailMesh extends gd.PrimitiveMesh {
	...
	public function set_radius(p_radius:Float):Float {
		__tubetrailmesh_ptr().value.set_radius(p_radius);
		return p_radius;
	}
	...
	public function set_radial_steps(p_radial_steps:Int):Int {
		__tubetrailmesh_ptr().value.set_radial_steps(p_radial_steps);
	...
	public function set_sections(p_sections:Int):Int {
		__tubetrailmesh_ptr().value.set_sections(p_sections);
		return p_sections;
	}
	...
	public function set_section_length(p_section_length:Float):Float {
		__tubetrailmesh_ptr().value.set_section_length(p_section_length);
	...
	public function set_section_rings(p_section_rings:Int):Int {
		__tubetrailmesh_ptr().value.set_section_rings(p_section_rings);
	...
	public function set_cap_top(p_cap_top:Bool):Bool {
		__tubetrailmesh_ptr().value.set_cap_top(p_cap_top);
		return p_cap_top;
	}
	...
	public function set_cap_bottom(p_cap_bottom:Bool):Bool {
		__tubetrailmesh_ptr().value.set_cap_bottom(p_cap_bottom);
		return p_cap_bottom;
	}
	...
	public function set_curve(p_curve:gd.Curve):gd.Curve {
		__tubetrailmesh_ptr().value.set_curve(p_curve);
		return p_curve;
	}
