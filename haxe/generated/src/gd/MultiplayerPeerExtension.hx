...
class MultiplayerPeerExtension extends gd.MultiplayerPeer {
	...
	public function _put_packet_script(p_p_buffer:gd.PackedByteArray):gd.Error return __multiplayerpeerextension_ptr().value._put_packet_script(((p_p_buffer : gd.PackedByteArray)));
	...
	public function _set_transfer_channel(p_p_channel:Int):Void __multiplayerpeerextension_ptr().value._set_transfer_channel(((p_p_channel : Int)));
	public function _get_transfer_channel():Int return __multiplayerpeerextension_ptr().value._get_transfer_channel();
	public function _set_transfer_mode(p_p_mode:gd.multiplayerpeer.TransferMode):Void __multiplayerpeerextension_ptr().value._set_transfer_mode(((p_p_mode : gd.multiplayerpeer.TransferMode)));
	...
	public function _set_target_peer(p_p_peer:Int):Void __multiplayerpeerextension_ptr().value._set_target_peer(((p_p_peer : Int)));
	...
	public function _disconnect_peer(p_p_peer:Int, p_p_force:Bool):Void __multiplayerpeerextension_ptr().value._disconnect_peer(((p_p_peer : Int)), ((p_p_force : Bool)));
	public function _get_unique_id():Int return __multiplayerpeerextension_ptr().value._get_unique_id();
	public function _set_refuse_new_connections(p_p_enable:Bool):Void __multiplayerpeerextension_ptr().value._set_refuse_new_connections(((p_p_enable : Bool)));
