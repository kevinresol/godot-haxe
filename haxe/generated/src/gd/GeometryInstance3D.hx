...
class GeometryInstance3D extends gd.VisualInstance3D {
	...
	public function set_material_override(p_material:gd.Material):gd.Material {
		__geometryinstance3d_ptr().value.set_material_override(p_material);
		return p_material;
	}
	...
	public function set_material_overlay(p_material:gd.Material):gd.Material {
		__geometryinstance3d_ptr().value.set_material_overlay(p_material);
		return p_material;
	}
	public function get_material_overlay():gd.Material return __geometryinstance3d_ptr().value.get_material_overlay();
	public function set_cast_shadows_setting(p_shadow_casting_setting:gd.geometryinstance3d.ShadowCastingSetting):Void __geometryinstance3d_ptr().value.set_cast_shadows_setting(p_shadow_casting_setting);
	...
	public function set_lod_bias(p_bias:Float):Float {
		__geometryinstance3d_ptr().value.set_lod_bias(p_bias);
		return p_bias;
	}
	...
	public function set_transparency(p_transparency:Float):Float {
		__geometryinstance3d_ptr().value.set_transparency(p_transparency);
	...
	public function set_visibility_range_end_margin(p_distance:Float):Float {
		__geometryinstance3d_ptr().value.set_visibility_range_end_margin(p_distance);
		return p_distance;
	}
	...
	public function set_visibility_range_end(p_distance:Float):Float {
		__geometryinstance3d_ptr().value.set_visibility_range_end(p_distance);
		return p_distance;
	}
	...
	public function set_visibility_range_begin_margin(p_distance:Float):Float {
		__geometryinstance3d_ptr().value.set_visibility_range_begin_margin(p_distance);
		return p_distance;
	}
	...
	public function set_visibility_range_begin(p_distance:Float):Float {
		__geometryinstance3d_ptr().value.set_visibility_range_begin(p_distance);
		return p_distance;
	}
	...
	public function set_visibility_range_fade_mode(p_mode:gd.geometryinstance3d.VisibilityRangeFadeMode):gd.geometryinstance3d.VisibilityRangeFadeMode {
		__geometryinstance3d_ptr().value.set_visibility_range_fade_mode(p_mode);
		return p_mode;
	}
	...
	public function set_instance_shader_parameter(p_name:std.String, p_value:gd.Variant):Void __geometryinstance3d_ptr().value.set_instance_shader_parameter(p_name, p_value);
	public function get_instance_shader_parameter(p_name:std.String):gd.Variant return __geometryinstance3d_ptr().value.get_instance_shader_parameter(p_name);
	public function set_extra_cull_margin(p_margin:Float):Float {
		__geometryinstance3d_ptr().value.set_extra_cull_margin(p_margin);
		return p_margin;
	}
	public function get_extra_cull_margin():Float return __geometryinstance3d_ptr().value.get_extra_cull_margin();
	public function set_lightmap_scale(p_scale:gd.geometryinstance3d.LightmapScale):Void __geometryinstance3d_ptr().value.set_lightmap_scale(p_scale);
	...
	public function set_gi_mode(p_mode:gd.geometryinstance3d.GIMode):gd.geometryinstance3d.GIMode {
		__geometryinstance3d_ptr().value.set_gi_mode(p_mode);
		return p_mode;
	}
	...
	public function set_ignore_occlusion_culling(p_ignore_culling:Bool):Bool {
		__geometryinstance3d_ptr().value.set_ignore_occlusion_culling(p_ignore_culling);
	...
	public function set_custom_aabb(p_aabb:gd.AABB):gd.AABB {
		__geometryinstance3d_ptr().value.set_custom_aabb(p_aabb);
		return p_aabb;
	}
