...
class VehicleBody3D extends gd.RigidBody3D {
	...
	public function set_engine_force(p_engine_force:Float):Float {
		__vehiclebody3d_ptr().value.set_engine_force(((p_engine_force : Float)));
	...
	public function set_brake(p_brake:Float):Float {
		__vehiclebody3d_ptr().value.set_brake(((p_brake : Float)));
		return p_brake;
	}
	...
	public function set_steering(p_steering:Float):Float {
		__vehiclebody3d_ptr().value.set_steering(((p_steering : Float)));
		return p_steering;
	}
