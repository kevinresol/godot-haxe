...
class NoiseTexture3D extends gd.Texture3D {
	...
	public function set_width(p_width:Int):Void __noisetexture3d_ptr().value.set_width(p_width);
	public function set_height(p_height:Int):Void __noisetexture3d_ptr().value.set_height(p_height);
	public function set_depth(p_depth:Int):Void __noisetexture3d_ptr().value.set_depth(p_depth);
	public function set_invert(p_invert:Bool):Bool {
		__noisetexture3d_ptr().value.set_invert(p_invert);
		return p_invert;
	}
	...
	public function set_seamless(p_seamless:Bool):Bool {
		__noisetexture3d_ptr().value.set_seamless(p_seamless);
		return p_seamless;
	}
	...
	public function set_seamless_blend_skirt(p_seamless_blend_skirt:Float):Float {
		__noisetexture3d_ptr().value.set_seamless_blend_skirt(p_seamless_blend_skirt);
	...
	public function set_normalize(p_normalize:Bool):Bool {
		__noisetexture3d_ptr().value.set_normalize(p_normalize);
		return p_normalize;
	}
	...
	public function set_color_ramp(p_gradient:gd.Gradient):gd.Gradient {
		__noisetexture3d_ptr().value.set_color_ramp(p_gradient);
		return p_gradient;
	}
	...
	public function set_noise(p_noise:gd.Noise):gd.Noise {
		__noisetexture3d_ptr().value.set_noise(p_noise);
		return p_noise;
	}
