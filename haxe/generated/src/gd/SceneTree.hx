...
class SceneTree extends gd.MainLoop {
	...
	public function has_group(p_name:std.String):Bool return __scenetree_ptr().value.has_group(p_name);
	...
	public function set_auto_accept_quit(p_enabled:Bool):Bool {
		__scenetree_ptr().value.set_auto_accept_quit(p_enabled);
		return p_enabled;
	}
	...
	public function set_quit_on_go_back(p_enabled:Bool):Bool {
		__scenetree_ptr().value.set_quit_on_go_back(p_enabled);
		return p_enabled;
	}
	public function set_debug_collisions_hint(p_enable:Bool):Bool {
		__scenetree_ptr().value.set_debug_collisions_hint(p_enable);
		return p_enable;
	}
	...
	public function set_debug_paths_hint(p_enable:Bool):Bool {
		__scenetree_ptr().value.set_debug_paths_hint(p_enable);
		return p_enable;
	}
	...
	public function set_debug_navigation_hint(p_enable:Bool):Bool {
		__scenetree_ptr().value.set_debug_navigation_hint(p_enable);
		return p_enable;
	}
	...
	public function set_edited_scene_root(p_scene:gd.Node):gd.Node {
		__scenetree_ptr().value.set_edited_scene_root(p_scene);
		return p_scene;
	}
	public function get_edited_scene_root():gd.Node return __scenetree_ptr().value.get_edited_scene_root();
	public function set_pause(p_enable:Bool):Void __scenetree_ptr().value.set_pause(p_enable);
	public function is_paused():Bool return __scenetree_ptr().value.is_paused();
	public function create_timer(p_time_sec:Float, ?p_process_always:Bool = true, ?p_process_in_physics:Bool = false, ?p_ignore_time_scale:Bool = false):gd.SceneTreeTimer return __scenetree_ptr().value.create_timer(p_time_sec, p_process_always, p_process_in_physics, p_ignore_time_scale);
	...
	public function quit(?p_exit_code:Int = 0):Void __scenetree_ptr().value.quit(p_exit_code);
	public function set_physics_interpolation_enabled(p_enabled:Bool):Void __scenetree_ptr().value.set_physics_interpolation_enabled(p_enabled);
	public function is_physics_interpolation_enabled():Bool return __scenetree_ptr().value.is_physics_interpolation_enabled();
	public function queue_delete(p_obj:gd.Object):Void __scenetree_ptr().value.queue_delete(p_obj);
	public function call_group_flags(p_flags:Int, p_group:std.String, p_method:std.String):Void __scenetree_ptr().value.call_group_flags(p_flags, p_group, p_method);
	public function notify_group_flags(p_call_flags:Int, p_group:std.String, p_notification:Int):Void __scenetree_ptr().value.notify_group_flags(p_call_flags, p_group, p_notification);
	public function set_group_flags(p_call_flags:Int, p_group:std.String, p_property:std.String, p_value:gd.Variant):Void __scenetree_ptr().value.set_group_flags(p_call_flags, p_group, p_property, p_value);
	public function call_group(p_group:std.String, p_method:std.String):Void __scenetree_ptr().value.call_group(p_group, p_method);
	public function notify_group(p_group:std.String, p_notification:Int):Void __scenetree_ptr().value.notify_group(p_group, p_notification);
	public function set_group(p_group:std.String, p_property:std.String, p_value:gd.Variant):Void __scenetree_ptr().value.set_group(p_group, p_property, p_value);
	public function get_first_node_in_group(p_group:std.String):gd.Node return __scenetree_ptr().value.get_first_node_in_group(p_group);
	public function get_node_count_in_group(p_group:std.String):Int return __scenetree_ptr().value.get_node_count_in_group(p_group);
	public function set_current_scene(p_child_node:gd.Node):gd.Node {
		__scenetree_ptr().value.set_current_scene(p_child_node);
		return p_child_node;
	}
	public function get_current_scene():gd.Node return __scenetree_ptr().value.get_current_scene();
	public function change_scene_to_file(p_path:std.String):gd.Error return __scenetree_ptr().value.change_scene_to_file(p_path);
	public function change_scene_to_packed(p_packed_scene:gd.PackedScene):gd.Error return __scenetree_ptr().value.change_scene_to_packed(p_packed_scene);
	...
	public function set_multiplayer_poll_enabled(p_enabled:Bool):Void __scenetree_ptr().value.set_multiplayer_poll_enabled(p_enabled);
