...
class InputEventAction extends gd.InputEvent {
	...
	public function set_action(p_action:std.String):std.String {
		__inputeventaction_ptr().value.set_action(p_action);
		return p_action;
	}
	public function get_action():std.String return __inputeventaction_ptr().value.get_action();
	public function set_pressed(p_pressed:Bool):Void __inputeventaction_ptr().value.set_pressed(p_pressed);
	public function set_strength(p_strength:Float):Float {
		__inputeventaction_ptr().value.set_strength(p_strength);
		return p_strength;
	}
	...
	public function set_event_index(p_index:Int):Int {
		__inputeventaction_ptr().value.set_event_index(p_index);
		return p_index;
	}
