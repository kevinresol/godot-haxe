...
class VisualShaderNodeBillboard extends gd.VisualShaderNode {
	...
	public function set_billboard_type(p_billboard_type:gd.visualshadernodebillboard.BillboardType):gd.visualshadernodebillboard.BillboardType {
		__visualshadernodebillboard_ptr().value.set_billboard_type(((p_billboard_type : gd.visualshadernodebillboard.BillboardType)));
	...
	public function set_keep_scale_enabled(p_enabled:Bool):Void __visualshadernodebillboard_ptr().value.set_keep_scale_enabled(((p_enabled : Bool)));
	public function is_keep_scale_enabled():Bool return __visualshadernodebillboard_ptr().value.is_keep_scale_enabled();
	public var billboard_type(get, set) : gd.visualshadernodebillboard.BillboardType;
