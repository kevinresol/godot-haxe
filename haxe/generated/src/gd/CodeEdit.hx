...
class CodeEdit extends gd.TextEdit {
	...
	public function _confirm_code_completion(p_replace:Bool):Void __codeedit_ptr().value._confirm_code_completion(p_replace);
	public function _request_code_completion(p_force:Bool):Void __codeedit_ptr().value._request_code_completion(p_force);
	public function set_indent_size(p_size:Int):Int {
		__codeedit_ptr().value.set_indent_size(p_size);
		return p_size;
	}
	public function get_indent_size():Int return __codeedit_ptr().value.get_indent_size();
	public function set_indent_using_spaces(p_use_spaces:Bool):Void __codeedit_ptr().value.set_indent_using_spaces(p_use_spaces);
	public function is_indent_using_spaces():Bool return __codeedit_ptr().value.is_indent_using_spaces();
	public function set_auto_indent_enabled(p_enable:Bool):Void __codeedit_ptr().value.set_auto_indent_enabled(p_enable);
	...
	public function convert_indent(?p_from_line:Int = -1, ?p_to_line:Int = -1):Void __codeedit_ptr().value.convert_indent(p_from_line, p_to_line);
	public function set_auto_brace_completion_enabled(p_enable:Bool):Bool {
		__codeedit_ptr().value.set_auto_brace_completion_enabled(p_enable);
		return p_enable;
	}
	public function is_auto_brace_completion_enabled():Bool return __codeedit_ptr().value.is_auto_brace_completion_enabled();
	public function set_highlight_matching_braces_enabled(p_enable:Bool):Void __codeedit_ptr().value.set_highlight_matching_braces_enabled(p_enable);
	...
	public function add_auto_brace_completion_pair(p_start_key:std.String, p_end_key:std.String):Void __codeedit_ptr().value.add_auto_brace_completion_pair(p_start_key, p_end_key);
	public function set_auto_brace_completion_pairs(p_pairs:gd.Dictionary):gd.Dictionary {
		__codeedit_ptr().value.set_auto_brace_completion_pairs(p_pairs);
		return p_pairs;
	}
	...
	public function has_auto_brace_completion_open_key(p_open_key:std.String):Bool return __codeedit_ptr().value.has_auto_brace_completion_open_key(p_open_key);
	public function has_auto_brace_completion_close_key(p_close_key:std.String):Bool return __codeedit_ptr().value.has_auto_brace_completion_close_key(p_close_key);
	public function get_auto_brace_completion_close_key(p_open_key:std.String):std.String return __codeedit_ptr().value.get_auto_brace_completion_close_key(p_open_key);
	public function set_draw_breakpoints_gutter(p_enable:Bool):Void __codeedit_ptr().value.set_draw_breakpoints_gutter(p_enable);
	public function is_drawing_breakpoints_gutter():Bool return __codeedit_ptr().value.is_drawing_breakpoints_gutter();
	public function set_draw_bookmarks_gutter(p_enable:Bool):Void __codeedit_ptr().value.set_draw_bookmarks_gutter(p_enable);
	public function is_drawing_bookmarks_gutter():Bool return __codeedit_ptr().value.is_drawing_bookmarks_gutter();
	public function set_draw_executing_lines_gutter(p_enable:Bool):Void __codeedit_ptr().value.set_draw_executing_lines_gutter(p_enable);
	public function is_drawing_executing_lines_gutter():Bool return __codeedit_ptr().value.is_drawing_executing_lines_gutter();
	public function set_line_as_breakpoint(p_line:Int, p_breakpointed:Bool):Void __codeedit_ptr().value.set_line_as_breakpoint(p_line, p_breakpointed);
	public function is_line_breakpointed(p_line:Int):Bool return __codeedit_ptr().value.is_line_breakpointed(p_line);
	...
	public function set_line_as_bookmarked(p_line:Int, p_bookmarked:Bool):Void __codeedit_ptr().value.set_line_as_bookmarked(p_line, p_bookmarked);
	public function is_line_bookmarked(p_line:Int):Bool return __codeedit_ptr().value.is_line_bookmarked(p_line);
	...
	public function set_line_as_executing(p_line:Int, p_executing:Bool):Void __codeedit_ptr().value.set_line_as_executing(p_line, p_executing);
	public function is_line_executing(p_line:Int):Bool return __codeedit_ptr().value.is_line_executing(p_line);
	...
	public function set_draw_line_numbers(p_enable:Bool):Void __codeedit_ptr().value.set_draw_line_numbers(p_enable);
	public function is_draw_line_numbers_enabled():Bool return __codeedit_ptr().value.is_draw_line_numbers_enabled();
	public function set_line_numbers_zero_padded(p_enable:Bool):Void __codeedit_ptr().value.set_line_numbers_zero_padded(p_enable);
	public function is_line_numbers_zero_padded():Bool return __codeedit_ptr().value.is_line_numbers_zero_padded();
	public function set_draw_fold_gutter(p_enable:Bool):Void __codeedit_ptr().value.set_draw_fold_gutter(p_enable);
	public function is_drawing_fold_gutter():Bool return __codeedit_ptr().value.is_drawing_fold_gutter();
	public function set_line_folding_enabled(p_enabled:Bool):Void __codeedit_ptr().value.set_line_folding_enabled(p_enabled);
	public function is_line_folding_enabled():Bool return __codeedit_ptr().value.is_line_folding_enabled();
	public function can_fold_line(p_line:Int):Bool return __codeedit_ptr().value.can_fold_line(p_line);
	public function fold_line(p_line:Int):Void __codeedit_ptr().value.fold_line(p_line);
	public function unfold_line(p_line:Int):Void __codeedit_ptr().value.unfold_line(p_line);
	...
	public function toggle_foldable_line(p_line:Int):Void __codeedit_ptr().value.toggle_foldable_line(p_line);
	public function toggle_foldable_lines_at_carets():Void __codeedit_ptr().value.toggle_foldable_lines_at_carets();
	public function is_line_folded(p_line:Int):Bool return __codeedit_ptr().value.is_line_folded(p_line);
	...
	public function set_code_region_tags(?p_start:std.String = "\"region\"", ?p_end:std.String = "\"endregion\""):Void __codeedit_ptr().value.set_code_region_tags(p_start, p_end);
	public function is_line_code_region_start(p_line:Int):Bool return __codeedit_ptr().value.is_line_code_region_start(p_line);
	public function is_line_code_region_end(p_line:Int):Bool return __codeedit_ptr().value.is_line_code_region_end(p_line);
	public function add_string_delimiter(p_start_key:std.String, p_end_key:std.String, ?p_line_only:Bool = false):Void __codeedit_ptr().value.add_string_delimiter(p_start_key, p_end_key, p_line_only);
	public function remove_string_delimiter(p_start_key:std.String):Void __codeedit_ptr().value.remove_string_delimiter(p_start_key);
	public function has_string_delimiter(p_start_key:std.String):Bool return __codeedit_ptr().value.has_string_delimiter(p_start_key);
	public function clear_string_delimiters():Void __codeedit_ptr().value.clear_string_delimiters();
	public function is_in_string(p_line:Int, ?p_column:Int = -1):Int return __codeedit_ptr().value.is_in_string(p_line, p_column);
	public function add_comment_delimiter(p_start_key:std.String, p_end_key:std.String, ?p_line_only:Bool = false):Void __codeedit_ptr().value.add_comment_delimiter(p_start_key, p_end_key, p_line_only);
	public function remove_comment_delimiter(p_start_key:std.String):Void __codeedit_ptr().value.remove_comment_delimiter(p_start_key);
	public function has_comment_delimiter(p_start_key:std.String):Bool return __codeedit_ptr().value.has_comment_delimiter(p_start_key);
	public function clear_comment_delimiters():Void __codeedit_ptr().value.clear_comment_delimiters();
	public function is_in_comment(p_line:Int, ?p_column:Int = -1):Int return __codeedit_ptr().value.is_in_comment(p_line, p_column);
	public function get_delimiter_start_key(p_delimiter_index:Int):std.String return __codeedit_ptr().value.get_delimiter_start_key(p_delimiter_index);
	public function get_delimiter_end_key(p_delimiter_index:Int):std.String return __codeedit_ptr().value.get_delimiter_end_key(p_delimiter_index);
	public function get_delimiter_start_position(p_line:Int, p_column:Int):gd.Vector2 return __codeedit_ptr().value.get_delimiter_start_position(p_line, p_column);
	public function get_delimiter_end_position(p_line:Int, p_column:Int):gd.Vector2 return __codeedit_ptr().value.get_delimiter_end_position(p_line, p_column);
	public function set_code_hint(p_code_hint:std.String):Void __codeedit_ptr().value.set_code_hint(p_code_hint);
	public function set_code_hint_draw_below(p_draw_below:Bool):Void __codeedit_ptr().value.set_code_hint_draw_below(p_draw_below);
	public function get_text_for_code_completion():std.String return __codeedit_ptr().value.get_text_for_code_completion();
	public function request_code_completion(?p_force:Bool = false):Void __codeedit_ptr().value.request_code_completion(p_force);
	public function update_code_completion_options(p_force:Bool):Void __codeedit_ptr().value.update_code_completion_options(p_force);
	public function get_code_completion_option(p_index:Int):gd.Dictionary return __codeedit_ptr().value.get_code_completion_option(p_index);
	public function get_code_completion_selected_index():Int return __codeedit_ptr().value.get_code_completion_selected_index();
	public function set_code_completion_selected_index(p_index:Int):Void __codeedit_ptr().value.set_code_completion_selected_index(p_index);
	public function confirm_code_completion(?p_replace:Bool = false):Void __codeedit_ptr().value.confirm_code_completion(p_replace);
	...
	public function set_code_completion_enabled(p_enable:Bool):Bool {
		__codeedit_ptr().value.set_code_completion_enabled(p_enable);
		return p_enable;
	}
	public function is_code_completion_enabled():Bool return __codeedit_ptr().value.is_code_completion_enabled();
	public function set_symbol_lookup_on_click_enabled(p_enable:Bool):Void __codeedit_ptr().value.set_symbol_lookup_on_click_enabled(p_enable);
	...
	public function get_text_with_cursor_char(p_line:Int, p_column:Int):std.String return __codeedit_ptr().value.get_text_with_cursor_char(p_line, p_column);
	public function set_symbol_lookup_word_as_valid(p_valid:Bool):Void __codeedit_ptr().value.set_symbol_lookup_word_as_valid(p_valid);
