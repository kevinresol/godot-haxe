...
class PhysicsRayQueryParameters2D extends gd.RefCounted {
	...
	public function set_from(p_from:gd.Vector2):gd.Vector2 {
		__physicsrayqueryparameters2d_ptr().value.set_from(p_from);
		return p_from;
	}
	...
	public function set_to(p_to:gd.Vector2):gd.Vector2 {
		__physicsrayqueryparameters2d_ptr().value.set_to(p_to);
		return p_to;
	}
	...
	public function set_collision_mask(p_collision_mask:Int):Int {
		__physicsrayqueryparameters2d_ptr().value.set_collision_mask(p_collision_mask);
	...
	public function set_collide_with_bodies(p_enable:Bool):Bool {
		__physicsrayqueryparameters2d_ptr().value.set_collide_with_bodies(p_enable);
		return p_enable;
	}
	...
	public function set_collide_with_areas(p_enable:Bool):Bool {
		__physicsrayqueryparameters2d_ptr().value.set_collide_with_areas(p_enable);
		return p_enable;
	}
	...
	public function set_hit_from_inside(p_enable:Bool):Bool {
		__physicsrayqueryparameters2d_ptr().value.set_hit_from_inside(p_enable);
		return p_enable;
	}
