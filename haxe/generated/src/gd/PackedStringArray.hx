...
class PackedStringArray_wrapper {
	...
	public function duplicate():gd.PackedStringArray return {
	...
	public function erase(p_value:std.String):Bool return __gd.erase(((p_value : std.String)));
	...
	function __op_equal_to_packedstringarray(p_rhs:gd.PackedStringArray):Bool return @:privateAccess this.__gd.__op_equal_to_packedstringarray(((p_rhs : gdnative.PackedStringArray)));
	function __op_not_equal_packedstringarray(p_rhs:gd.PackedStringArray):Bool return @:privateAccess this.__gd.__op_not_equal_packedstringarray(((p_rhs : gdnative.PackedStringArray)));
	function __op_add_packedstringarray(p_rhs:gd.PackedStringArray):gd.PackedStringArray return @:privateAccess this.__gd.__op_add_packedstringarray(((p_rhs : gdnative.PackedStringArray)));
}
