...
class PackedStringArray_wrapper {
	...
	public function get(p_index:Int):std.String return __gd.get(((p_index : Int)));
	public function size():Int return __gd.size();
	public function is_empty():Bool return __gd.is_empty();
	public function set(p_index:Int, p_value:std.String):Void __gd.set(((p_index : Int)), ((p_value : std.String)));
	...
	public function insert(p_at_index:Int, p_value:std.String):Int return __gd.insert(((p_at_index : Int)), ((p_value : std.String)));
	...
	public function slice(p_begin:Int, ?p_end:Int):gd.PackedStringArray return switch [p_begin, p_end] {
	...
	public function bsearch(p_value:std.String, ?p_before:Bool):Int return switch [p_value, p_before] {
	...
	public function find(p_value:std.String, ?p_from:Int):Int return switch [p_value, p_from] {
		case [_, null]:__gd.find(((p_value : std.String)));
		default:__gd.find(((p_value : std.String)), ((p_from : Int)));
	};
	public function rfind(p_value:std.String, ?p_from:Int):Int return switch [p_value, p_from] {
		case [_, null]:__gd.rfind(((p_value : std.String)));
		default:__gd.rfind(((p_value : std.String)), ((p_from : Int)));
	};
	public function count(p_value:std.String):Int return __gd.count(((p_value : std.String)));
