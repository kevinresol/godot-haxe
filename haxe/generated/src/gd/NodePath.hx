...
class NodePath_wrapper {
	...
	public function get_name(p_idx:Int):std.String return __gd.get_name(((p_idx : Int)));
	public function get_subname_count():Int return __gd.get_subname_count();
	public function hash():Int return __gd.hash();
	public function get_subname(p_idx:Int):std.String return __gd.get_subname(((p_idx : Int)));
	...
	public function slice(p_begin:Int, ?p_end:Int):std.String return switch [p_begin, p_end] {
