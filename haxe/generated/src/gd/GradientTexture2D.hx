...
class GradientTexture2D extends gd.Texture2D {
	...
	public function set_gradient(p_gradient:gd.Gradient):gd.Gradient {
		__gradienttexture2d_ptr().value.set_gradient(p_gradient);
		return p_gradient;
	}
	public function get_gradient():gd.Gradient return __gradienttexture2d_ptr().value.get_gradient();
	public function set_width(p_width:Int):Void __gradienttexture2d_ptr().value.set_width(p_width);
	public function set_height(p_height:Int):Void __gradienttexture2d_ptr().value.set_height(p_height);
	public function set_use_hdr(p_enabled:Bool):Bool {
		__gradienttexture2d_ptr().value.set_use_hdr(p_enabled);
		return p_enabled;
	}
	...
	public function set_fill(p_fill:gd.gradienttexture2d.Fill):gd.gradienttexture2d.Fill {
		__gradienttexture2d_ptr().value.set_fill(p_fill);
		return p_fill;
	}
	...
	public function set_fill_from(p_fill_from:gd.Vector2):gd.Vector2 {
		__gradienttexture2d_ptr().value.set_fill_from(p_fill_from);
		return p_fill_from;
	}
	...
	public function set_fill_to(p_fill_to:gd.Vector2):gd.Vector2 {
		__gradienttexture2d_ptr().value.set_fill_to(p_fill_to);
		return p_fill_to;
	}
	...
	public function set_repeat(p_repeat:gd.gradienttexture2d.Repeat):gd.gradienttexture2d.Repeat {
		__gradienttexture2d_ptr().value.set_repeat(p_repeat);
		return p_repeat;
	}
