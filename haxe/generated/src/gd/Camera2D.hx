...
class Camera2D extends gd.Node2D {
	...
	public function set_offset(p_offset:gd.Vector2):gd.Vector2 {
		__camera2d_ptr().value.set_offset(p_offset);
		return p_offset;
	}
	...
	public function set_anchor_mode(p_anchor_mode:gd.camera2d.AnchorMode):gd.camera2d.AnchorMode {
		__camera2d_ptr().value.set_anchor_mode(p_anchor_mode);
	...
	public function set_ignore_rotation(p_ignore:Bool):Bool {
		__camera2d_ptr().value.set_ignore_rotation(p_ignore);
		return p_ignore;
	}
	...
	public function set_process_callback(p_mode:gd.camera2d.Camera2DProcessCallback):gd.camera2d.Camera2DProcessCallback {
		__camera2d_ptr().value.set_process_callback(p_mode);
		return p_mode;
	}
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__camera2d_ptr().value.set_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_limit(p_margin:gd.Side, p_limit:Int):Void __camera2d_ptr().value.set_limit(p_margin, p_limit);
	public function get_limit(p_margin:gd.Side):Int return __camera2d_ptr().value.get_limit(p_margin);
	public function set_limit_smoothing_enabled(p_limit_smoothing_enabled:Bool):Void __camera2d_ptr().value.set_limit_smoothing_enabled(p_limit_smoothing_enabled);
	...
	public function set_drag_vertical_enabled(p_enabled:Bool):Bool {
		__camera2d_ptr().value.set_drag_vertical_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_drag_horizontal_enabled(p_enabled:Bool):Bool {
		__camera2d_ptr().value.set_drag_horizontal_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_drag_vertical_offset(p_offset:Float):Float {
		__camera2d_ptr().value.set_drag_vertical_offset(p_offset);
		return p_offset;
	}
	...
	public function set_drag_horizontal_offset(p_offset:Float):Float {
		__camera2d_ptr().value.set_drag_horizontal_offset(p_offset);
		return p_offset;
	}
	public function get_drag_horizontal_offset():Float return __camera2d_ptr().value.get_drag_horizontal_offset();
	public function set_drag_margin(p_margin:gd.Side, p_drag_margin:Float):Void __camera2d_ptr().value.set_drag_margin(p_margin, p_drag_margin);
	public function get_drag_margin(p_margin:gd.Side):Float return __camera2d_ptr().value.get_drag_margin(p_margin);
	...
	public function set_zoom(p_zoom:gd.Vector2):gd.Vector2 {
		__camera2d_ptr().value.set_zoom(p_zoom);
		return p_zoom;
	}
	...
	public function set_custom_viewport(p_viewport:gd.Node):gd.Node {
		__camera2d_ptr().value.set_custom_viewport(p_viewport);
		return p_viewport;
	}
	...
	public function set_position_smoothing_speed(p_position_smoothing_speed:Float):Float {
		__camera2d_ptr().value.set_position_smoothing_speed(p_position_smoothing_speed);
	...
	public function set_position_smoothing_enabled(p_position_smoothing_speed:Bool):Bool {
		__camera2d_ptr().value.set_position_smoothing_enabled(p_position_smoothing_speed);
		return p_position_smoothing_speed;
	}
	...
	public function set_rotation_smoothing_enabled(p_enabled:Bool):Bool {
		__camera2d_ptr().value.set_rotation_smoothing_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_rotation_smoothing_speed(p_speed:Float):Float {
		__camera2d_ptr().value.set_rotation_smoothing_speed(p_speed);
		return p_speed;
	}
	...
	public function set_screen_drawing_enabled(p_screen_drawing_enabled:Bool):Void __camera2d_ptr().value.set_screen_drawing_enabled(p_screen_drawing_enabled);
	public function is_screen_drawing_enabled():Bool return __camera2d_ptr().value.is_screen_drawing_enabled();
	public function set_limit_drawing_enabled(p_limit_drawing_enabled:Bool):Void __camera2d_ptr().value.set_limit_drawing_enabled(p_limit_drawing_enabled);
	public function is_limit_drawing_enabled():Bool return __camera2d_ptr().value.is_limit_drawing_enabled();
	public function set_margin_drawing_enabled(p_margin_drawing_enabled:Bool):Void __camera2d_ptr().value.set_margin_drawing_enabled(p_margin_drawing_enabled);
