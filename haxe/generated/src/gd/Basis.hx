...
class Basis_wrapper {
	...
	function set_x(v:gd.Vector3):gd.Vector3 return __gd.x = v;
	public var y(get, set) : gd.Vector3;
	function get_y():gd.Vector3 return __gd.y;
	function set_y(v:gd.Vector3):gd.Vector3 return __gd.y = v;
	public var z(get, set) : gd.Vector3;
	function get_z():gd.Vector3 return __gd.z;
	function set_z(v:gd.Vector3):gd.Vector3 return __gd.z = v;
