...
class SubViewportContainer extends gd.Container {
	...
	public function _propagate_input_event(p_event:gd.InputEvent):Bool return __subviewportcontainer_ptr().value._propagate_input_event(p_event);
	public function set_stretch(p_enable:Bool):Bool {
		__subviewportcontainer_ptr().value.set_stretch(p_enable);
		return p_enable;
	}
	...
	public function set_stretch_shrink(p_amount:Int):Int {
		__subviewportcontainer_ptr().value.set_stretch_shrink(p_amount);
		return p_amount;
	}
