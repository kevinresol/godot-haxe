...
class LightmapGI extends gd.VisualInstance3D {
	...
	public function set_light_data(p_data:gd.LightmapGIData):gd.LightmapGIData {
		__lightmapgi_ptr().value.set_light_data(((p_data : gd.LightmapGIData)));
		return p_data;
	}
	public function get_light_data():gd.LightmapGIData return __lightmapgi_ptr().value.get_light_data();
	public function set_bake_quality(p_bake_quality:gd.lightmapgi.BakeQuality):Void __lightmapgi_ptr().value.set_bake_quality(((p_bake_quality : gd.lightmapgi.BakeQuality)));
	...
	public function set_bounces(p_bounces:Int):Int {
		__lightmapgi_ptr().value.set_bounces(((p_bounces : Int)));
		return p_bounces;
	}
	...
	public function set_bounce_indirect_energy(p_bounce_indirect_energy:Float):Float {
		__lightmapgi_ptr().value.set_bounce_indirect_energy(((p_bounce_indirect_energy : Float)));
	...
	public function set_generate_probes(p_subdivision:gd.lightmapgi.GenerateProbes):Void __lightmapgi_ptr().value.set_generate_probes(((p_subdivision : gd.lightmapgi.GenerateProbes)));
	...
	public function set_bias(p_bias:Float):Float {
		__lightmapgi_ptr().value.set_bias(((p_bias : Float)));
		return p_bias;
	}
	...
	public function set_environment_mode(p_mode:gd.lightmapgi.EnvironmentMode):gd.lightmapgi.EnvironmentMode {
		__lightmapgi_ptr().value.set_environment_mode(((p_mode : gd.lightmapgi.EnvironmentMode)));
		return p_mode;
	}
	...
	public function set_environment_custom_sky(p_sky:gd.Sky):gd.Sky {
		__lightmapgi_ptr().value.set_environment_custom_sky(((p_sky : gd.Sky)));
		return p_sky;
	}
	...
	public function set_environment_custom_color(p_color:gd.Color):gd.Color {
		__lightmapgi_ptr().value.set_environment_custom_color(((p_color : gd.Color)));
		return p_color;
	}
	...
	public function set_environment_custom_energy(p_energy:Float):Float {
		__lightmapgi_ptr().value.set_environment_custom_energy(((p_energy : Float)));
		return p_energy;
	}
	...
	public function set_texel_scale(p_texel_scale:Float):Float {
		__lightmapgi_ptr().value.set_texel_scale(((p_texel_scale : Float)));
	...
	public function set_max_texture_size(p_max_texture_size:Int):Int {
		__lightmapgi_ptr().value.set_max_texture_size(((p_max_texture_size : Int)));
	...
	public function set_use_denoiser(p_use_denoiser:Bool):Bool {
		__lightmapgi_ptr().value.set_use_denoiser(((p_use_denoiser : Bool)));
	...
	public function set_denoiser_strength(p_denoiser_strength:Float):Float {
		__lightmapgi_ptr().value.set_denoiser_strength(((p_denoiser_strength : Float)));
	...
	public function set_denoiser_range(p_denoiser_range:Int):Int {
		__lightmapgi_ptr().value.set_denoiser_range(((p_denoiser_range : Int)));
	...
	public function set_interior(p_enable:Bool):Bool {
		__lightmapgi_ptr().value.set_interior(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_directional(p_directional:Bool):Bool {
		__lightmapgi_ptr().value.set_directional(((p_directional : Bool)));
	...
	public function set_use_texture_for_bounces(p_use_texture_for_bounces:Bool):Bool {
		__lightmapgi_ptr().value.set_use_texture_for_bounces(((p_use_texture_for_bounces : Bool)));
	...
	public function set_camera_attributes(p_camera_attributes:gd.CameraAttributes):gd.CameraAttributes {
		__lightmapgi_ptr().value.set_camera_attributes(((p_camera_attributes : gd.CameraAttributes)));
