...
class MethodTweener extends gd.Tweener {
	...
	public function set_delay(p_delay:Float):gd.MethodTweener return __methodtweener_ptr().value.set_delay(p_delay);
	public function set_trans(p_trans:gd.tween.TransitionType):gd.MethodTweener return __methodtweener_ptr().value.set_trans(p_trans);
	public function set_ease(p_ease:gd.tween.EaseType):gd.MethodTweener return __methodtweener_ptr().value.set_ease(p_ease);
}