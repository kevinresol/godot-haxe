...
class SystemFont extends gd.Font {
	...
	public function set_antialiasing(p_antialiasing:gd.textserver.FontAntialiasing):gd.textserver.FontAntialiasing {
		__systemfont_ptr().value.set_antialiasing(p_antialiasing);
	...
	public function set_disable_embedded_bitmaps(p_disable_embedded_bitmaps:Bool):Bool {
		__systemfont_ptr().value.set_disable_embedded_bitmaps(p_disable_embedded_bitmaps);
	...
	public function set_generate_mipmaps(p_generate_mipmaps:Bool):Bool {
		__systemfont_ptr().value.set_generate_mipmaps(p_generate_mipmaps);
	...
	public function set_allow_system_fallback(p_allow_system_fallback:Bool):Bool {
		__systemfont_ptr().value.set_allow_system_fallback(p_allow_system_fallback);
	...
	public function set_force_autohinter(p_force_autohinter:Bool):Bool {
		__systemfont_ptr().value.set_force_autohinter(p_force_autohinter);
	...
	public function set_hinting(p_hinting:gd.textserver.Hinting):gd.textserver.Hinting {
		__systemfont_ptr().value.set_hinting(p_hinting);
		return p_hinting;
	}
	...
	public function set_subpixel_positioning(p_subpixel_positioning:gd.textserver.SubpixelPositioning):gd.textserver.SubpixelPositioning {
		__systemfont_ptr().value.set_subpixel_positioning(p_subpixel_positioning);
	...
	public function set_multichannel_signed_distance_field(p_msdf:Bool):Bool {
		__systemfont_ptr().value.set_multichannel_signed_distance_field(p_msdf);
		return p_msdf;
	}
	...
	public function set_msdf_pixel_range(p_msdf_pixel_range:Int):Int {
		__systemfont_ptr().value.set_msdf_pixel_range(p_msdf_pixel_range);
	...
	public function set_msdf_size(p_msdf_size:Int):Int {
		__systemfont_ptr().value.set_msdf_size(p_msdf_size);
		return p_msdf_size;
	}
	...
	public function set_oversampling(p_oversampling:Float):Float {
		__systemfont_ptr().value.set_oversampling(p_oversampling);
	...
	public function set_font_names(p_names:gd.PackedStringArray):gd.PackedStringArray {
		__systemfont_ptr().value.set_font_names(p_names);
		return p_names;
	}
	...
	public function set_font_italic(p_italic:Bool):Bool {
		__systemfont_ptr().value.set_font_italic(p_italic);
		return p_italic;
	}
	public function set_font_weight(p_weight:Int):Void __systemfont_ptr().value.set_font_weight(p_weight);
	public function set_font_stretch(p_stretch:Int):Void __systemfont_ptr().value.set_font_stretch(p_stretch);
