...
enum abstract SpaceParameter(Int) from Int to Int {
	...
	@:to
	extern inline function toNative():gdnative.physicsserver3d.SpaceParameter return untyped __cpp__("static_cast<godot::PhysicsServer3D::SpaceParameter>({0})", this);
	@:from
	extern static inline function fromNative(v:gdnative.physicsserver3d.SpaceParameter):SpaceParameter return untyped __cpp__("static_cast<int32_t>({0})", v);
