...
enum abstract G6DOFJointAxisParam(Int) from Int to Int {
	@:op(A | B)
	extern static inline function or(a:G6DOFJointAxisParam, b:G6DOFJointAxisParam):G6DOFJointAxisParam {
		return untyped __cpp__('({0}) | ({1})', a, b);
	}
	@:to
	extern inline function toNative():gdnative.physicsserver3d.G6DOFJointAxisParam return untyped __cpp__("static_cast<godot::PhysicsServer3D::G6DOFJointAxisParam>({0})", this);
	@:from
	extern static inline function fromNative(v:gdnative.physicsserver3d.G6DOFJointAxisParam):G6DOFJointAxisParam return untyped __cpp__("static_cast<int32_t>({0})", v);
