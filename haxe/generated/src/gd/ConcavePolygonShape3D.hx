...
class ConcavePolygonShape3D extends gd.Shape3D {
	...
	public function set_faces(p_faces:gd.PackedVector3Array):Void __concavepolygonshape3d_ptr().value.set_faces(p_faces);
	public function get_faces():gd.PackedVector3Array return __concavepolygonshape3d_ptr().value.get_faces();
	public function set_backface_collision_enabled(p_enabled:Bool):Void __concavepolygonshape3d_ptr().value.set_backface_collision_enabled(p_enabled);
