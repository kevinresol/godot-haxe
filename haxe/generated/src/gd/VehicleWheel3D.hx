...
class VehicleWheel3D extends gd.Node3D {
	...
	public function set_radius(p_length:Float):Void __vehiclewheel3d_ptr().value.set_radius(p_length);
	public function get_radius():Float return __vehiclewheel3d_ptr().value.get_radius();
	public function set_suspension_rest_length(p_length:Float):Void __vehiclewheel3d_ptr().value.set_suspension_rest_length(p_length);
	...
	public function set_suspension_travel(p_length:Float):Float {
		__vehiclewheel3d_ptr().value.set_suspension_travel(p_length);
		return p_length;
	}
	...
	public function set_suspension_stiffness(p_length:Float):Float {
		__vehiclewheel3d_ptr().value.set_suspension_stiffness(p_length);
		return p_length;
	}
	...
	public function set_suspension_max_force(p_length:Float):Float {
		__vehiclewheel3d_ptr().value.set_suspension_max_force(p_length);
		return p_length;
	}
	...
	public function set_damping_compression(p_length:Float):Float {
		__vehiclewheel3d_ptr().value.set_damping_compression(p_length);
		return p_length;
	}
	...
	public function set_damping_relaxation(p_length:Float):Float {
		__vehiclewheel3d_ptr().value.set_damping_relaxation(p_length);
		return p_length;
	}
	...
	public function set_use_as_traction(p_enable:Bool):Bool {
		__vehiclewheel3d_ptr().value.set_use_as_traction(p_enable);
		return p_enable;
	}
	...
	public function set_use_as_steering(p_enable:Bool):Bool {
		__vehiclewheel3d_ptr().value.set_use_as_steering(p_enable);
		return p_enable;
	}
	public function is_used_as_steering():Bool return __vehiclewheel3d_ptr().value.is_used_as_steering();
	public function set_friction_slip(p_length:Float):Void __vehiclewheel3d_ptr().value.set_friction_slip(p_length);
	...
	public function set_roll_influence(p_roll_influence:Float):Void __vehiclewheel3d_ptr().value.set_roll_influence(p_roll_influence);
	...
	public function set_engine_force(p_engine_force:Float):Float {
		__vehiclewheel3d_ptr().value.set_engine_force(p_engine_force);
	...
	public function set_brake(p_brake:Float):Float {
		__vehiclewheel3d_ptr().value.set_brake(p_brake);
		return p_brake;
	}
	...
	public function set_steering(p_steering:Float):Float {
		__vehiclewheel3d_ptr().value.set_steering(p_steering);
		return p_steering;
	}
