...
class AcceptDialog extends gd.Window {
	...
	public function set_hide_on_ok(p_enabled:Bool):Void __acceptdialog_ptr().value.set_hide_on_ok(p_enabled);
	public function get_hide_on_ok():Bool return __acceptdialog_ptr().value.get_hide_on_ok();
	public function set_close_on_escape(p_enabled:Bool):Void __acceptdialog_ptr().value.set_close_on_escape(p_enabled);
	public function get_close_on_escape():Bool return __acceptdialog_ptr().value.get_close_on_escape();
	public function add_button(p_text:std.String, ?p_right:Bool = false, ?p_action:std.String = "\"\""):gd.Button return __acceptdialog_ptr().value.add_button(p_text, p_right, p_action);
	public function add_cancel_button(p_name:std.String):gd.Button return __acceptdialog_ptr().value.add_cancel_button(p_name);
	public function remove_button(p_button:gd.Button):Void __acceptdialog_ptr().value.remove_button(p_button);
	public function register_text_enter(p_line_edit:gd.LineEdit):Void __acceptdialog_ptr().value.register_text_enter(p_line_edit);
	public function set_text(p_text:std.String):Void __acceptdialog_ptr().value.set_text(p_text);
	public function get_text():std.String return __acceptdialog_ptr().value.get_text();
	public function set_autowrap(p_autowrap:Bool):Void __acceptdialog_ptr().value.set_autowrap(p_autowrap);
	...
	public function set_ok_button_text(p_text:std.String):std.String {
		__acceptdialog_ptr().value.set_ok_button_text(p_text);
		return p_text;
	}
