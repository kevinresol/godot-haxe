...
class GLTFBufferView extends gd.Resource {
	...
	public function load_buffer_view_data(p_state:gd.GLTFState):gd.PackedByteArray return __gltfbufferview_ptr().value.load_buffer_view_data(p_state);
	public function get_buffer():Int return __gltfbufferview_ptr().value.get_buffer();
	public function set_buffer(p_buffer:Int):Int {
		__gltfbufferview_ptr().value.set_buffer(p_buffer);
		return p_buffer;
	}
	...
	public function set_byte_offset(p_byte_offset:Int):Int {
		__gltfbufferview_ptr().value.set_byte_offset(p_byte_offset);
	...
	public function set_byte_length(p_byte_length:Int):Int {
		__gltfbufferview_ptr().value.set_byte_length(p_byte_length);
	...
	public function set_byte_stride(p_byte_stride:Int):Int {
		__gltfbufferview_ptr().value.set_byte_stride(p_byte_stride);
	...
	public function set_indices(p_indices:Bool):Bool {
		__gltfbufferview_ptr().value.set_indices(p_indices);
		return p_indices;
	}
	...
	public function set_vertex_attributes(p_is_attributes:Bool):Bool {
		__gltfbufferview_ptr().value.set_vertex_attributes(p_is_attributes);
