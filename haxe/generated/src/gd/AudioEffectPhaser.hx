...
class AudioEffectPhaser extends gd.AudioEffect {
	...
	public function set_range_min_hz(p_hz:Float):Float {
		__audioeffectphaser_ptr().value.set_range_min_hz(p_hz);
		return p_hz;
	}
	...
	public function set_range_max_hz(p_hz:Float):Float {
		__audioeffectphaser_ptr().value.set_range_max_hz(p_hz);
		return p_hz;
	}
	...
	public function set_rate_hz(p_hz:Float):Float {
		__audioeffectphaser_ptr().value.set_rate_hz(p_hz);
		return p_hz;
	}
	...
	public function set_feedback(p_fbk:Float):Float {
		__audioeffectphaser_ptr().value.set_feedback(p_fbk);
		return p_fbk;
	}
	...
	public function set_depth(p_depth:Float):Float {
		__audioeffectphaser_ptr().value.set_depth(p_depth);
		return p_depth;
	}
