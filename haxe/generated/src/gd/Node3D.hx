...
class Node3D extends gd.Node {
	...
	public function set_position(p_position:gd.Vector3):gd.Vector3 {
		__node3d_ptr().value.set_position(p_position);
		return p_position;
	}
	...
	public function set_rotation(p_euler_radians:gd.Vector3):gd.Vector3 {
		__node3d_ptr().value.set_rotation(p_euler_radians);
	...
	public function set_rotation_degrees(p_euler_degrees:gd.Vector3):gd.Vector3 {
		__node3d_ptr().value.set_rotation_degrees(p_euler_degrees);
	...
	public function set_rotation_order(p_order:gd.EulerOrder):gd.EulerOrder {
		__node3d_ptr().value.set_rotation_order(p_order);
		return p_order;
	}
	...
	public function set_rotation_edit_mode(p_edit_mode:gd.node3d.RotationEditMode):gd.node3d.RotationEditMode {
		__node3d_ptr().value.set_rotation_edit_mode(p_edit_mode);
		return p_edit_mode;
	}
	...
	public function set_scale(p_scale:gd.Vector3):gd.Vector3 {
		__node3d_ptr().value.set_scale(p_scale);
		return p_scale;
	}
	...
	public function set_quaternion(p_quaternion:gd.Quaternion):gd.Quaternion {
		__node3d_ptr().value.set_quaternion(p_quaternion);
		return p_quaternion;
	}
	...
	public function set_global_position(p_position:gd.Vector3):gd.Vector3 {
		__node3d_ptr().value.set_global_position(p_position);
		return p_position;
	}
	...
	public function set_global_rotation(p_euler_radians:gd.Vector3):gd.Vector3 {
		__node3d_ptr().value.set_global_rotation(p_euler_radians);
		return p_euler_radians;
	}
	...
	public function set_global_rotation_degrees(p_euler_degrees:gd.Vector3):gd.Vector3 {
		__node3d_ptr().value.set_global_rotation_degrees(p_euler_degrees);
		return p_euler_degrees;
	}
	...
	public function set_ignore_transform_notification(p_enabled:Bool):Void __node3d_ptr().value.set_ignore_transform_notification(p_enabled);
	public function set_as_top_level(p_enable:Bool):Void __node3d_ptr().value.set_as_top_level(p_enable);
	public function is_set_as_top_level():Bool return __node3d_ptr().value.is_set_as_top_level();
	public function set_disable_scale(p_disable:Bool):Void __node3d_ptr().value.set_disable_scale(p_disable);
	...
	public function set_visibility_parent(p_path:std.String):std.String {
		__node3d_ptr().value.set_visibility_parent(p_path);
		return p_path;
	}
	...
	public function add_gizmo(p_gizmo:gd.Node3DGizmo):Void __node3d_ptr().value.add_gizmo(p_gizmo);
	...
	public function set_visible(p_visible:Bool):Bool {
		__node3d_ptr().value.set_visible(p_visible);
		return p_visible;
	}
	...
	public function set_notify_local_transform(p_enable:Bool):Void __node3d_ptr().value.set_notify_local_transform(p_enable);
	...
	public function set_notify_transform(p_enable:Bool):Void __node3d_ptr().value.set_notify_transform(p_enable);
	public function is_transform_notification_enabled():Bool return __node3d_ptr().value.is_transform_notification_enabled();
	public function rotate(p_axis:gd.Vector3, p_angle:Float):Void __node3d_ptr().value.rotate(p_axis, p_angle);
	public function global_rotate(p_axis:gd.Vector3, p_angle:Float):Void __node3d_ptr().value.global_rotate(p_axis, p_angle);
	public function global_scale(p_scale:gd.Vector3):Void __node3d_ptr().value.global_scale(p_scale);
	public function global_translate(p_offset:gd.Vector3):Void __node3d_ptr().value.global_translate(p_offset);
	public function rotate_object_local(p_axis:gd.Vector3, p_angle:Float):Void __node3d_ptr().value.rotate_object_local(p_axis, p_angle);
	public function scale_object_local(p_scale:gd.Vector3):Void __node3d_ptr().value.scale_object_local(p_scale);
	public function translate_object_local(p_offset:gd.Vector3):Void __node3d_ptr().value.translate_object_local(p_offset);
	public function rotate_x(p_angle:Float):Void __node3d_ptr().value.rotate_x(p_angle);
	public function rotate_y(p_angle:Float):Void __node3d_ptr().value.rotate_y(p_angle);
	public function rotate_z(p_angle:Float):Void __node3d_ptr().value.rotate_z(p_angle);
	public function translate(p_offset:gd.Vector3):Void __node3d_ptr().value.translate(p_offset);
	...
	public function to_local(p_global_point:gd.Vector3):gd.Vector3 return __node3d_ptr().value.to_local(p_global_point);
	public function to_global(p_local_point:gd.Vector3):gd.Vector3 return __node3d_ptr().value.to_global(p_local_point);
