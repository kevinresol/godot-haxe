...
class Rect2_wrapper {
	...
	public var position(get, set) : gdnative.Vector2;
	function get_position():gdnative.Vector2 return __gd.position;
	function set_position(v:gdnative.Vector2):gdnative.Vector2 return __gd.position = v;
	public var size(get, set) : gdnative.Vector2;
	function get_size():gdnative.Vector2 return __gd.size;
	function set_size(v:gdnative.Vector2):gdnative.Vector2 return __gd.size = v;
}
