...
class Vector4_wrapper {
	...
	function __op_not_equal_vector4(p_rhs:gd.Vector4):Bool return this.__gd != ((p_rhs : gdnative.Vector4));
	function __op_less_than_vector4(p_rhs:gd.Vector4):Bool return this.__gd < ((p_rhs : gdnative.Vector4));
	function __op_less_equal_vector4(p_rhs:gd.Vector4):Bool return this.__gd <= ((p_rhs : gdnative.Vector4));
	function __op_greater_than_vector4(p_rhs:gd.Vector4):Bool return this.__gd > ((p_rhs : gdnative.Vector4));
	function __op_greater_equal_vector4(p_rhs:gd.Vector4):Bool return this.__gd >= ((p_rhs : gdnative.Vector4));
	function __op_add_vector4(p_rhs:gd.Vector4):gd.Vector4 return this.__gd + ((p_rhs : gdnative.Vector4));
	function __op_subtract_vector4(p_rhs:gd.Vector4):gd.Vector4 return this.__gd - ((p_rhs : gdnative.Vector4));
	function __op_multiply_vector4(p_rhs:gd.Vector4):gd.Vector4 return this.__gd * ((p_rhs : gdnative.Vector4));
	function __op_divide_vector4(p_rhs:gd.Vector4):gd.Vector4 return this.__gd / ((p_rhs : gdnative.Vector4));
	...
	function __op_membership_in_packedvector4array(p_rhs:gd.PackedVector4Array):Bool return this.__gd in ((p_rhs : gdnative.PackedVector4Array));
