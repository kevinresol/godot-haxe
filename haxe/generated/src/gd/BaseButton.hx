...
class BaseButton extends gd.Control {
	...
	public function _toggled(p_toggled_on:Bool):Void __basebutton_ptr().value._toggled(p_toggled_on);
	public function set_pressed(p_pressed:Bool):Void __basebutton_ptr().value.set_pressed(p_pressed);
	public function is_pressed():Bool return __basebutton_ptr().value.is_pressed();
	public function set_pressed_no_signal(p_pressed:Bool):Void __basebutton_ptr().value.set_pressed_no_signal(p_pressed);
	...
	public function set_toggle_mode(p_enabled:Bool):Bool {
		__basebutton_ptr().value.set_toggle_mode(p_enabled);
		return p_enabled;
	}
	...
	public function set_shortcut_in_tooltip(p_enabled:Bool):Bool {
		__basebutton_ptr().value.set_shortcut_in_tooltip(p_enabled);
		return p_enabled;
	}
	...
	public function set_disabled(p_disabled:Bool):Bool {
		__basebutton_ptr().value.set_disabled(p_disabled);
		return p_disabled;
	}
	...
	public function set_action_mode(p_mode:gd.basebutton.ActionMode):gd.basebutton.ActionMode {
		__basebutton_ptr().value.set_action_mode(p_mode);
		return p_mode;
	}
	...
	public function set_button_mask(p_mask:Int):Int {
		__basebutton_ptr().value.set_button_mask(p_mask);
		return p_mask;
	}
	...
	public function set_keep_pressed_outside(p_enabled:Bool):Bool {
		__basebutton_ptr().value.set_keep_pressed_outside(p_enabled);
		return p_enabled;
	}
	...
	public function set_shortcut_feedback(p_enabled:Bool):Bool {
		__basebutton_ptr().value.set_shortcut_feedback(p_enabled);
		return p_enabled;
	}
	...
	public function set_shortcut(p_shortcut:gd.Shortcut):gd.Shortcut {
		__basebutton_ptr().value.set_shortcut(p_shortcut);
		return p_shortcut;
	}
	...
	public function set_button_group(p_button_group:gd.ButtonGroup):gd.ButtonGroup {
		__basebutton_ptr().value.set_button_group(p_button_group);
