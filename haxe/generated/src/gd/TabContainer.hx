...
class TabContainer extends gd.Container {
	...
	public function set_current_tab(p_tab_idx:Int):Int {
		__tabcontainer_ptr().value.set_current_tab(p_tab_idx);
		return p_tab_idx;
	}
	...
	public function get_tab_control(p_tab_idx:Int):gd.Control return __tabcontainer_ptr().value.get_tab_control(p_tab_idx);
	public function set_tab_alignment(p_alignment:gd.tabbar.AlignmentMode):gd.tabbar.AlignmentMode {
		__tabcontainer_ptr().value.set_tab_alignment(p_alignment);
		return p_alignment;
	}
	...
	public function set_tabs_position(p_tabs_position:gd.tabcontainer.TabPosition):gd.tabcontainer.TabPosition {
		__tabcontainer_ptr().value.set_tabs_position(p_tabs_position);
	...
	public function set_clip_tabs(p_clip_tabs:Bool):Bool {
		__tabcontainer_ptr().value.set_clip_tabs(p_clip_tabs);
		return p_clip_tabs;
	}
	...
	public function set_tabs_visible(p_visible:Bool):Bool {
		__tabcontainer_ptr().value.set_tabs_visible(p_visible);
		return p_visible;
	}
	...
	public function set_all_tabs_in_front(p_is_front:Bool):Bool {
		__tabcontainer_ptr().value.set_all_tabs_in_front(p_is_front);
		return p_is_front;
	}
	public function is_all_tabs_in_front():Bool return __tabcontainer_ptr().value.is_all_tabs_in_front();
	public function set_tab_title(p_tab_idx:Int, p_title:std.String):Void __tabcontainer_ptr().value.set_tab_title(p_tab_idx, p_title);
	public function get_tab_title(p_tab_idx:Int):std.String return __tabcontainer_ptr().value.get_tab_title(p_tab_idx);
	public function set_tab_tooltip(p_tab_idx:Int, p_tooltip:std.String):Void __tabcontainer_ptr().value.set_tab_tooltip(p_tab_idx, p_tooltip);
	public function get_tab_tooltip(p_tab_idx:Int):std.String return __tabcontainer_ptr().value.get_tab_tooltip(p_tab_idx);
	public function set_tab_icon(p_tab_idx:Int, p_icon:gd.Texture2D):Void __tabcontainer_ptr().value.set_tab_icon(p_tab_idx, p_icon);
	public function get_tab_icon(p_tab_idx:Int):gd.Texture2D return __tabcontainer_ptr().value.get_tab_icon(p_tab_idx);
	public function set_tab_icon_max_width(p_tab_idx:Int, p_width:Int):Void __tabcontainer_ptr().value.set_tab_icon_max_width(p_tab_idx, p_width);
	public function get_tab_icon_max_width(p_tab_idx:Int):Int return __tabcontainer_ptr().value.get_tab_icon_max_width(p_tab_idx);
	public function set_tab_disabled(p_tab_idx:Int, p_disabled:Bool):Void __tabcontainer_ptr().value.set_tab_disabled(p_tab_idx, p_disabled);
	public function is_tab_disabled(p_tab_idx:Int):Bool return __tabcontainer_ptr().value.is_tab_disabled(p_tab_idx);
	public function set_tab_hidden(p_tab_idx:Int, p_hidden:Bool):Void __tabcontainer_ptr().value.set_tab_hidden(p_tab_idx, p_hidden);
	public function is_tab_hidden(p_tab_idx:Int):Bool return __tabcontainer_ptr().value.is_tab_hidden(p_tab_idx);
	public function set_tab_metadata(p_tab_idx:Int, p_metadata:gd.Variant):Void __tabcontainer_ptr().value.set_tab_metadata(p_tab_idx, p_metadata);
	public function get_tab_metadata(p_tab_idx:Int):gd.Variant return __tabcontainer_ptr().value.get_tab_metadata(p_tab_idx);
	public function set_tab_button_icon(p_tab_idx:Int, p_icon:gd.Texture2D):Void __tabcontainer_ptr().value.set_tab_button_icon(p_tab_idx, p_icon);
	public function get_tab_button_icon(p_tab_idx:Int):gd.Texture2D return __tabcontainer_ptr().value.get_tab_button_icon(p_tab_idx);
	public function get_tab_idx_at_point(p_point:gd.Vector2):Int return __tabcontainer_ptr().value.get_tab_idx_at_point(p_point);
	public function get_tab_idx_from_control(p_control:gd.Control):Int return __tabcontainer_ptr().value.get_tab_idx_from_control(p_control);
	public function set_popup(p_popup:gd.Node):Void __tabcontainer_ptr().value.set_popup(p_popup);
	...
	public function set_drag_to_rearrange_enabled(p_enabled:Bool):Bool {
		__tabcontainer_ptr().value.set_drag_to_rearrange_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_tabs_rearrange_group(p_group_id:Int):Int {
		__tabcontainer_ptr().value.set_tabs_rearrange_group(p_group_id);
		return p_group_id;
	}
	...
	public function set_use_hidden_tabs_for_min_size(p_enabled:Bool):Bool {
		__tabcontainer_ptr().value.set_use_hidden_tabs_for_min_size(p_enabled);
		return p_enabled;
	}
	...
	public function set_tab_focus_mode(p_focus_mode:gd.control.FocusMode):gd.control.FocusMode {
		__tabcontainer_ptr().value.set_tab_focus_mode(p_focus_mode);
		return p_focus_mode;
	}
	...
	public function set_deselect_enabled(p_enabled:Bool):Bool {
		__tabcontainer_ptr().value.set_deselect_enabled(p_enabled);
		return p_enabled;
	}
