...
enum abstract Parameter(Int) from Int to Int {
	...
	@:to
	extern inline function toNative():gdnative.cpuparticles2d.Parameter return untyped __cpp__("static_cast<godot::CPUParticles2D::Parameter>({0})", this);
	@:from
	extern static inline function fromNative(v:gdnative.cpuparticles2d.Parameter):Parameter return untyped __cpp__("static_cast<int32_t>({0})", v);
