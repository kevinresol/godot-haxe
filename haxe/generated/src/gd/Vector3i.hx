...
class Vector3i_wrapper {
	...
	public function sign():gd.Vector3i return {
		final v = __gd.sign();
		v;
	};
	public function abs():gd.Vector3i return {
		final v = __gd.abs();
		v;
	};
	public function clamp(p_min:gd.Vector3i, p_max:gd.Vector3i):gd.Vector3i return {
		final v = __gd.clamp(((p_min : gd.Vector3i)), ((p_max : gd.Vector3i)));
		v;
	};
	public function clampi(p_min:cpp.Int64, p_max:cpp.Int64):gd.Vector3i return {
		final v = __gd.clampi(((p_min : cpp.Int64)), ((p_max : cpp.Int64)));
		v;
	};
	public function snapped(p_step:gd.Vector3i):gd.Vector3i return {
		final v = __gd.snapped(((p_step : gd.Vector3i)));
		v;
	};
	public function snappedi(p_step:cpp.Int64):gd.Vector3i return {
		final v = __gd.snappedi(((p_step : cpp.Int64)));
		v;
	};
	public function min(p_with:gd.Vector3i):gd.Vector3i return {
		final v = __gd.min(((p_with : gd.Vector3i)));
		v;
	};
	public function mini(p_with:cpp.Int64):gd.Vector3i return {
		final v = __gd.mini(((p_with : cpp.Int64)));
		v;
	};
	public function max(p_with:gd.Vector3i):gd.Vector3i return {
		final v = __gd.max(((p_with : gd.Vector3i)));
		v;
	};
	public function maxi(p_with:cpp.Int64):gd.Vector3i return {
	...
	function __op_unary_minus():gd.Vector3i return @:privateAccess this.__gd.__op_unary_minus();
	function __op_multiply_int(p_rhs:cpp.Int64):gd.Vector3i return @:privateAccess this.__gd.__op_multiply_int(((p_rhs : cpp.Int64)));
	function __op_modulus_int(p_rhs:cpp.Int64):gd.Vector3i return @:privateAccess this.__gd.__op_modulus_int(((p_rhs : cpp.Int64)));
	function __op_equal_to_vector3i(p_rhs:gd.Vector3i):Bool return @:privateAccess this.__gd.__op_equal_to_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_not_equal_vector3i(p_rhs:gd.Vector3i):Bool return @:privateAccess this.__gd.__op_not_equal_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_less_than_vector3i(p_rhs:gd.Vector3i):Bool return @:privateAccess this.__gd.__op_less_than_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_less_equal_vector3i(p_rhs:gd.Vector3i):Bool return @:privateAccess this.__gd.__op_less_equal_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_greater_than_vector3i(p_rhs:gd.Vector3i):Bool return @:privateAccess this.__gd.__op_greater_than_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_greater_equal_vector3i(p_rhs:gd.Vector3i):Bool return @:privateAccess this.__gd.__op_greater_equal_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_add_vector3i(p_rhs:gd.Vector3i):gd.Vector3i return @:privateAccess this.__gd.__op_add_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_subtract_vector3i(p_rhs:gd.Vector3i):gd.Vector3i return @:privateAccess this.__gd.__op_subtract_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_multiply_vector3i(p_rhs:gd.Vector3i):gd.Vector3i return @:privateAccess this.__gd.__op_multiply_vector3i(((p_rhs : gdnative.Vector3i)));
	function __op_modulus_vector3i(p_rhs:gd.Vector3i):gd.Vector3i return @:privateAccess this.__gd.__op_modulus_vector3i(((p_rhs : gdnative.Vector3i)));
