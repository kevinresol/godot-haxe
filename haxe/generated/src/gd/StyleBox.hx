...
class StyleBox extends gd.Resource {
	...
	public function _draw(p_to_canvas_item:gd.RID, p_rect:gd.Rect2):Void __stylebox_ptr().value._draw(p_to_canvas_item, p_rect);
	public function _get_draw_rect(p_rect:gd.Rect2):gd.Rect2 return __stylebox_ptr().value._get_draw_rect(p_rect);
	public function _get_minimum_size():gd.Vector2 return __stylebox_ptr().value._get_minimum_size();
	public function _test_mask(p_point:gd.Vector2, p_rect:gd.Rect2):Bool return __stylebox_ptr().value._test_mask(p_point, p_rect);
	public function get_minimum_size():gd.Vector2 return __stylebox_ptr().value.get_minimum_size();
	public function set_content_margin(p_margin:gd.Side, p_offset:Float):Void __stylebox_ptr().value.set_content_margin(p_margin, p_offset);
	public function set_content_margin_all(p_offset:Float):Void __stylebox_ptr().value.set_content_margin_all(p_offset);
	public function get_content_margin(p_margin:gd.Side):Float return __stylebox_ptr().value.get_content_margin(p_margin);
	public function get_margin(p_margin:gd.Side):Float return __stylebox_ptr().value.get_margin(p_margin);
	public function get_offset():gd.Vector2 return __stylebox_ptr().value.get_offset();
	public function draw(p_canvas_item:gd.RID, p_rect:gd.Rect2):Void __stylebox_ptr().value.draw(p_canvas_item, p_rect);
	public function get_current_item_drawn():gd.CanvasItem return __stylebox_ptr().value.get_current_item_drawn();
	public function test_mask(p_point:gd.Vector2, p_rect:gd.Rect2):Bool return __stylebox_ptr().value.test_mask(p_point, p_rect);
