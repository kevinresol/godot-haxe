...
class NavigationObstacle3D extends gd.Node3D {
	...
	public function set_avoidance_enabled(p_enabled:Bool):Bool {
		__navigationobstacle3d_ptr().value.set_avoidance_enabled(p_enabled);
		return p_enabled;
	}
	public function get_avoidance_enabled():Bool return __navigationobstacle3d_ptr().value.get_avoidance_enabled();
	public function set_navigation_map(p_navigation_map:gd.RID):Void __navigationobstacle3d_ptr().value.set_navigation_map(p_navigation_map);
	...
	public function set_radius(p_radius:Float):Float {
		__navigationobstacle3d_ptr().value.set_radius(p_radius);
		return p_radius;
	}
	...
	public function set_height(p_height:Float):Float {
		__navigationobstacle3d_ptr().value.set_height(p_height);
		return p_height;
	}
	...
	public function set_velocity(p_velocity:gd.Vector3):gd.Vector3 {
		__navigationobstacle3d_ptr().value.set_velocity(p_velocity);
		return p_velocity;
	}
	...
	public function set_vertices(p_vertices:gd.PackedVector3Array):gd.PackedVector3Array {
		__navigationobstacle3d_ptr().value.set_vertices(p_vertices);
		return p_vertices;
	}
	...
	public function set_avoidance_layers(p_layers:Int):Int {
		__navigationobstacle3d_ptr().value.set_avoidance_layers(p_layers);
		return p_layers;
	}
	public function get_avoidance_layers():Int return __navigationobstacle3d_ptr().value.get_avoidance_layers();
	public function set_avoidance_layer_value(p_layer_number:Int, p_value:Bool):Void __navigationobstacle3d_ptr().value.set_avoidance_layer_value(p_layer_number, p_value);
	public function get_avoidance_layer_value(p_layer_number:Int):Bool return __navigationobstacle3d_ptr().value.get_avoidance_layer_value(p_layer_number);
	public function set_use_3d_avoidance(p_enabled:Bool):Bool {
		__navigationobstacle3d_ptr().value.set_use_3d_avoidance(p_enabled);
		return p_enabled;
	}
	...
	public function set_affect_navigation_mesh(p_enabled:Bool):Bool {
		__navigationobstacle3d_ptr().value.set_affect_navigation_mesh(p_enabled);
		return p_enabled;
	}
	...
	public function set_carve_navigation_mesh(p_enabled:Bool):Bool {
		__navigationobstacle3d_ptr().value.set_carve_navigation_mesh(p_enabled);
		return p_enabled;
	}
