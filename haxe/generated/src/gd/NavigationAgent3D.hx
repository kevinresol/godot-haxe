...
class NavigationAgent3D extends gd.Node {
	...
	public function set_avoidance_enabled(p_enabled:Bool):Bool {
		__navigationagent3d_ptr().value.set_avoidance_enabled(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_path_desired_distance(p_desired_distance:Float):Float {
		__navigationagent3d_ptr().value.set_path_desired_distance(((p_desired_distance : Float)));
	...
	public function set_target_desired_distance(p_desired_distance:Float):Float {
		__navigationagent3d_ptr().value.set_target_desired_distance(((p_desired_distance : Float)));
		return p_desired_distance;
	}
	...
	public function set_radius(p_radius:Float):Float {
		__navigationagent3d_ptr().value.set_radius(((p_radius : Float)));
		return p_radius;
	}
	...
	public function set_height(p_height:Float):Float {
		__navigationagent3d_ptr().value.set_height(((p_height : Float)));
		return p_height;
	}
	...
	public function set_path_height_offset(p_path_height_offset:Float):Float {
		__navigationagent3d_ptr().value.set_path_height_offset(((p_path_height_offset : Float)));
	...
	public function set_use_3d_avoidance(p_enabled:Bool):Bool {
		__navigationagent3d_ptr().value.set_use_3d_avoidance(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_keep_y_velocity(p_enabled:Bool):Bool {
		__navigationagent3d_ptr().value.set_keep_y_velocity(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_neighbor_distance(p_neighbor_distance:Float):Float {
		__navigationagent3d_ptr().value.set_neighbor_distance(((p_neighbor_distance : Float)));
	...
	public function set_max_neighbors(p_max_neighbors:Int):Int {
		__navigationagent3d_ptr().value.set_max_neighbors(((p_max_neighbors : Int)));
	...
	public function set_time_horizon_agents(p_time_horizon:Float):Float {
		__navigationagent3d_ptr().value.set_time_horizon_agents(((p_time_horizon : Float)));
	...
	public function set_time_horizon_obstacles(p_time_horizon:Float):Float {
		__navigationagent3d_ptr().value.set_time_horizon_obstacles(((p_time_horizon : Float)));
		return p_time_horizon;
	}
	...
	public function set_max_speed(p_max_speed:Float):Float {
		__navigationagent3d_ptr().value.set_max_speed(((p_max_speed : Float)));
		return p_max_speed;
	}
	...
	public function set_path_max_distance(p_max_speed:Float):Float {
		__navigationagent3d_ptr().value.set_path_max_distance(((p_max_speed : Float)));
		return p_max_speed;
	}
	...
	public function set_navigation_layers(p_navigation_layers:Int):Int {
		__navigationagent3d_ptr().value.set_navigation_layers(((p_navigation_layers : Int)));
	...
	public function set_navigation_layer_value(p_layer_number:Int, p_value:Bool):Void __navigationagent3d_ptr().value.set_navigation_layer_value(((p_layer_number : Int)), ((p_value : Bool)));
	public function get_navigation_layer_value(p_layer_number:Int):Bool return __navigationagent3d_ptr().value.get_navigation_layer_value(((p_layer_number : Int)));
	public function set_pathfinding_algorithm(p_pathfinding_algorithm:gd.navigationpathqueryparameters3d.PathfindingAlgorithm):gd.navigationpathqueryparameters3d.PathfindingAlgorithm {
		__navigationagent3d_ptr().value.set_pathfinding_algorithm(((p_pathfinding_algorithm : gd.navigationpathqueryparameters3d.PathfindingAlgorithm)));
	...
	public function set_path_postprocessing(p_path_postprocessing:gd.navigationpathqueryparameters3d.PathPostProcessing):gd.navigationpathqueryparameters3d.PathPostProcessing {
		__navigationagent3d_ptr().value.set_path_postprocessing(((p_path_postprocessing : gd.navigationpathqueryparameters3d.PathPostProcessing)));
	...
	public function set_path_metadata_flags(p_flags:Int):Int {
		__navigationagent3d_ptr().value.set_path_metadata_flags(((p_flags : Int)));
		return p_flags;
	}
	public function get_path_metadata_flags():Int return __navigationagent3d_ptr().value.get_path_metadata_flags();
	public function set_navigation_map(p_navigation_map:gd.RID):Void __navigationagent3d_ptr().value.set_navigation_map(((p_navigation_map : gd.RID)));
	...
	public function set_target_position(p_position:gd.Vector3):gd.Vector3 {
		__navigationagent3d_ptr().value.set_target_position(((p_position : gd.Vector3)));
		return p_position;
	}
	...
	public function set_simplify_path(p_enabled:Bool):Bool {
		__navigationagent3d_ptr().value.set_simplify_path(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_simplify_epsilon(p_epsilon:Float):Float {
		__navigationagent3d_ptr().value.set_simplify_epsilon(((p_epsilon : Float)));
		return p_epsilon;
	}
	...
	public function set_velocity_forced(p_velocity:gd.Vector3):Void __navigationagent3d_ptr().value.set_velocity_forced(((p_velocity : gd.Vector3)));
	public function set_velocity(p_velocity:gd.Vector3):gd.Vector3 {
		__navigationagent3d_ptr().value.set_velocity(((p_velocity : gd.Vector3)));
		return p_velocity;
	}
	...
	public function set_avoidance_layers(p_layers:Int):Int {
		__navigationagent3d_ptr().value.set_avoidance_layers(((p_layers : Int)));
		return p_layers;
	}
	...
	public function set_avoidance_mask(p_mask:Int):Int {
		__navigationagent3d_ptr().value.set_avoidance_mask(((p_mask : Int)));
		return p_mask;
	}
	public function get_avoidance_mask():Int return __navigationagent3d_ptr().value.get_avoidance_mask();
	public function set_avoidance_layer_value(p_layer_number:Int, p_value:Bool):Void __navigationagent3d_ptr().value.set_avoidance_layer_value(((p_layer_number : Int)), ((p_value : Bool)));
	public function get_avoidance_layer_value(p_layer_number:Int):Bool return __navigationagent3d_ptr().value.get_avoidance_layer_value(((p_layer_number : Int)));
	public function set_avoidance_mask_value(p_mask_number:Int, p_value:Bool):Void __navigationagent3d_ptr().value.set_avoidance_mask_value(((p_mask_number : Int)), ((p_value : Bool)));
	public function get_avoidance_mask_value(p_mask_number:Int):Bool return __navigationagent3d_ptr().value.get_avoidance_mask_value(((p_mask_number : Int)));
	public function set_avoidance_priority(p_priority:Float):Float {
		__navigationagent3d_ptr().value.set_avoidance_priority(((p_priority : Float)));
		return p_priority;
	}
	...
	public function set_debug_enabled(p_enabled:Bool):Bool {
		__navigationagent3d_ptr().value.set_debug_enabled(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_debug_use_custom(p_enabled:Bool):Bool {
		__navigationagent3d_ptr().value.set_debug_use_custom(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_debug_path_custom_color(p_color:gd.Color):gd.Color {
		__navigationagent3d_ptr().value.set_debug_path_custom_color(((p_color : gd.Color)));
		return p_color;
	}
	...
	public function set_debug_path_custom_point_size(p_point_size:Float):Float {
		__navigationagent3d_ptr().value.set_debug_path_custom_point_size(((p_point_size : Float)));
		return p_point_size;
	}
	...
	public var path_height_offset(get, set) : Float;
	...
	public var keep_y_velocity(get, set) : Bool;
