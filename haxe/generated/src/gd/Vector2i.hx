...
class Vector2i_wrapper {
	...
	public function distance_squared_to(p_to:gd.Vector2i):Int return __gd.distance_squared_to(((p_to : gd.Vector2i)));
	...
	public function clampi(p_min:Int, p_max:Int):gd.Vector2i return __gd.clampi(((p_min : Int)), ((p_max : Int)));
	public function snapped(p_step:gd.Vector2i):gd.Vector2i return __gd.snapped(((p_step : gd.Vector2i)));
	public function snappedi(p_step:Int):gd.Vector2i return __gd.snappedi(((p_step : Int)));
	public function min(p_with:gd.Vector2i):gd.Vector2i return __gd.min(((p_with : gd.Vector2i)));
	public function mini(p_with:Int):gd.Vector2i return __gd.mini(((p_with : Int)));
	public function max(p_with:gd.Vector2i):gd.Vector2i return __gd.max(((p_with : gd.Vector2i)));
	public function maxi(p_with:Int):gd.Vector2i return __gd.maxi(((p_with : Int)));
