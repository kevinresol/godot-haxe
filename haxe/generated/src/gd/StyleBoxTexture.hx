...
class StyleBoxTexture extends gd.StyleBox {
	...
	public function set_texture(p_texture:gd.Texture2D):gd.Texture2D {
		__styleboxtexture_ptr().value.set_texture(p_texture);
		return p_texture;
	}
	public function get_texture():gd.Texture2D return __styleboxtexture_ptr().value.get_texture();
	public function set_texture_margin(p_margin:gd.Side, p_size:Float):Void __styleboxtexture_ptr().value.set_texture_margin(p_margin, p_size);
	public function set_texture_margin_all(p_size:Float):Void __styleboxtexture_ptr().value.set_texture_margin_all(p_size);
	public function get_texture_margin(p_margin:gd.Side):Float return __styleboxtexture_ptr().value.get_texture_margin(p_margin);
	public function set_expand_margin(p_margin:gd.Side, p_size:Float):Void __styleboxtexture_ptr().value.set_expand_margin(p_margin, p_size);
	public function set_expand_margin_all(p_size:Float):Void __styleboxtexture_ptr().value.set_expand_margin_all(p_size);
	public function get_expand_margin(p_margin:gd.Side):Float return __styleboxtexture_ptr().value.get_expand_margin(p_margin);
	public function set_region_rect(p_region:gd.Rect2):gd.Rect2 {
		__styleboxtexture_ptr().value.set_region_rect(p_region);
		return p_region;
	}
	...
	public function set_draw_center(p_enable:Bool):Bool {
		__styleboxtexture_ptr().value.set_draw_center(p_enable);
		return p_enable;
	}
	public function is_draw_center_enabled():Bool return __styleboxtexture_ptr().value.is_draw_center_enabled();
	public function set_modulate(p_color:gd.Color):Void __styleboxtexture_ptr().value.set_modulate(p_color);
	public function get_modulate():gd.Color return __styleboxtexture_ptr().value.get_modulate();
	public function set_h_axis_stretch_mode(p_mode:gd.styleboxtexture.AxisStretchMode):Void __styleboxtexture_ptr().value.set_h_axis_stretch_mode(p_mode);
	...
	public function set_v_axis_stretch_mode(p_mode:gd.styleboxtexture.AxisStretchMode):Void __styleboxtexture_ptr().value.set_v_axis_stretch_mode(p_mode);
