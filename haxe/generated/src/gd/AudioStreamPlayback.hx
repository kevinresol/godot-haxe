...
class AudioStreamPlayback extends gd.RefCounted {
	...
	public function _start(p_from_pos:Float):Void __audiostreamplayback_ptr().value._start(p_from_pos);
	...
	public function _seek(p_position:Float):Void __audiostreamplayback_ptr().value._seek(p_position);
	public function _tag_used_streams():Void __audiostreamplayback_ptr().value._tag_used_streams();
	public function _set_parameter(p_name:std.String, p_value:gd.Variant):Void __audiostreamplayback_ptr().value._set_parameter(p_name, p_value);
	public function _get_parameter(p_name:std.String):gd.Variant return __audiostreamplayback_ptr().value._get_parameter(p_name);
	public function set_sample_playback(p_playback_sample:gd.AudioSamplePlayback):Void __audiostreamplayback_ptr().value.set_sample_playback(p_playback_sample);
