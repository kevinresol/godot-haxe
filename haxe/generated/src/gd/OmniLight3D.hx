...
class OmniLight3D extends gd.Light3D {
	...
	public function set_shadow_mode(p_mode:gd.omnilight3d.ShadowMode):Void __omnilight3d_ptr().value.set_shadow_mode(((p_mode : gd.omnilight3d.ShadowMode)));
	public function get_shadow_mode():gd.omnilight3d.ShadowMode return __omnilight3d_ptr().value.get_shadow_mode();
	public var omni_shadow_mode(get, set) : gd.omnilight3d.ShadowMode;
