...
class FileDialog extends gd.ConfirmationDialog {
	...
	public function add_filter(p_filter:std.String, ?p_description:std.String = "\"\""):Void __filedialog_ptr().value.add_filter(p_filter, p_description);
	public function set_filters(p_filters:gd.PackedStringArray):gd.PackedStringArray {
		__filedialog_ptr().value.set_filters(p_filters);
		return p_filters;
	}
	public function get_filters():gd.PackedStringArray return __filedialog_ptr().value.get_filters();
	public function get_option_name(p_option:Int):std.String return __filedialog_ptr().value.get_option_name(p_option);
	public function get_option_values(p_option:Int):gd.PackedStringArray return __filedialog_ptr().value.get_option_values(p_option);
	public function get_option_default(p_option:Int):Int return __filedialog_ptr().value.get_option_default(p_option);
	public function set_option_name(p_option:Int, p_name:std.String):Void __filedialog_ptr().value.set_option_name(p_option, p_name);
	public function set_option_values(p_option:Int, p_values:gd.PackedStringArray):Void __filedialog_ptr().value.set_option_values(p_option, p_values);
	public function set_option_default(p_option:Int, p_default_value_index:Int):Void __filedialog_ptr().value.set_option_default(p_option, p_default_value_index);
	public function set_option_count(p_count:Int):Int {
		__filedialog_ptr().value.set_option_count(p_count);
		return p_count;
	}
	public function get_option_count():Int return __filedialog_ptr().value.get_option_count();
	public function add_option(p_name:std.String, p_values:gd.PackedStringArray, p_default_value_index:Int):Void __filedialog_ptr().value.add_option(p_name, p_values, p_default_value_index);
	...
	public function set_current_dir(p_dir:std.String):std.String {
		__filedialog_ptr().value.set_current_dir(p_dir);
		return p_dir;
	}
	public function set_current_file(p_file:std.String):std.String {
		__filedialog_ptr().value.set_current_file(p_file);
		return p_file;
	}
	public function set_current_path(p_path:std.String):std.String {
		__filedialog_ptr().value.set_current_path(p_path);
		return p_path;
	}
	public function set_mode_overrides_title(p_override:Bool):Bool {
		__filedialog_ptr().value.set_mode_overrides_title(p_override);
		return p_override;
	}
	...
	public function set_file_mode(p_mode:gd.filedialog.FileMode):gd.filedialog.FileMode {
		__filedialog_ptr().value.set_file_mode(p_mode);
		return p_mode;
	}
	...
	public function set_access(p_access:gd.filedialog.Access):gd.filedialog.Access {
		__filedialog_ptr().value.set_access(p_access);
		return p_access;
	}
	...
	public function set_root_subfolder(p_dir:std.String):std.String {
		__filedialog_ptr().value.set_root_subfolder(p_dir);
		return p_dir;
	}
	...
	public function set_show_hidden_files(p_show:Bool):Bool {
		__filedialog_ptr().value.set_show_hidden_files(p_show);
		return p_show;
	}
	...
	public function set_use_native_dialog(p_native:Bool):Bool {
		__filedialog_ptr().value.set_use_native_dialog(p_native);
		return p_native;
	}
