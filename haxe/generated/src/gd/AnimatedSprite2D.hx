...
class AnimatedSprite2D extends gd.Node2D {
	...
	public function set_sprite_frames(p_sprite_frames:gd.SpriteFrames):gd.SpriteFrames {
		__animatedsprite2d_ptr().value.set_sprite_frames(p_sprite_frames);
	...
	public function set_animation(p_name:std.String):std.String {
		__animatedsprite2d_ptr().value.set_animation(p_name);
		return p_name;
	}
	...
	public function set_autoplay(p_name:std.String):std.String {
		__animatedsprite2d_ptr().value.set_autoplay(p_name);
		return p_name;
	}
	...
	public function play(?p_name:std.String = "&\"\"", ?p_custom_speed:Float = 1., ?p_from_end:Bool = false):Void __animatedsprite2d_ptr().value.play(p_name, p_custom_speed, p_from_end);
	public function play_backwards(?p_name:std.String = "&\"\""):Void __animatedsprite2d_ptr().value.play_backwards(p_name);
	...
	public function set_centered(p_centered:Bool):Bool {
		__animatedsprite2d_ptr().value.set_centered(p_centered);
		return p_centered;
	}
	...
	public function set_offset(p_offset:gd.Vector2):gd.Vector2 {
		__animatedsprite2d_ptr().value.set_offset(p_offset);
		return p_offset;
	}
	...
	public function set_flip_h(p_flip_h:Bool):Bool {
		__animatedsprite2d_ptr().value.set_flip_h(p_flip_h);
		return p_flip_h;
	}
	...
	public function set_flip_v(p_flip_v:Bool):Bool {
		__animatedsprite2d_ptr().value.set_flip_v(p_flip_v);
		return p_flip_v;
	}
	...
	public function set_frame(p_frame:Int):Int {
		__animatedsprite2d_ptr().value.set_frame(p_frame);
		return p_frame;
	}
	...
	public function set_frame_progress(p_progress:Float):Float {
		__animatedsprite2d_ptr().value.set_frame_progress(p_progress);
		return p_progress;
	}
	public function get_frame_progress():Float return __animatedsprite2d_ptr().value.get_frame_progress();
	public function set_frame_and_progress(p_frame:Int, p_progress:Float):Void __animatedsprite2d_ptr().value.set_frame_and_progress(p_frame, p_progress);
	public function set_speed_scale(p_speed_scale:Float):Float {
		__animatedsprite2d_ptr().value.set_speed_scale(p_speed_scale);
