...
class AnimatedTexture extends gd.Texture2D {
	...
	public function set_frames(p_frames:Int):Int {
		__animatedtexture_ptr().value.set_frames(p_frames);
		return p_frames;
	}
	...
	public function set_current_frame(p_frame:Int):Int {
		__animatedtexture_ptr().value.set_current_frame(p_frame);
		return p_frame;
	}
	...
	public function set_pause(p_pause:Bool):Bool {
		__animatedtexture_ptr().value.set_pause(p_pause);
		return p_pause;
	}
	...
	public function set_one_shot(p_one_shot:Bool):Bool {
		__animatedtexture_ptr().value.set_one_shot(p_one_shot);
		return p_one_shot;
	}
	...
	public function set_speed_scale(p_scale:Float):Float {
		__animatedtexture_ptr().value.set_speed_scale(p_scale);
		return p_scale;
	}
	public function get_speed_scale():Float return __animatedtexture_ptr().value.get_speed_scale();
	public function set_frame_texture(p_frame:Int, p_texture:gd.Texture2D):Void __animatedtexture_ptr().value.set_frame_texture(p_frame, p_texture);
	public function get_frame_texture(p_frame:Int):gd.Texture2D return __animatedtexture_ptr().value.get_frame_texture(p_frame);
	public function set_frame_duration(p_frame:Int, p_duration:Float):Void __animatedtexture_ptr().value.set_frame_duration(p_frame, p_duration);
	public function get_frame_duration(p_frame:Int):Float return __animatedtexture_ptr().value.get_frame_duration(p_frame);
