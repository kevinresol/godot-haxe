...
class InputEventScreenDrag extends gd.InputEventFromWindow {
	...
	public function set_index(p_index:Int):Int {
		__inputeventscreendrag_ptr().value.set_index(p_index);
		return p_index;
	}
	...
	public function set_tilt(p_tilt:gd.Vector2):gd.Vector2 {
		__inputeventscreendrag_ptr().value.set_tilt(p_tilt);
		return p_tilt;
	}
	...
	public function set_pressure(p_pressure:Float):Float {
		__inputeventscreendrag_ptr().value.set_pressure(p_pressure);
		return p_pressure;
	}
	...
	public function set_pen_inverted(p_pen_inverted:Bool):Bool {
		__inputeventscreendrag_ptr().value.set_pen_inverted(p_pen_inverted);
	...
	public function set_position(p_position:gd.Vector2):gd.Vector2 {
		__inputeventscreendrag_ptr().value.set_position(p_position);
		return p_position;
	}
	...
	public function set_relative(p_relative:gd.Vector2):gd.Vector2 {
		__inputeventscreendrag_ptr().value.set_relative(p_relative);
		return p_relative;
	}
	...
	public function set_screen_relative(p_relative:gd.Vector2):gd.Vector2 {
		__inputeventscreendrag_ptr().value.set_screen_relative(p_relative);
		return p_relative;
	}
	...
	public function set_velocity(p_velocity:gd.Vector2):gd.Vector2 {
		__inputeventscreendrag_ptr().value.set_velocity(p_velocity);
		return p_velocity;
	}
	...
	public function set_screen_velocity(p_velocity:gd.Vector2):gd.Vector2 {
		__inputeventscreendrag_ptr().value.set_screen_velocity(p_velocity);
		return p_velocity;
	}
