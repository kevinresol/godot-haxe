...
class RDPipelineRasterizationState extends gd.RefCounted {
	...
	public function set_enable_depth_clamp(p_p_member:Bool):Bool {
		__rdpipelinerasterizationstate_ptr().value.set_enable_depth_clamp(p_p_member);
		return p_p_member;
	}
	...
	public function set_discard_primitives(p_p_member:Bool):Bool {
		__rdpipelinerasterizationstate_ptr().value.set_discard_primitives(p_p_member);
		return p_p_member;
	}
	...
	public function set_wireframe(p_p_member:Bool):Bool {
		__rdpipelinerasterizationstate_ptr().value.set_wireframe(p_p_member);
		return p_p_member;
	}
	...
	public function set_cull_mode(p_p_member:gd.renderingdevice.PolygonCullMode):gd.renderingdevice.PolygonCullMode {
		__rdpipelinerasterizationstate_ptr().value.set_cull_mode(p_p_member);
		return p_p_member;
	}
	...
	public function set_front_face(p_p_member:gd.renderingdevice.PolygonFrontFace):gd.renderingdevice.PolygonFrontFace {
		__rdpipelinerasterizationstate_ptr().value.set_front_face(p_p_member);
		return p_p_member;
	}
	...
	public function set_depth_bias_enabled(p_p_member:Bool):Bool {
		__rdpipelinerasterizationstate_ptr().value.set_depth_bias_enabled(p_p_member);
		return p_p_member;
	}
	...
	public function set_depth_bias_constant_factor(p_p_member:Float):Float {
		__rdpipelinerasterizationstate_ptr().value.set_depth_bias_constant_factor(p_p_member);
		return p_p_member;
	}
	...
	public function set_depth_bias_clamp(p_p_member:Float):Float {
		__rdpipelinerasterizationstate_ptr().value.set_depth_bias_clamp(p_p_member);
		return p_p_member;
	}
	...
	public function set_depth_bias_slope_factor(p_p_member:Float):Float {
		__rdpipelinerasterizationstate_ptr().value.set_depth_bias_slope_factor(p_p_member);
		return p_p_member;
	}
	...
	public function set_line_width(p_p_member:Float):Float {
		__rdpipelinerasterizationstate_ptr().value.set_line_width(p_p_member);
		return p_p_member;
	}
	...
	public function set_patch_control_points(p_p_member:Int):Int {
		__rdpipelinerasterizationstate_ptr().value.set_patch_control_points(p_p_member);
		return p_p_member;
	}
