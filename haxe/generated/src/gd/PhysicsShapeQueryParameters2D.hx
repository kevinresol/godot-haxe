...
class PhysicsShapeQueryParameters2D extends gd.RefCounted {
	...
	public function set_shape(p_shape:gd.Resource):gd.Resource {
		__physicsshapequeryparameters2d_ptr().value.set_shape(p_shape);
		return p_shape;
	}
	...
	public function set_shape_rid(p_shape:gd.RID):gd.RID {
		__physicsshapequeryparameters2d_ptr().value.set_shape_rid(p_shape);
		return p_shape;
	}
	...
	public function set_motion(p_motion:gd.Vector2):gd.Vector2 {
		__physicsshapequeryparameters2d_ptr().value.set_motion(p_motion);
		return p_motion;
	}
	...
	public function set_margin(p_margin:Float):Float {
		__physicsshapequeryparameters2d_ptr().value.set_margin(p_margin);
		return p_margin;
	}
	...
	public function set_collision_mask(p_collision_mask:Int):Int {
		__physicsshapequeryparameters2d_ptr().value.set_collision_mask(p_collision_mask);
	...
	public function set_collide_with_bodies(p_enable:Bool):Bool {
		__physicsshapequeryparameters2d_ptr().value.set_collide_with_bodies(p_enable);
		return p_enable;
	}
	...
	public function set_collide_with_areas(p_enable:Bool):Bool {
		__physicsshapequeryparameters2d_ptr().value.set_collide_with_areas(p_enable);
		return p_enable;
	}
