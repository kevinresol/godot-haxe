...
class Gradient extends gd.Resource {
	...
	public function add_point(p_offset:Float, p_color:gd.Color):Void __gradient_ptr().value.add_point(p_offset, p_color);
	public function remove_point(p_point:Int):Void __gradient_ptr().value.remove_point(p_point);
	public function set_offset(p_point:Int, p_offset:Float):Void __gradient_ptr().value.set_offset(p_point, p_offset);
	public function get_offset(p_point:Int):Float return __gradient_ptr().value.get_offset(p_point);
	public function reverse():Void __gradient_ptr().value.reverse();
	public function set_color(p_point:Int, p_color:gd.Color):Void __gradient_ptr().value.set_color(p_point, p_color);
	public function get_color(p_point:Int):gd.Color return __gradient_ptr().value.get_color(p_point);
	public function sample(p_offset:Float):gd.Color return __gradient_ptr().value.sample(p_offset);
	...
	public function set_offsets(p_offsets:gd.PackedFloat32Array):gd.PackedFloat32Array {
		__gradient_ptr().value.set_offsets(p_offsets);
		return p_offsets;
	}
	...
	public function set_colors(p_colors:gd.PackedColorArray):gd.PackedColorArray {
		__gradient_ptr().value.set_colors(p_colors);
		return p_colors;
	}
	...
	public function set_interpolation_mode(p_interpolation_mode:gd.gradient.InterpolationMode):gd.gradient.InterpolationMode {
		__gradient_ptr().value.set_interpolation_mode(p_interpolation_mode);
	...
	public function set_interpolation_color_space(p_interpolation_color_space:gd.gradient.ColorSpace):gd.gradient.ColorSpace {
		__gradient_ptr().value.set_interpolation_color_space(p_interpolation_color_space);
