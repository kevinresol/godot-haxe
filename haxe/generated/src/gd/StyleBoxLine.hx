...
class StyleBoxLine extends gd.StyleBox {
	...
	public function set_color(p_color:gd.Color):gd.Color {
		__styleboxline_ptr().value.set_color(p_color);
		return p_color;
	}
	...
	public function set_thickness(p_thickness:Int):Int {
		__styleboxline_ptr().value.set_thickness(p_thickness);
		return p_thickness;
	}
	...
	public function set_grow_begin(p_offset:Float):Float {
		__styleboxline_ptr().value.set_grow_begin(p_offset);
		return p_offset;
	}
	...
	public function set_grow_end(p_offset:Float):Float {
		__styleboxline_ptr().value.set_grow_end(p_offset);
		return p_offset;
	}
	...
	public function set_vertical(p_vertical:Bool):Bool {
		__styleboxline_ptr().value.set_vertical(p_vertical);
		return p_vertical;
	}
