...
class Light2D extends gd.Node2D {
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__light2d_ptr().value.set_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_editor_only(p_editor_only:Bool):Bool {
		__light2d_ptr().value.set_editor_only(p_editor_only);
	...
	public function set_color(p_color:gd.Color):gd.Color {
		__light2d_ptr().value.set_color(p_color);
		return p_color;
	}
	public function get_color():gd.Color return __light2d_ptr().value.get_color();
	public function set_energy(p_energy:Float):Float {
		__light2d_ptr().value.set_energy(p_energy);
		return p_energy;
	}
	public function get_energy():Float return __light2d_ptr().value.get_energy();
	public function set_z_range_min(p_z:Int):Void __light2d_ptr().value.set_z_range_min(p_z);
	public function get_z_range_min():Int return __light2d_ptr().value.get_z_range_min();
	public function set_z_range_max(p_z:Int):Void __light2d_ptr().value.set_z_range_max(p_z);
	public function get_z_range_max():Int return __light2d_ptr().value.get_z_range_max();
	public function set_layer_range_min(p_layer:Int):Void __light2d_ptr().value.set_layer_range_min(p_layer);
	public function get_layer_range_min():Int return __light2d_ptr().value.get_layer_range_min();
	public function set_layer_range_max(p_layer:Int):Void __light2d_ptr().value.set_layer_range_max(p_layer);
	public function get_layer_range_max():Int return __light2d_ptr().value.get_layer_range_max();
	public function set_item_cull_mask(p_item_cull_mask:Int):Void __light2d_ptr().value.set_item_cull_mask(p_item_cull_mask);
	public function get_item_cull_mask():Int return __light2d_ptr().value.get_item_cull_mask();
	public function set_item_shadow_cull_mask(p_item_shadow_cull_mask:Int):Void __light2d_ptr().value.set_item_shadow_cull_mask(p_item_shadow_cull_mask);
	...
	public function set_shadow_enabled(p_enabled:Bool):Bool {
		__light2d_ptr().value.set_shadow_enabled(p_enabled);
		return p_enabled;
	}
	public function is_shadow_enabled():Bool return __light2d_ptr().value.is_shadow_enabled();
	public function set_shadow_smooth(p_smooth:Float):Void __light2d_ptr().value.set_shadow_smooth(p_smooth);
	...
	public function set_shadow_filter(p_filter:gd.light2d.ShadowFilter):gd.light2d.ShadowFilter {
		__light2d_ptr().value.set_shadow_filter(p_filter);
		return p_filter;
	}
	...
	public function set_shadow_color(p_shadow_color:gd.Color):gd.Color {
		__light2d_ptr().value.set_shadow_color(p_shadow_color);
	...
	public function set_blend_mode(p_mode:gd.light2d.BlendMode):gd.light2d.BlendMode {
		__light2d_ptr().value.set_blend_mode(p_mode);
		return p_mode;
	}
	public function get_blend_mode():gd.light2d.BlendMode return __light2d_ptr().value.get_blend_mode();
	public function set_height(p_height:Float):Void __light2d_ptr().value.set_height(p_height);
