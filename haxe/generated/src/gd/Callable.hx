...
class Callable_wrapper {
	...
	static function _new2(p_object:gd.Object, p_method:String):Callable_wrapper return new Callable_wrapper(new gdnative.Callable(p_object, p_method));
	public function create(p_variant:gd.Variant, p_method:String):gd.Callable return __gd.create(p_variant, p_method);
	...
	public function get_method():String return __gd.get_method();
...
@:forward @:forwardStatics abstract Callable(Callable_wrapper) from Callable_wrapper to Callable_wrapper {
	...
	public extern overload inline function new(p_object:gd.Object, p_method:String) this = @:privateAccess Callable_wrapper._new2(p_object, p_method);
}