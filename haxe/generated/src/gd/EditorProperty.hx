...
class EditorProperty extends gd.Container {
	...
	public function _set_read_only(p_read_only:Bool):Void __editorproperty_ptr().value._set_read_only(p_read_only);
	public function set_label(p_text:std.String):std.String {
		__editorproperty_ptr().value.set_label(p_text);
		return p_text;
	}
	...
	public function set_read_only(p_read_only:Bool):Bool {
		__editorproperty_ptr().value.set_read_only(p_read_only);
		return p_read_only;
	}
	...
	public function set_checkable(p_checkable:Bool):Bool {
		__editorproperty_ptr().value.set_checkable(p_checkable);
		return p_checkable;
	}
	...
	public function set_checked(p_checked:Bool):Bool {
		__editorproperty_ptr().value.set_checked(p_checked);
		return p_checked;
	}
	...
	public function set_draw_warning(p_draw_warning:Bool):Bool {
		__editorproperty_ptr().value.set_draw_warning(p_draw_warning);
	...
	public function set_keying(p_keying:Bool):Bool {
		__editorproperty_ptr().value.set_keying(p_keying);
		return p_keying;
	}
	...
	public function set_deletable(p_deletable:Bool):Bool {
		__editorproperty_ptr().value.set_deletable(p_deletable);
		return p_deletable;
	}
	...
	public function add_focusable(p_control:gd.Control):Void __editorproperty_ptr().value.add_focusable(p_control);
	public function set_bottom_editor(p_editor:gd.Control):Void __editorproperty_ptr().value.set_bottom_editor(p_editor);
	public function emit_changed(p_property:std.String, p_value:gd.Variant, ?p_field:std.String = "&\"\"", ?p_changing:Bool = false):Void __editorproperty_ptr().value.emit_changed(p_property, p_value, p_field, p_changing);
