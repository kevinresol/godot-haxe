...
@:cppInclude('iostream') class InputEventWithModifiers extends gd.InputEventFromWindow {
	public function new(?native:gdnative.InputEventWithModifiers.InputEventWithModifiers_extern) {
	...
	public function is_command_or_control_autoremap():Bool return __inputeventwithmodifiers_ptr().is_command_or_control_autoremap();
	public function is_command_or_control_pressed():Bool return __inputeventwithmodifiers_ptr().is_command_or_control_pressed();
	public function set_alt_pressed(p_pressed:Bool):Bool {
		__inputeventwithmodifiers_ptr().set_alt_pressed(((p_pressed : Bool)));
		return p_pressed;
	}
	public function is_alt_pressed():Bool return __inputeventwithmodifiers_ptr().is_alt_pressed();
	public function set_shift_pressed(p_pressed:Bool):Bool {
		__inputeventwithmodifiers_ptr().set_shift_pressed(((p_pressed : Bool)));
		return p_pressed;
	}
	public function is_shift_pressed():Bool return __inputeventwithmodifiers_ptr().is_shift_pressed();
	public function set_ctrl_pressed(p_pressed:Bool):Bool {
		__inputeventwithmodifiers_ptr().set_ctrl_pressed(((p_pressed : Bool)));
		return p_pressed;
	}
	public function is_ctrl_pressed():Bool return __inputeventwithmodifiers_ptr().is_ctrl_pressed();
	public function set_meta_pressed(p_pressed:Bool):Bool {
		__inputeventwithmodifiers_ptr().set_meta_pressed(((p_pressed : Bool)));
		return p_pressed;
	}
	public function is_meta_pressed():Bool return __inputeventwithmodifiers_ptr().is_meta_pressed();
	public function get_modifiers_mask():Int return __inputeventwithmodifiers_ptr().get_modifiers_mask();
