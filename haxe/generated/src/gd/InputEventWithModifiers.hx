...
class InputEventWithModifiers extends gd.InputEventFromWindow {
	...
	public function set_command_or_control_autoremap(p_enable:Bool):Bool {
		__inputeventwithmodifiers_ptr().value.set_command_or_control_autoremap(p_enable);
		return p_enable;
	}
	...
	public function set_alt_pressed(p_pressed:Bool):Bool {
		__inputeventwithmodifiers_ptr().value.set_alt_pressed(p_pressed);
		return p_pressed;
	}
	...
	public function set_shift_pressed(p_pressed:Bool):Bool {
		__inputeventwithmodifiers_ptr().value.set_shift_pressed(p_pressed);
		return p_pressed;
	}
	...
	public function set_ctrl_pressed(p_pressed:Bool):Bool {
		__inputeventwithmodifiers_ptr().value.set_ctrl_pressed(p_pressed);
		return p_pressed;
	}
	...
	public function set_meta_pressed(p_pressed:Bool):Bool {
		__inputeventwithmodifiers_ptr().value.set_meta_pressed(p_pressed);
		return p_pressed;
	}
