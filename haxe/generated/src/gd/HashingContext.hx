...
class HashingContext extends gd.RefCounted {
	...
	public function start(p_type:gd.hashingcontext.HashType):gd.Error return __hashingcontext_ptr().value.start(p_type);
	public function update(p_chunk:gd.PackedByteArray):gd.Error return __hashingcontext_ptr().value.update(p_chunk);
