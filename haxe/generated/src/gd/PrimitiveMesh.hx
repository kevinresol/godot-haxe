...
class PrimitiveMesh extends gd.Mesh {
	...
	public function set_material(p_material:gd.Material):gd.Material {
		__primitivemesh_ptr().value.set_material(p_material);
		return p_material;
	}
	...
	public function set_custom_aabb(p_aabb:gd.AABB):gd.AABB {
		__primitivemesh_ptr().value.set_custom_aabb(p_aabb);
		return p_aabb;
	}
	...
	public function set_flip_faces(p_flip_faces:Bool):Bool {
		__primitivemesh_ptr().value.set_flip_faces(p_flip_faces);
		return p_flip_faces;
	}
	...
	public function set_add_uv2(p_add_uv2:Bool):Bool {
		__primitivemesh_ptr().value.set_add_uv2(p_add_uv2);
		return p_add_uv2;
	}
	...
	public function set_uv2_padding(p_uv2_padding:Float):Float {
		__primitivemesh_ptr().value.set_uv2_padding(p_uv2_padding);
