...
class OS extends gd.Object {
	...
	public function get_entropy(p_size:Int):gd.PackedByteArray return __os_ptr().value.get_entropy(p_size);
	...
	public function alert(p_text:std.String, ?p_title:std.String = "\"Alert!\""):Void __os_ptr().value.alert(p_text, p_title);
	public function crash(p_message:std.String):Void __os_ptr().value.crash(p_message);
	public function set_low_processor_usage_mode(p_enable:Bool):Bool {
		__os_ptr().value.set_low_processor_usage_mode(p_enable);
		return p_enable;
	}
	...
	public function set_low_processor_usage_mode_sleep_usec(p_usec:Int):Int {
		__os_ptr().value.set_low_processor_usage_mode_sleep_usec(p_usec);
		return p_usec;
	}
	...
	public function set_delta_smoothing(p_delta_smoothing_enabled:Bool):Bool {
		__os_ptr().value.set_delta_smoothing(p_delta_smoothing_enabled);
	...
	public function get_system_font_path(p_font_name:std.String, ?p_weight:Int = 400, ?p_stretch:Int = 100, ?p_italic:Bool = false):std.String return __os_ptr().value.get_system_font_path(p_font_name, p_weight, p_stretch, p_italic);
	public function get_system_font_path_for_text(p_font_name:std.String, p_text:std.String, ?p_locale:std.String = "\"\"", ?p_script:std.String = "\"\"", ?p_weight:Int = 400, ?p_stretch:Int = 100, ?p_italic:Bool = false):gd.PackedStringArray return __os_ptr().value.get_system_font_path_for_text(p_font_name, p_text, p_locale, p_script, p_weight, p_stretch, p_italic);
	...
	public function execute_with_pipe(p_path:std.String, p_arguments:gd.PackedStringArray):gd.Dictionary return __os_ptr().value.execute_with_pipe(p_path, p_arguments);
	public function create_process(p_path:std.String, p_arguments:gd.PackedStringArray, ?p_open_console:Bool = false):Int return __os_ptr().value.create_process(p_path, p_arguments, p_open_console);
	public function create_instance(p_arguments:gd.PackedStringArray):Int return __os_ptr().value.create_instance(p_arguments);
	public function kill(p_pid:Int):gd.Error return __os_ptr().value.kill(p_pid);
	public function shell_open(p_uri:std.String):gd.Error return __os_ptr().value.shell_open(p_uri);
	public function shell_show_in_file_manager(p_file_or_dir_path:std.String, ?p_open_folder:Bool = true):gd.Error return __os_ptr().value.shell_show_in_file_manager(p_file_or_dir_path, p_open_folder);
	public function is_process_running(p_pid:Int):Bool return __os_ptr().value.is_process_running(p_pid);
	public function get_process_exit_code(p_pid:Int):Int return __os_ptr().value.get_process_exit_code(p_pid);
	public function get_process_id():Int return __os_ptr().value.get_process_id();
	public function has_environment(p_variable:std.String):Bool return __os_ptr().value.has_environment(p_variable);
	public function get_environment(p_variable:std.String):std.String return __os_ptr().value.get_environment(p_variable);
	public function set_environment(p_variable:std.String, p_value:std.String):Void __os_ptr().value.set_environment(p_variable, p_value);
	public function unset_environment(p_variable:std.String):Void __os_ptr().value.unset_environment(p_variable);
	...
	public function delay_usec(p_usec:Int):Void __os_ptr().value.delay_usec(p_usec);
	public function delay_msec(p_msec:Int):Void __os_ptr().value.delay_msec(p_msec);
	...
	public function move_to_trash(p_path:std.String):gd.Error return __os_ptr().value.move_to_trash(p_path);
	public function get_user_data_dir():std.String return __os_ptr().value.get_user_data_dir();
	public function get_system_dir(p_dir:gd.os.SystemDir, ?p_shared_storage:Bool = true):std.String return __os_ptr().value.get_system_dir(p_dir, p_shared_storage);
	...
	public function get_keycode_string(p_code:gd.Key):std.String return __os_ptr().value.get_keycode_string(p_code);
	public function is_keycode_unicode(p_code:Int):Bool return __os_ptr().value.is_keycode_unicode(p_code);
	public function find_keycode_from_string(p_string:std.String):gd.Key return __os_ptr().value.find_keycode_from_string(p_string);
	public function set_use_file_access_save_and_swap(p_enabled:Bool):Void __os_ptr().value.set_use_file_access_save_and_swap(p_enabled);
	public function set_thread_name(p_name:std.String):gd.Error return __os_ptr().value.set_thread_name(p_name);
	...
	public function has_feature(p_tag_name:std.String):Bool return __os_ptr().value.has_feature(p_tag_name);
	public function is_sandboxed():Bool return __os_ptr().value.is_sandboxed();
	public function request_permission(p_name:std.String):Bool return __os_ptr().value.request_permission(p_name);
