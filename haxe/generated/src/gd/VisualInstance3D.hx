...
class VisualInstance3D extends gd.Node3D {
	...
	public function set_base(p_base:gd.RID):Void __visualinstance3d_ptr().value.set_base(p_base);
	...
	public function set_layer_mask(p_mask:Int):Void __visualinstance3d_ptr().value.set_layer_mask(p_mask);
	public function get_layer_mask():Int return __visualinstance3d_ptr().value.get_layer_mask();
	public function set_layer_mask_value(p_layer_number:Int, p_value:Bool):Void __visualinstance3d_ptr().value.set_layer_mask_value(p_layer_number, p_value);
	public function get_layer_mask_value(p_layer_number:Int):Bool return __visualinstance3d_ptr().value.get_layer_mask_value(p_layer_number);
	public function set_sorting_offset(p_offset:Float):Float {
		__visualinstance3d_ptr().value.set_sorting_offset(p_offset);
		return p_offset;
	}
	...
	public function set_sorting_use_aabb_center(p_enabled:Bool):Bool {
		__visualinstance3d_ptr().value.set_sorting_use_aabb_center(p_enabled);
		return p_enabled;
	}
