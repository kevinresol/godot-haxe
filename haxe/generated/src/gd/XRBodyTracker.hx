...
class XRBodyTracker extends gd.XRPositionalTracker {
	...
	public function set_has_tracking_data(p_has_data:Bool):Bool {
		__xrbodytracker_ptr().value.set_has_tracking_data(p_has_data);
		return p_has_data;
	}
	...
	public function set_body_flags(p_flags:Int):Int {
		__xrbodytracker_ptr().value.set_body_flags(p_flags);
		return p_flags;
	}
	public function get_body_flags():Int return __xrbodytracker_ptr().value.get_body_flags();
	public function set_joint_flags(p_joint:gd.xrbodytracker.Joint, p_flags:Int):Void __xrbodytracker_ptr().value.set_joint_flags(p_joint, p_flags);
	public function get_joint_flags(p_joint:gd.xrbodytracker.Joint):Int return __xrbodytracker_ptr().value.get_joint_flags(p_joint);
