...
class PackedVector4Array_wrapper {
	...
	static function _new0():PackedVector4Array_wrapper {
		final v = new gdnative.PackedVector4Array();
		return new PackedVector4Array_wrapper(v);
	}
	static function _new1(p_from:gd.PackedVector4Array):PackedVector4Array_wrapper {
		final v = new gdnative.PackedVector4Array(p_from);
		return new PackedVector4Array_wrapper(v);
	}
	...
	public function get(p_index:cpp.Int64):gd.Vector4 return {
		final v = __gd.get(((p_index : cpp.Int64)));
		v;
	};
	public function set(p_index:cpp.Int64, p_value:gd.Vector4):Void __gd.set(((p_index : cpp.Int64)), ((p_value : gd.Vector4)));
	...
	public function insert(p_at_index:cpp.Int64, p_value:gd.Vector4):cpp.Int64 return __gd.insert(((p_at_index : cpp.Int64)), ((p_value : gd.Vector4)));
	...
	public function slice(p_begin:cpp.Int64, ?p_end:cpp.Int64):gd.PackedVector4Array return switch [p_begin, p_end] {
		case [_, null]:{
	...
	public function bsearch(p_value:gd.Vector4, ?p_before:Bool):cpp.Int64 return switch [p_value, p_before] {
		case [_, null]:__gd.bsearch(((p_value : gd.Vector4)));
		default:__gd.bsearch(((p_value : gd.Vector4)), ((p_before : Bool)));
	};
	public function duplicate():gd.PackedVector4Array return {
		final v = __gd.duplicate();
		v;
	};
	public function find(p_value:gd.Vector4, ?p_from:cpp.Int64):cpp.Int64 return switch [p_value, p_from] {
		case [_, null]:__gd.find(((p_value : gd.Vector4)));
		default:__gd.find(((p_value : gd.Vector4)), ((p_from : cpp.Int64)));
	};
	public function rfind(p_value:gd.Vector4, ?p_from:cpp.Int64):cpp.Int64 return switch [p_value, p_from] {
	...
	public function erase(p_value:gd.Vector4):Bool return __gd.erase(((p_value : gd.Vector4)));
