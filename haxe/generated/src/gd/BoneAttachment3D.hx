...
class BoneAttachment3D extends gd.Node3D {
	...
	public function set_bone_name(p_bone_name:std.String):std.String {
		__boneattachment3d_ptr().value.set_bone_name(((p_bone_name : std.String)));
		return p_bone_name;
	}
	...
	public function set_bone_idx(p_bone_idx:Int):Int {
		__boneattachment3d_ptr().value.set_bone_idx(((p_bone_idx : Int)));
		return p_bone_idx;
	}
	...
	public function set_override_pose(p_override_pose:Bool):Bool {
		__boneattachment3d_ptr().value.set_override_pose(((p_override_pose : Bool)));
		return p_override_pose;
	}
	public function get_override_pose():Bool return __boneattachment3d_ptr().value.get_override_pose();
	public function set_use_external_skeleton(p_use_external_skeleton:Bool):Void __boneattachment3d_ptr().value.set_use_external_skeleton(((p_use_external_skeleton : Bool)));
