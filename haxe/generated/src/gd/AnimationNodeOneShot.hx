...
class AnimationNodeOneShot extends gd.AnimationNodeSync {
	...
	public function set_fadein_time(p_time:Float):Float {
		__animationnodeoneshot_ptr().value.set_fadein_time(p_time);
		return p_time;
	}
	...
	public function set_fadein_curve(p_curve:gd.Curve):gd.Curve {
		__animationnodeoneshot_ptr().value.set_fadein_curve(p_curve);
		return p_curve;
	}
	...
	public function set_fadeout_time(p_time:Float):Float {
		__animationnodeoneshot_ptr().value.set_fadeout_time(p_time);
		return p_time;
	}
	...
	public function set_fadeout_curve(p_curve:gd.Curve):gd.Curve {
		__animationnodeoneshot_ptr().value.set_fadeout_curve(p_curve);
		return p_curve;
	}
	...
	public function set_break_loop_at_end(p_enable:Bool):Bool {
		__animationnodeoneshot_ptr().value.set_break_loop_at_end(p_enable);
		return p_enable;
	}
	...
	public function set_autorestart(p_active:Bool):Bool {
		__animationnodeoneshot_ptr().value.set_autorestart(p_active);
		return p_active;
	}
	...
	public function set_autorestart_delay(p_time:Float):Float {
		__animationnodeoneshot_ptr().value.set_autorestart_delay(p_time);
		return p_time;
	}
	...
	public function set_autorestart_random_delay(p_time:Float):Float {
		__animationnodeoneshot_ptr().value.set_autorestart_random_delay(p_time);
		return p_time;
	}
	...
	public function set_mix_mode(p_mode:gd.animationnodeoneshot.MixMode):gd.animationnodeoneshot.MixMode {
		__animationnodeoneshot_ptr().value.set_mix_mode(p_mode);
		return p_mode;
	}
