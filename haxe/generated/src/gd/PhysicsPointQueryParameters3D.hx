...
class PhysicsPointQueryParameters3D extends gd.RefCounted {
	...
	public function set_position(p_position:gd.Vector3):gd.Vector3 {
		__physicspointqueryparameters3d_ptr().value.set_position(((p_position : gd.Vector3)));
		return p_position;
	}
	...
	public function set_collision_mask(p_collision_mask:Int):Int {
		__physicspointqueryparameters3d_ptr().value.set_collision_mask(((p_collision_mask : Int)));
	...
	public function set_collide_with_bodies(p_enable:Bool):Bool {
		__physicspointqueryparameters3d_ptr().value.set_collide_with_bodies(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_collide_with_areas(p_enable:Bool):Bool {
		__physicspointqueryparameters3d_ptr().value.set_collide_with_areas(((p_enable : Bool)));
		return p_enable;
	}
