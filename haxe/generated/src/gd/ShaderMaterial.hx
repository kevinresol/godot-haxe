...
class ShaderMaterial extends gd.Material {
	...
	public function set_shader(p_shader:gd.Shader):gd.Shader {
		__shadermaterial_ptr().value.set_shader(p_shader);
		return p_shader;
	}
	public function get_shader():gd.Shader return __shadermaterial_ptr().value.get_shader();
	public function set_shader_parameter(p_param:std.String, p_value:gd.Variant):Void __shadermaterial_ptr().value.set_shader_parameter(p_param, p_value);
	public function get_shader_parameter(p_param:std.String):gd.Variant return __shadermaterial_ptr().value.get_shader_parameter(p_param);
