...
class VisualShaderNodeCompare extends gd.VisualShaderNode {
	...
	public function set_comparison_type(p_type:gd.visualshadernodecompare.ComparisonType):Void __visualshadernodecompare_ptr().value.set_comparison_type(((p_type : gd.visualshadernodecompare.ComparisonType)));
	...
	public function set_function(p_func:gd.visualshadernodecompare.Function):Void __visualshadernodecompare_ptr().value.set_function(((p_func : gd.visualshadernodecompare.Function)));
	...
	public function set_condition(p_condition:gd.visualshadernodecompare.Condition):gd.visualshadernodecompare.Condition {
		__visualshadernodecompare_ptr().value.set_condition(((p_condition : gd.visualshadernodecompare.Condition)));
		return p_condition;
	}
