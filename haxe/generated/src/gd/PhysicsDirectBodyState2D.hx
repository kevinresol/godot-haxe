...
class PhysicsDirectBodyState2D extends gd.Object {
	...
	public function set_linear_velocity(p_velocity:gd.Vector2):gd.Vector2 {
		__physicsdirectbodystate2d_ptr().value.set_linear_velocity(((p_velocity : gd.Vector2)));
		return p_velocity;
	}
	...
	public function set_angular_velocity(p_velocity:Float):Float {
		__physicsdirectbodystate2d_ptr().value.set_angular_velocity(((p_velocity : Float)));
		return p_velocity;
	}
	...
	public function apply_impulse(p_impulse:gd.Vector2, ?p_position:gd.Vector2):Void switch [p_impulse, p_position] {
		case [_, null]:__physicsdirectbodystate2d_ptr().value.apply_impulse(((p_impulse : gd.Vector2)));
		default:__physicsdirectbodystate2d_ptr().value.apply_impulse(((p_impulse : gd.Vector2)), ((p_position : gd.Vector2)));
	};
	public function apply_central_force(?p_force:gd.Vector2):Void switch [p_force] {
		case [null]:__physicsdirectbodystate2d_ptr().value.apply_central_force();
		default:__physicsdirectbodystate2d_ptr().value.apply_central_force(((p_force : gd.Vector2)));
	};
	public function apply_force(p_force:gd.Vector2, ?p_position:gd.Vector2):Void switch [p_force, p_position] {
		case [_, null]:__physicsdirectbodystate2d_ptr().value.apply_force(((p_force : gd.Vector2)));
		default:__physicsdirectbodystate2d_ptr().value.apply_force(((p_force : gd.Vector2)), ((p_position : gd.Vector2)));
	};
	public function apply_torque(p_torque:Float):Void __physicsdirectbodystate2d_ptr().value.apply_torque(((p_torque : Float)));
	public function add_constant_central_force(?p_force:gd.Vector2):Void switch [p_force] {
		case [null]:__physicsdirectbodystate2d_ptr().value.add_constant_central_force();
		default:__physicsdirectbodystate2d_ptr().value.add_constant_central_force(((p_force : gd.Vector2)));
	};
	public function add_constant_force(p_force:gd.Vector2, ?p_position:gd.Vector2):Void switch [p_force, p_position] {
		case [_, null]:__physicsdirectbodystate2d_ptr().value.add_constant_force(((p_force : gd.Vector2)));
		default:__physicsdirectbodystate2d_ptr().value.add_constant_force(((p_force : gd.Vector2)), ((p_position : gd.Vector2)));
	};
	public function add_constant_torque(p_torque:Float):Void __physicsdirectbodystate2d_ptr().value.add_constant_torque(((p_torque : Float)));
	public function set_constant_force(p_force:gd.Vector2):Void __physicsdirectbodystate2d_ptr().value.set_constant_force(((p_force : gd.Vector2)));
	public function get_constant_force():gd.Vector2 return __physicsdirectbodystate2d_ptr().value.get_constant_force();
	public function set_constant_torque(p_torque:Float):Void __physicsdirectbodystate2d_ptr().value.set_constant_torque(((p_torque : Float)));
	public function get_constant_torque():Float return __physicsdirectbodystate2d_ptr().value.get_constant_torque();
	public function set_sleep_state(p_enabled:Bool):Void __physicsdirectbodystate2d_ptr().value.set_sleep_state(((p_enabled : Bool)));
	...
	public function get_contact_local_position(p_contact_idx:Int):gd.Vector2 return __physicsdirectbodystate2d_ptr().value.get_contact_local_position(((p_contact_idx : Int)));
	public function get_contact_local_normal(p_contact_idx:Int):gd.Vector2 return __physicsdirectbodystate2d_ptr().value.get_contact_local_normal(((p_contact_idx : Int)));
	public function get_contact_local_shape(p_contact_idx:Int):Int return __physicsdirectbodystate2d_ptr().value.get_contact_local_shape(((p_contact_idx : Int)));
	public function get_contact_local_velocity_at_position(p_contact_idx:Int):gd.Vector2 return __physicsdirectbodystate2d_ptr().value.get_contact_local_velocity_at_position(((p_contact_idx : Int)));
	public function get_contact_collider(p_contact_idx:Int):gd.RID return __physicsdirectbodystate2d_ptr().value.get_contact_collider(((p_contact_idx : Int)));
	public function get_contact_collider_position(p_contact_idx:Int):gd.Vector2 return __physicsdirectbodystate2d_ptr().value.get_contact_collider_position(((p_contact_idx : Int)));
	public function get_contact_collider_id(p_contact_idx:Int):Int return __physicsdirectbodystate2d_ptr().value.get_contact_collider_id(((p_contact_idx : Int)));
	public function get_contact_collider_object(p_contact_idx:Int):gd.Object return __physicsdirectbodystate2d_ptr().value.get_contact_collider_object(((p_contact_idx : Int)));
	public function get_contact_collider_shape(p_contact_idx:Int):Int return __physicsdirectbodystate2d_ptr().value.get_contact_collider_shape(((p_contact_idx : Int)));
	public function get_contact_collider_velocity_at_position(p_contact_idx:Int):gd.Vector2 return __physicsdirectbodystate2d_ptr().value.get_contact_collider_velocity_at_position(((p_contact_idx : Int)));
	public function get_contact_impulse(p_contact_idx:Int):gd.Vector2 return __physicsdirectbodystate2d_ptr().value.get_contact_impulse(((p_contact_idx : Int)));
