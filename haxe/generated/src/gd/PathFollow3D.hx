...
class PathFollow3D extends gd.Node3D {
	...
	public function set_progress(p_progress:Float):Float {
		__pathfollow3d_ptr().value.set_progress(p_progress);
		return p_progress;
	}
	...
	public function set_h_offset(p_h_offset:Float):Float {
		__pathfollow3d_ptr().value.set_h_offset(p_h_offset);
		return p_h_offset;
	}
	...
	public function set_v_offset(p_v_offset:Float):Float {
		__pathfollow3d_ptr().value.set_v_offset(p_v_offset);
		return p_v_offset;
	}
	...
	public function set_progress_ratio(p_ratio:Float):Float {
		__pathfollow3d_ptr().value.set_progress_ratio(p_ratio);
		return p_ratio;
	}
	...
	public function set_rotation_mode(p_rotation_mode:gd.pathfollow3d.RotationMode):gd.pathfollow3d.RotationMode {
		__pathfollow3d_ptr().value.set_rotation_mode(p_rotation_mode);
	...
	public function set_cubic_interpolation(p_enabled:Bool):Void __pathfollow3d_ptr().value.set_cubic_interpolation(p_enabled);
	...
	public function set_use_model_front(p_enabled:Bool):Bool {
		__pathfollow3d_ptr().value.set_use_model_front(p_enabled);
		return p_enabled;
	}
	...
	public function set_loop(p_loop:Bool):Bool {
		__pathfollow3d_ptr().value.set_loop(p_loop);
		return p_loop;
	}
	...
	public function set_tilt_enabled(p_enabled:Bool):Bool {
		__pathfollow3d_ptr().value.set_tilt_enabled(p_enabled);
		return p_enabled;
	}
