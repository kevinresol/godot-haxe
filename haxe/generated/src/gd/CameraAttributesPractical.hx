...
class CameraAttributesPractical extends gd.CameraAttributes {
	...
	public function set_dof_blur_far_enabled(p_enabled:Bool):Bool {
		__cameraattributespractical_ptr().value.set_dof_blur_far_enabled(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_dof_blur_far_distance(p_distance:Float):Float {
		__cameraattributespractical_ptr().value.set_dof_blur_far_distance(((p_distance : Float)));
		return p_distance;
	}
	...
	public function set_dof_blur_far_transition(p_distance:Float):Float {
		__cameraattributespractical_ptr().value.set_dof_blur_far_transition(((p_distance : Float)));
		return p_distance;
	}
	...
	public function set_dof_blur_near_enabled(p_enabled:Bool):Bool {
		__cameraattributespractical_ptr().value.set_dof_blur_near_enabled(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_dof_blur_near_distance(p_distance:Float):Float {
		__cameraattributespractical_ptr().value.set_dof_blur_near_distance(((p_distance : Float)));
		return p_distance;
	}
	...
	public function set_dof_blur_near_transition(p_distance:Float):Float {
		__cameraattributespractical_ptr().value.set_dof_blur_near_transition(((p_distance : Float)));
		return p_distance;
	}
	...
	public function set_dof_blur_amount(p_amount:Float):Float {
		__cameraattributespractical_ptr().value.set_dof_blur_amount(((p_amount : Float)));
		return p_amount;
	}
	...
	public function set_auto_exposure_max_sensitivity(p_max_sensitivity:Float):Float {
		__cameraattributespractical_ptr().value.set_auto_exposure_max_sensitivity(((p_max_sensitivity : Float)));
	...
	public function set_auto_exposure_min_sensitivity(p_min_sensitivity:Float):Float {
		__cameraattributespractical_ptr().value.set_auto_exposure_min_sensitivity(((p_min_sensitivity : Float)));
