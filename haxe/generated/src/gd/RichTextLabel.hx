...
class RichTextLabel extends gd.Control {
	...
	public function add_text(p_text:std.String):Void __richtextlabel_ptr().value.add_text(p_text);
	public function set_text(p_text:std.String):std.String {
		__richtextlabel_ptr().value.set_text(p_text);
		return p_text;
	}
	public function newline():Void __richtextlabel_ptr().value.newline();
	public function remove_paragraph(p_paragraph:Int, ?p_no_invalidate:Bool = false):Bool return __richtextlabel_ptr().value.remove_paragraph(p_paragraph, p_no_invalidate);
	public function invalidate_paragraph(p_paragraph:Int):Bool return __richtextlabel_ptr().value.invalidate_paragraph(p_paragraph);
	public function push_font(p_font:gd.Font, ?p_font_size:Int = 0):Void __richtextlabel_ptr().value.push_font(p_font, p_font_size);
	public function push_font_size(p_font_size:Int):Void __richtextlabel_ptr().value.push_font_size(p_font_size);
	...
	public function push_color(p_color:gd.Color):Void __richtextlabel_ptr().value.push_color(p_color);
	public function push_outline_size(p_outline_size:Int):Void __richtextlabel_ptr().value.push_outline_size(p_outline_size);
	public function push_outline_color(p_color:gd.Color):Void __richtextlabel_ptr().value.push_outline_color(p_color);
	public function push_indent(p_level:Int):Void __richtextlabel_ptr().value.push_indent(p_level);
	public function push_list(p_level:Int, p_type:gd.richtextlabel.ListType, p_capitalize:Bool, ?p_bullet:std.String = "\"•\""):Void __richtextlabel_ptr().value.push_list(p_level, p_type, p_capitalize, p_bullet);
	public function push_hint(p_description:std.String):Void __richtextlabel_ptr().value.push_hint(p_description);
	public function push_language(p_language:std.String):Void __richtextlabel_ptr().value.push_language(p_language);
	...
	public function set_table_column_expand(p_column:Int, p_expand:Bool, ?p_ratio:Int = 1):Void __richtextlabel_ptr().value.set_table_column_expand(p_column, p_expand, p_ratio);
	public function set_cell_row_background_color(p_odd_row_bg:gd.Color, p_even_row_bg:gd.Color):Void __richtextlabel_ptr().value.set_cell_row_background_color(p_odd_row_bg, p_even_row_bg);
	public function set_cell_border_color(p_color:gd.Color):Void __richtextlabel_ptr().value.set_cell_border_color(p_color);
	public function set_cell_size_override(p_min_size:gd.Vector2, p_max_size:gd.Vector2):Void __richtextlabel_ptr().value.set_cell_size_override(p_min_size, p_max_size);
	public function set_cell_padding(p_padding:gd.Rect2):Void __richtextlabel_ptr().value.set_cell_padding(p_padding);
	public function push_cell():Void __richtextlabel_ptr().value.push_cell();
	public function push_fgcolor(p_fgcolor:gd.Color):Void __richtextlabel_ptr().value.push_fgcolor(p_fgcolor);
	public function push_bgcolor(p_bgcolor:gd.Color):Void __richtextlabel_ptr().value.push_bgcolor(p_bgcolor);
	public function push_customfx(p_effect:gd.RichTextEffect, p_env:gd.Dictionary):Void __richtextlabel_ptr().value.push_customfx(p_effect, p_env);
	...
	public function set_structured_text_bidi_override(p_parser:gd.textserver.StructuredTextParser):gd.textserver.StructuredTextParser {
		__richtextlabel_ptr().value.set_structured_text_bidi_override(p_parser);
		return p_parser;
	}
	...
	public function set_structured_text_bidi_override_options(p_args:gd.Array):gd.Array {
		__richtextlabel_ptr().value.set_structured_text_bidi_override_options(p_args);
		return p_args;
	}
	...
	public function set_text_direction(p_direction:gd.control.TextDirection):gd.control.TextDirection {
		__richtextlabel_ptr().value.set_text_direction(p_direction);
		return p_direction;
	}
	...
	public function set_language(p_language:std.String):std.String {
		__richtextlabel_ptr().value.set_language(p_language);
		return p_language;
	}
	...
	public function set_autowrap_mode(p_autowrap_mode:gd.textserver.AutowrapMode):gd.textserver.AutowrapMode {
		__richtextlabel_ptr().value.set_autowrap_mode(p_autowrap_mode);
	...
	public function set_meta_underline(p_enable:Bool):Void __richtextlabel_ptr().value.set_meta_underline(p_enable);
	public function is_meta_underlined():Bool return __richtextlabel_ptr().value.is_meta_underlined();
	public function set_hint_underline(p_enable:Bool):Void __richtextlabel_ptr().value.set_hint_underline(p_enable);
	...
	public function set_scroll_active(p_active:Bool):Bool {
		__richtextlabel_ptr().value.set_scroll_active(p_active);
		return p_active;
	}
	public function is_scroll_active():Bool return __richtextlabel_ptr().value.is_scroll_active();
	public function set_scroll_follow(p_follow:Bool):Void __richtextlabel_ptr().value.set_scroll_follow(p_follow);
	...
	public function scroll_to_line(p_line:Int):Void __richtextlabel_ptr().value.scroll_to_line(p_line);
	public function scroll_to_paragraph(p_paragraph:Int):Void __richtextlabel_ptr().value.scroll_to_paragraph(p_paragraph);
	...
	public function set_tab_size(p_spaces:Int):Int {
		__richtextlabel_ptr().value.set_tab_size(p_spaces);
		return p_spaces;
	}
	...
	public function set_fit_content(p_enabled:Bool):Bool {
		__richtextlabel_ptr().value.set_fit_content(p_enabled);
		return p_enabled;
	}
	...
	public function set_selection_enabled(p_enabled:Bool):Bool {
		__richtextlabel_ptr().value.set_selection_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_context_menu_enabled(p_enabled:Bool):Bool {
		__richtextlabel_ptr().value.set_context_menu_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_shortcut_keys_enabled(p_enabled:Bool):Bool {
		__richtextlabel_ptr().value.set_shortcut_keys_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_deselect_on_focus_loss_enabled(p_enable:Bool):Bool {
		__richtextlabel_ptr().value.set_deselect_on_focus_loss_enabled(p_enable);
		return p_enable;
	}
	...
	public function set_drag_and_drop_selection_enabled(p_enable:Bool):Bool {
		__richtextlabel_ptr().value.set_drag_and_drop_selection_enabled(p_enable);
		return p_enable;
	}
	...
	public function parse_bbcode(p_bbcode:std.String):Void __richtextlabel_ptr().value.parse_bbcode(p_bbcode);
	public function append_text(p_bbcode:std.String):Void __richtextlabel_ptr().value.append_text(p_bbcode);
	...
	public function set_threaded(p_threaded:Bool):Bool {
		__richtextlabel_ptr().value.set_threaded(p_threaded);
		return p_threaded;
	}
	...
	public function set_progress_bar_delay(p_delay_ms:Int):Int {
		__richtextlabel_ptr().value.set_progress_bar_delay(p_delay_ms);
		return p_delay_ms;
	}
	...
	public function set_visible_characters(p_amount:Int):Int {
		__richtextlabel_ptr().value.set_visible_characters(p_amount);
		return p_amount;
	}
	...
	public function set_visible_characters_behavior(p_behavior:gd.textserver.VisibleCharactersBehavior):gd.textserver.VisibleCharactersBehavior {
		__richtextlabel_ptr().value.set_visible_characters_behavior(p_behavior);
		return p_behavior;
	}
	public function set_visible_ratio(p_ratio:Float):Float {
		__richtextlabel_ptr().value.set_visible_ratio(p_ratio);
		return p_ratio;
	}
	public function get_visible_ratio():Float return __richtextlabel_ptr().value.get_visible_ratio();
	public function get_character_line(p_character:Int):Int return __richtextlabel_ptr().value.get_character_line(p_character);
	public function get_character_paragraph(p_character:Int):Int return __richtextlabel_ptr().value.get_character_paragraph(p_character);
	public function get_total_character_count():Int return __richtextlabel_ptr().value.get_total_character_count();
	public function set_use_bbcode(p_enable:Bool):Void __richtextlabel_ptr().value.set_use_bbcode(p_enable);
	...
	public function get_line_offset(p_line:Int):Float return __richtextlabel_ptr().value.get_line_offset(p_line);
	public function get_paragraph_offset(p_paragraph:Int):Float return __richtextlabel_ptr().value.get_paragraph_offset(p_paragraph);
	public function parse_expressions_for_values(p_expressions:gd.PackedStringArray):gd.Dictionary return __richtextlabel_ptr().value.parse_expressions_for_values(p_expressions);
	public function set_effects(p_effects:gd.Array):Void __richtextlabel_ptr().value.set_effects(p_effects);
	public function get_effects():gd.Array return __richtextlabel_ptr().value.get_effects();
	public function install_effect(p_effect:gd.Variant):Void __richtextlabel_ptr().value.install_effect(p_effect);
	...
	public function menu_option(p_option:Int):Void __richtextlabel_ptr().value.menu_option(p_option);
