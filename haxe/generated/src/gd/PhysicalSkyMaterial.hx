...
class PhysicalSkyMaterial extends gd.Material {
	...
	public function set_rayleigh_coefficient(p_rayleigh:Float):Float {
		__physicalskymaterial_ptr().value.set_rayleigh_coefficient(p_rayleigh);
		return p_rayleigh;
	}
	...
	public function set_rayleigh_color(p_color:gd.Color):gd.Color {
		__physicalskymaterial_ptr().value.set_rayleigh_color(p_color);
		return p_color;
	}
	...
	public function set_mie_coefficient(p_mie:Float):Float {
		__physicalskymaterial_ptr().value.set_mie_coefficient(p_mie);
		return p_mie;
	}
	...
	public function set_mie_eccentricity(p_eccentricity:Float):Float {
		__physicalskymaterial_ptr().value.set_mie_eccentricity(p_eccentricity);
	...
	public function set_mie_color(p_color:gd.Color):gd.Color {
		__physicalskymaterial_ptr().value.set_mie_color(p_color);
		return p_color;
	}
	...
	public function set_turbidity(p_turbidity:Float):Float {
		__physicalskymaterial_ptr().value.set_turbidity(p_turbidity);
		return p_turbidity;
	}
	...
	public function set_sun_disk_scale(p_scale:Float):Float {
		__physicalskymaterial_ptr().value.set_sun_disk_scale(p_scale);
		return p_scale;
	}
	...
	public function set_ground_color(p_color:gd.Color):gd.Color {
		__physicalskymaterial_ptr().value.set_ground_color(p_color);
		return p_color;
	}
	...
	public function set_energy_multiplier(p_multiplier:Float):Float {
		__physicalskymaterial_ptr().value.set_energy_multiplier(p_multiplier);
		return p_multiplier;
	}
	...
	public function set_use_debanding(p_use_debanding:Bool):Bool {
		__physicalskymaterial_ptr().value.set_use_debanding(p_use_debanding);
	...
	public function set_night_sky(p_night_sky:gd.Texture2D):gd.Texture2D {
		__physicalskymaterial_ptr().value.set_night_sky(p_night_sky);
		return p_night_sky;
	}
