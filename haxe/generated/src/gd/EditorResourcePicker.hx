...
class EditorResourcePicker extends gd.HBoxContainer {
	...
	public function _set_create_options(p_menu_node:gd.Object):Void __editorresourcepicker_ptr().value._set_create_options(p_menu_node);
	public function _handle_menu_selected(p_id:Int):Bool return __editorresourcepicker_ptr().value._handle_menu_selected(p_id);
	public function set_base_type(p_base_type:std.String):std.String {
		__editorresourcepicker_ptr().value.set_base_type(p_base_type);
		return p_base_type;
	}
	...
	public function set_edited_resource(p_resource:gd.Resource):gd.Resource {
		__editorresourcepicker_ptr().value.set_edited_resource(p_resource);
		return p_resource;
	}
	...
	public function set_toggle_mode(p_enable:Bool):Bool {
		__editorresourcepicker_ptr().value.set_toggle_mode(p_enable);
		return p_enable;
	}
	public function is_toggle_mode():Bool return __editorresourcepicker_ptr().value.is_toggle_mode();
	public function set_toggle_pressed(p_pressed:Bool):Void __editorresourcepicker_ptr().value.set_toggle_pressed(p_pressed);
	public function set_editable(p_enable:Bool):Bool {
		__editorresourcepicker_ptr().value.set_editable(p_enable);
		return p_enable;
	}
