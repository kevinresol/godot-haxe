...
class LabelSettings extends gd.Resource {
	...
	public function set_line_spacing(p_spacing:Float):Float {
		__labelsettings_ptr().value.set_line_spacing(p_spacing);
		return p_spacing;
	}
	...
	public function set_font_color(p_color:gd.Color):gd.Color {
		__labelsettings_ptr().value.set_font_color(p_color);
		return p_color;
	}
	...
	public function set_outline_size(p_size:Int):Int {
		__labelsettings_ptr().value.set_outline_size(p_size);
		return p_size;
	}
	...
	public function set_outline_color(p_color:gd.Color):gd.Color {
		__labelsettings_ptr().value.set_outline_color(p_color);
		return p_color;
	}
	...
	public function set_shadow_size(p_size:Int):Int {
		__labelsettings_ptr().value.set_shadow_size(p_size);
		return p_size;
	}
	...
	public function set_shadow_color(p_color:gd.Color):gd.Color {
		__labelsettings_ptr().value.set_shadow_color(p_color);
		return p_color;
	}
	...
	public function set_shadow_offset(p_offset:gd.Vector2):gd.Vector2 {
		__labelsettings_ptr().value.set_shadow_offset(p_offset);
		return p_offset;
	}
