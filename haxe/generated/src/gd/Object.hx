...
class Object {
	...
	public function notification(p_what:Int, ?p_reversed:Bool = false):Void __object_ptr().value.notification(p_what, p_reversed);
	...
	public function callv(p_method:std.String, p_arg_array:gd.Array):gd.Variant return __object_ptr().value.callv(p_method, p_arg_array);
	...
	public function connect(p_signal:std.String, p_callable:gd.Callable, ?p_flags:Int = 0):gd.Error return __object_ptr().value.connect(p_signal, p_callable, p_flags);
