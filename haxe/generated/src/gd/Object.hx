package gd;
class Object {
	public function get_class():String return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.get_class();
	public function is_class(p_class:String):Bool return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.is_class(p_class);
	public function set(p_property:String, p_value:gd.Variant):Void ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.set(p_property, p_value);
	public function get(p_property:String):gd.Variant return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.get(p_property);
	public function set_indexed(p_property_path:String, p_value:gd.Variant):Void ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.set_indexed(p_property_path, p_value);
	public function get_indexed(p_property_path:String):gd.Variant return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.get_indexed(p_property_path);
	public function property_can_revert(p_property:String):Bool return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.property_can_revert(p_property);
	public function property_get_revert(p_property:String):gd.Variant return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.property_get_revert(p_property);
	...
	public function to_string():String return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.to_string();
	...
	public function set_meta(p_name:String, p_value:gd.Variant):Void ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.set_meta(p_name, p_value);
	public function remove_meta(p_name:String):Void ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.remove_meta(p_name);
	public function get_meta(p_name:String, ?p_default:gd.Variant):gd.Variant return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.get_meta(p_name, p_default);
	...
	public function tr(p_message:String, ?p_context:String):String return ((cast __gd.ptr : cpp.Pointer<gdnative.Object.Object_extern>)).value.tr(p_message, p_context);
	...
	public function new(allocate:Bool = true) {
		if (allocate) __gd = new gdnative.ObjectContainer(((gdnative.Object.Object_extern.__alloc().reinterpret() : cpp.Pointer<gdnative.Object.Object_extern>)), true);
	}
