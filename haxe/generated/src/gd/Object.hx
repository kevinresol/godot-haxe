...
@:cppInclude('iostream') class Object {
	...
	public function get_class():std.String return {
		final v = __object_ptr().value.get_class();
		v;
	};
	...
	public function get(p_property:std.String):gd.Variant return {
		final v = __object_ptr().value.get(((p_property : std.String)));
		v;
	};
	...
	public function get_indexed(p_property_path:std.String):gd.Variant return {
		final v = __object_ptr().value.get_indexed(((p_property_path : std.String)));
		v;
	};
	...
	public function property_get_revert(p_property:std.String):gd.Variant return {
		final v = __object_ptr().value.property_get_revert(((p_property : std.String)));
		v;
	};
	...
	public function to_string():std.String return {
		final v = __object_ptr().value.to_string();
		v;
	};
	...
	public function get_script():gd.Variant return {
		final v = __object_ptr().value.get_script();
		v;
	};
	...
	public function get_meta(p_name:std.String, ?p_default:gd.Variant):gd.Variant return switch [p_name, p_default] {
		case [_, null]:{
			final v = __object_ptr().value.get_meta(((p_name : std.String)));
			v;
		};
		default:{
			final v = __object_ptr().value.get_meta(((p_name : std.String)), ((p_default : gd.Variant)));
			v;
		};
	};
	...
	public function callv(p_method:std.String, p_arg_array:gd.Array):gd.Variant return {
		final v = __object_ptr().value.callv(((p_method : std.String)), ((p_arg_array : gd.Array)));
		v;
	};
	...
	public function tr(p_message:std.String, ?p_context:std.String):std.String return switch [p_message, p_context] {
		case [_, null]:{
			final v = __object_ptr().value.tr(((p_message : std.String)));
			v;
		};
		default:{
			final v = __object_ptr().value.tr(((p_message : std.String)), ((p_context : std.String)));
			v;
		};
	};
	public function tr_n(p_message:std.String, p_plural_message:std.String, p_n:cpp.Int64, ?p_context:std.String):std.String return switch [p_message, p_plural_message, p_n, p_context] {
		case [_, _, _, null]:{
			final v = __object_ptr().value.tr_n(((p_message : std.String)), ((p_plural_message : std.String)), ((p_n : cpp.Int64)));
			v;
		};
		default:{
			final v = __object_ptr().value.tr_n(((p_message : std.String)), ((p_plural_message : std.String)), ((p_n : cpp.Int64)), ((p_context : std.String)));
			v;
		};
	};
	public function get_translation_domain():std.String return {
		final v = __object_ptr().value.get_translation_domain();
		v;
	};
