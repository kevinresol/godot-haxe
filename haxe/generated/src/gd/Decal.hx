...
class Decal extends gd.VisualInstance3D {
	...
	public function set_size(p_size:gd.Vector3):gd.Vector3 {
		__decal_ptr().value.set_size(p_size);
		return p_size;
	}
	public function get_size():gd.Vector3 return __decal_ptr().value.get_size();
	public function set_texture(p_type:gd.decal.DecalTexture, p_texture:gd.Texture2D):Void __decal_ptr().value.set_texture(p_type, p_texture);
	public function get_texture(p_type:gd.decal.DecalTexture):gd.Texture2D return __decal_ptr().value.get_texture(p_type);
	public function set_emission_energy(p_energy:Float):Float {
		__decal_ptr().value.set_emission_energy(p_energy);
		return p_energy;
	}
	...
	public function set_albedo_mix(p_energy:Float):Float {
		__decal_ptr().value.set_albedo_mix(p_energy);
		return p_energy;
	}
	...
	public function set_modulate(p_color:gd.Color):gd.Color {
		__decal_ptr().value.set_modulate(p_color);
		return p_color;
	}
	...
	public function set_upper_fade(p_fade:Float):Float {
		__decal_ptr().value.set_upper_fade(p_fade);
		return p_fade;
	}
	...
	public function set_lower_fade(p_fade:Float):Float {
		__decal_ptr().value.set_lower_fade(p_fade);
		return p_fade;
	}
	...
	public function set_normal_fade(p_fade:Float):Float {
		__decal_ptr().value.set_normal_fade(p_fade);
		return p_fade;
	}
	public function get_normal_fade():Float return __decal_ptr().value.get_normal_fade();
	public function set_enable_distance_fade(p_enable:Bool):Void __decal_ptr().value.set_enable_distance_fade(p_enable);
	...
	public function set_distance_fade_begin(p_distance:Float):Float {
		__decal_ptr().value.set_distance_fade_begin(p_distance);
		return p_distance;
	}
	...
	public function set_distance_fade_length(p_distance:Float):Float {
		__decal_ptr().value.set_distance_fade_length(p_distance);
		return p_distance;
	}
	...
	public function set_cull_mask(p_mask:Int):Int {
		__decal_ptr().value.set_cull_mask(p_mask);
		return p_mask;
	}
