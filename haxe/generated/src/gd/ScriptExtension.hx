...
class ScriptExtension extends gd.Script {
	...
	public function _inherits_script(p_script:gd.Script):Bool return __scriptextension_ptr().value._inherits_script(p_script);
	public function _get_instance_base_type():std.String return __scriptextension_ptr().value._get_instance_base_type();
	public function _instance_has(p_object:gd.Object):Bool return __scriptextension_ptr().value._instance_has(p_object);
	...
	public function _set_source_code(p_code:std.String):Void __scriptextension_ptr().value._set_source_code(p_code);
	public function _reload(p_keep_state:Bool):gd.Error return __scriptextension_ptr().value._reload(p_keep_state);
	public function _get_class_icon_path():std.String return __scriptextension_ptr().value._get_class_icon_path();
	public function _has_method(p_method:std.String):Bool return __scriptextension_ptr().value._has_method(p_method);
	public function _has_static_method(p_method:std.String):Bool return __scriptextension_ptr().value._has_static_method(p_method);
	public function _get_script_method_argument_count(p_method:std.String):gd.Variant return __scriptextension_ptr().value._get_script_method_argument_count(p_method);
	public function _get_method_info(p_method:std.String):gd.Dictionary return __scriptextension_ptr().value._get_method_info(p_method);
	...
	public function _has_script_signal(p_signal:std.String):Bool return __scriptextension_ptr().value._has_script_signal(p_signal);
	public function _has_property_default_value(p_property:std.String):Bool return __scriptextension_ptr().value._has_property_default_value(p_property);
	public function _get_property_default_value(p_property:std.String):gd.Variant return __scriptextension_ptr().value._get_property_default_value(p_property);
	public function _update_exports():Void __scriptextension_ptr().value._update_exports();
	public function _get_member_line(p_member:std.String):Int return __scriptextension_ptr().value._get_member_line(p_member);
