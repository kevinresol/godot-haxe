...
class MultiplayerAPI extends gd.RefCounted {
	...
	public function set_multiplayer_peer(p_peer:gd.MultiplayerPeer):gd.MultiplayerPeer {
		__multiplayerapi_ptr().value.set_multiplayer_peer(p_peer);
		return p_peer;
	}
	...
	public function object_configuration_add(p_object:gd.Object, p_configuration:gd.Variant):gd.Error return __multiplayerapi_ptr().value.object_configuration_add(p_object, p_configuration);
	public function object_configuration_remove(p_object:gd.Object, p_configuration:gd.Variant):gd.Error return __multiplayerapi_ptr().value.object_configuration_remove(p_object, p_configuration);
	public function get_peers():gd.PackedInt32Array return __multiplayerapi_ptr().value.get_peers();
	public static function set_default_interface(p_interface_name:std.String):Void gdnative.MultiplayerAPI.MultiplayerAPI_extern.set_default_interface(p_interface_name);
