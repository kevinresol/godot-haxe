...
class EditorFileDialog extends gd.ConfirmationDialog {
	...
	public function add_filter(p_filter:std.String, ?p_description:std.String):Void switch [p_filter, p_description] {
		case [_, null]:__editorfiledialog_ptr().value.add_filter(((p_filter : std.String)));
		default:__editorfiledialog_ptr().value.add_filter(((p_filter : std.String)), ((p_description : std.String)));
	};
	public function set_filters(p_filters:gd.PackedStringArray):gd.PackedStringArray {
		__editorfiledialog_ptr().value.set_filters(((p_filters : gd.PackedStringArray)));
		return p_filters;
	}
	public function get_filters():gd.PackedStringArray return __editorfiledialog_ptr().value.get_filters();
	public function get_option_name(p_option:Int):std.String return __editorfiledialog_ptr().value.get_option_name(((p_option : Int)));
	public function get_option_values(p_option:Int):gd.PackedStringArray return __editorfiledialog_ptr().value.get_option_values(((p_option : Int)));
	public function get_option_default(p_option:Int):Int return __editorfiledialog_ptr().value.get_option_default(((p_option : Int)));
	public function set_option_name(p_option:Int, p_name:std.String):Void __editorfiledialog_ptr().value.set_option_name(((p_option : Int)), ((p_name : std.String)));
	public function set_option_values(p_option:Int, p_values:gd.PackedStringArray):Void __editorfiledialog_ptr().value.set_option_values(((p_option : Int)), ((p_values : gd.PackedStringArray)));
	public function set_option_default(p_option:Int, p_default_value_index:Int):Void __editorfiledialog_ptr().value.set_option_default(((p_option : Int)), ((p_default_value_index : Int)));
	public function set_option_count(p_count:Int):Int {
		__editorfiledialog_ptr().value.set_option_count(((p_count : Int)));
		return p_count;
	}
	public function get_option_count():Int return __editorfiledialog_ptr().value.get_option_count();
	public function add_option(p_name:std.String, p_values:gd.PackedStringArray, p_default_value_index:Int):Void __editorfiledialog_ptr().value.add_option(((p_name : std.String)), ((p_values : gd.PackedStringArray)), ((p_default_value_index : Int)));
	...
	public function set_current_dir(p_dir:std.String):std.String {
		__editorfiledialog_ptr().value.set_current_dir(((p_dir : std.String)));
		return p_dir;
	}
	public function set_current_file(p_file:std.String):std.String {
		__editorfiledialog_ptr().value.set_current_file(((p_file : std.String)));
		return p_file;
	}
	public function set_current_path(p_path:std.String):std.String {
		__editorfiledialog_ptr().value.set_current_path(((p_path : std.String)));
		return p_path;
	}
	public function set_file_mode(p_mode:gd.editorfiledialog.FileMode):gd.editorfiledialog.FileMode {
		__editorfiledialog_ptr().value.set_file_mode(((p_mode : gd.editorfiledialog.FileMode)));
		return p_mode;
	}
	...
	public function set_access(p_access:gd.editorfiledialog.Access):gd.editorfiledialog.Access {
		__editorfiledialog_ptr().value.set_access(((p_access : gd.editorfiledialog.Access)));
		return p_access;
	}
	...
	public function set_show_hidden_files(p_show:Bool):Bool {
		__editorfiledialog_ptr().value.set_show_hidden_files(((p_show : Bool)));
		return p_show;
	}
	...
	public function set_display_mode(p_mode:gd.editorfiledialog.DisplayMode):gd.editorfiledialog.DisplayMode {
		__editorfiledialog_ptr().value.set_display_mode(((p_mode : gd.editorfiledialog.DisplayMode)));
		return p_mode;
	}
	...
	public function set_disable_overwrite_warning(p_disable:Bool):Bool {
		__editorfiledialog_ptr().value.set_disable_overwrite_warning(((p_disable : Bool)));
		return p_disable;
	}
	public function is_overwrite_warning_disabled():Bool return __editorfiledialog_ptr().value.is_overwrite_warning_disabled();
	public function add_side_menu(p_menu:gd.Control, ?p_title:std.String):Void switch [p_menu, p_title] {
		case [_, null]:__editorfiledialog_ptr().value.add_side_menu(((p_menu : gd.Control)));
		default:__editorfiledialog_ptr().value.add_side_menu(((p_menu : gd.Control)), ((p_title : std.String)));
	};
