...
class VisualShaderNodeUIntOp extends gd.VisualShaderNode {
	...
	public function set_operator(p_op:gd.visualshadernodeuintop.Operator):Void __visualshadernodeuintop_ptr().value.set_operator(p_op);
	...
	function get__operator():gd.visualshadernodeuintop.Operator return get_operator();
