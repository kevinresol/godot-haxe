...
class AudioStreamPlayer2D extends gd.Node2D {
	...
	public function set_stream(p_stream:gd.AudioStream):gd.AudioStream {
		__audiostreamplayer2d_ptr().value.set_stream(((p_stream : gd.AudioStream)));
		return p_stream;
	}
	...
	public function set_volume_db(p_volume_db:Float):Float {
		__audiostreamplayer2d_ptr().value.set_volume_db(((p_volume_db : Float)));
		return p_volume_db;
	}
	...
	public function set_pitch_scale(p_pitch_scale:Float):Float {
		__audiostreamplayer2d_ptr().value.set_pitch_scale(((p_pitch_scale : Float)));
	...
	public function play(?p_from_position:Float):Void switch [p_from_position] {
		case [null]:__audiostreamplayer2d_ptr().value.play();
		default:__audiostreamplayer2d_ptr().value.play(((p_from_position : Float)));
	};
	public function seek(p_to_position:Float):Void __audiostreamplayer2d_ptr().value.seek(((p_to_position : Float)));
	...
	public function set_bus(p_bus:std.String):std.String {
		__audiostreamplayer2d_ptr().value.set_bus(((p_bus : std.String)));
		return p_bus;
	}
	...
	public function set_autoplay(p_enable:Bool):Bool {
		__audiostreamplayer2d_ptr().value.set_autoplay(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_max_distance(p_pixels:Float):Float {
		__audiostreamplayer2d_ptr().value.set_max_distance(((p_pixels : Float)));
		return p_pixels;
	}
	...
	public function set_attenuation(p_curve:Float):Float {
		__audiostreamplayer2d_ptr().value.set_attenuation(((p_curve : Float)));
		return p_curve;
	}
	...
	public function set_area_mask(p_mask:Int):Int {
		__audiostreamplayer2d_ptr().value.set_area_mask(((p_mask : Int)));
		return p_mask;
	}
	...
	public function set_stream_paused(p_pause:Bool):Bool {
		__audiostreamplayer2d_ptr().value.set_stream_paused(((p_pause : Bool)));
		return p_pause;
	}
	...
	public function set_max_polyphony(p_max_polyphony:Int):Int {
		__audiostreamplayer2d_ptr().value.set_max_polyphony(((p_max_polyphony : Int)));
	...
	public function set_panning_strength(p_panning_strength:Float):Float {
		__audiostreamplayer2d_ptr().value.set_panning_strength(((p_panning_strength : Float)));
	...
	public function set_playback_type(p_playback_type:gd.audioserver.PlaybackType):gd.audioserver.PlaybackType {
		__audiostreamplayer2d_ptr().value.set_playback_type(((p_playback_type : gd.audioserver.PlaybackType)));
