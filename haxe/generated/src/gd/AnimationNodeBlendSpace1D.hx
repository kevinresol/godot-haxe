...
class AnimationNodeBlendSpace1D extends gd.AnimationRootNode {
	...
	public function add_blend_point(p_node:gd.AnimationRootNode, p_pos:Float, ?p_at_index:Int = -1):Void __animationnodeblendspace1d_ptr().value.add_blend_point(p_node, p_pos, p_at_index);
	public function set_blend_point_position(p_point:Int, p_pos:Float):Void __animationnodeblendspace1d_ptr().value.set_blend_point_position(p_point, p_pos);
	public function get_blend_point_position(p_point:Int):Float return __animationnodeblendspace1d_ptr().value.get_blend_point_position(p_point);
	public function set_blend_point_node(p_point:Int, p_node:gd.AnimationRootNode):Void __animationnodeblendspace1d_ptr().value.set_blend_point_node(p_point, p_node);
	public function get_blend_point_node(p_point:Int):gd.AnimationRootNode return __animationnodeblendspace1d_ptr().value.get_blend_point_node(p_point);
	public function remove_blend_point(p_point:Int):Void __animationnodeblendspace1d_ptr().value.remove_blend_point(p_point);
	...
	public function set_min_space(p_min_space:Float):Float {
		__animationnodeblendspace1d_ptr().value.set_min_space(p_min_space);
		return p_min_space;
	}
	...
	public function set_max_space(p_max_space:Float):Float {
		__animationnodeblendspace1d_ptr().value.set_max_space(p_max_space);
		return p_max_space;
	}
	...
	public function set_snap(p_snap:Float):Float {
		__animationnodeblendspace1d_ptr().value.set_snap(p_snap);
		return p_snap;
	}
	...
	public function set_value_label(p_text:std.String):std.String {
		__animationnodeblendspace1d_ptr().value.set_value_label(p_text);
		return p_text;
	}
	...
	public function set_blend_mode(p_mode:gd.animationnodeblendspace1d.BlendMode):gd.animationnodeblendspace1d.BlendMode {
		__animationnodeblendspace1d_ptr().value.set_blend_mode(p_mode);
		return p_mode;
	}
	...
	public function set_use_sync(p_enable:Bool):Void __animationnodeblendspace1d_ptr().value.set_use_sync(p_enable);
