...
class Script extends gd.Resource {
	...
	public function instance_has(p_base_object:gd.Object):Bool return __script_ptr().value.instance_has(p_base_object);
	...
	public function set_source_code(p_source:std.String):std.String {
		__script_ptr().value.set_source_code(p_source);
		return p_source;
	}
	public function reload(?p_keep_state:Bool = false):gd.Error return __script_ptr().value.reload(p_keep_state);
	...
	public function has_script_signal(p_signal_name:std.String):Bool return __script_ptr().value.has_script_signal(p_signal_name);
	public function get_script_constant_map():gd.Dictionary return __script_ptr().value.get_script_constant_map();
	public function get_property_default_value(p_property:std.String):gd.Variant return __script_ptr().value.get_property_default_value(p_property);
