...
class PackedByteArray_wrapper {
	...
	public function slice(p_begin:Int, ?p_end:Int):gd.PackedByteArray return switch [p_begin, p_end] {
	...
	public function compress(?p_compression_mode:Int):gd.PackedByteArray return switch [p_compression_mode] {
		case [null]:__gd.compress();
		default:__gd.compress(((p_compression_mode : Int)));
	};
	public function decompress(p_buffer_size:Int, ?p_compression_mode:Int):gd.PackedByteArray return switch [p_buffer_size, p_compression_mode] {
		case [_, null]:__gd.decompress(((p_buffer_size : Int)));
		default:__gd.decompress(((p_buffer_size : Int)), ((p_compression_mode : Int)));
	};
	public function decompress_dynamic(p_max_output_size:Int, ?p_compression_mode:Int):gd.PackedByteArray return switch [p_max_output_size, p_compression_mode] {
		case [_, null]:__gd.decompress_dynamic(((p_max_output_size : Int)));
		default:__gd.decompress_dynamic(((p_max_output_size : Int)), ((p_compression_mode : Int)));
	};
	public function decode_u8(p_byte_offset:Int):Int return __gd.decode_u8(((p_byte_offset : Int)));
	public function decode_s8(p_byte_offset:Int):Int return __gd.decode_s8(((p_byte_offset : Int)));
	public function decode_u16(p_byte_offset:Int):Int return __gd.decode_u16(((p_byte_offset : Int)));
	public function decode_s16(p_byte_offset:Int):Int return __gd.decode_s16(((p_byte_offset : Int)));
	public function decode_u32(p_byte_offset:Int):Int return __gd.decode_u32(((p_byte_offset : Int)));
	public function decode_s32(p_byte_offset:Int):Int return __gd.decode_s32(((p_byte_offset : Int)));
	public function decode_u64(p_byte_offset:Int):Int return __gd.decode_u64(((p_byte_offset : Int)));
	public function decode_s64(p_byte_offset:Int):Int return __gd.decode_s64(((p_byte_offset : Int)));
	public function decode_half(p_byte_offset:Int):Float return __gd.decode_half(((p_byte_offset : Int)));
	public function decode_float(p_byte_offset:Int):Float return __gd.decode_float(((p_byte_offset : Int)));
	public function decode_double(p_byte_offset:Int):Float return __gd.decode_double(((p_byte_offset : Int)));
	public function has_encoded_var(p_byte_offset:Int, ?p_allow_objects:Bool):Bool return switch [p_byte_offset, p_allow_objects] {
		case [_, null]:__gd.has_encoded_var(((p_byte_offset : Int)));
		default:__gd.has_encoded_var(((p_byte_offset : Int)), ((p_allow_objects : Bool)));
	};
	public function decode_var(p_byte_offset:Int, ?p_allow_objects:Bool):gd.Variant return switch [p_byte_offset, p_allow_objects] {
		case [_, null]:__gd.decode_var(((p_byte_offset : Int)));
		default:__gd.decode_var(((p_byte_offset : Int)), ((p_allow_objects : Bool)));
	};
	public function decode_var_size(p_byte_offset:Int, ?p_allow_objects:Bool):Int return switch [p_byte_offset, p_allow_objects] {
		case [_, null]:__gd.decode_var_size(((p_byte_offset : Int)));
		default:__gd.decode_var_size(((p_byte_offset : Int)), ((p_allow_objects : Bool)));
	};
	...
	public function encode_u8(p_byte_offset:Int, p_value:Int):Void __gd.encode_u8(((p_byte_offset : Int)), ((p_value : Int)));
	public function encode_s8(p_byte_offset:Int, p_value:Int):Void __gd.encode_s8(((p_byte_offset : Int)), ((p_value : Int)));
	public function encode_u16(p_byte_offset:Int, p_value:Int):Void __gd.encode_u16(((p_byte_offset : Int)), ((p_value : Int)));
	public function encode_s16(p_byte_offset:Int, p_value:Int):Void __gd.encode_s16(((p_byte_offset : Int)), ((p_value : Int)));
	public function encode_u32(p_byte_offset:Int, p_value:Int):Void __gd.encode_u32(((p_byte_offset : Int)), ((p_value : Int)));
	public function encode_s32(p_byte_offset:Int, p_value:Int):Void __gd.encode_s32(((p_byte_offset : Int)), ((p_value : Int)));
	public function encode_u64(p_byte_offset:Int, p_value:Int):Void __gd.encode_u64(((p_byte_offset : Int)), ((p_value : Int)));
	public function encode_s64(p_byte_offset:Int, p_value:Int):Void __gd.encode_s64(((p_byte_offset : Int)), ((p_value : Int)));
	public function encode_half(p_byte_offset:Int, p_value:Float):Void __gd.encode_half(((p_byte_offset : Int)), ((p_value : Float)));
	public function encode_float(p_byte_offset:Int, p_value:Float):Void __gd.encode_float(((p_byte_offset : Int)), ((p_value : Float)));
	public function encode_double(p_byte_offset:Int, p_value:Float):Void __gd.encode_double(((p_byte_offset : Int)), ((p_value : Float)));
	public function encode_var(p_byte_offset:Int, p_value:gd.Variant, ?p_allow_objects:Bool):Int return switch [p_byte_offset, p_value, p_allow_objects] {
		case [_, _, null]:__gd.encode_var(((p_byte_offset : Int)), ((p_value : gd.Variant)));
		default:__gd.encode_var(((p_byte_offset : Int)), ((p_value : gd.Variant)), ((p_allow_objects : Bool)));
	};
