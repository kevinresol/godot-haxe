...
class XRNode3D extends gd.Node3D {
	...
	public function set_tracker(p_tracker_name:std.String):std.String {
		__xrnode3d_ptr().value.set_tracker(p_tracker_name);
		return p_tracker_name;
	}
	public function get_tracker():std.String return __xrnode3d_ptr().value.get_tracker();
	public function set_pose_name(p_pose:std.String):Void __xrnode3d_ptr().value.set_pose_name(p_pose);
	...
	public function set_show_when_tracked(p_show:Bool):Bool {
		__xrnode3d_ptr().value.set_show_when_tracked(p_show);
		return p_show;
	}
	...
	public function trigger_haptic_pulse(p_action_name:std.String, p_frequency:Float, p_amplitude:Float, p_duration_sec:Float, p_delay_sec:Float):Void __xrnode3d_ptr().value.trigger_haptic_pulse(p_action_name, p_frequency, p_amplitude, p_duration_sec, p_delay_sec);
