...
class Rect2i_wrapper {
	...
	function __op_equal_to_rect2i(p_rhs:gd.Rect2i):Bool return @:privateAccess this.__gd.__op_equal_to_rect2i(((p_rhs : gdnative.Rect2i)));
	function __op_not_equal_rect2i(p_rhs:gd.Rect2i):Bool return @:privateAccess this.__gd.__op_not_equal_rect2i(((p_rhs : gdnative.Rect2i)));
