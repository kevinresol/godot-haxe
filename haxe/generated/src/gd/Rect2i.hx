...
class Rect2i_wrapper {
	...
	static function _new2(p_from:gd.Rect2):Rect2i_wrapper return new Rect2i_wrapper(new gdnative.Rect2i(p_from));
	static function _new3(p_position:gd.Vector2i, p_size:gd.Vector2i):Rect2i_wrapper return new Rect2i_wrapper(new gdnative.Rect2i(p_position, p_size));
	static function _new4(p_x:Int, p_y:Int, p_width:Int, p_height:Int):Rect2i_wrapper return new Rect2i_wrapper(new gdnative.Rect2i(p_x, p_y, p_width, p_height));
...
@:forward @:forwardStatics abstract Rect2i(Rect2i_wrapper) from Rect2i_wrapper to Rect2i_wrapper {
	...
	public extern overload inline function new(p_from:gd.Rect2) this = @:privateAccess Rect2i_wrapper._new2(p_from);
	public extern overload inline function new(p_position:gd.Vector2i, p_size:gd.Vector2i) this = @:privateAccess Rect2i_wrapper._new3(p_position, p_size);
	public extern overload inline function new(p_x:Int, p_y:Int, p_width:Int, p_height:Int) this = @:privateAccess Rect2i_wrapper._new4(p_x, p_y, p_width, p_height);
}