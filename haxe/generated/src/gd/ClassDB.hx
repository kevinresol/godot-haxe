...
class ClassDB extends gd.Object {
	...
	public function get_inheriters_from_class(p_class:std.String):gd.PackedStringArray return __classdb_ptr().value.get_inheriters_from_class(p_class);
	...
	public function class_get_signal(p_class:std.String, p_signal:std.String):gd.Dictionary return __classdb_ptr().value.class_get_signal(p_class, p_signal);
	...
	public function class_has_method(p_class:std.String, p_method:std.String, ?p_no_inheritance:Bool = false):Bool return __classdb_ptr().value.class_has_method(p_class, p_method, p_no_inheritance);
	public function class_get_method_argument_count(p_class:std.String, p_method:std.String, ?p_no_inheritance:Bool = false):Int return __classdb_ptr().value.class_get_method_argument_count(p_class, p_method, p_no_inheritance);
	public function class_get_integer_constant_list(p_class:std.String, ?p_no_inheritance:Bool = false):gd.PackedStringArray return __classdb_ptr().value.class_get_integer_constant_list(p_class, p_no_inheritance);
	...
	public function class_has_enum(p_class:std.String, p_name:std.String, ?p_no_inheritance:Bool = false):Bool return __classdb_ptr().value.class_has_enum(p_class, p_name, p_no_inheritance);
	public function class_get_enum_list(p_class:std.String, ?p_no_inheritance:Bool = false):gd.PackedStringArray return __classdb_ptr().value.class_get_enum_list(p_class, p_no_inheritance);
	public function class_get_enum_constants(p_class:std.String, p_enum:std.String, ?p_no_inheritance:Bool = false):gd.PackedStringArray return __classdb_ptr().value.class_get_enum_constants(p_class, p_enum, p_no_inheritance);
	public function class_get_integer_constant_enum(p_class:std.String, p_name:std.String, ?p_no_inheritance:Bool = false):std.String return __classdb_ptr().value.class_get_integer_constant_enum(p_class, p_name, p_no_inheritance);
	public function is_class_enum_bitfield(p_class:std.String, p_enum:std.String, ?p_no_inheritance:Bool = false):Bool return __classdb_ptr().value.is_class_enum_bitfield(p_class, p_enum, p_no_inheritance);
