...
@:cppInclude('iostream') class ClassDB extends gd.Object {
	...
	public function get_class_list():gd.PackedStringArray return {
		final v = __classdb_ptr().value.get_class_list();
		v;
	};
	public function get_inheriters_from_class(p_class:std.String):gd.PackedStringArray return {
		final v = __classdb_ptr().value.get_inheriters_from_class(((p_class : std.String)));
		v;
	};
	public function get_parent_class(p_class:std.String):std.String return {
		final v = __classdb_ptr().value.get_parent_class(((p_class : std.String)));
		v;
	};
	...
	public function instantiate(p_class:std.String):gd.Variant return {
		final v = __classdb_ptr().value.instantiate(((p_class : std.String)));
		v;
	};
	...
	public function class_get_signal(p_class:std.String, p_signal:std.String):gd.Dictionary return {
		final v = __classdb_ptr().value.class_get_signal(((p_class : std.String)), ((p_signal : std.String)));
		v;
	};
	public function class_get_property_getter(p_class:std.String, p_property:std.String):std.String return {
		final v = __classdb_ptr().value.class_get_property_getter(((p_class : std.String)), ((p_property : std.String)));
		v;
	};
	public function class_get_property_setter(p_class:std.String, p_property:std.String):std.String return {
		final v = __classdb_ptr().value.class_get_property_setter(((p_class : std.String)), ((p_property : std.String)));
		v;
	};
	public function class_get_property(p_object:gd.Object, p_property:std.String):gd.Variant return {
		final v = __classdb_ptr().value.class_get_property(((p_object : gd.Object)), ((p_property : std.String)));
		v;
	};
	...
	public function class_get_property_default_value(p_class:std.String, p_property:std.String):gd.Variant return {
		final v = __classdb_ptr().value.class_get_property_default_value(((p_class : std.String)), ((p_property : std.String)));
		v;
	};
	...
	public function class_get_integer_constant_list(p_class:std.String, ?p_no_inheritance:Bool):gd.PackedStringArray return switch [p_class, p_no_inheritance] {
		case [_, null]:{
			final v = __classdb_ptr().value.class_get_integer_constant_list(((p_class : std.String)));
			v;
		};
		default:{
			final v = __classdb_ptr().value.class_get_integer_constant_list(((p_class : std.String)), ((p_no_inheritance : Bool)));
			v;
		};
	};
	...
	public function class_get_enum_list(p_class:std.String, ?p_no_inheritance:Bool):gd.PackedStringArray return switch [p_class, p_no_inheritance] {
		case [_, null]:{
			final v = __classdb_ptr().value.class_get_enum_list(((p_class : std.String)));
			v;
		};
		default:{
			final v = __classdb_ptr().value.class_get_enum_list(((p_class : std.String)), ((p_no_inheritance : Bool)));
			v;
		};
	};
	public function class_get_enum_constants(p_class:std.String, p_enum:std.String, ?p_no_inheritance:Bool):gd.PackedStringArray return switch [p_class, p_enum, p_no_inheritance] {
		case [_, _, null]:{
			final v = __classdb_ptr().value.class_get_enum_constants(((p_class : std.String)), ((p_enum : std.String)));
			v;
		};
		default:{
			final v = __classdb_ptr().value.class_get_enum_constants(((p_class : std.String)), ((p_enum : std.String)), ((p_no_inheritance : Bool)));
			v;
		};
	};
	public function class_get_integer_constant_enum(p_class:std.String, p_name:std.String, ?p_no_inheritance:Bool):std.String return switch [p_class, p_name, p_no_inheritance] {
		case [_, _, null]:{
			final v = __classdb_ptr().value.class_get_integer_constant_enum(((p_class : std.String)), ((p_name : std.String)));
			v;
		};
		default:{
			final v = __classdb_ptr().value.class_get_integer_constant_enum(((p_class : std.String)), ((p_name : std.String)), ((p_no_inheritance : Bool)));
			v;
		};
	};
