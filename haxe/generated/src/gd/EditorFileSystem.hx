...
class EditorFileSystem extends gd.Node {
	...
	public function update_file(p_path:std.String):Void __editorfilesystem_ptr().value.update_file(((p_path : std.String)));
	public function get_filesystem_path(p_path:std.String):gd.EditorFileSystemDirectory return __editorfilesystem_ptr().value.get_filesystem_path(((p_path : std.String)));
	public function get_file_type(p_path:std.String):std.String return __editorfilesystem_ptr().value.get_file_type(((p_path : std.String)));
	public function reimport_files(p_files:gd.PackedStringArray):Void __editorfilesystem_ptr().value.reimport_files(((p_files : gd.PackedStringArray)));
}