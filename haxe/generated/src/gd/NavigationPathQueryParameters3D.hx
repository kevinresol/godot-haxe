...
class NavigationPathQueryParameters3D extends gd.RefCounted {
	...
	public function set_pathfinding_algorithm(p_pathfinding_algorithm:gd.navigationpathqueryparameters3d.PathfindingAlgorithm):gd.navigationpathqueryparameters3d.PathfindingAlgorithm {
		__navigationpathqueryparameters3d_ptr().value.set_pathfinding_algorithm(((p_pathfinding_algorithm : gd.navigationpathqueryparameters3d.PathfindingAlgorithm)));
	...
	public function set_path_postprocessing(p_path_postprocessing:gd.navigationpathqueryparameters3d.PathPostProcessing):gd.navigationpathqueryparameters3d.PathPostProcessing {
		__navigationpathqueryparameters3d_ptr().value.set_path_postprocessing(((p_path_postprocessing : gd.navigationpathqueryparameters3d.PathPostProcessing)));
	...
	public function set_map(p_map:gd.RID):gd.RID {
		__navigationpathqueryparameters3d_ptr().value.set_map(((p_map : gd.RID)));
		return p_map;
	}
	...
	public function set_start_position(p_start_position:gd.Vector3):gd.Vector3 {
		__navigationpathqueryparameters3d_ptr().value.set_start_position(((p_start_position : gd.Vector3)));
	...
	public function set_target_position(p_target_position:gd.Vector3):gd.Vector3 {
		__navigationpathqueryparameters3d_ptr().value.set_target_position(((p_target_position : gd.Vector3)));
	...
	public function set_navigation_layers(p_navigation_layers:Int):Int {
		__navigationpathqueryparameters3d_ptr().value.set_navigation_layers(((p_navigation_layers : Int)));
	...
	public function set_metadata_flags(p_flags:Int):Int {
		__navigationpathqueryparameters3d_ptr().value.set_metadata_flags(((p_flags : Int)));
		return p_flags;
	}
	...
	public function set_simplify_path(p_enabled:Bool):Bool {
		__navigationpathqueryparameters3d_ptr().value.set_simplify_path(((p_enabled : Bool)));
		return p_enabled;
	}
	...
	public function set_simplify_epsilon(p_epsilon:Float):Float {
		__navigationpathqueryparameters3d_ptr().value.set_simplify_epsilon(((p_epsilon : Float)));
		return p_epsilon;
	}
