...
class XRPositionalTracker extends gd.XRTracker {
	...
	public function set_tracker_profile(p_profile:std.String):Void __xrpositionaltracker_ptr().value.set_tracker_profile(((p_profile : std.String)));
	...
	public function set_tracker_hand(p_hand:gd.xrpositionaltracker.TrackerHand):Void __xrpositionaltracker_ptr().value.set_tracker_hand(((p_hand : gd.xrpositionaltracker.TrackerHand)));
