...
class RDPipelineColorBlendState extends gd.RefCounted {
	...
	public function set_enable_logic_op(p_p_member:Bool):Bool {
		__rdpipelinecolorblendstate_ptr().value.set_enable_logic_op(((p_p_member : Bool)));
		return p_p_member;
	}
	...
	public function set_logic_op(p_p_member:gd.renderingdevice.LogicOperation):gd.renderingdevice.LogicOperation {
		__rdpipelinecolorblendstate_ptr().value.set_logic_op(((p_p_member : gd.renderingdevice.LogicOperation)));
		return p_p_member;
	}
	...
	public function set_blend_constant(p_p_member:gd.Color):gd.Color {
		__rdpipelinecolorblendstate_ptr().value.set_blend_constant(((p_p_member : gd.Color)));
		return p_p_member;
	}
