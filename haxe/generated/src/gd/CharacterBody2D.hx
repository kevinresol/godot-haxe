...
class CharacterBody2D extends gd.PhysicsBody2D {
	...
	public function set_velocity(p_velocity:gd.Vector2):gd.Vector2 {
		__characterbody2d_ptr().value.set_velocity(p_velocity);
		return p_velocity;
	}
	...
	public function set_safe_margin(p_margin:Float):Float {
		__characterbody2d_ptr().value.set_safe_margin(p_margin);
		return p_margin;
	}
	...
	public function set_floor_stop_on_slope_enabled(p_enabled:Bool):Void __characterbody2d_ptr().value.set_floor_stop_on_slope_enabled(p_enabled);
	public function set_floor_constant_speed_enabled(p_enabled:Bool):Void __characterbody2d_ptr().value.set_floor_constant_speed_enabled(p_enabled);
	public function is_floor_constant_speed_enabled():Bool return __characterbody2d_ptr().value.is_floor_constant_speed_enabled();
	public function set_floor_block_on_wall_enabled(p_enabled:Bool):Void __characterbody2d_ptr().value.set_floor_block_on_wall_enabled(p_enabled);
	public function is_floor_block_on_wall_enabled():Bool return __characterbody2d_ptr().value.is_floor_block_on_wall_enabled();
	public function set_slide_on_ceiling_enabled(p_enabled:Bool):Void __characterbody2d_ptr().value.set_slide_on_ceiling_enabled(p_enabled);
	...
	public function set_platform_floor_layers(p_exclude_layer:Int):Int {
		__characterbody2d_ptr().value.set_platform_floor_layers(p_exclude_layer);
	...
	public function set_platform_wall_layers(p_exclude_layer:Int):Int {
		__characterbody2d_ptr().value.set_platform_wall_layers(p_exclude_layer);
		return p_exclude_layer;
	}
	...
	public function set_max_slides(p_max_slides:Int):Int {
		__characterbody2d_ptr().value.set_max_slides(p_max_slides);
		return p_max_slides;
	}
	...
	public function set_floor_max_angle(p_radians:Float):Float {
		__characterbody2d_ptr().value.set_floor_max_angle(p_radians);
		return p_radians;
	}
	...
	public function set_floor_snap_length(p_floor_snap_length:Float):Float {
		__characterbody2d_ptr().value.set_floor_snap_length(p_floor_snap_length);
	...
	public function set_wall_min_slide_angle(p_radians:Float):Float {
		__characterbody2d_ptr().value.set_wall_min_slide_angle(p_radians);
		return p_radians;
	}
	...
	public function set_platform_on_leave(p_on_leave_apply_velocity:gd.characterbody2d.PlatformOnLeave):gd.characterbody2d.PlatformOnLeave {
		__characterbody2d_ptr().value.set_platform_on_leave(p_on_leave_apply_velocity);
	...
	public function get_slide_collision(p_slide_idx:Int):gd.KinematicCollision2D return __characterbody2d_ptr().value.get_slide_collision(p_slide_idx);
