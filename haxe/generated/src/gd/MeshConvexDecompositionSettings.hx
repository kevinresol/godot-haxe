...
class MeshConvexDecompositionSettings extends gd.RefCounted {
	...
	public function set_max_concavity(p_max_concavity:Float):Float {
		__meshconvexdecompositionsettings_ptr().value.set_max_concavity(p_max_concavity);
	...
	public function set_symmetry_planes_clipping_bias(p_symmetry_planes_clipping_bias:Float):Float {
		__meshconvexdecompositionsettings_ptr().value.set_symmetry_planes_clipping_bias(p_symmetry_planes_clipping_bias);
	...
	public function set_revolution_axes_clipping_bias(p_revolution_axes_clipping_bias:Float):Float {
		__meshconvexdecompositionsettings_ptr().value.set_revolution_axes_clipping_bias(p_revolution_axes_clipping_bias);
	...
	public function set_min_volume_per_convex_hull(p_min_volume_per_convex_hull:Float):Float {
		__meshconvexdecompositionsettings_ptr().value.set_min_volume_per_convex_hull(p_min_volume_per_convex_hull);
	...
	public function set_resolution(p_min_volume_per_convex_hull:Int):Int {
		__meshconvexdecompositionsettings_ptr().value.set_resolution(p_min_volume_per_convex_hull);
		return p_min_volume_per_convex_hull;
	}
	...
	public function set_max_num_vertices_per_convex_hull(p_max_num_vertices_per_convex_hull:Int):Int {
		__meshconvexdecompositionsettings_ptr().value.set_max_num_vertices_per_convex_hull(p_max_num_vertices_per_convex_hull);
	...
	public function set_plane_downsampling(p_plane_downsampling:Int):Int {
		__meshconvexdecompositionsettings_ptr().value.set_plane_downsampling(p_plane_downsampling);
	...
	public function set_convex_hull_downsampling(p_convex_hull_downsampling:Int):Int {
		__meshconvexdecompositionsettings_ptr().value.set_convex_hull_downsampling(p_convex_hull_downsampling);
	...
	public function set_normalize_mesh(p_normalize_mesh:Bool):Bool {
		__meshconvexdecompositionsettings_ptr().value.set_normalize_mesh(p_normalize_mesh);
	...
	public function set_mode(p_mode:gd.meshconvexdecompositionsettings.Mode):gd.meshconvexdecompositionsettings.Mode {
		__meshconvexdecompositionsettings_ptr().value.set_mode(p_mode);
		return p_mode;
	}
	...
	public function set_convex_hull_approximation(p_convex_hull_approximation:Bool):Bool {
		__meshconvexdecompositionsettings_ptr().value.set_convex_hull_approximation(p_convex_hull_approximation);
	...
	public function set_max_convex_hulls(p_max_convex_hulls:Int):Int {
		__meshconvexdecompositionsettings_ptr().value.set_max_convex_hulls(p_max_convex_hulls);
	...
	public function set_project_hull_vertices(p_project_hull_vertices:Bool):Bool {
		__meshconvexdecompositionsettings_ptr().value.set_project_hull_vertices(p_project_hull_vertices);
