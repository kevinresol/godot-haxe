...
class RDPipelineColorBlendStateAttachment extends gd.RefCounted {
	...
	public function set_enable_blend(p_p_member:Bool):Bool {
		__rdpipelinecolorblendstateattachment_ptr().value.set_enable_blend(p_p_member);
		return p_p_member;
	}
	...
	public function set_src_color_blend_factor(p_p_member:gd.renderingdevice.BlendFactor):gd.renderingdevice.BlendFactor {
		__rdpipelinecolorblendstateattachment_ptr().value.set_src_color_blend_factor(p_p_member);
		return p_p_member;
	}
	...
	public function set_dst_color_blend_factor(p_p_member:gd.renderingdevice.BlendFactor):gd.renderingdevice.BlendFactor {
		__rdpipelinecolorblendstateattachment_ptr().value.set_dst_color_blend_factor(p_p_member);
		return p_p_member;
	}
	...
	public function set_color_blend_op(p_p_member:gd.renderingdevice.BlendOperation):gd.renderingdevice.BlendOperation {
		__rdpipelinecolorblendstateattachment_ptr().value.set_color_blend_op(p_p_member);
		return p_p_member;
	}
	...
	public function set_src_alpha_blend_factor(p_p_member:gd.renderingdevice.BlendFactor):gd.renderingdevice.BlendFactor {
		__rdpipelinecolorblendstateattachment_ptr().value.set_src_alpha_blend_factor(p_p_member);
		return p_p_member;
	}
	...
	public function set_dst_alpha_blend_factor(p_p_member:gd.renderingdevice.BlendFactor):gd.renderingdevice.BlendFactor {
		__rdpipelinecolorblendstateattachment_ptr().value.set_dst_alpha_blend_factor(p_p_member);
		return p_p_member;
	}
	...
	public function set_alpha_blend_op(p_p_member:gd.renderingdevice.BlendOperation):gd.renderingdevice.BlendOperation {
		__rdpipelinecolorblendstateattachment_ptr().value.set_alpha_blend_op(p_p_member);
		return p_p_member;
	}
	...
	public function set_write_r(p_p_member:Bool):Bool {
		__rdpipelinecolorblendstateattachment_ptr().value.set_write_r(p_p_member);
		return p_p_member;
	}
	...
	public function set_write_g(p_p_member:Bool):Bool {
		__rdpipelinecolorblendstateattachment_ptr().value.set_write_g(p_p_member);
		return p_p_member;
	}
	...
	public function set_write_b(p_p_member:Bool):Bool {
		__rdpipelinecolorblendstateattachment_ptr().value.set_write_b(p_p_member);
		return p_p_member;
	}
	...
	public function set_write_a(p_p_member:Bool):Bool {
		__rdpipelinecolorblendstateattachment_ptr().value.set_write_a(p_p_member);
		return p_p_member;
	}
