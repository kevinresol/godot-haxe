...
class Parallax2D extends gd.Node2D {
	...
	public function set_scroll_scale(p_scale:gd.Vector2):gd.Vector2 {
		__parallax2d_ptr().value.set_scroll_scale(((p_scale : gd.Vector2)));
		return p_scale;
	}
	...
	public function set_repeat_size(p_repeat_size:gd.Vector2):gd.Vector2 {
		__parallax2d_ptr().value.set_repeat_size(((p_repeat_size : gd.Vector2)));
	...
	public function set_repeat_times(p_repeat_times:Int):Int {
		__parallax2d_ptr().value.set_repeat_times(((p_repeat_times : Int)));
	...
	public function set_autoscroll(p_autoscroll:gd.Vector2):gd.Vector2 {
		__parallax2d_ptr().value.set_autoscroll(((p_autoscroll : gd.Vector2)));
		return p_autoscroll;
	}
	...
	public function set_scroll_offset(p_offset:gd.Vector2):gd.Vector2 {
		__parallax2d_ptr().value.set_scroll_offset(((p_offset : gd.Vector2)));
		return p_offset;
	}
	...
	public function set_screen_offset(p_offset:gd.Vector2):gd.Vector2 {
		__parallax2d_ptr().value.set_screen_offset(((p_offset : gd.Vector2)));
		return p_offset;
	}
	...
	public function set_limit_begin(p_offset:gd.Vector2):gd.Vector2 {
		__parallax2d_ptr().value.set_limit_begin(((p_offset : gd.Vector2)));
		return p_offset;
	}
	...
	public function set_limit_end(p_offset:gd.Vector2):gd.Vector2 {
		__parallax2d_ptr().value.set_limit_end(((p_offset : gd.Vector2)));
		return p_offset;
	}
	...
	public function set_follow_viewport(p_follow:Bool):Bool {
		__parallax2d_ptr().value.set_follow_viewport(((p_follow : Bool)));
		return p_follow;
	}
	...
	public function set_ignore_camera_scroll(p_ignore:Bool):Bool {
		__parallax2d_ptr().value.set_ignore_camera_scroll(((p_ignore : Bool)));
		return p_ignore;
	}
