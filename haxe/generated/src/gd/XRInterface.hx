...
class XRInterface extends gd.RefCounted {
	...
	public function set_primary(p_primary:Bool):Void __xrinterface_ptr().value.set_primary(p_primary);
	...
	public function trigger_haptic_pulse(p_action_name:std.String, p_tracker_name:std.String, p_frequency:Float, p_amplitude:Float, p_duration_sec:Float, p_delay_sec:Float):Void __xrinterface_ptr().value.trigger_haptic_pulse(p_action_name, p_tracker_name, p_frequency, p_amplitude, p_duration_sec, p_delay_sec);
	public function supports_play_area_mode(p_mode:gd.xrinterface.PlayAreaMode):Bool return __xrinterface_ptr().value.supports_play_area_mode(p_mode);
	public function get_play_area_mode():gd.xrinterface.PlayAreaMode return __xrinterface_ptr().value.get_play_area_mode();
	public function set_play_area_mode(p_mode:gd.xrinterface.PlayAreaMode):Bool return __xrinterface_ptr().value.set_play_area_mode(p_mode);
	...
	public function set_anchor_detection_is_enabled(p_enable:Bool):Void __xrinterface_ptr().value.set_anchor_detection_is_enabled(p_enable);
	...
	public function set_environment_blend_mode(p_mode:gd.xrinterface.EnvironmentBlendMode):Bool return __xrinterface_ptr().value.set_environment_blend_mode(p_mode);
