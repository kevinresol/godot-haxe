...
class Transform3D_wrapper {
	...
	function __op_multiply_int(p_rhs:cpp.Int64):gd.Transform3D return @:privateAccess this.__gd.__op_multiply_int(((p_rhs : cpp.Int64)));
	function __op_divide_int(p_rhs:cpp.Int64):gd.Transform3D return @:privateAccess this.__gd.__op_divide_int(((p_rhs : cpp.Int64)));
	function __op_multiply_float(p_rhs:Float):gd.Transform3D return @:privateAccess this.__gd.__op_multiply_float(((p_rhs : Float)));
	function __op_divide_float(p_rhs:Float):gd.Transform3D return @:privateAccess this.__gd.__op_divide_float(((p_rhs : Float)));
	function __op_equal_to_transform3d(p_rhs:gd.Transform3D):Bool return @:privateAccess this.__gd.__op_equal_to_transform3d(((p_rhs : gdnative.Transform3D)));
	function __op_not_equal_transform3d(p_rhs:gd.Transform3D):Bool return @:privateAccess this.__gd.__op_not_equal_transform3d(((p_rhs : gdnative.Transform3D)));
	function __op_multiply_transform3d(p_rhs:gd.Transform3D):gd.Transform3D return @:privateAccess this.__gd.__op_multiply_transform3d(((p_rhs : gdnative.Transform3D)));
