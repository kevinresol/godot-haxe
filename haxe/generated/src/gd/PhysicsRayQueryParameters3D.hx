...
class PhysicsRayQueryParameters3D extends gd.RefCounted {
	...
	public function set_from(p_from:gd.Vector3):gd.Vector3 {
		__physicsrayqueryparameters3d_ptr().value.set_from(((p_from : gd.Vector3)));
		return p_from;
	}
	...
	public function set_to(p_to:gd.Vector3):gd.Vector3 {
		__physicsrayqueryparameters3d_ptr().value.set_to(((p_to : gd.Vector3)));
		return p_to;
	}
	...
	public function set_collision_mask(p_collision_mask:Int):Int {
		__physicsrayqueryparameters3d_ptr().value.set_collision_mask(((p_collision_mask : Int)));
	...
	public function set_collide_with_bodies(p_enable:Bool):Bool {
		__physicsrayqueryparameters3d_ptr().value.set_collide_with_bodies(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_collide_with_areas(p_enable:Bool):Bool {
		__physicsrayqueryparameters3d_ptr().value.set_collide_with_areas(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_hit_from_inside(p_enable:Bool):Bool {
		__physicsrayqueryparameters3d_ptr().value.set_hit_from_inside(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_hit_back_faces(p_enable:Bool):Bool {
		__physicsrayqueryparameters3d_ptr().value.set_hit_back_faces(((p_enable : Bool)));
		return p_enable;
	}
	public function is_hit_back_faces_enabled():Bool return __physicsrayqueryparameters3d_ptr().value.is_hit_back_faces_enabled();
	public var from(get, set) : gd.Vector3;
	public var to(get, set) : gd.Vector3;
