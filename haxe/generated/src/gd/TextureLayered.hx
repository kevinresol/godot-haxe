...
class TextureLayered extends gd.Texture {
	...
	public function _get_layer_data(p_layer_index:Int):gd.Image return __texturelayered_ptr().value._get_layer_data(p_layer_index);
	...
	public function get_layer_data(p_layer:Int):gd.Image return __texturelayered_ptr().value.get_layer_data(p_layer);
}