...
class MultiplayerAPIExtension extends gd.MultiplayerAPI {
	...
	public function _set_multiplayer_peer(p_multiplayer_peer:gd.MultiplayerPeer):Void __multiplayerapiextension_ptr().value._set_multiplayer_peer(((p_multiplayer_peer : gd.MultiplayerPeer)));
	...
	public function _rpc(p_peer:Int, p_object:gd.Object, p_method:std.String, p_args:gd.Array):gd.Error return __multiplayerapiextension_ptr().value._rpc(((p_peer : Int)), ((p_object : gd.Object)), ((p_method : std.String)), ((p_args : gd.Array)));
	public function _get_remote_sender_id():Int return __multiplayerapiextension_ptr().value._get_remote_sender_id();
	public function _object_configuration_add(p_object:gd.Object, p_configuration:gd.Variant):gd.Error return __multiplayerapiextension_ptr().value._object_configuration_add(((p_object : gd.Object)), ((p_configuration : gd.Variant)));
	public function _object_configuration_remove(p_object:gd.Object, p_configuration:gd.Variant):gd.Error return __multiplayerapiextension_ptr().value._object_configuration_remove(((p_object : gd.Object)), ((p_configuration : gd.Variant)));
}