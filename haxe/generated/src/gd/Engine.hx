...
class Engine extends gd.Object {
	...
	public function set_physics_ticks_per_second(p_physics_ticks_per_second:Int):Int {
		__engine_ptr().value.set_physics_ticks_per_second(p_physics_ticks_per_second);
	...
	public function set_max_physics_steps_per_frame(p_max_physics_steps:Int):Int {
		__engine_ptr().value.set_max_physics_steps_per_frame(p_max_physics_steps);
	...
	public function set_physics_jitter_fix(p_physics_jitter_fix:Float):Float {
		__engine_ptr().value.set_physics_jitter_fix(p_physics_jitter_fix);
	...
	public function set_max_fps(p_max_fps:Int):Int {
		__engine_ptr().value.set_max_fps(p_max_fps);
		return p_max_fps;
	}
	...
	public function set_time_scale(p_time_scale:Float):Float {
		__engine_ptr().value.set_time_scale(p_time_scale);
		return p_time_scale;
	}
	...
	public function has_singleton(p_name:std.String):Bool return __engine_ptr().value.has_singleton(p_name);
	public function get_singleton(p_name:std.String):gd.Object return __engine_ptr().value.get_singleton(p_name);
	public function register_singleton(p_name:std.String, p_instance:gd.Object):Void __engine_ptr().value.register_singleton(p_name, p_instance);
	public function unregister_singleton(p_name:std.String):Void __engine_ptr().value.unregister_singleton(p_name);
	public function get_singleton_list():gd.PackedStringArray return __engine_ptr().value.get_singleton_list();
	public function register_script_language(p_language:gd.ScriptLanguage):gd.Error return __engine_ptr().value.register_script_language(p_language);
	public function unregister_script_language(p_language:gd.ScriptLanguage):gd.Error return __engine_ptr().value.unregister_script_language(p_language);
	public function get_script_language_count():Int return __engine_ptr().value.get_script_language_count();
	public function get_script_language(p_index:Int):gd.ScriptLanguage return __engine_ptr().value.get_script_language(p_index);
	...
	public function set_print_error_messages(p_enabled:Bool):Bool {
		__engine_ptr().value.set_print_error_messages(p_enabled);
		return p_enabled;
	}
