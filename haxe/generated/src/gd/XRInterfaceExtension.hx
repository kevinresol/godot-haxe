...
class XRInterfaceExtension extends gd.XRInterface {
	...
	public function _supports_play_area_mode(p_mode:gd.xrinterface.PlayAreaMode):Bool return __xrinterfaceextension_ptr().value._supports_play_area_mode(p_mode);
	...
	public function _set_play_area_mode(p_mode:gd.xrinterface.PlayAreaMode):Bool return __xrinterfaceextension_ptr().value._set_play_area_mode(p_mode);
	...
	public function _get_projection_for_view(p_view:Int, p_aspect:Float, p_z_near:Float, p_z_far:Float):gd.PackedFloat64Array return __xrinterfaceextension_ptr().value._get_projection_for_view(p_view, p_aspect, p_z_near, p_z_far);
	...
	public function _pre_draw_viewport(p_render_target:gd.RID):Bool return __xrinterfaceextension_ptr().value._pre_draw_viewport(p_render_target);
	public function _post_draw_viewport(p_render_target:gd.RID, p_screen_rect:gd.Rect2):Void __xrinterfaceextension_ptr().value._post_draw_viewport(p_render_target, p_screen_rect);
	...
	public function _get_suggested_pose_names(p_tracker_name:std.String):gd.PackedStringArray return __xrinterfaceextension_ptr().value._get_suggested_pose_names(p_tracker_name);
	...
	public function _trigger_haptic_pulse(p_action_name:std.String, p_tracker_name:std.String, p_frequency:Float, p_amplitude:Float, p_duration_sec:Float, p_delay_sec:Float):Void __xrinterfaceextension_ptr().value._trigger_haptic_pulse(p_action_name, p_tracker_name, p_frequency, p_amplitude, p_duration_sec, p_delay_sec);
	...
	public function _set_anchor_detection_is_enabled(p_enabled:Bool):Void __xrinterfaceextension_ptr().value._set_anchor_detection_is_enabled(p_enabled);
	...
	public function add_blit(p_render_target:gd.RID, p_src_rect:gd.Rect2, p_dst_rect:gd.Rect2i, p_use_layer:Bool, p_layer:Int, p_apply_lens_distortion:Bool, p_eye_center:gd.Vector2, p_k1:Float, p_k2:Float, p_upscale:Float, p_aspect_ratio:Float):Void __xrinterfaceextension_ptr().value.add_blit(p_render_target, p_src_rect, p_dst_rect, p_use_layer, p_layer, p_apply_lens_distortion, p_eye_center, p_k1, p_k2, p_upscale, p_aspect_ratio);
	public function get_render_target_texture(p_render_target:gd.RID):gd.RID return __xrinterfaceextension_ptr().value.get_render_target_texture(p_render_target);
}