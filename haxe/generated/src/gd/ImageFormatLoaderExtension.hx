...
class ImageFormatLoaderExtension extends gd.ImageFormatLoader {
	...
	public function _load_image(p_image:gd.Image, p_fileaccess:gd.FileAccess, p_flags:Int, p_scale:Float):gd.Error return __imageformatloaderextension_ptr().value._load_image(p_image, p_fileaccess, p_flags, p_scale);
