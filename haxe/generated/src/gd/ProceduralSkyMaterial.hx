...
class ProceduralSkyMaterial extends gd.Material {
	...
	public function set_sky_top_color(p_color:gd.Color):gd.Color {
		__proceduralskymaterial_ptr().value.set_sky_top_color(((p_color : gd.Color)));
		return p_color;
	}
	...
	public function set_sky_horizon_color(p_color:gd.Color):gd.Color {
		__proceduralskymaterial_ptr().value.set_sky_horizon_color(((p_color : gd.Color)));
		return p_color;
	}
	...
	public function set_sky_curve(p_curve:Float):Float {
		__proceduralskymaterial_ptr().value.set_sky_curve(((p_curve : Float)));
		return p_curve;
	}
	...
	public function set_sky_energy_multiplier(p_multiplier:Float):Float {
		__proceduralskymaterial_ptr().value.set_sky_energy_multiplier(((p_multiplier : Float)));
		return p_multiplier;
	}
	...
	public function set_sky_cover(p_sky_cover:gd.Texture2D):gd.Texture2D {
		__proceduralskymaterial_ptr().value.set_sky_cover(((p_sky_cover : gd.Texture2D)));
		return p_sky_cover;
	}
	...
	public function set_sky_cover_modulate(p_color:gd.Color):gd.Color {
		__proceduralskymaterial_ptr().value.set_sky_cover_modulate(((p_color : gd.Color)));
		return p_color;
	}
	...
	public function set_ground_bottom_color(p_color:gd.Color):gd.Color {
		__proceduralskymaterial_ptr().value.set_ground_bottom_color(((p_color : gd.Color)));
		return p_color;
	}
	...
	public function set_ground_horizon_color(p_color:gd.Color):gd.Color {
		__proceduralskymaterial_ptr().value.set_ground_horizon_color(((p_color : gd.Color)));
		return p_color;
	}
	...
	public function set_ground_curve(p_curve:Float):Float {
		__proceduralskymaterial_ptr().value.set_ground_curve(((p_curve : Float)));
		return p_curve;
	}
	...
	public function set_ground_energy_multiplier(p_energy:Float):Float {
		__proceduralskymaterial_ptr().value.set_ground_energy_multiplier(((p_energy : Float)));
		return p_energy;
	}
	...
	public function set_sun_angle_max(p_degrees:Float):Float {
		__proceduralskymaterial_ptr().value.set_sun_angle_max(((p_degrees : Float)));
		return p_degrees;
	}
	...
	public function set_sun_curve(p_curve:Float):Float {
		__proceduralskymaterial_ptr().value.set_sun_curve(((p_curve : Float)));
		return p_curve;
	}
	...
	public function set_use_debanding(p_use_debanding:Bool):Bool {
		__proceduralskymaterial_ptr().value.set_use_debanding(((p_use_debanding : Bool)));
	...
	public function set_energy_multiplier(p_multiplier:Float):Float {
		__proceduralskymaterial_ptr().value.set_energy_multiplier(((p_multiplier : Float)));
		return p_multiplier;
	}
