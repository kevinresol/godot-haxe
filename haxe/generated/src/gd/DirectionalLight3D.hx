...
class DirectionalLight3D extends gd.Light3D {
	...
	public function set_shadow_mode(p_mode:gd.directionallight3d.ShadowMode):Void __directionallight3d_ptr().value.set_shadow_mode(p_mode);
	public function get_shadow_mode():gd.directionallight3d.ShadowMode return __directionallight3d_ptr().value.get_shadow_mode();
	public function set_blend_splits(p_enabled:Bool):Void __directionallight3d_ptr().value.set_blend_splits(p_enabled);
	...
	public function set_sky_mode(p_mode:gd.directionallight3d.SkyMode):gd.directionallight3d.SkyMode {
		__directionallight3d_ptr().value.set_sky_mode(p_mode);
		return p_mode;
	}
