...
class NavigationMeshSourceGeometryData3D extends gd.Resource {
	...
	public function set_vertices(p_vertices:gd.PackedFloat32Array):gd.PackedFloat32Array {
		__navigationmeshsourcegeometrydata3d_ptr().value.set_vertices(p_vertices);
		return p_vertices;
	}
	...
	public function set_indices(p_indices:gd.PackedInt32Array):gd.PackedInt32Array {
		__navigationmeshsourcegeometrydata3d_ptr().value.set_indices(p_indices);
		return p_indices;
	}
	public function get_indices():gd.PackedInt32Array return __navigationmeshsourcegeometrydata3d_ptr().value.get_indices();
	public function append_arrays(p_vertices:gd.PackedFloat32Array, p_indices:gd.PackedInt32Array):Void __navigationmeshsourcegeometrydata3d_ptr().value.append_arrays(p_vertices, p_indices);
	...
	public function merge(p_other_geometry:gd.NavigationMeshSourceGeometryData3D):Void __navigationmeshsourcegeometrydata3d_ptr().value.merge(p_other_geometry);
	public function add_projected_obstruction(p_vertices:gd.PackedVector3Array, p_elevation:Float, p_height:Float, p_carve:Bool):Void __navigationmeshsourcegeometrydata3d_ptr().value.add_projected_obstruction(p_vertices, p_elevation, p_height, p_carve);
	...
	public function set_projected_obstructions(p_projected_obstructions:gd.Array):gd.Array {
		__navigationmeshsourcegeometrydata3d_ptr().value.set_projected_obstructions(p_projected_obstructions);
