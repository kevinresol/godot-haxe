...
class ArrayOccluder3D extends gd.Occluder3D {
	...
	public function set_arrays(p_vertices:gd.PackedVector3Array, p_indices:gd.PackedInt32Array):Void __arrayoccluder3d_ptr().value.set_arrays(p_vertices, p_indices);
	public function set_vertices(p_vertices:gd.PackedVector3Array):Void __arrayoccluder3d_ptr().value.set_vertices(p_vertices);
	public function set_indices(p_indices:gd.PackedInt32Array):Void __arrayoccluder3d_ptr().value.set_indices(p_indices);
}