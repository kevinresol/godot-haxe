...
class PhysicsDirectSpaceState3D extends gd.Object {
	...
	public function intersect_ray(p_parameters:gd.PhysicsRayQueryParameters3D):gd.Dictionary return __physicsdirectspacestate3d_ptr().value.intersect_ray(p_parameters);
	public function cast_motion(p_parameters:gd.PhysicsShapeQueryParameters3D):gd.PackedFloat32Array return __physicsdirectspacestate3d_ptr().value.cast_motion(p_parameters);
	public function get_rest_info(p_parameters:gd.PhysicsShapeQueryParameters3D):gd.Dictionary return __physicsdirectspacestate3d_ptr().value.get_rest_info(p_parameters);
}