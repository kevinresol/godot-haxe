...
class NavigationRegion3D extends gd.Node3D {
	...
	public function set_navigation_mesh(p_navigation_mesh:gd.NavigationMesh):gd.NavigationMesh {
		__navigationregion3d_ptr().value.set_navigation_mesh(p_navigation_mesh);
	...
	public function set_enabled(p_enabled:Bool):Bool {
		__navigationregion3d_ptr().value.set_enabled(p_enabled);
		return p_enabled;
	}
	public function is_enabled():Bool return __navigationregion3d_ptr().value.is_enabled();
	public function set_navigation_map(p_navigation_map:gd.RID):Void __navigationregion3d_ptr().value.set_navigation_map(p_navigation_map);
	...
	public function set_use_edge_connections(p_enabled:Bool):Bool {
		__navigationregion3d_ptr().value.set_use_edge_connections(p_enabled);
		return p_enabled;
	}
	...
	public function set_navigation_layers(p_navigation_layers:Int):Int {
		__navigationregion3d_ptr().value.set_navigation_layers(p_navigation_layers);
	...
	public function set_navigation_layer_value(p_layer_number:Int, p_value:Bool):Void __navigationregion3d_ptr().value.set_navigation_layer_value(p_layer_number, p_value);
	public function get_navigation_layer_value(p_layer_number:Int):Bool return __navigationregion3d_ptr().value.get_navigation_layer_value(p_layer_number);
	...
	public function set_enter_cost(p_enter_cost:Float):Float {
		__navigationregion3d_ptr().value.set_enter_cost(p_enter_cost);
		return p_enter_cost;
	}
	...
	public function set_travel_cost(p_travel_cost:Float):Float {
		__navigationregion3d_ptr().value.set_travel_cost(p_travel_cost);
		return p_travel_cost;
	}
	public function get_travel_cost():Float return __navigationregion3d_ptr().value.get_travel_cost();
	public function bake_navigation_mesh(?p_on_thread:Bool = true):Void __navigationregion3d_ptr().value.bake_navigation_mesh(p_on_thread);
