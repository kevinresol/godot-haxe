...
class VisualShaderNodeFrame extends gd.VisualShaderNodeResizableBase {
	...
	public function set_title(p_title:std.String):std.String {
		__visualshadernodeframe_ptr().value.set_title(((p_title : std.String)));
		return p_title;
	}
	...
	public function set_tint_color_enabled(p_enable:Bool):Bool {
		__visualshadernodeframe_ptr().value.set_tint_color_enabled(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_tint_color(p_color:gd.Color):gd.Color {
		__visualshadernodeframe_ptr().value.set_tint_color(((p_color : gd.Color)));
		return p_color;
	}
	public function get_tint_color():gd.Color return __visualshadernodeframe_ptr().value.get_tint_color();
	public function set_autoshrink_enabled(p_enable:Bool):Void __visualshadernodeframe_ptr().value.set_autoshrink_enabled(((p_enable : Bool)));
	public function is_autoshrink_enabled():Bool return __visualshadernodeframe_ptr().value.is_autoshrink_enabled();
	public function add_attached_node(p_node:Int):Void __visualshadernodeframe_ptr().value.add_attached_node(((p_node : Int)));
	public function remove_attached_node(p_node:Int):Void __visualshadernodeframe_ptr().value.remove_attached_node(((p_node : Int)));
	public function set_attached_nodes(p_attached_nodes:gd.PackedInt32Array):gd.PackedInt32Array {
		__visualshadernodeframe_ptr().value.set_attached_nodes(((p_attached_nodes : gd.PackedInt32Array)));
