...
class PhysicsTestMotionParameters3D extends gd.RefCounted {
	...
	public function set_motion(p_motion:gd.Vector3):gd.Vector3 {
		__physicstestmotionparameters3d_ptr().value.set_motion(p_motion);
		return p_motion;
	}
	...
	public function set_margin(p_margin:Float):Float {
		__physicstestmotionparameters3d_ptr().value.set_margin(p_margin);
		return p_margin;
	}
	...
	public function set_max_collisions(p_max_collisions:Int):Int {
		__physicstestmotionparameters3d_ptr().value.set_max_collisions(p_max_collisions);
	...
	public function set_collide_separation_ray_enabled(p_enabled:Bool):Void __physicstestmotionparameters3d_ptr().value.set_collide_separation_ray_enabled(p_enabled);
	...
	public function set_recovery_as_collision_enabled(p_enabled:Bool):Void __physicstestmotionparameters3d_ptr().value.set_recovery_as_collision_enabled(p_enabled);
