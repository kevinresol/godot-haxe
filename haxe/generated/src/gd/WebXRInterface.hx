...
class WebXRInterface extends gd.XRInterface {
	...
	public function is_session_supported(p_session_mode:std.String):Void __webxrinterface_ptr().value.is_session_supported(p_session_mode);
	public function set_session_mode(p_session_mode:std.String):std.String {
		__webxrinterface_ptr().value.set_session_mode(p_session_mode);
	...
	public function set_required_features(p_required_features:std.String):std.String {
		__webxrinterface_ptr().value.set_required_features(p_required_features);
	...
	public function set_optional_features(p_optional_features:std.String):std.String {
		__webxrinterface_ptr().value.set_optional_features(p_optional_features);
	...
	public function set_requested_reference_space_types(p_requested_reference_space_types:std.String):std.String {
		__webxrinterface_ptr().value.set_requested_reference_space_types(p_requested_reference_space_types);
	...
	public function is_input_source_active(p_input_source_id:Int):Bool return __webxrinterface_ptr().value.is_input_source_active(p_input_source_id);
	public function get_input_source_tracker(p_input_source_id:Int):gd.XRControllerTracker return __webxrinterface_ptr().value.get_input_source_tracker(p_input_source_id);
	public function get_input_source_target_ray_mode(p_input_source_id:Int):gd.webxrinterface.TargetRayMode return __webxrinterface_ptr().value.get_input_source_target_ray_mode(p_input_source_id);
	...
	public function set_display_refresh_rate(p_refresh_rate:Float):Void __webxrinterface_ptr().value.set_display_refresh_rate(p_refresh_rate);
