...
class Transform2D_wrapper {
	...
	function __op_multiply_int(p_rhs:cpp.Int64):gd.Transform2D return @:privateAccess this.__gd.__op_multiply_int(((p_rhs : cpp.Int64)));
	function __op_divide_int(p_rhs:cpp.Int64):gd.Transform2D return @:privateAccess this.__gd.__op_divide_int(((p_rhs : cpp.Int64)));
	function __op_multiply_float(p_rhs:Float):gd.Transform2D return @:privateAccess this.__gd.__op_multiply_float(((p_rhs : Float)));
	function __op_divide_float(p_rhs:Float):gd.Transform2D return @:privateAccess this.__gd.__op_divide_float(((p_rhs : Float)));
	function __op_equal_to_transform2d(p_rhs:gd.Transform2D):Bool return @:privateAccess this.__gd.__op_equal_to_transform2d(((p_rhs : gdnative.Transform2D)));
	function __op_not_equal_transform2d(p_rhs:gd.Transform2D):Bool return @:privateAccess this.__gd.__op_not_equal_transform2d(((p_rhs : gdnative.Transform2D)));
	function __op_multiply_transform2d(p_rhs:gd.Transform2D):gd.Transform2D return @:privateAccess this.__gd.__op_multiply_transform2d(((p_rhs : gdnative.Transform2D)));
