...
class Transform2D_wrapper {
	...
	function set_x(v:gd.Vector2):gd.Vector2 return __gd.x = v;
	public var y(get, set) : gd.Vector2;
	function get_y():gd.Vector2 return __gd.y;
	function set_y(v:gd.Vector2):gd.Vector2 return __gd.y = v;
	public var origin(get, set) : gd.Vector2;
	function set_origin(v:gd.Vector2):gd.Vector2 return __gd.origin = v;
