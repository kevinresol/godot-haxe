...
class VisualShaderNodeIntFunc extends gd.VisualShaderNode {
	...
	public function set_function(p_func:gd.visualshadernodeintfunc.Function):Void __visualshadernodeintfunc_ptr().value.set_function(((p_func : gd.visualshadernodeintfunc.Function)));
	public function get_function():gd.visualshadernodeintfunc.Function return __visualshadernodeintfunc_ptr().value.get_function();
	public var function_(get, set) : gd.visualshadernodeintfunc.Function;
