...
class Environment extends gd.Resource {
	...
	public function set_background(p_mode:gd.environment.BGMode):Void __environment_ptr().value.set_background(p_mode);
	...
	public function set_sky(p_sky:gd.Sky):gd.Sky {
		__environment_ptr().value.set_sky(p_sky);
		return p_sky;
	}
	...
	public function set_sky_custom_fov(p_scale:Float):Float {
		__environment_ptr().value.set_sky_custom_fov(p_scale);
		return p_scale;
	}
	...
	public function set_sky_rotation(p_euler_radians:gd.Vector3):gd.Vector3 {
		__environment_ptr().value.set_sky_rotation(p_euler_radians);
		return p_euler_radians;
	}
	public function get_sky_rotation():gd.Vector3 return __environment_ptr().value.get_sky_rotation();
	public function set_bg_color(p_color:gd.Color):Void __environment_ptr().value.set_bg_color(p_color);
	public function get_bg_color():gd.Color return __environment_ptr().value.get_bg_color();
	public function set_bg_energy_multiplier(p_energy:Float):Void __environment_ptr().value.set_bg_energy_multiplier(p_energy);
	public function get_bg_energy_multiplier():Float return __environment_ptr().value.get_bg_energy_multiplier();
	public function set_bg_intensity(p_energy:Float):Void __environment_ptr().value.set_bg_intensity(p_energy);
	public function get_bg_intensity():Float return __environment_ptr().value.get_bg_intensity();
	public function set_canvas_max_layer(p_layer:Int):Void __environment_ptr().value.set_canvas_max_layer(p_layer);
	public function get_canvas_max_layer():Int return __environment_ptr().value.get_canvas_max_layer();
	public function set_camera_feed_id(p_id:Int):Void __environment_ptr().value.set_camera_feed_id(p_id);
	...
	public function set_ambient_light_color(p_color:gd.Color):gd.Color {
		__environment_ptr().value.set_ambient_light_color(p_color);
		return p_color;
	}
	public function get_ambient_light_color():gd.Color return __environment_ptr().value.get_ambient_light_color();
	public function set_ambient_source(p_source:gd.environment.AmbientSource):Void __environment_ptr().value.set_ambient_source(p_source);
	...
	public function set_ambient_light_energy(p_energy:Float):Float {
		__environment_ptr().value.set_ambient_light_energy(p_energy);
		return p_energy;
	}
	...
	public function set_ambient_light_sky_contribution(p_ratio:Float):Float {
		__environment_ptr().value.set_ambient_light_sky_contribution(p_ratio);
		return p_ratio;
	}
	...
	public function set_reflection_source(p_source:gd.environment.ReflectionSource):Void __environment_ptr().value.set_reflection_source(p_source);
	...
	public function set_tonemapper(p_mode:gd.environment.ToneMapper):Void __environment_ptr().value.set_tonemapper(p_mode);
	...
	public function set_tonemap_exposure(p_exposure:Float):Float {
		__environment_ptr().value.set_tonemap_exposure(p_exposure);
		return p_exposure;
	}
	...
	public function set_tonemap_white(p_white:Float):Float {
		__environment_ptr().value.set_tonemap_white(p_white);
		return p_white;
	}
	...
	public function set_ssr_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_ssr_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_ssr_max_steps(p_max_steps:Int):Int {
		__environment_ptr().value.set_ssr_max_steps(p_max_steps);
		return p_max_steps;
	}
	...
	public function set_ssr_fade_in(p_fade_in:Float):Float {
		__environment_ptr().value.set_ssr_fade_in(p_fade_in);
		return p_fade_in;
	}
	...
	public function set_ssr_fade_out(p_fade_out:Float):Float {
		__environment_ptr().value.set_ssr_fade_out(p_fade_out);
		return p_fade_out;
	}
	...
	public function set_ssr_depth_tolerance(p_depth_tolerance:Float):Float {
		__environment_ptr().value.set_ssr_depth_tolerance(p_depth_tolerance);
	...
	public function set_ssao_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_ssao_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_ssao_radius(p_radius:Float):Float {
		__environment_ptr().value.set_ssao_radius(p_radius);
		return p_radius;
	}
	...
	public function set_ssao_intensity(p_intensity:Float):Float {
		__environment_ptr().value.set_ssao_intensity(p_intensity);
		return p_intensity;
	}
	...
	public function set_ssao_power(p_power:Float):Float {
		__environment_ptr().value.set_ssao_power(p_power);
		return p_power;
	}
	...
	public function set_ssao_detail(p_detail:Float):Float {
		__environment_ptr().value.set_ssao_detail(p_detail);
		return p_detail;
	}
	...
	public function set_ssao_horizon(p_horizon:Float):Float {
		__environment_ptr().value.set_ssao_horizon(p_horizon);
		return p_horizon;
	}
	...
	public function set_ssao_sharpness(p_sharpness:Float):Float {
		__environment_ptr().value.set_ssao_sharpness(p_sharpness);
		return p_sharpness;
	}
	public function get_ssao_sharpness():Float return __environment_ptr().value.get_ssao_sharpness();
	public function set_ssao_direct_light_affect(p_amount:Float):Void __environment_ptr().value.set_ssao_direct_light_affect(p_amount);
	...
	public function set_ssao_ao_channel_affect(p_amount:Float):Float {
		__environment_ptr().value.set_ssao_ao_channel_affect(p_amount);
		return p_amount;
	}
	...
	public function set_ssil_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_ssil_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_ssil_radius(p_radius:Float):Float {
		__environment_ptr().value.set_ssil_radius(p_radius);
		return p_radius;
	}
	...
	public function set_ssil_intensity(p_intensity:Float):Float {
		__environment_ptr().value.set_ssil_intensity(p_intensity);
		return p_intensity;
	}
	...
	public function set_ssil_sharpness(p_sharpness:Float):Float {
		__environment_ptr().value.set_ssil_sharpness(p_sharpness);
		return p_sharpness;
	}
	...
	public function set_ssil_normal_rejection(p_normal_rejection:Float):Float {
		__environment_ptr().value.set_ssil_normal_rejection(p_normal_rejection);
	...
	public function set_sdfgi_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_sdfgi_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_sdfgi_cascades(p_amount:Int):Int {
		__environment_ptr().value.set_sdfgi_cascades(p_amount);
		return p_amount;
	}
	...
	public function set_sdfgi_min_cell_size(p_size:Float):Float {
		__environment_ptr().value.set_sdfgi_min_cell_size(p_size);
		return p_size;
	}
	...
	public function set_sdfgi_max_distance(p_distance:Float):Float {
		__environment_ptr().value.set_sdfgi_max_distance(p_distance);
		return p_distance;
	}
	...
	public function set_sdfgi_cascade0_distance(p_distance:Float):Float {
		__environment_ptr().value.set_sdfgi_cascade0_distance(p_distance);
		return p_distance;
	}
	...
	public function set_sdfgi_y_scale(p_scale:gd.environment.SDFGIYScale):gd.environment.SDFGIYScale {
		__environment_ptr().value.set_sdfgi_y_scale(p_scale);
		return p_scale;
	}
	...
	public function set_sdfgi_use_occlusion(p_enable:Bool):Bool {
		__environment_ptr().value.set_sdfgi_use_occlusion(p_enable);
		return p_enable;
	}
	...
	public function set_sdfgi_bounce_feedback(p_amount:Float):Float {
		__environment_ptr().value.set_sdfgi_bounce_feedback(p_amount);
		return p_amount;
	}
	...
	public function set_sdfgi_read_sky_light(p_enable:Bool):Bool {
		__environment_ptr().value.set_sdfgi_read_sky_light(p_enable);
		return p_enable;
	}
	...
	public function set_sdfgi_energy(p_amount:Float):Float {
		__environment_ptr().value.set_sdfgi_energy(p_amount);
		return p_amount;
	}
	...
	public function set_sdfgi_normal_bias(p_bias:Float):Float {
		__environment_ptr().value.set_sdfgi_normal_bias(p_bias);
		return p_bias;
	}
	...
	public function set_sdfgi_probe_bias(p_bias:Float):Float {
		__environment_ptr().value.set_sdfgi_probe_bias(p_bias);
		return p_bias;
	}
	...
	public function set_glow_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_glow_enabled(p_enabled);
		return p_enabled;
	}
	public function is_glow_enabled():Bool return __environment_ptr().value.is_glow_enabled();
	public function set_glow_level(p_idx:Int, p_intensity:Float):Void __environment_ptr().value.set_glow_level(p_idx, p_intensity);
	public function get_glow_level(p_idx:Int):Float return __environment_ptr().value.get_glow_level(p_idx);
	public function set_glow_normalized(p_normalize:Bool):Bool {
		__environment_ptr().value.set_glow_normalized(p_normalize);
		return p_normalize;
	}
	...
	public function set_glow_intensity(p_intensity:Float):Float {
		__environment_ptr().value.set_glow_intensity(p_intensity);
		return p_intensity;
	}
	...
	public function set_glow_strength(p_strength:Float):Float {
		__environment_ptr().value.set_glow_strength(p_strength);
		return p_strength;
	}
	...
	public function set_glow_mix(p_mix:Float):Float {
		__environment_ptr().value.set_glow_mix(p_mix);
		return p_mix;
	}
	...
	public function set_glow_bloom(p_amount:Float):Float {
		__environment_ptr().value.set_glow_bloom(p_amount);
		return p_amount;
	}
	...
	public function set_glow_blend_mode(p_mode:gd.environment.GlowBlendMode):gd.environment.GlowBlendMode {
		__environment_ptr().value.set_glow_blend_mode(p_mode);
		return p_mode;
	}
	public function get_glow_blend_mode():gd.environment.GlowBlendMode return __environment_ptr().value.get_glow_blend_mode();
	public function set_glow_hdr_bleed_threshold(p_threshold:Float):Void __environment_ptr().value.set_glow_hdr_bleed_threshold(p_threshold);
	public function get_glow_hdr_bleed_threshold():Float return __environment_ptr().value.get_glow_hdr_bleed_threshold();
	public function set_glow_hdr_bleed_scale(p_scale:Float):Void __environment_ptr().value.set_glow_hdr_bleed_scale(p_scale);
	...
	public function set_glow_hdr_luminance_cap(p_amount:Float):Float {
		__environment_ptr().value.set_glow_hdr_luminance_cap(p_amount);
		return p_amount;
	}
	...
	public function set_glow_map_strength(p_strength:Float):Float {
		__environment_ptr().value.set_glow_map_strength(p_strength);
		return p_strength;
	}
	...
	public function set_glow_map(p_mode:gd.Texture):gd.Texture {
		__environment_ptr().value.set_glow_map(p_mode);
		return p_mode;
	}
	...
	public function set_fog_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_fog_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_fog_mode(p_mode:gd.environment.FogMode):gd.environment.FogMode {
		__environment_ptr().value.set_fog_mode(p_mode);
		return p_mode;
	}
	...
	public function set_fog_light_color(p_light_color:gd.Color):gd.Color {
		__environment_ptr().value.set_fog_light_color(p_light_color);
	...
	public function set_fog_light_energy(p_light_energy:Float):Float {
		__environment_ptr().value.set_fog_light_energy(p_light_energy);
	...
	public function set_fog_sun_scatter(p_sun_scatter:Float):Float {
		__environment_ptr().value.set_fog_sun_scatter(p_sun_scatter);
	...
	public function set_fog_density(p_density:Float):Float {
		__environment_ptr().value.set_fog_density(p_density);
		return p_density;
	}
	...
	public function set_fog_height(p_height:Float):Float {
		__environment_ptr().value.set_fog_height(p_height);
		return p_height;
	}
	...
	public function set_fog_height_density(p_height_density:Float):Float {
		__environment_ptr().value.set_fog_height_density(p_height_density);
	...
	public function set_fog_aerial_perspective(p_aerial_perspective:Float):Float {
		__environment_ptr().value.set_fog_aerial_perspective(p_aerial_perspective);
	...
	public function set_fog_sky_affect(p_sky_affect:Float):Float {
		__environment_ptr().value.set_fog_sky_affect(p_sky_affect);
		return p_sky_affect;
	}
	...
	public function set_fog_depth_curve(p_curve:Float):Float {
		__environment_ptr().value.set_fog_depth_curve(p_curve);
		return p_curve;
	}
	...
	public function set_fog_depth_begin(p_begin:Float):Float {
		__environment_ptr().value.set_fog_depth_begin(p_begin);
		return p_begin;
	}
	...
	public function set_fog_depth_end(p_end:Float):Float {
		__environment_ptr().value.set_fog_depth_end(p_end);
		return p_end;
	}
	...
	public function set_volumetric_fog_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_volumetric_fog_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_volumetric_fog_emission(p_color:gd.Color):gd.Color {
		__environment_ptr().value.set_volumetric_fog_emission(p_color);
		return p_color;
	}
	...
	public function set_volumetric_fog_albedo(p_color:gd.Color):gd.Color {
		__environment_ptr().value.set_volumetric_fog_albedo(p_color);
		return p_color;
	}
	...
	public function set_volumetric_fog_density(p_density:Float):Float {
		__environment_ptr().value.set_volumetric_fog_density(p_density);
		return p_density;
	}
	...
	public function set_volumetric_fog_emission_energy(p_begin:Float):Float {
		__environment_ptr().value.set_volumetric_fog_emission_energy(p_begin);
		return p_begin;
	}
	...
	public function set_volumetric_fog_anisotropy(p_anisotropy:Float):Float {
		__environment_ptr().value.set_volumetric_fog_anisotropy(p_anisotropy);
		return p_anisotropy;
	}
	...
	public function set_volumetric_fog_length(p_length:Float):Float {
		__environment_ptr().value.set_volumetric_fog_length(p_length);
		return p_length;
	}
	...
	public function set_volumetric_fog_detail_spread(p_detail_spread:Float):Float {
		__environment_ptr().value.set_volumetric_fog_detail_spread(p_detail_spread);
	...
	public function set_volumetric_fog_gi_inject(p_gi_inject:Float):Float {
		__environment_ptr().value.set_volumetric_fog_gi_inject(p_gi_inject);
		return p_gi_inject;
	}
	...
	public function set_volumetric_fog_ambient_inject(p_enabled:Float):Float {
		__environment_ptr().value.set_volumetric_fog_ambient_inject(p_enabled);
		return p_enabled;
	}
	...
	public function set_volumetric_fog_sky_affect(p_sky_affect:Float):Float {
		__environment_ptr().value.set_volumetric_fog_sky_affect(p_sky_affect);
		return p_sky_affect;
	}
	...
	public function set_volumetric_fog_temporal_reprojection_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_volumetric_fog_temporal_reprojection_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_volumetric_fog_temporal_reprojection_amount(p_temporal_reprojection_amount:Float):Float {
		__environment_ptr().value.set_volumetric_fog_temporal_reprojection_amount(p_temporal_reprojection_amount);
	...
	public function set_adjustment_enabled(p_enabled:Bool):Bool {
		__environment_ptr().value.set_adjustment_enabled(p_enabled);
		return p_enabled;
	}
	...
	public function set_adjustment_brightness(p_brightness:Float):Float {
		__environment_ptr().value.set_adjustment_brightness(p_brightness);
		return p_brightness;
	}
	...
	public function set_adjustment_contrast(p_contrast:Float):Float {
		__environment_ptr().value.set_adjustment_contrast(p_contrast);
		return p_contrast;
	}
	...
	public function set_adjustment_saturation(p_saturation:Float):Float {
		__environment_ptr().value.set_adjustment_saturation(p_saturation);
		return p_saturation;
	}
	...
	public function set_adjustment_color_correction(p_color_correction:gd.Texture):gd.Texture {
		__environment_ptr().value.set_adjustment_color_correction(p_color_correction);
