...
class AnimationNodeBlendSpace2D extends gd.AnimationRootNode {
	...
	public function add_blend_point(p_node:gd.AnimationRootNode, p_pos:gd.Vector2, ?p_at_index:Int = -1):Void __animationnodeblendspace2d_ptr().value.add_blend_point(p_node, p_pos, p_at_index);
	public function set_blend_point_position(p_point:Int, p_pos:gd.Vector2):Void __animationnodeblendspace2d_ptr().value.set_blend_point_position(p_point, p_pos);
	public function get_blend_point_position(p_point:Int):gd.Vector2 return __animationnodeblendspace2d_ptr().value.get_blend_point_position(p_point);
	public function set_blend_point_node(p_point:Int, p_node:gd.AnimationRootNode):Void __animationnodeblendspace2d_ptr().value.set_blend_point_node(p_point, p_node);
	public function get_blend_point_node(p_point:Int):gd.AnimationRootNode return __animationnodeblendspace2d_ptr().value.get_blend_point_node(p_point);
	public function remove_blend_point(p_point:Int):Void __animationnodeblendspace2d_ptr().value.remove_blend_point(p_point);
	public function get_blend_point_count():Int return __animationnodeblendspace2d_ptr().value.get_blend_point_count();
	public function add_triangle(p_x:Int, p_y:Int, p_z:Int, ?p_at_index:Int = -1):Void __animationnodeblendspace2d_ptr().value.add_triangle(p_x, p_y, p_z, p_at_index);
	public function get_triangle_point(p_triangle:Int, p_point:Int):Int return __animationnodeblendspace2d_ptr().value.get_triangle_point(p_triangle, p_point);
	public function remove_triangle(p_triangle:Int):Void __animationnodeblendspace2d_ptr().value.remove_triangle(p_triangle);
	...
	public function set_min_space(p_min_space:gd.Vector2):gd.Vector2 {
		__animationnodeblendspace2d_ptr().value.set_min_space(p_min_space);
		return p_min_space;
	}
	...
	public function set_max_space(p_max_space:gd.Vector2):gd.Vector2 {
		__animationnodeblendspace2d_ptr().value.set_max_space(p_max_space);
		return p_max_space;
	}
	...
	public function set_snap(p_snap:gd.Vector2):gd.Vector2 {
		__animationnodeblendspace2d_ptr().value.set_snap(p_snap);
		return p_snap;
	}
	...
	public function set_x_label(p_text:std.String):std.String {
		__animationnodeblendspace2d_ptr().value.set_x_label(p_text);
		return p_text;
	}
	...
	public function set_y_label(p_text:std.String):std.String {
		__animationnodeblendspace2d_ptr().value.set_y_label(p_text);
		return p_text;
	}
	...
	public function set_auto_triangles(p_enable:Bool):Bool {
		__animationnodeblendspace2d_ptr().value.set_auto_triangles(p_enable);
		return p_enable;
	}
	...
	public function set_blend_mode(p_mode:gd.animationnodeblendspace2d.BlendMode):gd.animationnodeblendspace2d.BlendMode {
		__animationnodeblendspace2d_ptr().value.set_blend_mode(p_mode);
		return p_mode;
	}
	...
	public function set_use_sync(p_enable:Bool):Void __animationnodeblendspace2d_ptr().value.set_use_sync(p_enable);
