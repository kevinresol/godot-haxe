...
class RootMotionView extends gd.VisualInstance3D {
	...
	public function set_animation_path(p_path:std.String):std.String {
		__rootmotionview_ptr().value.set_animation_path(p_path);
		return p_path;
	}
	...
	public function set_color(p_color:gd.Color):gd.Color {
		__rootmotionview_ptr().value.set_color(p_color);
		return p_color;
	}
	...
	public function set_cell_size(p_size:Float):Float {
		__rootmotionview_ptr().value.set_cell_size(p_size);
		return p_size;
	}
	...
	public function set_radius(p_size:Float):Float {
		__rootmotionview_ptr().value.set_radius(p_size);
		return p_size;
	}
	...
	public function set_zero_y(p_enable:Bool):Bool {
		__rootmotionview_ptr().value.set_zero_y(p_enable);
		return p_enable;
	}
