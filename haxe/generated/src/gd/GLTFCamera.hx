...
class GLTFCamera extends gd.Resource {
	...
	public static function from_node(p_camera_node:gd.Camera3D):gd.GLTFCamera return gdnative.GLTFCamera.GLTFCamera_extern.from_node(p_camera_node);
	public function to_node():gd.Camera3D return __gltfcamera_ptr().value.to_node();
	public static function from_dictionary(p_dictionary:gd.Dictionary):gd.GLTFCamera return gdnative.GLTFCamera.GLTFCamera_extern.from_dictionary(p_dictionary);
	...
	public function set_perspective(p_perspective:Bool):Bool {
		__gltfcamera_ptr().value.set_perspective(p_perspective);
	...
	public function set_fov(p_fov:Float):Float {
		__gltfcamera_ptr().value.set_fov(p_fov);
		return p_fov;
	}
	...
	public function set_size_mag(p_size_mag:Float):Float {
		__gltfcamera_ptr().value.set_size_mag(p_size_mag);
		return p_size_mag;
	}
	...
	public function set_depth_far(p_zdepth_far:Float):Float {
		__gltfcamera_ptr().value.set_depth_far(p_zdepth_far);
		return p_zdepth_far;
	}
	...
	public function set_depth_near(p_zdepth_near:Float):Float {
		__gltfcamera_ptr().value.set_depth_near(p_zdepth_near);
