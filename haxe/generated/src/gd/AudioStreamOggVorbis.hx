...
class AudioStreamOggVorbis extends gd.AudioStream {
	...
	public static function load_from_buffer(p_buffer:gd.PackedByteArray):gd.AudioStreamOggVorbis return gdnative.AudioStreamOggVorbis.AudioStreamOggVorbis_extern.load_from_buffer(((p_buffer : gd.PackedByteArray)));
	public static function load_from_file(p_path:std.String):gd.AudioStreamOggVorbis return gdnative.AudioStreamOggVorbis.AudioStreamOggVorbis_extern.load_from_file(((p_path : std.String)));
	public function set_packet_sequence(p_packet_sequence:gd.OggPacketSequence):gd.OggPacketSequence {
		__audiostreamoggvorbis_ptr().value.set_packet_sequence(((p_packet_sequence : gd.OggPacketSequence)));
	...
	public function set_loop(p_enable:Bool):Bool {
		__audiostreamoggvorbis_ptr().value.set_loop(((p_enable : Bool)));
		return p_enable;
	}
	...
	public function set_loop_offset(p_seconds:Float):Float {
		__audiostreamoggvorbis_ptr().value.set_loop_offset(((p_seconds : Float)));
		return p_seconds;
	}
	...
	public function set_bpm(p_bpm:Float):Float {
		__audiostreamoggvorbis_ptr().value.set_bpm(((p_bpm : Float)));
		return p_bpm;
	}
	...
	public function set_beat_count(p_count:Int):Int {
		__audiostreamoggvorbis_ptr().value.set_beat_count(((p_count : Int)));
		return p_count;
	}
	...
	public function set_bar_beats(p_count:Int):Int {
		__audiostreamoggvorbis_ptr().value.set_bar_beats(((p_count : Int)));
		return p_count;
	}
	public function get_bar_beats():Int return __audiostreamoggvorbis_ptr().value.get_bar_beats();
	public var packet_sequence(get, set) : gd.OggPacketSequence;
