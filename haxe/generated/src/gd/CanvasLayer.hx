...
class CanvasLayer extends gd.Node {
	...
	public function set_offset(p_offset:gd.Vector2):gd.Vector2 {
		__canvaslayer_ptr().value.set_offset(p_offset);
		return p_offset;
	}
	...
	public function set_rotation(p_radians:Float):Float {
		__canvaslayer_ptr().value.set_rotation(p_radians);
		return p_radians;
	}
	...
	public function set_scale(p_scale:gd.Vector2):gd.Vector2 {
		__canvaslayer_ptr().value.set_scale(p_scale);
		return p_scale;
	}
	public function get_scale():gd.Vector2 return __canvaslayer_ptr().value.get_scale();
	public function set_follow_viewport(p_enable:Bool):Void __canvaslayer_ptr().value.set_follow_viewport(p_enable);
	...
	public function set_follow_viewport_scale(p_scale:Float):Float {
		__canvaslayer_ptr().value.set_follow_viewport_scale(p_scale);
		return p_scale;
	}
	...
	public function set_custom_viewport(p_viewport:gd.Node):gd.Node {
		__canvaslayer_ptr().value.set_custom_viewport(p_viewport);
		return p_viewport;
	}
