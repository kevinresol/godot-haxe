...
class RemoteTransform3D extends gd.Node3D {
	...
	public function set_remote_node(p_path:std.String):Void __remotetransform3d_ptr().value.set_remote_node(((p_path : std.String)));
	...
	public function set_use_global_coordinates(p_use_global_coordinates:Bool):Bool {
		__remotetransform3d_ptr().value.set_use_global_coordinates(((p_use_global_coordinates : Bool)));
	...
	public function set_update_position(p_update_remote_position:Bool):Bool {
		__remotetransform3d_ptr().value.set_update_position(((p_update_remote_position : Bool)));
	...
	public function set_update_rotation(p_update_remote_rotation:Bool):Bool {
		__remotetransform3d_ptr().value.set_update_rotation(((p_update_remote_rotation : Bool)));
	...
	public function set_update_scale(p_update_remote_scale:Bool):Bool {
		__remotetransform3d_ptr().value.set_update_scale(((p_update_remote_scale : Bool)));
