...
class RDFramebufferPass extends gd.RefCounted {
	...
	public function set_input_attachments(p_p_member:gd.PackedInt32Array):gd.PackedInt32Array {
		__rdframebufferpass_ptr().value.set_input_attachments(((p_p_member : gd.PackedInt32Array)));
		return p_p_member;
	}
	...
	public function set_resolve_attachments(p_p_member:gd.PackedInt32Array):gd.PackedInt32Array {
		__rdframebufferpass_ptr().value.set_resolve_attachments(((p_p_member : gd.PackedInt32Array)));
		return p_p_member;
	}
	...
	public function set_preserve_attachments(p_p_member:gd.PackedInt32Array):gd.PackedInt32Array {
		__rdframebufferpass_ptr().value.set_preserve_attachments(((p_p_member : gd.PackedInt32Array)));
		return p_p_member;
	}
	...
	public function set_depth_attachment(p_p_member:Int):Int {
		__rdframebufferpass_ptr().value.set_depth_attachment(((p_p_member : Int)));
		return p_p_member;
	}
