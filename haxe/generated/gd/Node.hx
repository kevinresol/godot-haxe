...
class Node extends gd.Object {
	function _process(p_delta:Float):Void ((cast __gd__native.ptr : godot.Node)).value._process(p_delta);
	function _physics_process(p_delta:Float):Void ((cast __gd__native.ptr : godot.Node)).value._physics_process(p_delta);
	function _enter_tree():Void ((cast __gd__native.ptr : godot.Node)).value._enter_tree();
	...
	function get_tree_string():String return ((cast __gd__native.ptr : godot.Node)).value.get_tree_string();
	function get_tree_string_pretty():String return ((cast __gd__native.ptr : godot.Node)).value.get_tree_string_pretty();
	function set_scene_file_path(p_scene_file_path:String):Void ((cast __gd__native.ptr : godot.Node)).value.set_scene_file_path(p_scene_file_path);
	function get_scene_file_path():String return ((cast __gd__native.ptr : godot.Node)).value.get_scene_file_path();
	function propagate_notification(p_what:Int):Void ((cast __gd__native.ptr : godot.Node)).value.propagate_notification(p_what);
	function set_physics_process(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_physics_process(p_enable);
	function get_physics_process_delta_time():Float return ((cast __gd__native.ptr : godot.Node)).value.get_physics_process_delta_time();
	function is_physics_processing():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_physics_processing();
	function get_process_delta_time():Float return ((cast __gd__native.ptr : godot.Node)).value.get_process_delta_time();
	function set_process(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_process(p_enable);
	function set_process_priority(p_priority:Int):Void ((cast __gd__native.ptr : godot.Node)).value.set_process_priority(p_priority);
	function get_process_priority():Int return ((cast __gd__native.ptr : godot.Node)).value.get_process_priority();
	function set_physics_process_priority(p_priority:Int):Void ((cast __gd__native.ptr : godot.Node)).value.set_physics_process_priority(p_priority);
	function get_physics_process_priority():Int return ((cast __gd__native.ptr : godot.Node)).value.get_physics_process_priority();
	function is_processing():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_processing();
	function set_process_input(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_process_input(p_enable);
	function is_processing_input():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_processing_input();
	function set_process_shortcut_input(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_process_shortcut_input(p_enable);
	function is_processing_shortcut_input():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_processing_shortcut_input();
	function set_process_unhandled_input(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_process_unhandled_input(p_enable);
	function is_processing_unhandled_input():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_processing_unhandled_input();
	function set_process_unhandled_key_input(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_process_unhandled_key_input(p_enable);
	function is_processing_unhandled_key_input():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_processing_unhandled_key_input();
	function can_process():Bool return ((cast __gd__native.ptr : godot.Node)).value.can_process();
	function set_process_thread_group_order(p_order:Int):Void ((cast __gd__native.ptr : godot.Node)).value.set_process_thread_group_order(p_order);
	function get_process_thread_group_order():Int return ((cast __gd__native.ptr : godot.Node)).value.get_process_thread_group_order();
	function set_display_folded(p_fold:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_display_folded(p_fold);
	function is_displayed_folded():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_displayed_folded();
	function set_process_internal(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_process_internal(p_enable);
	function is_processing_internal():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_processing_internal();
	function set_physics_process_internal(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_physics_process_internal(p_enable);
	function is_physics_processing_internal():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_physics_processing_internal();
	...
	function set_multiplayer_authority(p_id:Int, ?p_recursive:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_multiplayer_authority(p_id, p_recursive);
	function get_multiplayer_authority():Int return ((cast __gd__native.ptr : godot.Node)).value.get_multiplayer_authority();
	function is_multiplayer_authority():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_multiplayer_authority();
	function rpc_config(p_method:String, p_config:Dynamic):Void ((cast __gd__native.ptr : godot.Node)).value.rpc_config(p_method, p_config);
	function set_editor_description(p_editor_description:String):Void ((cast __gd__native.ptr : godot.Node)).value.set_editor_description(p_editor_description);
	function get_editor_description():String return ((cast __gd__native.ptr : godot.Node)).value.get_editor_description();
	function set_unique_name_in_owner(p_enable:Bool):Void ((cast __gd__native.ptr : godot.Node)).value.set_unique_name_in_owner(p_enable);
	function is_unique_name_in_owner():Bool return ((cast __gd__native.ptr : godot.Node)).value.is_unique_name_in_owner();
	function atr(p_message:String, ?p_context:String):String return ((cast __gd__native.ptr : godot.Node)).value.atr(p_message, p_context);
	function atr_n(p_message:String, p_plural_message:String, p_n:Int, ?p_context:String):String return ((cast __gd__native.ptr : godot.Node)).value.atr_n(p_message, p_plural_message, p_n, p_context);
	function update_configuration_warnings():Void ((cast __gd__native.ptr : godot.Node)).value.update_configuration_warnings();
	function call_deferred_thread_group(p_method:String):Dynamic return ((cast __gd__native.ptr : godot.Node)).value.call_deferred_thread_group(p_method);
	function set_deferred_thread_group(p_property:String, p_value:Dynamic):Void ((cast __gd__native.ptr : godot.Node)).value.set_deferred_thread_group(p_property, p_value);
	function notify_deferred_thread_group(p_what:Int):Void ((cast __gd__native.ptr : godot.Node)).value.notify_deferred_thread_group(p_what);
