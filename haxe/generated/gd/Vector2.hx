package gd;
class Vector2 {
	final __gd_value : cpp.Struct<godot.Vector2>;
	public function new(value:cpp.Struct<godot.Vector2>) __gd_value = value;
	...
	public static function _new1(p_from:gd.Vector2.Vector2AutoCast) return new Vector2(new godot.Vector2(p_from));
...
@:forward abstract Vector2AutoCast(Vector2) from Vector2 to Vector2 {
	@:from
	static inline function fromNative(v:godot.Vector2):Vector2AutoCast {
		return new Vector2(v);
	}
	@:to
	inline function toNative():godot.Vector2 {
