...
class CanvasItem extends gd.Node {
	function _draw():Void ((cast __gd__native.ptr : godot.CanvasItem)).value._draw();
	function set_visible(p_visible:Bool):Void ((cast __gd__native.ptr : godot.CanvasItem)).value.set_visible(p_visible);
	function is_visible():Bool return ((cast __gd__native.ptr : godot.CanvasItem)).value.is_visible();
	function is_visible_in_tree():Bool return ((cast __gd__native.ptr : godot.CanvasItem)).value.is_visible_in_tree();
	function show():Void ((cast __gd__native.ptr : godot.CanvasItem)).value.show();
	function hide():Void ((cast __gd__native.ptr : godot.CanvasItem)).value.hide();
	function queue_redraw():Void ((cast __gd__native.ptr : godot.CanvasItem)).value.queue_redraw();
	function move_to_front():Void ((cast __gd__native.ptr : godot.CanvasItem)).value.move_to_front();
	function set_as_top_level(p_enable:Bool):Void ((cast __gd__native.ptr : godot.CanvasItem)).value.set_as_top_level(p_enable);
	function is_set_as_top_level():Bool return ((cast __gd__native.ptr : godot.CanvasItem)).value.is_set_as_top_level();
	function set_light_mask(p_light_mask:Int):Void ((cast __gd__native.ptr : godot.CanvasItem)).value.set_light_mask(p_light_mask);
	function get_light_mask():Int return ((cast __gd__native.ptr : godot.CanvasItem)).value.get_light_mask();
	function set_z_index(p_z_index:Int):Void ((cast __gd__native.ptr : godot.CanvasItem)).value.set_z_index(p_z_index);
	function get_z_index():Int return ((cast __gd__native.ptr : godot.CanvasItem)).value.get_z_index();
	function set_z_as_relative(p_enable:Bool):Void ((cast __gd__native.ptr : godot.CanvasItem)).value.set_z_as_relative(p_enable);
	function is_z_relative():Bool return ((cast __gd__native.ptr : godot.CanvasItem)).value.is_z_relative();
	function set_y_sort_enabled(p_enabled:Bool):Void ((cast __gd__native.ptr : godot.CanvasItem)).value.set_y_sort_enabled(p_enabled);
	...
	function is_local_transform_notification_enabled():Bool return ((cast __gd__native.ptr : godot.CanvasItem)).value.is_local_transform_notification_enabled();
	...
	function get_visibility_layer_bit(p_layer:Int):Bool return ((cast __gd__native.ptr : godot.CanvasItem)).value.get_visibility_layer_bit(p_layer);
}

@:forward abstract CanvasItemAutoCast(CanvasItem) from CanvasItem to CanvasItem {
	@:from
	static inline function fromStar(v:godot.CanvasItem.CanvasItem_star):CanvasItemAutoCast {
		return fromPointer(cpp.Pointer.fromStar(v));
	}
	@:from
	static inline function fromPointer(v:godot.CanvasItem):CanvasItemAutoCast {
		return new CanvasItem(v.reinterpret());
	}
	@:to
	inline function toPointer():godot.CanvasItem {
		return @:privateAccess this.__gd__native.reinterpret();
	}
	@:analyzer(no_const_propagation)
	@:to
	inline function toStar():godot.CanvasItem.CanvasItem_star {
		final p = toPointer();
		return p.ptr;
	}
}