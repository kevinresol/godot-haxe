...
extern class Time extends gd.Object {
	...
	function get_datetime_string_from_unix_time(p_unix_time_val:Int, ?p_use_space:Bool):std.String;
	...
	function get_datetime_dict_from_system(?p_utc:Bool):gd.Dictionary;
	function get_date_dict_from_system(?p_utc:Bool):gd.Dictionary;
	function get_time_dict_from_system(?p_utc:Bool):gd.Dictionary;
	function get_datetime_string_from_system(?p_utc:Bool, ?p_use_space:Bool):std.String;
	function get_date_string_from_system(?p_utc:Bool):std.String;
	function get_time_string_from_system(?p_utc:Bool):std.String;
