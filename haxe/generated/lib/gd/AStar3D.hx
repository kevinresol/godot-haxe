package gd;
extern class AStar3D extends gd.RefCounted {
	...
	function add_point(p_id:Int, p_position:gd.Vector3, ?p_weight_scale:Float):Void;
	function get_point_position(p_id:Int):gd.Vector3;
	function set_point_position(p_id:Int, p_position:gd.Vector3):Void;
	...
	function clear():Void;
	function get_closest_point(p_to_position:gd.Vector3, ?p_include_disabled:Bool):Int;
	function get_closest_position_in_segment(p_to_position:gd.Vector3):gd.Vector3;
	function get_point_path(p_from_id:Int, p_to_id:Int, ?p_allow_partial_path:Bool):gd.PackedVector3Array;
	function get_id_path(p_from_id:Int, p_to_id:Int, ?p_allow_partial_path:Bool):gd.PackedInt64Array;
}