...
extern class AStar3D extends gd.RefCounted {
	...
	function add_point(p_id:Int, p_position:gd.Vector3, ?p_weight_scale:Float = 1.):Void;
	...
	function clear():Void;
	function get_closest_point(p_to_position:gd.Vector3, ?p_include_disabled:Bool = false):Int;
	function get_closest_position_in_segment(p_to_position:gd.Vector3):gd.Vector3;
	function get_point_path(p_from_id:Int, p_to_id:Int, ?p_allow_partial_path:Bool = false):gd.PackedVector3Array;
