...
extern class EditorNode3DGizmo extends gd.Node3DGizmo {
	...
	function _set_subgizmo_transform(p_id:Int, p_transform:gd.Transform3D):Void;
	function _get_subgizmo_transform(p_id:Int):gd.Transform3D;
	function add_lines(p_lines:gd.PackedVector3Array, p_material:gd.Material, ?p_billboard:Bool, ?p_modulate:gd.Color):Void;
	function add_mesh(p_mesh:gd.Mesh, ?p_material:gd.Material, ?p_transform:gd.Transform3D, ?p_skeleton:gd.SkinReference):Void;
