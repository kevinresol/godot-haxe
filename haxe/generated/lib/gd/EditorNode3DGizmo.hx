...
extern class EditorNode3DGizmo extends gd.Node3DGizmo {
	...
	function add_handles(p_handles:gd.PackedVector3Array, p_material:gd.Material, p_ids:gd.PackedInt32Array, ?p_billboard:Bool = false, ?p_secondary:Bool = false):Void;
