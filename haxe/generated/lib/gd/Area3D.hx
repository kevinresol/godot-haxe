package gd;
extern class Area3D extends gd.CollisionObject3D {
	function new(?owner:Dynamic);
	function set_gravity_space_override_mode(p_space_override_mode:gd.area3d.SpaceOverride):Void;
	function get_gravity_space_override_mode():gd.area3d.SpaceOverride;
	...
	function set_gravity_point_center(p_center:gd.Vector3):gd.Vector3;
	function get_gravity_point_center():gd.Vector3;
	function set_gravity_direction(p_direction:gd.Vector3):gd.Vector3;
	function get_gravity_direction():gd.Vector3;
	function set_gravity(p_gravity:Float):Float;
	function get_gravity():Float;
	function set_linear_damp_space_override_mode(p_space_override_mode:gd.area3d.SpaceOverride):Void;
	function get_linear_damp_space_override_mode():gd.area3d.SpaceOverride;
	function set_angular_damp_space_override_mode(p_space_override_mode:gd.area3d.SpaceOverride):Void;
	function get_angular_damp_space_override_mode():gd.area3d.SpaceOverride;
	...
	function set_wind_force_magnitude(p_wind_force_magnitude:Float):Float;
	function get_wind_force_magnitude():Float;
	function set_wind_attenuation_factor(p_wind_attenuation_factor:Float):Float;
	function get_wind_attenuation_factor():Float;
	function set_wind_source_path(p_wind_source_path:std.String):std.String;
	function get_wind_source_path():std.String;
	...
	function set_reverb_bus_name(p_name:std.String):std.String;
	function get_reverb_bus_name():std.String;
	...
	function get_gravity_space_override():gd.area3d.SpaceOverride;
	...
	function get_linear_damp_space_override():gd.area3d.SpaceOverride;
	...
	function get_angular_damp_space_override():gd.area3d.SpaceOverride;
