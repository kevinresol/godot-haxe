...
extern class AStar2D extends gd.RefCounted {
	...
	function add_point(p_id:Int, p_position:gd.Vector2, ?p_weight_scale:Float):Void;
	...
	function clear():Void;
	function get_closest_point(p_to_position:gd.Vector2, ?p_include_disabled:Bool):Int;
	function get_closest_position_in_segment(p_to_position:gd.Vector2):gd.Vector2;
	function get_point_path(p_from_id:Int, p_to_id:Int, ?p_allow_partial_path:Bool):gd.PackedVector2Array;
