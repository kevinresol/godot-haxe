...
extern class RenderingDevice extends gd.Object {
	...
	function framebuffer_format_create_empty(?p_samples:gd.renderingdevice.TextureSamples):Int;
	function framebuffer_format_get_texture_samples(p_format:Int, ?p_render_pass:Int):gd.renderingdevice.TextureSamples;
	function framebuffer_create_empty(p_size:gd.Vector2i, ?p_samples:gd.renderingdevice.TextureSamples, ?p_validate_with_format:Int):gd.RID;
	...
	function vertex_buffer_create(p_size_bytes:Int, ?p_data:gd.PackedByteArray, ?p_use_as_storage:Bool):gd.RID;
	function index_buffer_create(p_size_indices:Int, p_format:gd.renderingdevice.IndexBufferFormat, ?p_data:gd.PackedByteArray, ?p_use_restart_indices:Bool):gd.RID;
	function index_array_create(p_index_buffer:gd.RID, p_index_offset:Int, p_index_count:Int):gd.RID;
	function shader_compile_spirv_from_source(p_shader_source:gd.RDShaderSource, ?p_allow_cache:Bool):gd.RDShaderSPIRV;
	...
	function shader_create_from_bytecode(p_binary_data:gd.PackedByteArray, ?p_placeholder_rid:gd.RID):gd.RID;
	function shader_create_placeholder():gd.RID;
	function shader_get_vertex_input_attribute_mask(p_shader:gd.RID):Int;
	function uniform_buffer_create(p_size_bytes:Int, ?p_data:gd.PackedByteArray):gd.RID;
	function storage_buffer_create(p_size_bytes:Int, ?p_data:gd.PackedByteArray, ?p_usage:Int):gd.RID;
	function texture_buffer_create(p_size_bytes:Int, p_format:gd.renderingdevice.DataFormat, ?p_data:gd.PackedByteArray):gd.RID;
	...
	function buffer_get_data(p_buffer:gd.RID, ?p_offset_bytes:Int, ?p_size_bytes:Int):gd.PackedByteArray;
	...
	function draw_list_begin_for_screen(?p_screen:Int, ?p_clear_color:gd.Color):Int;
	function draw_list_begin(p_framebuffer:gd.RID, p_initial_color_action:gd.renderingdevice.InitialAction, p_final_color_action:gd.renderingdevice.FinalAction, p_initial_depth_action:gd.renderingdevice.InitialAction, p_final_depth_action:gd.renderingdevice.FinalAction, ?p_clear_color_values:gd.PackedColorArray, ?p_clear_depth:Float, ?p_clear_stencil:Int, ?p_region:gd.Rect2):Int;
	...
	function draw_list_enable_scissor(p_draw_list:Int, ?p_rect:gd.Rect2):Void;
