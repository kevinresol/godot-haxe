...
extern class ClassDB extends gd.Object {
	...
	function class_get_api_type(p_class:std.String):gd.classdb.APIType;
	...
	function class_get_property_getter(p_class:std.String, p_property:std.String):std.String;
	function class_get_property_setter(p_class:std.String, p_property:std.String):std.String;
	...
	function class_call_static(p_class:std.String, p_method:std.String):gd.Variant;
