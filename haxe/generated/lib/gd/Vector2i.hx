...
extern class Vector2i_wrapper {
	...
	function distance_squared_to(p_to:gd.Vector2i):cpp.Int64;
	...
	function clampi(p_min:cpp.Int64, p_max:cpp.Int64):gd.Vector2i;
	function snapped(p_step:gd.Vector2i):gd.Vector2i;
	function snappedi(p_step:cpp.Int64):gd.Vector2i;
	function min(p_with:gd.Vector2i):gd.Vector2i;
	function mini(p_with:cpp.Int64):gd.Vector2i;
	function max(p_with:gd.Vector2i):gd.Vector2i;
	function maxi(p_with:cpp.Int64):gd.Vector2i;
	var x(get, set) : cpp.Int64;
	var y(get, set) : cpp.Int64;
	function __op_equal_to_variant(p_rhs:gd.Variant):Bool;
	function __op_not_equal_variant(p_rhs:gd.Variant):Bool;
	function __op_unary_minus():gd.Vector2i;
	function __op_multiply_int(p_rhs:cpp.Int64):gd.Vector2i;
	function __op_modulus_int(p_rhs:cpp.Int64):gd.Vector2i;
...
@:forward @:forwardStatics abstract Vector2i(Vector2i_wrapper) from Vector2i_wrapper to Vector2i_wrapper {
	...
	public extern overload inline function new(p_x:cpp.Int64, p_y:cpp.Int64) this = Vector2i_wrapper._new2(p_x, p_y);
	@:op(A == B)
