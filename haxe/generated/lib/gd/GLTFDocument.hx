...
extern class GLTFDocument extends gd.Resource {
	...
	function append_from_file(p_path:std.String, p_state:gd.GLTFState, ?p_flags:Int, ?p_base_path:std.String):gd.Error;
	function append_from_buffer(p_bytes:gd.PackedByteArray, p_base_path:std.String, p_state:gd.GLTFState, ?p_flags:Int):gd.Error;
	function append_from_scene(p_node:gd.Node, p_state:gd.GLTFState, ?p_flags:Int):gd.Error;
	function generate_scene(p_state:gd.GLTFState, ?p_bake_fps:Float, ?p_trimming:Bool, ?p_remove_immutable_tracks:Bool):gd.Node;
	...
	static function register_gltf_document_extension(p_extension:gd.GLTFDocumentExtension, ?p_first_priority:Bool):Void;
