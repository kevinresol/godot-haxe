...
extern class PopupMenu extends gd.Popup {
	...
	function activate_item_by_event(p_event:gd.InputEvent, ?p_for_global_only:Bool):Bool;
	function set_prefer_native_menu(p_enabled:Bool):Bool;
	function is_prefer_native_menu():Bool;
	function is_native_menu():Bool;
	function add_item(p_label:std.String, ?p_id:Int, ?p_accel:gd.Key):Void;
	function add_icon_item(p_texture:gd.Texture2D, p_label:std.String, ?p_id:Int, ?p_accel:gd.Key):Void;
	function add_check_item(p_label:std.String, ?p_id:Int, ?p_accel:gd.Key):Void;
	function add_icon_check_item(p_texture:gd.Texture2D, p_label:std.String, ?p_id:Int, ?p_accel:gd.Key):Void;
	function add_radio_check_item(p_label:std.String, ?p_id:Int, ?p_accel:gd.Key):Void;
	function add_icon_radio_check_item(p_texture:gd.Texture2D, p_label:std.String, ?p_id:Int, ?p_accel:gd.Key):Void;
	function add_multistate_item(p_label:std.String, p_max_states:Int, ?p_default_state:Int, ?p_id:Int, ?p_accel:gd.Key):Void;
	function add_shortcut(p_shortcut:gd.Shortcut, ?p_id:Int, ?p_global:Bool, ?p_allow_echo:Bool):Void;
	function add_icon_shortcut(p_texture:gd.Texture2D, p_shortcut:gd.Shortcut, ?p_id:Int, ?p_global:Bool, ?p_allow_echo:Bool):Void;
	function add_check_shortcut(p_shortcut:gd.Shortcut, ?p_id:Int, ?p_global:Bool):Void;
	function add_icon_check_shortcut(p_texture:gd.Texture2D, p_shortcut:gd.Shortcut, ?p_id:Int, ?p_global:Bool):Void;
	function add_radio_check_shortcut(p_shortcut:gd.Shortcut, ?p_id:Int, ?p_global:Bool):Void;
	function add_icon_radio_check_shortcut(p_texture:gd.Texture2D, p_shortcut:gd.Shortcut, ?p_id:Int, ?p_global:Bool):Void;
	function add_submenu_item(p_label:std.String, p_submenu:std.String, ?p_id:Int):Void;
	function add_submenu_node_item(p_label:std.String, p_submenu:gd.PopupMenu, ?p_id:Int):Void;
	...
	function set_item_shortcut(p_index:Int, p_shortcut:gd.Shortcut, ?p_global:Bool):Void;
	...
	function add_separator(?p_label:std.String, ?p_id:Int):Void;
