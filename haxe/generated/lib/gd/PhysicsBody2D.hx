...
extern class PhysicsBody2D extends gd.CollisionObject2D {
	...
	function move_and_collide(p_motion:gd.Vector2, ?p_test_only:Bool = false, ?p_safe_margin:Float = 0.08, ?p_recovery_as_collision:Bool = false):gd.KinematicCollision2D;
