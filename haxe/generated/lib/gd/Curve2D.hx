...
extern class Curve2D extends gd.Resource {
	...
	function add_point(p_position:gd.Vector2, ?p_in:gd.Vector2, ?p_out:gd.Vector2, ?p_index:Int):Void;
	...
	function tessellate(?p_max_stages:Int, ?p_tolerance_degrees:Float):gd.PackedVector2Array;
	function tessellate_even_length(?p_max_stages:Int, ?p_tolerance_length:Float):gd.PackedVector2Array;
