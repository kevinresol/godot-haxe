...
extern class Node extends gd.Object {
	...
	function add_sibling(p_sibling:gd.Node, ?p_force_readable_name:Bool = false):Void;
	function set_name(p_name:std.String):std.String;
	function get_name():std.String;
	function add_child(p_node:gd.Node, ?p_force_readable_name:Bool = false):Void;
	function remove_child(p_node:gd.Node):Void;
	function reparent(p_new_parent:gd.Node, ?p_keep_global_transform:Bool = true):Void;
	function get_child_count(?p_include_internal:Bool = false):Int;
	function get_child(p_idx:Int, ?p_include_internal:Bool = false):gd.Node;
	...
	function find_child(p_pattern:std.String, ?p_recursive:Bool = true, ?p_owned:Bool = true):gd.Node;
	...
	function get_path_to(p_node:gd.Node, ?p_use_unique_path:Bool = false):std.String;
	function add_to_group(p_group:std.String, ?p_persistent:Bool = false):Void;
	...
	function get_index(?p_include_internal:Bool = false):Int;
	...
	function duplicate(?p_flags:Int = 15):gd.Node;
	function replace_by(p_node:gd.Node, ?p_keep_groups:Bool = false):Void;
	...
	function set_multiplayer_authority(p_id:Int, ?p_recursive:Bool = true):Void;
