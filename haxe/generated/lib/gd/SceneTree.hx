...
extern class SceneTree extends gd.MainLoop {
	...
	function call_group_flags(p_flags:Int, p_group:std.String, p_method:std.String):Void;
	function notify_group_flags(p_call_flags:Int, p_group:std.String, p_notification:Int):Void;
	function set_group_flags(p_call_flags:Int, p_group:std.String, p_property:std.String, p_value:gd.Variant):Void;
	function call_group(p_group:std.String, p_method:std.String):Void;
	function notify_group(p_group:std.String, p_notification:Int):Void;
	...
	function get_node_count_in_group(p_group:std.String):Int;
