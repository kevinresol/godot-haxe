...
extern class CanvasItem extends gd.Node {
	...
	function set_light_mask(p_light_mask:cpp.Int64):cpp.Int64;
	...
	function set_z_index(p_z_index:cpp.Int64):cpp.Int64;
	...
	function draw_arc(p_center:gd.Vector2, p_radius:Float, p_start_angle:Float, p_end_angle:Float, p_point_count:cpp.Int64, p_color:gd.Color, ?p_width:Float, ?p_antialiased:Bool):Void;
	...
	function set_visibility_layer(p_layer:cpp.Int64):cpp.Int64;
	...
	var light_mask(get, set) : cpp.Int64;
	var visibility_layer(get, set) : cpp.Int64;
	var z_index(get, set) : cpp.Int64;
