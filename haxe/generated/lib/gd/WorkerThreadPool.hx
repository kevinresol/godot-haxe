...
extern class WorkerThreadPool extends gd.Object {
	...
	function add_task(p_action:gd.Callable, ?p_high_priority:Bool = false, ?p_description:std.String = "\"\""):Int;
	function is_task_completed(p_task_id:Int):Bool;
	function wait_for_task_completion(p_task_id:Int):gd.Error;
	function add_group_task(p_action:gd.Callable, p_elements:Int, ?p_tasks_needed:Int = -1, ?p_high_priority:Bool = false, ?p_description:std.String = "\"\""):Int;
