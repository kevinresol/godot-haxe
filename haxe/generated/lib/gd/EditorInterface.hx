...
extern class EditorInterface extends gd.Object {
	...
	function get_editor_viewport_3d(?p_idx:Int):gd.SubViewport;
	...
	function popup_dialog(p_dialog:gd.Window, ?p_rect:gd.Rect2i):Void;
	function popup_dialog_centered(p_dialog:gd.Window, ?p_minsize:gd.Vector2i):Void;
	function popup_dialog_centered_ratio(p_dialog:gd.Window, ?p_ratio:Float):Void;
	function popup_dialog_centered_clamped(p_dialog:gd.Window, ?p_minsize:gd.Vector2i, ?p_fallback_ratio:Float):Void;
	function get_current_feature_profile():std.String;
	function set_current_feature_profile(p_profile_name:std.String):Void;
	function popup_property_selector(p_object:gd.Object, p_callback:gd.Callable, ?p_type_filter:gd.PackedInt32Array):Void;
	...
	function inspect_object(p_object:gd.Object, ?p_for_property:std.String, ?p_inspector_only:Bool):Void;
	function edit_resource(p_resource:gd.Resource):Void;
	function edit_node(p_node:gd.Node):Void;
	function edit_script(p_script:gd.Script, ?p_line:Int, ?p_column:Int, ?p_grab_focus:Bool):Void;
	...
	function save_scene_as(p_path:std.String, ?p_with_preview:Bool):Void;
