...
extern class JavaScriptBridge extends gd.Object {
	...
	function eval(p_code:std.String, ?p_use_global_execution_context:Bool = false):gd.Variant;
	...
	function download_buffer(p_buffer:gd.PackedByteArray, p_name:std.String, ?p_mime:std.String = "\"application/octet-stream\""):Void;
