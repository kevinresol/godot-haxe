...
extern class Control extends gd.CanvasItem {
	...
	function set_anchors_preset(p_preset:gd.control.LayoutPreset, ?p_keep_offsets:Bool = false):Void;
	function set_anchor(p_side:gd.Side, p_anchor:Float, ?p_keep_offset:Bool = false, ?p_push_opposite_anchor:Bool = true):Void;
	...
	function set_anchor_and_offset(p_side:gd.Side, p_anchor:Float, p_offset:Float, ?p_push_opposite_anchor:Bool = false):Void;
	function set_begin(p_position:gd.Vector2):Void;
	function set_end(p_position:gd.Vector2):Void;
	function set_position(p_position:gd.Vector2, ?p_keep_offsets:Bool = false):Void;
	function set_size(p_size:gd.Vector2, ?p_keep_offsets:Bool = false):Void;
	function reset_size():Void;
	function set_custom_minimum_size(p_size:gd.Vector2):gd.Vector2;
	function set_global_position(p_position:gd.Vector2, ?p_keep_offsets:Bool = false):Void;
