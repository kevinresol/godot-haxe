...
extern class Array_wrapper {
	...
	function get(p_index:cpp.Int64):gd.Variant;
	function set(p_index:cpp.Int64, p_value:gd.Variant):Void;
	...
	function insert(p_position:cpp.Int64, p_value:gd.Variant):cpp.Int64;
	...
	function find(p_what:gd.Variant, ?p_from:cpp.Int64):cpp.Int64;
	function find_custom(p_method:gd.Callable, ?p_from:cpp.Int64):cpp.Int64;
	function rfind(p_what:gd.Variant, ?p_from:cpp.Int64):cpp.Int64;
	function rfind_custom(p_method:gd.Callable, ?p_from:cpp.Int64):cpp.Int64;
	function count(p_value:gd.Variant):cpp.Int64;
	function has(p_value:gd.Variant):Bool;
	function pop_back():gd.Variant;
	function pop_front():gd.Variant;
	function pop_at(p_position:cpp.Int64):gd.Variant;
	function sort():Void;
	function sort_custom(p_func:gd.Callable):Void;
	function shuffle():Void;
	function bsearch(p_value:gd.Variant, ?p_before:Bool):cpp.Int64;
...
@:forward @:forwardStatics abstract Array(Array_wrapper) from Array_wrapper to Array_wrapper {
	...
	public extern overload inline function new(p_base:gd.Array, p_type:cpp.Int64, p_class_name:std.String, p_script:gd.Variant) this = Array_wrapper._new2(p_base, p_type, p_class_name, p_script);
