...
extern class Input extends gd.Object {
	...
	function is_action_pressed(p_action:std.String, ?p_exact_match:Bool = false):Bool;
	function is_action_just_pressed(p_action:std.String, ?p_exact_match:Bool = false):Bool;
	function is_action_just_released(p_action:std.String, ?p_exact_match:Bool = false):Bool;
	function get_action_strength(p_action:std.String, ?p_exact_match:Bool = false):Float;
	function get_action_raw_strength(p_action:std.String, ?p_exact_match:Bool = false):Float;
	function get_axis(p_negative_action:std.String, p_positive_action:std.String):Float;
	function get_vector(p_negative_x:std.String, p_positive_x:std.String, p_negative_y:std.String, p_positive_y:std.String, ?p_deadzone:Float = -1.):gd.Vector2;
	function add_joy_mapping(p_mapping:std.String, ?p_update_existing:Bool = false):Void;
	...
	function start_joy_vibration(p_device:Int, p_weak_magnitude:Float, p_strong_magnitude:Float, ?p_duration:Float = 0.):Void;
	function stop_joy_vibration(p_device:Int):Void;
	function vibrate_handheld(?p_duration_ms:Int = 500, ?p_amplitude:Float = -1.):Void;
	...
	function action_press(p_action:std.String, ?p_strength:Float = 1.):Void;
