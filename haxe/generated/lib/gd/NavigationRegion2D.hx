package gd;
extern class NavigationRegion2D extends gd.Node2D {
	function new(?owner:Dynamic);
	function get_rid():gd.RID;
	function set_navigation_polygon(p_navigation_polygon:gd.NavigationPolygon):gd.NavigationPolygon;
	function get_navigation_polygon():gd.NavigationPolygon;
