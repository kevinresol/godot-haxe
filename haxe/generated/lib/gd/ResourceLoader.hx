...
extern class ResourceLoader extends gd.Object {
	...
	function load_threaded_request(p_path:std.String, ?p_type_hint:std.String = "\"\"", ?p_use_sub_threads:Bool = false):gd.Error;
	...
	function add_resource_format_loader(p_format_loader:gd.ResourceFormatLoader, ?p_at_front:Bool = false):Void;
