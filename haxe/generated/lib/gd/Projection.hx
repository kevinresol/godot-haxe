...
extern class Projection_wrapper {
	...
	static function create_frustum_aspect(p_size:Float, p_aspect:Float, p_offset:gd.Vector2, p_z_near:Float, p_z_far:Float, ?p_flip_fov:Bool):gd.Projection;
	static function create_fit_aabb(p_aabb:gd.AABB):gd.Projection;
