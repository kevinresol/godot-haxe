...
@:include("vector") extern class UtilityFunctions {
	...
	static function type_string(p_type:cpp.Int64):std.String;
	...
	static function hash(p_variable:gd.Variant):cpp.Int64;
	static function instance_from_id(p_instance_id:cpp.Int64):gd.Object;
	static function is_instance_id_valid(p_id:cpp.Int64):Bool;
	static function rid_allocate_id():cpp.Int64;
	static function rid_from_int64(p_base:cpp.Int64):gd.RID;
