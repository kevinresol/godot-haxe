...
extern class Window extends gd.Viewport {
	...
	function popup(?p_rect:gd.Rect2i):Void;
	function popup_on_parent(p_parent_rect:gd.Rect2i):Void;
	function popup_centered(?p_minsize:gd.Vector2i):Void;
	function popup_centered_ratio(?p_ratio:Float):Void;
	function popup_centered_clamped(?p_minsize:gd.Vector2i, ?p_fallback_ratio:Float):Void;
	function popup_exclusive(p_from_node:gd.Node, ?p_rect:gd.Rect2i):Void;
	function popup_exclusive_on_parent(p_from_node:gd.Node, p_parent_rect:gd.Rect2i):Void;
	function popup_exclusive_centered(p_from_node:gd.Node, ?p_minsize:gd.Vector2i):Void;
	function popup_exclusive_centered_ratio(p_from_node:gd.Node, ?p_ratio:Float):Void;
	function popup_exclusive_centered_clamped(p_from_node:gd.Node, ?p_minsize:gd.Vector2i, ?p_fallback_ratio:Float):Void;
