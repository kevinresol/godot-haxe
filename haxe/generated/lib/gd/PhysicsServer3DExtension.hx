...
extern class PhysicsServer3DExtension extends gd.PhysicsServer3D {
	...
	function _area_add_shape(p_area:gd.RID, p_shape:gd.RID, p_transform:gd.Transform3D, p_disabled:Bool):Void;
	function _area_set_shape(p_area:gd.RID, p_shape_idx:Int, p_shape:gd.RID):Void;
	function _area_set_shape_transform(p_area:gd.RID, p_shape_idx:Int, p_transform:gd.Transform3D):Void;
	...
	function _area_get_shape_transform(p_area:gd.RID, p_shape_idx:Int):gd.Transform3D;
	...
	function _area_set_transform(p_area:gd.RID, p_transform:gd.Transform3D):Void;
	function _area_get_param(p_area:gd.RID, p_param:gd.physicsserver3d.AreaParameter):gd.Variant;
	function _area_get_transform(p_area:gd.RID):gd.Transform3D;
	...
	function _body_add_shape(p_body:gd.RID, p_shape:gd.RID, p_transform:gd.Transform3D, p_disabled:Bool):Void;
	function _body_set_shape(p_body:gd.RID, p_shape_idx:Int, p_shape:gd.RID):Void;
	function _body_set_shape_transform(p_body:gd.RID, p_shape_idx:Int, p_transform:gd.Transform3D):Void;
	...
	function _body_get_shape_transform(p_body:gd.RID, p_shape_idx:Int):gd.Transform3D;
	...
	function _soft_body_set_transform(p_body:gd.RID, p_transform:gd.Transform3D):Void;
	...
	function _joint_make_hinge(p_joint:gd.RID, p_body_A:gd.RID, p_hinge_A:gd.Transform3D, p_body_B:gd.RID, p_hinge_B:gd.Transform3D):Void;
	...
	function _joint_make_slider(p_joint:gd.RID, p_body_A:gd.RID, p_local_ref_A:gd.Transform3D, p_body_B:gd.RID, p_local_ref_B:gd.Transform3D):Void;
	...
	function _joint_make_cone_twist(p_joint:gd.RID, p_body_A:gd.RID, p_local_ref_A:gd.Transform3D, p_body_B:gd.RID, p_local_ref_B:gd.Transform3D):Void;
	...
	function _joint_make_generic_6dof(p_joint:gd.RID, p_body_A:gd.RID, p_local_ref_A:gd.Transform3D, p_body_B:gd.RID, p_local_ref_B:gd.Transform3D):Void;
