...
extern class TextEdit extends gd.Control {
	...
	function get_line_width(p_line:Int, ?p_wrap_index:Int = -1):Int;
	...
	function remove_line_at(p_line:Int, ?p_move_carets_down:Bool = true):Void;
	function insert_text_at_caret(p_text:std.String, ?p_caret_index:Int = -1):Void;
	function insert_text(p_text:std.String, p_line:Int, p_column:Int, ?p_before_selection_begin:Bool = true, ?p_before_selection_end:Bool = false):Void;
	...
	function backspace(?p_caret_index:Int = -1):Void;
	function cut(?p_caret_index:Int = -1):Void;
	function copy(?p_caret_index:Int = -1):Void;
	function paste(?p_caret_index:Int = -1):Void;
	function paste_primary_clipboard(?p_caret_index:Int = -1):Void;
	...
	function get_line_column_at_pos(p_position:gd.Vector2i, ?p_allow_out_of_bounds:Bool = true):gd.Vector2i;
	...
	function is_mouse_over_selection(p_edges:Bool, ?p_caret_index:Int = -1):Bool;
	...
	function get_sorted_carets(?p_include_ignored_carets:Bool = false):gd.PackedInt32Array;
	function collapse_carets(p_from_line:Int, p_from_column:Int, p_to_line:Int, p_to_column:Int, ?p_inclusive:Bool = false):Void;
	...
	function is_caret_visible(?p_caret_index:Int = 0):Bool;
	function get_caret_draw_pos(?p_caret_index:Int = 0):gd.Vector2;
	function set_caret_line(p_line:Int, ?p_adjust_viewport:Bool = true, ?p_can_be_hidden:Bool = true, ?p_wrap_index:Int = 0, ?p_caret_index:Int = 0):Void;
	function get_caret_line(?p_caret_index:Int = 0):Int;
	function set_caret_column(p_column:Int, ?p_adjust_viewport:Bool = true, ?p_caret_index:Int = 0):Void;
	function get_caret_column(?p_caret_index:Int = 0):Int;
	function get_caret_wrap_index(?p_caret_index:Int = 0):Int;
	function get_word_under_caret(?p_caret_index:Int = -1):std.String;
	...
	function select_word_under_caret(?p_caret_index:Int = -1):Void;
	function add_selection_for_next_occurrence():Void;
	function skip_selection_for_next_occurrence():Void;
	function select(p_origin_line:Int, p_origin_column:Int, p_caret_line:Int, p_caret_column:Int, ?p_caret_index:Int = 0):Void;
	function has_selection(?p_caret_index:Int = -1):Bool;
	function get_selected_text(?p_caret_index:Int = -1):std.String;
	function get_selection_at_line_column(p_line:Int, p_column:Int, ?p_include_edges:Bool = true, ?p_only_selections:Bool = true):Int;
	function get_selection_origin_line(?p_caret_index:Int = 0):Int;
	function get_selection_origin_column(?p_caret_index:Int = 0):Int;
	function set_selection_origin_line(p_line:Int, ?p_can_be_hidden:Bool = true, ?p_wrap_index:Int = -1, ?p_caret_index:Int = 0):Void;
	function set_selection_origin_column(p_column:Int, ?p_caret_index:Int = 0):Void;
	function get_selection_from_line(?p_caret_index:Int = 0):Int;
	function get_selection_from_column(?p_caret_index:Int = 0):Int;
	function get_selection_to_line(?p_caret_index:Int = 0):Int;
	function get_selection_to_column(?p_caret_index:Int = 0):Int;
	function is_caret_after_selection_origin(?p_caret_index:Int = 0):Bool;
	function deselect(?p_caret_index:Int = -1):Void;
	function delete_selection(?p_caret_index:Int = -1):Void;
	...
	function get_scroll_pos_for_line(p_line:Int, ?p_wrap_index:Int = 0):Float;
	function set_line_as_first_visible(p_line:Int, ?p_wrap_index:Int = 0):Void;
	function get_first_visible_line():Int;
	function set_line_as_center_visible(p_line:Int, ?p_wrap_index:Int = 0):Void;
	function set_line_as_last_visible(p_line:Int, ?p_wrap_index:Int = 0):Void;
	...
	function adjust_viewport_to_caret(?p_caret_index:Int = 0):Void;
	function center_viewport_to_caret(?p_caret_index:Int = 0):Void;
	...
	function add_gutter(?p_at:Int = -1):Void;
	...
	function get_selection_line(?p_caret_index:Int = 0):Int;
	function get_selection_column(?p_caret_index:Int = 0):Int;
