...
extern class RichTextLabel extends gd.Control {
	...
	function add_image(p_image:gd.Texture2D, ?p_width:Int, ?p_height:Int, ?p_color:gd.Color, ?p_inline_align:gd.InlineAlignment, ?p_region:gd.Rect2, ?p_key:gd.Variant, ?p_pad:Bool, ?p_tooltip:std.String, ?p_size_in_percent:Bool):Void;
	function update_image(p_key:gd.Variant, p_mask:Int, p_image:gd.Texture2D, ?p_width:Int, ?p_height:Int, ?p_color:gd.Color, ?p_inline_align:gd.InlineAlignment, ?p_region:gd.Rect2, ?p_pad:Bool, ?p_tooltip:std.String, ?p_size_in_percent:Bool):Void;
	...
	function push_font(p_font:gd.Font, ?p_font_size:Int):Void;
	...
	function push_paragraph(p_alignment:gd.HorizontalAlignment, ?p_base_direction:gd.control.TextDirection, ?p_language:std.String, ?p_st_parser:gd.textserver.StructuredTextParser, ?p_justification_flags:Int, ?p_tab_stops:gd.PackedFloat32Array):Void;
	...
	function push_meta(p_data:gd.Variant, ?p_underline_mode:gd.richtextlabel.MetaUnderline):Void;
	...
	function push_table(p_columns:Int, ?p_inline_align:gd.InlineAlignment, ?p_align_to_row:Int):Void;
	function push_dropcap(p_string:std.String, p_font:gd.Font, p_size:Int, ?p_dropcap_margins:gd.Rect2, ?p_color:gd.Color, ?p_outline_size:Int, ?p_outline_color:gd.Color):Void;
