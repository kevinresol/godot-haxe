...
extern class StringName_wrapper {
	...
	function __op_less_than_stringname(p_rhs:std.String):Bool;
	function __op_less_equal_stringname(p_rhs:std.String):Bool;
	function __op_greater_than_stringname(p_rhs:std.String):Bool;
	function __op_greater_equal_stringname(p_rhs:std.String):Bool;
