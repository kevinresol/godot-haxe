...
extern class TextServer extends gd.RefCounted {
	...
	function font_set_transform(p_font_rid:gd.RID, p_transform:gd.Transform2D):Void;
	function font_get_transform(p_font_rid:gd.RID):gd.Transform2D;
	...
	function font_draw_glyph(p_font_rid:gd.RID, p_canvas:gd.RID, p_size:Int, p_pos:gd.Vector2, p_index:Int, ?p_color:gd.Color):Void;
	function font_draw_glyph_outline(p_font_rid:gd.RID, p_canvas:gd.RID, p_size:Int, p_outline_size:Int, p_pos:gd.Vector2, p_index:Int, ?p_color:gd.Color):Void;
	...
	function create_shaped_text(?p_direction:gd.textserver.Direction, ?p_orientation:gd.textserver.Orientation):gd.RID;
	function shaped_text_clear(p_rid:gd.RID):Void;
	function shaped_text_set_direction(p_shaped:gd.RID, ?p_direction:gd.textserver.Direction):Void;
	...
	function shaped_text_set_orientation(p_shaped:gd.RID, ?p_orientation:gd.textserver.Orientation):Void;
	...
	function shaped_text_add_object(p_shaped:gd.RID, p_key:gd.Variant, p_size:gd.Vector2, ?p_inline_align:gd.InlineAlignment, ?p_length:Int, ?p_baseline:Float):Bool;
	function shaped_text_resize_object(p_shaped:gd.RID, p_key:gd.Variant, p_size:gd.Vector2, ?p_inline_align:gd.InlineAlignment, ?p_baseline:Float):Bool;
	...
	function shaped_text_fit_to_width(p_shaped:gd.RID, p_width:Float, ?p_justification_flags:Int):Float;
	...
	function shaped_text_get_line_breaks_adv(p_shaped:gd.RID, p_width:gd.PackedFloat32Array, ?p_start:Int, ?p_once:Bool, ?p_break_flags:Int):gd.PackedInt32Array;
	function shaped_text_get_line_breaks(p_shaped:gd.RID, p_width:Float, ?p_start:Int, ?p_break_flags:Int):gd.PackedInt32Array;
	function shaped_text_get_word_breaks(p_shaped:gd.RID, ?p_grapheme_flags:Int, ?p_skip_grapheme_flags:Int):gd.PackedInt32Array;
	...
	function shaped_text_overrun_trim_to_width(p_shaped:gd.RID, ?p_width:Float, ?p_overrun_trim_flags:Int):Void;
	...
	function shaped_text_draw(p_shaped:gd.RID, p_canvas:gd.RID, p_pos:gd.Vector2, ?p_clip_l:Float, ?p_clip_r:Float, ?p_color:gd.Color):Void;
	function shaped_text_draw_outline(p_shaped:gd.RID, p_canvas:gd.RID, p_pos:gd.Vector2, ?p_clip_l:Float, ?p_clip_r:Float, ?p_outline_size:Int, ?p_color:gd.Color):Void;
	...
	function string_get_word_breaks(p_string:std.String, ?p_language:std.String, ?p_chars_per_line:Int):gd.PackedInt32Array;
