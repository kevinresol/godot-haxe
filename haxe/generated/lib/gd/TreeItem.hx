...
extern class TreeItem extends gd.Object {
	...
	function propagate_check(p_column:Int, ?p_emit_signal:Bool = true):Void;
	...
	function set_range_config(p_column:Int, p_min:Float, p_max:Float, p_step:Float, ?p_expr:Bool = false):Void;
	...
	function is_any_collapsed(?p_only_visible:Bool = false):Bool;
	...
	function set_custom_bg_color(p_column:Int, p_color:gd.Color, ?p_just_outline:Bool = false):Void;
	...
	function add_button(p_column:Int, p_button:gd.Texture2D, ?p_id:Int = -1, ?p_disabled:Bool = false, ?p_tooltip_text:std.String = "\"\""):Void;
	...
	function create_child(?p_index:Int = -1):gd.TreeItem;
	...
	function get_next_in_tree(?p_wrap:Bool = false):gd.TreeItem;
	function get_prev_in_tree(?p_wrap:Bool = false):gd.TreeItem;
	function get_next_visible(?p_wrap:Bool = false):gd.TreeItem;
	function get_prev_visible(?p_wrap:Bool = false):gd.TreeItem;
