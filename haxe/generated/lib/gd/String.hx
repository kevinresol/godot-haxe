...
extern class String_wrapper {
	...
	function casecmp_to(p_to:std.String):cpp.Int64;
	function nocasecmp_to(p_to:std.String):cpp.Int64;
	function naturalcasecmp_to(p_to:std.String):cpp.Int64;
	function naturalnocasecmp_to(p_to:std.String):cpp.Int64;
	function filecasecmp_to(p_to:std.String):cpp.Int64;
	function filenocasecmp_to(p_to:std.String):cpp.Int64;
	function length():cpp.Int64;
	function substr(p_from:cpp.Int64, ?p_len:cpp.Int64):std.String;
	function get_slice(p_delimiter:std.String, p_slice:cpp.Int64):std.String;
	function get_slicec(p_delimiter:cpp.Int64, p_slice:cpp.Int64):std.String;
	function get_slice_count(p_delimiter:std.String):cpp.Int64;
	function find(p_what:std.String, ?p_from:cpp.Int64):cpp.Int64;
	function findn(p_what:std.String, ?p_from:cpp.Int64):cpp.Int64;
	function count(p_what:std.String, ?p_from:cpp.Int64, ?p_to:cpp.Int64):cpp.Int64;
	function countn(p_what:std.String, ?p_from:cpp.Int64, ?p_to:cpp.Int64):cpp.Int64;
	function rfind(p_what:std.String, ?p_from:cpp.Int64):cpp.Int64;
	function rfindn(p_what:std.String, ?p_from:cpp.Int64):cpp.Int64;
	...
	function erase(p_position:cpp.Int64, ?p_chars:cpp.Int64):std.String;
	...
	function left(p_length:cpp.Int64):std.String;
	function right(p_length:cpp.Int64):std.String;
	...
	function lpad(p_min_length:cpp.Int64, ?p_character:std.String):std.String;
	function rpad(p_min_length:cpp.Int64, ?p_character:std.String):std.String;
	function pad_decimals(p_digits:cpp.Int64):std.String;
	function pad_zeros(p_digits:cpp.Int64):std.String;
	...
	static function num(p_number:Float, ?p_decimals:cpp.Int64):std.String;
	static function num_int64(p_number:cpp.Int64, ?p_base:cpp.Int64, ?p_capitalize_hex:Bool):std.String;
	static function num_uint64(p_number:cpp.Int64, ?p_base:cpp.Int64, ?p_capitalize_hex:Bool):std.String;
	static function chr(p_char:cpp.Int64):std.String;
	static function humanize_size(p_size:cpp.Int64):std.String;
	...
	function __op_modulus_int(p_rhs:cpp.Int64):std.String;
