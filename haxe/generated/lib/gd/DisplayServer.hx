...
extern class DisplayServer extends gd.Object {
	...
	function global_menu_add_submenu_item(p_menu_root:std.String, p_label:std.String, p_submenu:std.String, ?p_index:Int = -1):Int;
	function global_menu_add_separator(p_menu_root:std.String, ?p_index:Int = -1):Int;
	...
	function tts_speak(p_text:std.String, p_voice:std.String, ?p_volume:Int = 50, ?p_pitch:Float = 1., ?p_rate:Float = 1., ?p_utterance_id:Int = 0, ?p_interrupt:Bool = false):Void;
	...
	function screen_get_position(?p_screen:Int = -1):gd.Vector2i;
	function screen_get_size(?p_screen:Int = -1):gd.Vector2i;
	function screen_get_usable_rect(?p_screen:Int = -1):gd.Rect2i;
	function screen_get_dpi(?p_screen:Int = -1):Int;
	function screen_get_scale(?p_screen:Int = -1):Float;
	function is_touchscreen_available():Bool;
	function screen_get_max_scale():Float;
	function screen_get_refresh_rate(?p_screen:Int = -1):Float;
	function screen_get_pixel(p_position:gd.Vector2i):gd.Color;
	function screen_get_image(?p_screen:Int = -1):gd.Image;
	function screen_set_orientation(p_orientation:gd.displayserver.ScreenOrientation, ?p_screen:Int = -1):Void;
	function screen_get_orientation(?p_screen:Int = -1):gd.displayserver.ScreenOrientation;
	...
	function window_get_native_handle(p_handle_type:gd.displayserver.HandleType, ?p_window_id:Int = 0):Int;
	...
	function window_set_title(p_title:std.String, ?p_window_id:Int = 0):Void;
	function window_get_title_size(p_title:std.String, ?p_window_id:Int = 0):gd.Vector2i;
	function window_set_mouse_passthrough(p_region:gd.PackedVector2Array, ?p_window_id:Int = 0):Void;
	function window_get_current_screen(?p_window_id:Int = 0):Int;
	function window_set_current_screen(p_screen:Int, ?p_window_id:Int = 0):Void;
	function window_get_position(?p_window_id:Int = 0):gd.Vector2i;
	function window_get_position_with_decorations(?p_window_id:Int = 0):gd.Vector2i;
	function window_set_position(p_position:gd.Vector2i, ?p_window_id:Int = 0):Void;
	function window_get_size(?p_window_id:Int = 0):gd.Vector2i;
	function window_set_size(p_size:gd.Vector2i, ?p_window_id:Int = 0):Void;
	function window_set_rect_changed_callback(p_callback:gd.Callable, ?p_window_id:Int = 0):Void;
	function window_set_window_event_callback(p_callback:gd.Callable, ?p_window_id:Int = 0):Void;
	function window_set_input_event_callback(p_callback:gd.Callable, ?p_window_id:Int = 0):Void;
	function window_set_input_text_callback(p_callback:gd.Callable, ?p_window_id:Int = 0):Void;
	function window_set_drop_files_callback(p_callback:gd.Callable, ?p_window_id:Int = 0):Void;
	function window_get_attached_instance_id(?p_window_id:Int = 0):Int;
	function window_get_max_size(?p_window_id:Int = 0):gd.Vector2i;
	function window_set_max_size(p_max_size:gd.Vector2i, ?p_window_id:Int = 0):Void;
	function window_get_min_size(?p_window_id:Int = 0):gd.Vector2i;
	function window_set_min_size(p_min_size:gd.Vector2i, ?p_window_id:Int = 0):Void;
	function window_get_size_with_decorations(?p_window_id:Int = 0):gd.Vector2i;
	function window_get_mode(?p_window_id:Int = 0):gd.displayserver.WindowMode;
	function window_set_mode(p_mode:gd.displayserver.WindowMode, ?p_window_id:Int = 0):Void;
	function window_set_flag(p_flag:gd.displayserver.WindowFlags, p_enabled:Bool, ?p_window_id:Int = 0):Void;
	function window_get_flag(p_flag:gd.displayserver.WindowFlags, ?p_window_id:Int = 0):Bool;
	function window_set_window_buttons_offset(p_offset:gd.Vector2i, ?p_window_id:Int = 0):Void;
	function window_get_safe_title_margins(?p_window_id:Int = 0):gd.Vector3i;
	function window_request_attention(?p_window_id:Int = 0):Void;
	function window_move_to_foreground(?p_window_id:Int = 0):Void;
	function window_is_focused(?p_window_id:Int = 0):Bool;
	function window_can_draw(?p_window_id:Int = 0):Bool;
	...
	function window_set_ime_active(p_active:Bool, ?p_window_id:Int = 0):Void;
	function window_set_ime_position(p_position:gd.Vector2i, ?p_window_id:Int = 0):Void;
	function window_set_vsync_mode(p_vsync_mode:gd.displayserver.VSyncMode, ?p_window_id:Int = 0):Void;
	function window_get_vsync_mode(?p_window_id:Int = 0):gd.displayserver.VSyncMode;
	function window_is_maximize_allowed(?p_window_id:Int = 0):Bool;
