...
@:include("godot_cpp/classes/node2d.hpp") @:native("godot::Node2D") @:structAccess extern class Node2D_obj extends godot.gen.CanvasItem.CanvasItem_obj {
	function set_position(p_position:godot.gen.Vector2):Void;
	...
	function set_scale(p_scale:godot.gen.Vector2):Void;
	function get_position():godot.gen.Vector2;
	function get_rotation():Float;
	function get_rotation_degrees():Float;
	function get_skew():Float;
	function get_scale():godot.gen.Vector2;
	...
	function translate(p_offset:godot.gen.Vector2):Void;
	function global_translate(p_offset:godot.gen.Vector2):Void;
	function apply_scale(p_ratio:godot.gen.Vector2):Void;
	function set_global_position(p_position:godot.gen.Vector2):Void;
	function get_global_position():godot.gen.Vector2;
	...
	function set_global_scale(p_scale:godot.gen.Vector2):Void;
	function get_global_scale():godot.gen.Vector2;
	function look_at(p_point:godot.gen.Vector2):Void;
	function get_angle_to(p_point:godot.gen.Vector2):Float;
...
typedef Node2D_star = cpp.Star<Node2D_obj>;