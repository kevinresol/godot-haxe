package godot.gen;
@:include("godot_cpp/classes/sprite2d.hpp") @:native("godot::Sprite2D") @:structAccess extern class Sprite2D_obj extends godot.gen.Node2D.Node2D_obj {
	function set_centered(p_centered:Bool):Void;
	function is_centered():Bool;
	function set_offset(p_offset:godot.gen.Vector2):Void;
	function get_offset():godot.gen.Vector2;
	...
	function is_pixel_opaque(p_pos:godot.gen.Vector2):Bool;
