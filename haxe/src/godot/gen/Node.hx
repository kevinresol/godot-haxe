...
@:include("godot_cpp/classes/node.hpp") @:native("godot::Node") @:structAccess extern class Node_obj extends godot.gen.Object.Object_obj {
	...
	function add_sibling(p_sibling:godot.gen.Node, ?p_force_readable_name:Bool):Void;
	function set_name(p_name:godot.String):Void;
	function get_name():godot.StringName;
	function remove_child(p_node:godot.gen.Node):Void;
	function reparent(p_new_parent:godot.gen.Node, ?p_keep_global_transform:Bool):Void;
	function get_child_count(?p_include_internal:Bool):Int;
	function get_child(p_idx:Int, ?p_include_internal:Bool):godot.gen.Node;
	function has_node(p_path:godot.NodePath):Bool;
	extern inline function get_node(p_path:godot.NodePath):godot.gen.Node return untyped __cpp__("{0}.get_node<godot::Node>({1})", this, p_path);
	function get_node_or_null(p_path:godot.NodePath):godot.gen.Node;
	function get_parent():godot.gen.Node;
	function find_child(p_pattern:godot.String, ?p_recursive:Bool, ?p_owned:Bool):godot.gen.Node;
	function find_parent(p_pattern:godot.String):godot.gen.Node;
	...
	function is_ancestor_of(p_node:godot.gen.Node):Bool;
	function is_greater_than(p_node:godot.gen.Node):Bool;
	function get_path():godot.NodePath;
	function get_path_to(p_node:godot.gen.Node, ?p_use_unique_path:Bool):godot.NodePath;
	...
	function move_child(p_child_node:godot.gen.Node, p_to_index:Int):Void;
	function set_owner(p_owner:godot.gen.Node):Void;
	function get_owner():godot.gen.Node;
	...
	function duplicate(?p_flags:Int):godot.gen.Node;
	function replace_by(p_node:godot.gen.Node, ?p_keep_groups:Bool):Void;
	...
	function set_editable_instance(p_node:godot.gen.Node, p_is_editable:Bool):Void;
	function is_editable_instance(p_node:godot.gen.Node):Bool;
